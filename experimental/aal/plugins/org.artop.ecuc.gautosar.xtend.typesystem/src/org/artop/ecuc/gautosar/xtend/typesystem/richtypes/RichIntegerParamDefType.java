...
public class RichIntegerParamDefType extends AbstractRichConfigParameterType {

	public RichIntegerParamDefType(EcucContext context, GIntegerParamDef integerParamDef) {
