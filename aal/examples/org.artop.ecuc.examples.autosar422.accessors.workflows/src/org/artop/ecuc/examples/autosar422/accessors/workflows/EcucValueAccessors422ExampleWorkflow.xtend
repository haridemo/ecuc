 ...
 * </copyright>
 */
package org.artop.ecuc.examples.autosar422.accessors.workflows
...
import org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor.NvMTargetBlockReference
import java.math.BigInteger

class EcucValueAccessors422ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new EcucValueAccessors422ExampleWorkflowComponent
	}
}

class EcucValueAccessors422ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
