...
class Autosar422ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new Autosar422ExampleWorkflowComponent
	}
}

class Autosar422ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
