...
class Autosar444ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new Autosar444ExampleWorkflowComponent
	}
}

class Autosar444ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
