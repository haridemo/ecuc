 ...
 * </copyright>
 */
package org.artop.ecuc.examples.autosar444.accessors.workflows
...
import org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor.NvMTargetBlockReference
import java.math.BigInteger

class EcucValueAccessors444ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new EcucValueAccessors444ExampleWorkflowComponent
	}
}

class EcucValueAccessors444ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
