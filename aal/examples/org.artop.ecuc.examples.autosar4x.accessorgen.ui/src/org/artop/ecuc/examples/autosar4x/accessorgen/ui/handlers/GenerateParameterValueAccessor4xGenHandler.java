 ...
 */
public class GenerateParameterValueAccessor4xGenHandler extends AbstractGenerateFromAutosarHandler {

	/*
	 * @see org.artop.ecuc.gautosar.paramdefgen.ui.handlers.AbstractGenerateFromAutosarHandler#
	...
	protected IWorkspaceOperation createGenerateFromAutosarOperation(IFile autosarFile) {
		return new GenerateEcucValueAccessor4xOperation(autosarFile,
				GenerateEcucValueAccessor4xGenAction.DEFAULT_ABSOLUTE_QUALIFIED_AR_PACKAGE_NAME);
	}
}
