...
class Autosar442ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new Autosar442ExampleWorkflowComponent
	}
}

class Autosar442ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
