...
import org.artop.ecuc.autosar431.accessors.NvM.NvMBlockDescriptor.NvMTargetBlockReference
import java.math.BigInteger

class EcucValueAccessors431ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new EcucValueAccessors431ExampleWorkflowComponent
	}
}

class EcucValueAccessors431ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
