 ...
 * </copyright>
 */
package org.artop.ecuc.examples.autosar430.accessors.workflows
...
import org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor.NvMTargetBlockReference
import java.math.BigInteger

class EcucValueAccessors430ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new EcucValueAccessors430ExampleWorkflowComponent
	}
}

class EcucValueAccessors430ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
