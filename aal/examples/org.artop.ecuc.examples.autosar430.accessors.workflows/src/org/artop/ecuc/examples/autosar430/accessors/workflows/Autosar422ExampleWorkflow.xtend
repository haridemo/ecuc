...
class Autosar430ExampleWorkflow extends WorkspaceWorkflow {

	new(){
		children += new Autosar430ExampleWorkflowComponent
	}
}

class Autosar430ExampleWorkflowComponent extends AbstractModelWorkflowComponent {
