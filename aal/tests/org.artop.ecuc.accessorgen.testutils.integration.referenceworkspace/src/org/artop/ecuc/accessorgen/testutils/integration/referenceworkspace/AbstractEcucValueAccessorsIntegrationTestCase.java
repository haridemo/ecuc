...
import static org.artop.ecuc.accessorgen.testutils.integration.referenceworkspace.EcucValueAccessorsTestReferenceWorkspaceDescriptor.AUTOSAR_4X_PARAMETER_DEFINITIONS_FILE_PATH;
import static org.artop.ecuc.accessorgen.testutils.integration.referenceworkspace.EcucValueAccessorsTestReferenceWorkspaceDescriptor.AUTOSAR_4X_PARAMETER_VALUES_FILE_PATH;
...
public abstract class AbstractEcucValueAccessorsIntegrationTestCase extends
		IntegrationTestCase<EcucValueAccessorsTestReferenceWorkspace> {
	...
	public AbstractEcucValueAccessorsIntegrationTestCase() {
		super(new EcucValueAccessorsTestReferenceWorkspace(AUTOSAR_4X_PROJECT_NAME));
	}
