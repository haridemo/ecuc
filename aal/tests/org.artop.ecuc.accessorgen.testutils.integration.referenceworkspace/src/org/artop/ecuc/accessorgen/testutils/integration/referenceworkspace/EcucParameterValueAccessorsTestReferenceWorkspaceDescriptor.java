...
public class EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor extends AbstractReferenceWorkspace implements IRefWorkspaceDescriptor {

	private static final String REFERENCE_WORKSPACE_NAME = "ecucParameterValueAccessorsReferenceWorkspace";
	...
	public EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor(String[] referenceProjectNames) {
	...
	public Bundle getSrcBundle() {
		return getBundle(EcucParameterValueAccessorsTestReferenceWorkspace.class);
	}
