...
import org.artop.ecuc.accessorgen.testutils.integration.referenceworkspace.AbstractEcucParameterValueAccessorsIntegrationTestCase;
import org.artop.ecuc.accessorgen.testutils.integration.referenceworkspace.EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor;
...
public class EcucParameterValueAccessorsTest extends AbstractEcucParameterValueAccessorsIntegrationTestCase {
	...
	public void testGModuleConfigurationShortNameAccessors() {
		EObject adcModuleConfiguration = getConfigurationObject(EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor.URI_FRAGMENT_ADC_MODULE_CONFIGURATION);
	...
	public void testContainerValueSetterAccessors() {
		EObject nvmModuleConfiguration = getConfigurationObject(EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor.URI_FRAGMENT_NVM_MODULE_CONFIGURATION);
	...
	public void testAddingContainerValueMany() {
		final EObject nvmModuleConfiguration = getConfigurationObject(EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor.URI_FRAGMENT_NVM_MODULE_CONFIGURATION);
		assertTrue(nvmModuleConfiguration instanceof EcucModuleConfigurationValues);
	...
	public void testTextualParameterValueGetterAccessors() {
		EObject bswModuleConfiguration = getConfigurationObject(EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor.URI_FRAGMENT_BSW_MODULE_CONFIGURATION);
	...
	public void testReferenceValueAccessors() {
		...
		final EObject ecucPartitionContainerValue = getConfigurationObject(EcucParameterValueAccessorsTestReferenceWorkspaceDescriptor.URI_FRAGMENT_ECUC_PARTITION_MODULE_CONFIGURATION);
