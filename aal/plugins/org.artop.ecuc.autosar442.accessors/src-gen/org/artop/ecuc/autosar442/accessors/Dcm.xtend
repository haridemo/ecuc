...
class Dcm implements IWrapper<GModuleConfiguration> {
		...
		static class DcmDsd implements IWrapper<GContainer> {
			...
			def List<DcmDsdServiceRequestManufacturerNotification> getDcmDsdServiceRequestManufacturerNotifications(){
				...
				return new BasicWrappingEList<DcmDsdServiceRequestManufacturerNotification, GContainer>(filteredContainers, typeof(DcmDsdServiceRequestManufacturerNotification), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceRequestManufacturerNotification dcmDsdServiceRequestManufacturerNotification) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceRequestManufacturerNotification dcmDsdServiceRequestManufacturerNotification) {
						dcmDsdServiceRequestManufacturerNotification.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDsdServiceRequestManufacturerNotification"))
			...
			def List<DcmDsdServiceRequestSupplierNotification> getDcmDsdServiceRequestSupplierNotifications(){
				...
				return new BasicWrappingEList<DcmDsdServiceRequestSupplierNotification, GContainer>(filteredContainers, typeof(DcmDsdServiceRequestSupplierNotification), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceRequestSupplierNotification dcmDsdServiceRequestSupplierNotification) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceRequestSupplierNotification dcmDsdServiceRequestSupplierNotification) {
						dcmDsdServiceRequestSupplierNotification.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDsdServiceRequestSupplierNotification"))
			...
			def List<DcmDsdServiceTable> getDcmDsdServiceTables(){
				...
				return new BasicWrappingEList<DcmDsdServiceTable, GContainer>(filteredContainers, typeof(DcmDsdServiceTable), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable dcmDsdServiceTable) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable dcmDsdServiceTable) {
						dcmDsdServiceTable.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDsdServiceTable"))
			...
			static class DcmDsdServiceTable implements IWrapper<GContainer> {
				...
				def List<DcmDsdService> getDcmDsdServices(){
					...
					return new BasicWrappingEList<DcmDsdService, GContainer>(filteredContainers, typeof(DcmDsdService), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable.DcmDsdService dcmDsdService) {
							dcmDsdService.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDsdService"))
							super.delegateAdd(dcmDsdService)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable.DcmDsdService dcmDsdService) {
							dcmDsdService.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDsdService"))
				...
				static class DcmDsdService implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDsdSidTabModeRuleRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDsdSidTabModeRuleRef")
					}
					
					def void setDcmDsdSidTabModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDsdSidTabSecurityLevelRefs(){
						val containerDef = containerValue.gGetDefinition
						...
						return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow)) {
							override protected wrap(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow object) throws CoreException {
								if (object !== null) {
							...
							override protected unwrap(GReferenceValue referenceValue) {
								if (referenceValue !== null) {
									...
									if (referenceValueValue instanceof GContainer) {
										return new org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow(referenceValueValue as GContainer)
									}
								}
							}
						}
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDsdSidTabSessionLevelRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
						...
						return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow)) {
							override protected wrap(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow object) throws CoreException {
								if (object !== null) {
									val container = object.getTarget()
									val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
									referenceValue.gSetDefinition(referenceValueDef)
							...
							override protected unwrap(GReferenceValue referenceValue) {
								if (referenceValue !== null) {
									val referenceValueValue = referenceValue.gGetValue
									if (referenceValueValue instanceof GContainer) {
										return new org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow(referenceValueValue as GContainer)
									}
								}
							}
						}
					...
					def List<DcmDsdSubService> getDcmDsdSubServices(){
						...
						return new BasicWrappingEList<DcmDsdSubService, GContainer>(filteredContainers, typeof(DcmDsdSubService), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable.DcmDsdService.DcmDsdSubService dcmDsdSubService) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable.DcmDsdService.DcmDsdSubService dcmDsdSubService) {
								dcmDsdSubService.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDsdSubService"))
					...
					static class DcmDsdSubService implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDsdSubServiceModeRuleRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDsdSubServiceModeRuleRef")
						}
						
						def void setDcmDsdSubServiceModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDsdSubServiceSecurityLevelRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
						...
						def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDsdSubServiceSessionLevelRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DcmDsl implements IWrapper<GContainer> {
			...
			def List<DcmDslBuffer> getDcmDslBuffers(){
				...
				return new BasicWrappingEList<DcmDslBuffer, GContainer>(filteredContainers, typeof(DcmDslBuffer), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer dcmDslBuffer) {
						dcmDslBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslBuffer"))
						super.delegateAdd(dcmDslBuffer)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer dcmDslBuffer) {
						dcmDslBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslBuffer"))
			...
			def List<DcmDslCallbackDCMRequestService> getDcmDslCallbackDCMRequestServices(){
				...
				return new BasicWrappingEList<DcmDslCallbackDCMRequestService, GContainer>(filteredContainers, typeof(DcmDslCallbackDCMRequestService), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslCallbackDCMRequestService dcmDslCallbackDCMRequestService) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslCallbackDCMRequestService dcmDslCallbackDCMRequestService) {
						dcmDslCallbackDCMRequestService.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslCallbackDCMRequestService"))
			...
			static class DcmDslProtocol implements IWrapper<GContainer> {
				...
				def List<DcmDslProtocolRow> getDcmDslProtocolRows(){
					...
					return new BasicWrappingEList<DcmDslProtocolRow, GContainer>(filteredContainers, typeof(DcmDslProtocolRow), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow dcmDslProtocolRow) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow dcmDslProtocolRow) {
							dcmDslProtocolRow.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslProtocolRow"))
				...
				static class DcmDslProtocolRow implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient getDcmDemClientRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient), "DcmDemClientRef")
					}
					
					def void setDcmDemClientRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer getDcmDslProtocolRxBufferRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer), "DcmDslProtocolRxBufferRef")
					}
					
					def void setDcmDslProtocolRxBufferRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable getDcmDslProtocolSIDTable(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable), "DcmDslProtocolSIDTable")
					}
					
					def void setDcmDslProtocolSIDTable(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsd.DcmDsdServiceTable object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer getDcmDslProtocolTxBufferRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer), "DcmDslProtocolTxBufferRef")
					}
					
					def void setDcmDslProtocolTxBufferRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslBuffer object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def List<DcmDslConnection> getDcmDslConnections(){
						...
						return new BasicWrappingEList<DcmDslConnection, GContainer>(filteredContainers, typeof(DcmDslConnection), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection dcmDslConnection) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection dcmDslConnection) {
								dcmDslConnection.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslConnection"))
					...
					static class DcmDslConnection implements IWrapper<GContainer> {
						...
						static class DcmDslMainConnection implements IWrapper<GContainer> {
							...
							def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslPeriodicTransmission getDcmDslPeriodicTransmissionConRef(){
								containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslPeriodicTransmission), "DcmDslPeriodicTransmissionConRef")
							}
							
							def void setDcmDslPeriodicTransmissionConRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslPeriodicTransmission object){
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
							...
							def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getDcmDslProtocolComMChannelRef(){
								containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "DcmDslProtocolComMChannelRef")
							}
							
							def void setDcmDslProtocolComMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
							...
							def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslResponseOnEvent getDcmDslROEConnectionRef(){
								containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslResponseOnEvent), "DcmDslROEConnectionRef")
							}
							
							def void setDcmDslROEConnectionRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslResponseOnEvent object){
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
							...
							def List<DcmDslProtocolRx> getDcmDslProtocolRxs(){
								...
								return new BasicWrappingEList<DcmDslProtocolRx, GContainer>(filteredContainers, typeof(DcmDslProtocolRx), typeof(GContainer)) {
									override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslMainConnection.DcmDslProtocolRx dcmDslProtocolRx) {
									...
									override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslMainConnection.DcmDslProtocolRx dcmDslProtocolRx) {
										dcmDslProtocolRx.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslProtocolRx"))
							...
							static class DcmDslProtocolRx implements IWrapper<GContainer> {
								...
								def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDcmDslProtocolRxPduRef(){
									containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DcmDslProtocolRxPduRef")
								}
								
								def void setDcmDslProtocolRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
									val containerDef = containerValue.gGetDefinition
									if (containerDef instanceof GParamConfContainerDef) {
							...
							static class DcmDslProtocolTx implements IWrapper<GContainer> {
								...
								def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDcmDslProtocolTxPduRef(){
									containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DcmDslProtocolTxPduRef")
								}
								
								def void setDcmDslProtocolTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
									val containerDef = containerValue.gGetDefinition
									if (containerDef instanceof GParamConfContainerDef) {
						...
						static class DcmDslPeriodicTransmission implements IWrapper<GContainer> {
							...
							def List<DcmDslPeriodicConnection> getDcmDslPeriodicConnections(){
								...
								return new BasicWrappingEList<DcmDslPeriodicConnection, GContainer>(filteredContainers, typeof(DcmDslPeriodicConnection), typeof(GContainer)) {
									override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslPeriodicTransmission.DcmDslPeriodicConnection dcmDslPeriodicConnection) {
									...
									override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsl.DcmDslProtocol.DcmDslProtocolRow.DcmDslConnection.DcmDslPeriodicTransmission.DcmDslPeriodicConnection dcmDslPeriodicConnection) {
										dcmDslPeriodicConnection.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDslPeriodicConnection"))
							...
							static class DcmDslPeriodicConnection implements IWrapper<GContainer> {
								...
								def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDcmDslPeriodicTxPduRef(){
									containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DcmDslPeriodicTxPduRef")
								}
								
								def void setDcmDslPeriodicTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
									val containerDef = containerValue.gGetDefinition
									if (containerDef instanceof GParamConfContainerDef) {
						...
						static class DcmDslResponseOnEvent implements IWrapper<GContainer> {
							...
							def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDcmDslRoeTxPduRef(){
								containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DcmDslRoeTxPduRef")
							}
							
							def void setDcmDslRoeTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DcmDsp implements IWrapper<GContainer> {
			...
			def List<DcmDspCommonAuthorization> getDcmDspCommonAuthorizations(){
				...
				return new BasicWrappingEList<DcmDspCommonAuthorization, GContainer>(filteredContainers, typeof(DcmDspCommonAuthorization), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization dcmDspCommonAuthorization) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization dcmDspCommonAuthorization) {
						dcmDspCommonAuthorization.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspCommonAuthorization"))
			...
			def List<DcmDspData> getDcmDspDatas(){
				...
				return new BasicWrappingEList<DcmDspData, GContainer>(filteredContainers, typeof(DcmDspData), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData dcmDspData) {
						dcmDspData.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspData"))
						super.delegateAdd(dcmDspData)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData dcmDspData) {
						dcmDspData.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspData"))
			...
			def List<DcmDspDataInfo> getDcmDspDataInfos(){
				...
				return new BasicWrappingEList<DcmDspDataInfo, GContainer>(filteredContainers, typeof(DcmDspDataInfo), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDataInfo dcmDspDataInfo) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDataInfo dcmDspDataInfo) {
						dcmDspDataInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDataInfo"))
			...
			def List<DcmDspDid> getDcmDspDids(){
				...
				return new BasicWrappingEList<DcmDspDid, GContainer>(filteredContainers, typeof(DcmDspDid), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid dcmDspDid) {
						dcmDspDid.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDid"))
						super.delegateAdd(dcmDspDid)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid dcmDspDid) {
						dcmDspDid.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDid"))
			...
			def List<DcmDspDidInfo> getDcmDspDidInfos(){
				...
				return new BasicWrappingEList<DcmDspDidInfo, GContainer>(filteredContainers, typeof(DcmDspDidInfo), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo dcmDspDidInfo) {
						dcmDspDidInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDidInfo"))
						super.delegateAdd(dcmDspDidInfo)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo dcmDspDidInfo) {
						dcmDspDidInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDidInfo"))
			...
			def List<DcmDspDidRange> getDcmDspDidRanges(){
				...
				return new BasicWrappingEList<DcmDspDidRange, GContainer>(filteredContainers, typeof(DcmDspDidRange), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidRange dcmDspDidRange) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidRange dcmDspDidRange) {
						dcmDspDidRange.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDidRange"))
			...
			def List<DcmDspPid> getDcmDspPids(){
				...
				return new BasicWrappingEList<DcmDspPid, GContainer>(filteredContainers, typeof(DcmDspPid), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid dcmDspPid) {
						dcmDspPid.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspPid"))
						super.delegateAdd(dcmDspPid)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid dcmDspPid) {
						dcmDspPid.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspPid"))
			...
			def List<DcmDspRequestControl> getDcmDspRequestControls(){
				...
				return new BasicWrappingEList<DcmDspRequestControl, GContainer>(filteredContainers, typeof(DcmDspRequestControl), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRequestControl dcmDspRequestControl) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRequestControl dcmDspRequestControl) {
						dcmDspRequestControl.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspRequestControl"))
			...
			def List<DcmDspRoutine> getDcmDspRoutines(){
				...
				return new BasicWrappingEList<DcmDspRoutine, GContainer>(filteredContainers, typeof(DcmDspRoutine), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine dcmDspRoutine) {
						dcmDspRoutine.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspRoutine"))
						super.delegateAdd(dcmDspRoutine)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine dcmDspRoutine) {
						dcmDspRoutine.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspRoutine"))
			...
			def List<DcmDspVehInfo> getDcmDspVehInfos(){
				...
				return new BasicWrappingEList<DcmDspVehInfo, GContainer>(filteredContainers, typeof(DcmDspVehInfo), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspVehInfo dcmDspVehInfo) {
						dcmDspVehInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspVehInfo"))
						super.delegateAdd(dcmDspVehInfo)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspVehInfo dcmDspVehInfo) {
						dcmDspVehInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspVehInfo"))
			...
			static class DcmDspClearDTC implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspClearDTCModeRuleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspClearDTCModeRuleRef")
				}
				
				def void setDcmDspClearDTCModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspComControl implements IWrapper<GContainer> {
				...
				def List<DcmDspComControlAllChannel> getDcmDspComControlAllChannels(){
					...
					return new BasicWrappingEList<DcmDspComControlAllChannel, GContainer>(filteredContainers, typeof(DcmDspComControlAllChannel), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspComControl.DcmDspComControlAllChannel dcmDspComControlAllChannel) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspComControl.DcmDspComControlAllChannel dcmDspComControlAllChannel) {
							dcmDspComControlAllChannel.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspComControlAllChannel"))
				...
				def List<DcmDspComControlSpecificChannel> getDcmDspComControlSpecificChannels(){
					...
					return new BasicWrappingEList<DcmDspComControlSpecificChannel, GContainer>(filteredContainers, typeof(DcmDspComControlSpecificChannel), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspComControl.DcmDspComControlSpecificChannel dcmDspComControlSpecificChannel) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspComControl.DcmDspComControlSpecificChannel dcmDspComControlSpecificChannel) {
							dcmDspComControlSpecificChannel.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspComControlSpecificChannel"))
				...
				def List<DcmDspComControlSubNode> getDcmDspComControlSubNodes(){
					...
					return new BasicWrappingEList<DcmDspComControlSubNode, GContainer>(filteredContainers, typeof(DcmDspComControlSubNode), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspComControl.DcmDspComControlSubNode dcmDspComControlSubNode) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspComControl.DcmDspComControlSubNode dcmDspComControlSubNode) {
							dcmDspComControlSubNode.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspComControlSubNode"))
				...
				static class DcmDspComControlAllChannel implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getDcmDspAllComMChannelRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "DcmDspAllComMChannelRef")
					}
					
					def void setDcmDspAllComMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class DcmDspComControlSetting implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspComControlCommunicationReEnableModeRuleRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspComControlCommunicationReEnableModeRuleRef")
					}
					
					def void setDcmDspComControlCommunicationReEnableModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class DcmDspComControlSpecificChannel implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getDcmDspSpecificComMChannelRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "DcmDspSpecificComMChannelRef")
					}
					
					def void setDcmDspSpecificComMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class DcmDspComControlSubNode implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getDcmDspComControlSubNodeComMChannelRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "DcmDspComControlSubNodeComMChannelRef")
					}
					
					def void setDcmDspComControlSubNodeComMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspCommonAuthorization implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspCommonAuthorizationModeRuleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspCommonAuthorizationModeRuleRef")
				}
				
				def void setDcmDspCommonAuthorizationModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDspCommonAuthorizationSecurityLevelRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDspCommonAuthorizationSessionRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			static class DcmDspControlDTCSetting implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspControlDTCSettingReEnableModeRuleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspControlDTCSettingReEnableModeRuleRef")
				}
				
				def void setDcmDspControlDTCSettingReEnableModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspData implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor getDcmDspDataBlockIdRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor), "DcmDspDataBlockIdRef")
				}
				
				def void setDcmDspDataBlockIdRef(org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDataInfo getDcmDspDataInfoRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDataInfo), "DcmDspDataInfoRef")
				}
				
				def void setDcmDspDataInfoRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDataInfo object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
					...
					static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
						...
						def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
							...
							return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData.DcmDspDiagnosisScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData.DcmDspDiagnosisScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
									dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
				...
				static class DcmDspDidDataSupportInfo implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid.DcmDspDidSupportInfo getDcmDspDidDataSupportInfoRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid.DcmDspDidSupportInfo), "DcmDspDidDataSupportInfoRef")
					}
					
					def void setDcmDspDidDataSupportInfoRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid.DcmDspDidSupportInfo object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspDid implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo getDcmDspDidInfoRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo), "DcmDspDidInfoRef")
				}
				
				def void setDcmDspDidInfoRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid> getDcmDspDidRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid)) {
						override protected wrap(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid object) throws CoreException {
							if (object !== null) {
								val container = object.getTarget()
								val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
								referenceValue.gSetDefinition(referenceValueDef)
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								val referenceValueValue = referenceValue.gGetValue
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid(referenceValueValue as GContainer)
								}
							}
						}
					}
				...
				def List<DcmDspDidSignal> getDcmDspDidSignals(){
					...
					return new BasicWrappingEList<DcmDspDidSignal, GContainer>(filteredContainers, typeof(DcmDspDidSignal), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid.DcmDspDidSignal dcmDspDidSignal) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid.DcmDspDidSignal dcmDspDidSignal) {
							dcmDspDidSignal.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDidSignal"))
				...
				static class DcmDspDidSignal implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData getDcmDspDidDataRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData), "DcmDspDidDataRef")
					}
					
					def void setDcmDspDidDataRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspData object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspDidInfo implements IWrapper<GContainer> {
				...
				static class DcmDspDidControl implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspDidControlModeRuleRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspDidControlModeRuleRef")
					}
					
					def void setDcmDspDidControlModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDspDidControlSecurityLevelRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDspDidControlSessionRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					def List<DcmDspDidControlEnableMask> getDcmDspDidControlEnableMasks(){
						...
						return new BasicWrappingEList<DcmDspDidControlEnableMask, GContainer>(filteredContainers, typeof(DcmDspDidControlEnableMask), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo.DcmDspDidControl.DcmDspDidControlEnableMask dcmDspDidControlEnableMask) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo.DcmDspDidControl.DcmDspDidControlEnableMask dcmDspDidControlEnableMask) {
								dcmDspDidControlEnableMask.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspDidControlEnableMask"))
				...
				static class DcmDspDidRead implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspDidReadModeRuleRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspDidReadModeRuleRef")
					}
					
					def void setDcmDspDidReadModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDspDidReadSecurityLevelRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDspDidReadSessionRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				static class DcmDspDidWrite implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspDidWriteModeRuleRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspDidWriteModeRuleRef")
					}
					
					def void setDcmDspDidWriteModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDspDidWriteSecurityLevelRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDspDidWriteSessionRefs(){
						val containerDef = containerValue.gGetDefinition
						val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			static class DcmDspDidRange implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo getDcmDspDidRangeInfoRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo), "DcmDspDidRangeInfoRef")
				}
				
				def void setDcmDspDidRangeInfoRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDidInfo object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspMemory implements IWrapper<GContainer> {
				...
				def List<DcmDspMemoryIdInfo> getDcmDspMemoryIdInfos(){
					...
					return new BasicWrappingEList<DcmDspMemoryIdInfo, GContainer>(filteredContainers, typeof(DcmDspMemoryIdInfo), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo dcmDspMemoryIdInfo) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo dcmDspMemoryIdInfo) {
							dcmDspMemoryIdInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspMemoryIdInfo"))
				...
				static class DcmDspMemoryIdInfo implements IWrapper<GContainer> {
					...
					def List<DcmDspReadMemoryRangeByLabelInfo> getDcmDspReadMemoryRangeByLabelInfos(){
						...
						return new BasicWrappingEList<DcmDspReadMemoryRangeByLabelInfo, GContainer>(filteredContainers, typeof(DcmDspReadMemoryRangeByLabelInfo), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspReadMemoryRangeByLabelInfo dcmDspReadMemoryRangeByLabelInfo) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspReadMemoryRangeByLabelInfo dcmDspReadMemoryRangeByLabelInfo) {
								dcmDspReadMemoryRangeByLabelInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspReadMemoryRangeByLabelInfo"))
					...
					def List<DcmDspReadMemoryRangeInfo> getDcmDspReadMemoryRangeInfos(){
						...
						return new BasicWrappingEList<DcmDspReadMemoryRangeInfo, GContainer>(filteredContainers, typeof(DcmDspReadMemoryRangeInfo), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspReadMemoryRangeInfo dcmDspReadMemoryRangeInfo) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspReadMemoryRangeInfo dcmDspReadMemoryRangeInfo) {
								dcmDspReadMemoryRangeInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspReadMemoryRangeInfo"))
					...
					def List<DcmDspWriteMemoryRangeByLabelInfo> getDcmDspWriteMemoryRangeByLabelInfos(){
						...
						return new BasicWrappingEList<DcmDspWriteMemoryRangeByLabelInfo, GContainer>(filteredContainers, typeof(DcmDspWriteMemoryRangeByLabelInfo), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspWriteMemoryRangeByLabelInfo dcmDspWriteMemoryRangeByLabelInfo) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspWriteMemoryRangeByLabelInfo dcmDspWriteMemoryRangeByLabelInfo) {
								dcmDspWriteMemoryRangeByLabelInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspWriteMemoryRangeByLabelInfo"))
					...
					def List<DcmDspWriteMemoryRangeInfo> getDcmDspWriteMemoryRangeInfos(){
						...
						return new BasicWrappingEList<DcmDspWriteMemoryRangeInfo, GContainer>(filteredContainers, typeof(DcmDspWriteMemoryRangeInfo), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspWriteMemoryRangeInfo dcmDspWriteMemoryRangeInfo) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspMemory.DcmDspMemoryIdInfo.DcmDspWriteMemoryRangeInfo dcmDspWriteMemoryRangeInfo) {
								dcmDspWriteMemoryRangeInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspWriteMemoryRangeInfo"))
					...
					static class DcmDspReadMemoryRangeByLabelInfo implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspReadMemoryRangeModeRuleRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspReadMemoryRangeModeRuleRef")
						}
						
						def void setDcmDspReadMemoryRangeModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDspReadMemoryRangeSecurityLevelRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
						...
						def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDspReadMemoryRangeSessionLevelRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					static class DcmDspWriteMemoryRangeByLabelInfo implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule getDcmDspWriteMemoryRangeModeRuleRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule), "DcmDspWriteMemoryRangeModeRuleRef")
						}
						
						def void setDcmDspWriteMemoryRangeModeRuleRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow> getDcmDspWriteMemoryRangeSecurityLevelRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
						...
						def List<org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow> getDcmDspWriteMemoryRangeSessionLevelRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			static class DcmDspPid implements IWrapper<GContainer> {
				...
				def List<DcmDspPidData> getDcmDspPidDatas(){
					...
					return new BasicWrappingEList<DcmDspPidData, GContainer>(filteredContainers, typeof(DcmDspPidData), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidData dcmDspPidData) {
							dcmDspPidData.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspPidData"))
							super.delegateAdd(dcmDspPidData)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidData dcmDspPidData) {
							dcmDspPidData.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspPidData"))
				...
				def List<DcmDspPidSupportInfo> getDcmDspPidSupportInfos(){
					...
					return new BasicWrappingEList<DcmDspPidSupportInfo, GContainer>(filteredContainers, typeof(DcmDspPidSupportInfo), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidSupportInfo dcmDspPidSupportInfo) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidSupportInfo dcmDspPidSupportInfo) {
							dcmDspPidSupportInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspPidSupportInfo"))
				...
				static class DcmDspPidData implements IWrapper<GContainer> {
					...
					static class DcmDspPidDataSupportInfo implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidSupportInfo getDcmDspPidDataSupportInfoRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidSupportInfo), "DcmDspPidDataSupportInfoRef")
						}
						
						def void setDcmDspPidDataSupportInfoRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidSupportInfo object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						static class DcmDspDiagnosisScaling implements IWrapper<GContainer> {
							...
							static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
								...
								def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
									...
									return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
										override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidData.DcmDspPidService01.DcmDspDiagnosisScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
											dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
											super.delegateAdd(dcmDspTextTableMapping)
										}
								
										override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspPid.DcmDspPidData.DcmDspPidService01.DcmDspDiagnosisScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
											dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
											super.delegateAdd(index, dcmDspTextTableMapping)
										}
									}
					...
					static class DcmDspPidService02 implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement getDcmDspPidDataDemRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement), "DcmDspPidDataDemRef")
						}
						
						def void setDcmDspPidDataDemRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspRoe implements IWrapper<GContainer> {
				...
				def List<DcmDspRoeEvent> getDcmDspRoeEvents(){
					...
					return new BasicWrappingEList<DcmDspRoeEvent, GContainer>(filteredContainers, typeof(DcmDspRoeEvent), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoe.DcmDspRoeEvent dcmDspRoeEvent) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoe.DcmDspRoeEvent dcmDspRoeEvent) {
							dcmDspRoeEvent.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspRoeEvent"))
				...
				def List<DcmDspRoeEventWindowTime> getDcmDspRoeEventWindowTimes(){
					...
					return new BasicWrappingEList<DcmDspRoeEventWindowTime, GContainer>(filteredContainers, typeof(DcmDspRoeEventWindowTime), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoe.DcmDspRoeEventWindowTime dcmDspRoeEventWindowTime) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoe.DcmDspRoeEventWindowTime dcmDspRoeEventWindowTime) {
							dcmDspRoeEventWindowTime.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspRoeEventWindowTime"))
				...
				static class DcmDspRoeEvent implements IWrapper<GContainer> {
					...
					static class DcmDspRoeEventProperties implements IWrapper<GContainer> {
						...
						static class DcmDspRoeOnChangeOfDataIdentifier implements IWrapper<GContainer> {
							...
							def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid getDcmDspRoeDidRef(){
								containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid), "DcmDspRoeDidRef")
							}
							
							def void setDcmDspRoeDidRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid object){
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DcmDspRoutine implements IWrapper<GContainer> {
				...
				static class DcmDspRequestRoutineResults implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization getDcmDspRequestRoutineResultsCommonAuthorizationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization), "DcmDspRequestRoutineResultsCommonAuthorizationRef")
					}
					
					def void setDcmDspRequestRoutineResultsCommonAuthorizationRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class DcmDspRequestRoutineResultsOut implements IWrapper<GContainer> {
						...
						def List<DcmDspRequestRoutineResultsOutSignal> getDcmDspRequestRoutineResultsOutSignals(){
							...
							return new BasicWrappingEList<DcmDspRequestRoutineResultsOutSignal, GContainer>(filteredContainers, typeof(DcmDspRequestRoutineResultsOutSignal), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspRequestRoutineResults.DcmDspRequestRoutineResultsOut.DcmDspRequestRoutineResultsOutSignal dcmDspRequestRoutineResultsOutSignal) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspRequestRoutineResults.DcmDspRequestRoutineResultsOut.DcmDspRequestRoutineResultsOutSignal dcmDspRequestRoutineResultsOutSignal) {
									dcmDspRequestRoutineResultsOutSignal.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspRequestRoutineResultsOutSignal"))
							...
							static class DcmDspArgumentScaling implements IWrapper<GContainer> {
								...
								static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
									...
									def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
										...
										return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
											override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspRequestRoutineResults.DcmDspRequestRoutineResultsOut.DcmDspRequestRoutineResultsOutSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(dcmDspTextTableMapping)
											}
									
											override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspRequestRoutineResults.DcmDspRequestRoutineResultsOut.DcmDspRequestRoutineResultsOutSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(index, dcmDspTextTableMapping)
											}
										}
				...
				static class DcmDspStartRoutine implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization getDcmDspStartRoutineCommonAuthorizationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization), "DcmDspStartRoutineCommonAuthorizationRef")
					}
					
					def void setDcmDspStartRoutineCommonAuthorizationRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class DcmDspStartRoutineIn implements IWrapper<GContainer> {
						...
						def List<DcmDspStartRoutineInSignal> getDcmDspStartRoutineInSignals(){
							...
							return new BasicWrappingEList<DcmDspStartRoutineInSignal, GContainer>(filteredContainers, typeof(DcmDspStartRoutineInSignal), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineIn.DcmDspStartRoutineInSignal dcmDspStartRoutineInSignal) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineIn.DcmDspStartRoutineInSignal dcmDspStartRoutineInSignal) {
									dcmDspStartRoutineInSignal.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspStartRoutineInSignal"))
							...
							static class DcmDspArgumentScaling implements IWrapper<GContainer> {
								...
								static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
									...
									def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
										...
										return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
											override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineIn.DcmDspStartRoutineInSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(dcmDspTextTableMapping)
											}
									
											override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineIn.DcmDspStartRoutineInSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(index, dcmDspTextTableMapping)
											}
										}
					...
					static class DcmDspStartRoutineOut implements IWrapper<GContainer> {
						...
						def List<DcmDspStartRoutineOutSignal> getDcmDspStartRoutineOutSignals(){
							...
							return new BasicWrappingEList<DcmDspStartRoutineOutSignal, GContainer>(filteredContainers, typeof(DcmDspStartRoutineOutSignal), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineOut.DcmDspStartRoutineOutSignal dcmDspStartRoutineOutSignal) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineOut.DcmDspStartRoutineOutSignal dcmDspStartRoutineOutSignal) {
									dcmDspStartRoutineOutSignal.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspStartRoutineOutSignal"))
							...
							static class DcmDspArgumentScaling implements IWrapper<GContainer> {
								...
								static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
									...
									def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
										...
										return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
											override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineOut.DcmDspStartRoutineOutSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(dcmDspTextTableMapping)
											}
									
											override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStartRoutine.DcmDspStartRoutineOut.DcmDspStartRoutineOutSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(index, dcmDspTextTableMapping)
											}
										}
				...
				static class DcmDspStopRoutine implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization getDcmDspStopRoutineCommonAuthorizationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization), "DcmDspStopRoutineCommonAuthorizationRef")
					}
					
					def void setDcmDspStopRoutineCommonAuthorizationRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspCommonAuthorization object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class DcmDspStopRoutineIn implements IWrapper<GContainer> {
						...
						def List<DcmDspStopRoutineInSignal> getDcmDspStopRoutineInSignals(){
							...
							return new BasicWrappingEList<DcmDspStopRoutineInSignal, GContainer>(filteredContainers, typeof(DcmDspStopRoutineInSignal), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineIn.DcmDspStopRoutineInSignal dcmDspStopRoutineInSignal) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineIn.DcmDspStopRoutineInSignal dcmDspStopRoutineInSignal) {
									dcmDspStopRoutineInSignal.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspStopRoutineInSignal"))
							...
							static class DcmDspArgumentScaling implements IWrapper<GContainer> {
								...
								static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
									...
									def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
										...
										return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
											override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineIn.DcmDspStopRoutineInSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(dcmDspTextTableMapping)
											}
									
											override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineIn.DcmDspStopRoutineInSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(index, dcmDspTextTableMapping)
											}
										}
					...
					static class DcmDspStopRoutineOut implements IWrapper<GContainer> {
						...
						def List<DcmDspStopRoutineOutSignal> getDcmDspStopRoutineOutSignals(){
							...
							return new BasicWrappingEList<DcmDspStopRoutineOutSignal, GContainer>(filteredContainers, typeof(DcmDspStopRoutineOutSignal), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineOut.DcmDspStopRoutineOutSignal dcmDspStopRoutineOutSignal) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineOut.DcmDspStopRoutineOutSignal dcmDspStopRoutineOutSignal) {
									dcmDspStopRoutineOutSignal.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspStopRoutineOutSignal"))
							...
							static class DcmDspArgumentScaling implements IWrapper<GContainer> {
								...
								static class DcmDspAlternativeDataType implements IWrapper<GContainer> {
									...
									def List<DcmDspTextTableMapping> getDcmDspTextTableMappings(){
										...
										return new BasicWrappingEList<DcmDspTextTableMapping, GContainer>(filteredContainers, typeof(DcmDspTextTableMapping), typeof(GContainer)) {
											override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineOut.DcmDspStopRoutineOutSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(dcmDspTextTableMapping)
											}
									
											override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspRoutine.DcmDspStopRoutine.DcmDspStopRoutineOut.DcmDspStopRoutineOutSignal.DcmDspArgumentScaling.DcmDspAlternativeDataType.DcmDspTextTableMapping dcmDspTextTableMapping) {
												dcmDspTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspTextTableMapping"))
												super.delegateAdd(index, dcmDspTextTableMapping)
											}
										}
			...
			static class DcmDspSecurity implements IWrapper<GContainer> {
				...
				def List<DcmDspSecurityRow> getDcmDspSecurityRows(){
					...
					return new BasicWrappingEList<DcmDspSecurityRow, GContainer>(filteredContainers, typeof(DcmDspSecurityRow), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow dcmDspSecurityRow) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSecurity.DcmDspSecurityRow dcmDspSecurityRow) {
							dcmDspSecurityRow.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspSecurityRow"))
			...
			static class DcmDspSession implements IWrapper<GContainer> {
				...
				def List<DcmDspSessionRow> getDcmDspSessionRows(){
					...
					return new BasicWrappingEList<DcmDspSessionRow, GContainer>(filteredContainers, typeof(DcmDspSessionRow), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow dcmDspSessionRow) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspSession.DcmDspSessionRow dcmDspSessionRow) {
							dcmDspSessionRow.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspSessionRow"))
			...
			static class DcmDspVehInfo implements IWrapper<GContainer> {
				...
				def List<DcmDspVehInfoData> getDcmDspVehInfoDatas(){
					...
					return new BasicWrappingEList<DcmDspVehInfoData, GContainer>(filteredContainers, typeof(DcmDspVehInfoData), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspVehInfo.DcmDspVehInfoData dcmDspVehInfoData) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspVehInfo.DcmDspVehInfoData dcmDspVehInfoData) {
							dcmDspVehInfoData.target?.gSetDefinition(containerValue.getContainerDefinition("DcmDspVehInfoData"))
		...
		static class DcmProcessingConditions implements IWrapper<GContainer> {
			...
			def List<DcmModeCondition> getDcmModeConditions(){
				...
				return new BasicWrappingEList<DcmModeCondition, GContainer>(filteredContainers, typeof(DcmModeCondition), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeCondition dcmModeCondition) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeCondition dcmModeCondition) {
						dcmModeCondition.target?.gSetDefinition(containerValue.getContainerDefinition("DcmModeCondition"))
			...
			def List<DcmModeRule> getDcmModeRules(){
				...
				return new BasicWrappingEList<DcmModeRule, GContainer>(filteredContainers, typeof(DcmModeRule), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule dcmModeRule) {
						dcmModeRule.target?.gSetDefinition(containerValue.getContainerDefinition("DcmModeRule"))
						super.delegateAdd(dcmModeRule)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmProcessingConditions.DcmModeRule dcmModeRule) {
						dcmModeRule.target?.gSetDefinition(containerValue.getContainerDefinition("DcmModeRule"))
	...
	static class DcmGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid getDcmVinRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid), "DcmVinRef")
		}
		
		def void setDcmVinRef(org.artop.ecuc.autosar442.accessors.Dcm.DcmConfigSet.DcmDsp.DcmDspDid object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
