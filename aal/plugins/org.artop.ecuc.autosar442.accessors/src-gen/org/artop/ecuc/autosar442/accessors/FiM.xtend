	...
	static class FiMConfigSet implements IWrapper<GContainer> {
		...
		def List<FiMFID> getFiMFIDs(){
			...
			return new BasicWrappingEList<FiMFID, GContainer>(filteredContainers, typeof(FiMFID), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID fiMFID) {
					fiMFID.target?.gSetDefinition(containerValue.getContainerDefinition("FiMFID"))
					super.delegateAdd(fiMFID)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID fiMFID) {
					fiMFID.target?.gSetDefinition(containerValue.getContainerDefinition("FiMFID"))
		...
		def List<FiMInhibitionConfiguration> getFiMInhibitionConfigurations(){
			...
			return new BasicWrappingEList<FiMInhibitionConfiguration, GContainer>(filteredContainers, typeof(FiMInhibitionConfiguration), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMInhibitionConfiguration fiMInhibitionConfiguration) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMInhibitionConfiguration fiMInhibitionConfiguration) {
					fiMInhibitionConfiguration.target?.gSetDefinition(containerValue.getContainerDefinition("FiMInhibitionConfiguration"))
		...
		def List<FiMSummaryEvent> getFiMSummaryEvents(){
			...
			return new BasicWrappingEList<FiMSummaryEvent, GContainer>(filteredContainers, typeof(FiMSummaryEvent), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent fiMSummaryEvent) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent fiMSummaryEvent) {
					fiMSummaryEvent.target?.gSetDefinition(containerValue.getContainerDefinition("FiMSummaryEvent"))
		...
		static class FiMInhibitionConfiguration implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent> getFiMInhComponentRefs(){
				val containerDef = containerValue.gGetDefinition
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter> getFiMInhEventRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			def org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID getFiMInhFunctionIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID), "FiMInhFunctionIdRef")
			}
			
			def void setFiMInhFunctionIdRef(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent> getFiMInhSumRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMSummaryEvent(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class FiMSummaryEvent implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter> getFiMInputEventRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
