...
class Lin implements IWrapper<GModuleConfiguration> {
	...
	static class LinDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getLIN_E_TIMEOUT(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "LIN_E_TIMEOUT")
		}
		
		def void setLIN_E_TIMEOUT(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
	...
	static class LinGlobalConfig implements IWrapper<GContainer> {
		...
		def List<LinChannel> getLinChannels(){
			...
			return new BasicWrappingEList<LinChannel, GContainer>(filteredContainers, typeof(LinChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Lin.LinGlobalConfig.LinChannel linChannel) {
					linChannel.target?.gSetDefinition(containerValue.getContainerDefinition("LinChannel"))
					super.delegateAdd(linChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Lin.LinGlobalConfig.LinChannel linChannel) {
					linChannel.target?.gSetDefinition(containerValue.getContainerDefinition("LinChannel"))
		...
		static class LinChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getLinChannelEcuMWakeupSource(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "LinChannelEcuMWakeupSource")
			}
			
			def void setLinChannelEcuMWakeupSource(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint getLinClockRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint), "LinClockRef")
			}
			
			def void setLinClockRef(org.artop.ecuc.autosar442.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
