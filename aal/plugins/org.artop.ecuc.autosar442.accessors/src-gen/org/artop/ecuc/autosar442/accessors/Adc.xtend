	...
	static class AdcConfigSet implements IWrapper<GContainer> {
		...
		def List<AdcHwUnit> getAdcHwUnits(){
			...
			return new BasicWrappingEList<AdcHwUnit, GContainer>(filteredContainers, typeof(AdcHwUnit), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit adcHwUnit) {
					adcHwUnit.target?.gSetDefinition(containerValue.getContainerDefinition("AdcHwUnit"))
					super.delegateAdd(adcHwUnit)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit adcHwUnit) {
					adcHwUnit.target?.gSetDefinition(containerValue.getContainerDefinition("AdcHwUnit"))
		...
		static class AdcHwUnit implements IWrapper<GContainer> {
			...
			def List<AdcChannel> getAdcChannels(){
				...
				return new BasicWrappingEList<AdcChannel, GContainer>(filteredContainers, typeof(AdcChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel adcChannel) {
						adcChannel.target?.gSetDefinition(containerValue.getContainerDefinition("AdcChannel"))
						super.delegateAdd(adcChannel)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel adcChannel) {
						adcChannel.target?.gSetDefinition(containerValue.getContainerDefinition("AdcChannel"))
			...
			def List<AdcGroup> getAdcGroups(){
				...
				return new BasicWrappingEList<AdcGroup, GContainer>(filteredContainers, typeof(AdcGroup), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcGroup adcGroup) {
						adcGroup.target?.gSetDefinition(containerValue.getContainerDefinition("AdcGroup"))
						super.delegateAdd(adcGroup)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcGroup adcGroup) {
						adcGroup.target?.gSetDefinition(containerValue.getContainerDefinition("AdcGroup"))
			...
			static class AdcGroup implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel> getAdcGroupDefinitions(){
					val containerDef = containerValue.gGetDefinition
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel)) {
						override protected wrap(org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel object) throws CoreException {
							if (object !== null) {
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								...
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar442.accessors.Adc.AdcConfigSet.AdcHwUnit.AdcChannel(referenceValueValue as GContainer)
								}
							}
						}
					}
	...
	static class AdcGeneral implements IWrapper<GContainer> {
		...
		def List<AdcPowerStateConfig> getAdcPowerStateConfigs(){
			...
			return new BasicWrappingEList<AdcPowerStateConfig, GContainer>(filteredContainers, typeof(AdcPowerStateConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Adc.AdcGeneral.AdcPowerStateConfig adcPowerStateConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Adc.AdcGeneral.AdcPowerStateConfig adcPowerStateConfig) {
					adcPowerStateConfig.target?.gSetDefinition(containerValue.getContainerDefinition("AdcPowerStateConfig"))
