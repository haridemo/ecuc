	...
	static class SdConfig implements IWrapper<GContainer> {
		...
		def List<SdCapabilityRecordMatchCallout> getSdCapabilityRecordMatchCallouts(){
			...
			return new BasicWrappingEList<SdCapabilityRecordMatchCallout, GContainer>(filteredContainers, typeof(SdCapabilityRecordMatchCallout), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout sdCapabilityRecordMatchCallout) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout sdCapabilityRecordMatchCallout) {
					sdCapabilityRecordMatchCallout.target?.gSetDefinition(containerValue.getContainerDefinition("SdCapabilityRecordMatchCallout"))
		...
		def List<SdInstance> getSdInstances(){
			...
			return new BasicWrappingEList<SdInstance, GContainer>(filteredContainers, typeof(SdInstance), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance sdInstance) {
					sdInstance.target?.gSetDefinition(containerValue.getContainerDefinition("SdInstance"))
					super.delegateAdd(sdInstance)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance sdInstance) {
					sdInstance.target?.gSetDefinition(containerValue.getContainerDefinition("SdInstance"))
		...
		static class SdInstance implements IWrapper<GContainer> {
			...
			def List<SdClientService> getSdClientServices(){
				...
				return new BasicWrappingEList<SdClientService, GContainer>(filteredContainers, typeof(SdClientService), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService sdClientService) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService sdClientService) {
						sdClientService.target?.gSetDefinition(containerValue.getContainerDefinition("SdClientService"))
			...
			def List<SdClientTimer> getSdClientTimers(){
				...
				return new BasicWrappingEList<SdClientTimer, GContainer>(filteredContainers, typeof(SdClientTimer), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer sdClientTimer) {
						sdClientTimer.target?.gSetDefinition(containerValue.getContainerDefinition("SdClientTimer"))
						super.delegateAdd(sdClientTimer)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer sdClientTimer) {
						sdClientTimer.target?.gSetDefinition(containerValue.getContainerDefinition("SdClientTimer"))
			...
			def List<SdServerService> getSdServerServices(){
				...
				return new BasicWrappingEList<SdServerService, GContainer>(filteredContainers, typeof(SdServerService), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService sdServerService) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService sdServerService) {
						sdServerService.target?.gSetDefinition(containerValue.getContainerDefinition("SdServerService"))
			...
			def List<SdServerTimer> getSdServerTimers(){
				...
				return new BasicWrappingEList<SdServerTimer, GContainer>(filteredContainers, typeof(SdServerTimer), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer sdServerTimer) {
						sdServerTimer.target?.gSetDefinition(containerValue.getContainerDefinition("SdServerTimer"))
						super.delegateAdd(sdServerTimer)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer sdServerTimer) {
						sdServerTimer.target?.gSetDefinition(containerValue.getContainerDefinition("SdServerTimer"))
			...
			static class SdClientService implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout getSdClientCapabilityRecordMatchCalloutRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout), "SdClientCapabilityRecordMatchCalloutRef")
				}
				
				def void setSdClientCapabilityRecordMatchCalloutRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup getSdClientServiceTcpRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup), "SdClientServiceTcpRef")
				}
				
				def void setSdClientServiceTcpRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer getSdClientServiceTimerRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer), "SdClientServiceTimerRef")
				}
				
				def void setSdClientServiceTimerRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup getSdClientServiceUdpRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup), "SdClientServiceUdpRef")
				}
				
				def void setSdClientServiceUdpRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<SdClientCapabilityRecord> getSdClientCapabilityRecords(){
					...
					return new BasicWrappingEList<SdClientCapabilityRecord, GContainer>(filteredContainers, typeof(SdClientCapabilityRecord), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdClientCapabilityRecord sdClientCapabilityRecord) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdClientCapabilityRecord sdClientCapabilityRecord) {
							sdClientCapabilityRecord.target?.gSetDefinition(containerValue.getContainerDefinition("SdClientCapabilityRecord"))
				...
				def List<SdConsumedEventGroup> getSdConsumedEventGroups(){
					...
					return new BasicWrappingEList<SdConsumedEventGroup, GContainer>(filteredContainers, typeof(SdConsumedEventGroup), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdConsumedEventGroup sdConsumedEventGroup) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdConsumedEventGroup sdConsumedEventGroup) {
							sdConsumedEventGroup.target?.gSetDefinition(containerValue.getContainerDefinition("SdConsumedEventGroup"))
				...
				static class SdConsumedEventGroup implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdConsumedEventGroupMulticastActivationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdConsumedEventGroupMulticastActivationRef")
					}
					
					def void setSdConsumedEventGroupMulticastActivationRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def List<org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup> getSdConsumedEventGroupMulticastGroupRefs(){
						val containerDef = containerValue.gGetDefinition
						...
						return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup)) {
							override protected wrap(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup object) throws CoreException {
								if (object !== null) {
							...
							override protected unwrap(GReferenceValue referenceValue) {
								if (referenceValue !== null) {
									...
									if (referenceValueValue instanceof GContainer) {
										return new org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup(referenceValueValue as GContainer)
									}
								}
							}
						}
					...
					def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdConsumedEventGroupTcpActivationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdConsumedEventGroupTcpActivationRef")
					}
					
					def void setSdConsumedEventGroupTcpActivationRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer getSdConsumedEventGroupTimerRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer), "SdConsumedEventGroupTimerRef")
					}
					
					def void setSdConsumedEventGroupTimerRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientTimer object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdConsumedEventGroupUdpActivationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdConsumedEventGroupUdpActivationRef")
					}
					
					def void setSdConsumedEventGroupUdpActivationRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class SdConsumedMethods implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdClientServiceActivationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdClientServiceActivationRef")
					}
					
					def void setSdClientServiceActivationRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SdInstanceDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getSD_E_MALFORMED_MSG(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "SD_E_MALFORMED_MSG")
				}
				
				def void setSD_E_MALFORMED_MSG(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getSD_E_OUT_OF_RES(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "SD_E_OUT_OF_RES")
				}
				
				def void setSD_E_OUT_OF_RES(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getSD_E_SUBSCR_NACK_RECV(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "SD_E_SUBSCR_NACK_RECV")
				}
				
				def void setSD_E_SUBSCR_NACK_RECV(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SdInstanceMulticastRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSdRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SdRxPduRef")
				}
				
				def void setSdRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SdInstanceTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSdTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SdTxPduRef")
				}
				
				def void setSdTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SdServerService implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout getSdServerCapabilityRecordMatchCalloutRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout), "SdServerCapabilityRecordMatchCalloutRef")
				}
				
				def void setSdServerCapabilityRecordMatchCalloutRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdCapabilityRecordMatchCallout object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup getSdServerServiceTcpRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup), "SdServerServiceTcpRef")
				}
				
				def void setSdServerServiceTcpRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer getSdServerServiceTimerRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer), "SdServerServiceTimerRef")
				}
				
				def void setSdServerServiceTimerRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup getSdServerServiceUdpRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup), "SdServerServiceUdpRef")
				}
				
				def void setSdServerServiceUdpRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<SdEventHandler> getSdEventHandlers(){
					...
					return new BasicWrappingEList<SdEventHandler, GContainer>(filteredContainers, typeof(SdEventHandler), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdEventHandler sdEventHandler) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdEventHandler sdEventHandler) {
							sdEventHandler.target?.gSetDefinition(containerValue.getContainerDefinition("SdEventHandler"))
				...
				def List<SdServerCapabilityRecord> getSdServerCapabilityRecords(){
					...
					return new BasicWrappingEList<SdServerCapabilityRecord, GContainer>(filteredContainers, typeof(SdServerCapabilityRecord), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdServerCapabilityRecord sdServerCapabilityRecord) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdServerCapabilityRecord sdServerCapabilityRecord) {
							sdServerCapabilityRecord.target?.gSetDefinition(containerValue.getContainerDefinition("SdServerCapabilityRecord"))
				...
				static class SdEventHandler implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer getSdEventHandlerTimerRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer), "SdEventHandlerTimerRef")
					}
					
					def void setSdEventHandlerTimerRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerTimer object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class SdEventHandlerMulticast implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdEventActivationRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdEventActivationRef")
						}
						
						def void setSdEventActivationRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup.SoAdSocketConnection getSdMulticastEventSoConRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup.SoAdSocketConnection), "SdMulticastEventSoConRef")
						}
						
						def void setSdMulticastEventSoConRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup.SoAdSocketConnection object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class SdEventHandlerTcp implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdEventTriggeringRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdEventTriggeringRef")
						}
						
						def void setSdEventTriggeringRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
				...
				static class SdProvidedMethods implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup getSdServerServiceActivationRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup), "SdServerServiceActivationRef")
					}
					
					def void setSdServerServiceActivationRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
