...
class Os implements IWrapper<GModuleConfiguration> {
	...
	def List<OsAlarm> getOsAlarms(){
		...
		return new BasicWrappingEList<OsAlarm, GContainer>(filteredContainers, typeof(OsAlarm), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsAlarm osAlarm) {
				osAlarm.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsAlarm"))
				super.delegateAdd(osAlarm)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsAlarm osAlarm) {
				osAlarm.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsAlarm"))
	...
	def List<OsAppMode> getOsAppModes(){
		...
		return new BasicWrappingEList<OsAppMode, GContainer>(filteredContainers, typeof(OsAppMode), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsAppMode osAppMode) {
				osAppMode.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsAppMode"))
				super.delegateAdd(osAppMode)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsAppMode osAppMode) {
				osAppMode.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsAppMode"))
	...
	def List<OsApplication> getOsApplications(){
		...
		return new BasicWrappingEList<OsApplication, GContainer>(filteredContainers, typeof(OsApplication), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsApplication osApplication) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsApplication osApplication) {
				osApplication.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsApplication"))
	...
	def List<OsCounter> getOsCounters(){
		...
		return new BasicWrappingEList<OsCounter, GContainer>(filteredContainers, typeof(OsCounter), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsCounter osCounter) {
				osCounter.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsCounter"))
				super.delegateAdd(osCounter)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsCounter osCounter) {
				osCounter.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsCounter"))
	...
	def List<OsEvent> getOsEvents(){
		...
		return new BasicWrappingEList<OsEvent, GContainer>(filteredContainers, typeof(OsEvent), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsEvent osEvent) {
				osEvent.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsEvent"))
				super.delegateAdd(osEvent)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsEvent osEvent) {
				osEvent.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsEvent"))
	...
	def List<OsIsr> getOsIsrs(){
		...
		return new BasicWrappingEList<OsIsr, GContainer>(filteredContainers, typeof(OsIsr), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsIsr osIsr) {
				osIsr.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsIsr"))
				super.delegateAdd(osIsr)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsIsr osIsr) {
				osIsr.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsIsr"))
	...
	def List<OsPeripheralArea> getOsPeripheralAreas(){
		...
		return new BasicWrappingEList<OsPeripheralArea, GContainer>(filteredContainers, typeof(OsPeripheralArea), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsPeripheralArea osPeripheralArea) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsPeripheralArea osPeripheralArea) {
				osPeripheralArea.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsPeripheralArea"))
	...
	def List<OsResource> getOsResources(){
		...
		return new BasicWrappingEList<OsResource, GContainer>(filteredContainers, typeof(OsResource), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsResource osResource) {
				osResource.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsResource"))
				super.delegateAdd(osResource)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsResource osResource) {
				osResource.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsResource"))
	...
	def List<OsScheduleTable> getOsScheduleTables(){
		...
		return new BasicWrappingEList<OsScheduleTable, GContainer>(filteredContainers, typeof(OsScheduleTable), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable osScheduleTable) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable osScheduleTable) {
				osScheduleTable.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsScheduleTable"))
	...
	def List<OsSpinlock> getOsSpinlocks(){
		...
		return new BasicWrappingEList<OsSpinlock, GContainer>(filteredContainers, typeof(OsSpinlock), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsSpinlock osSpinlock) {
				osSpinlock.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsSpinlock"))
				super.delegateAdd(osSpinlock)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsSpinlock osSpinlock) {
				osSpinlock.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsSpinlock"))
	...
	def List<OsTask> getOsTasks(){
		...
		return new BasicWrappingEList<OsTask, GContainer>(filteredContainers, typeof(OsTask), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsTask osTask) {
				osTask.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsTask"))
				super.delegateAdd(osTask)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsTask osTask) {
				osTask.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("OsTask"))
	...
	static class OsAlarm implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsAlarmAccessingApplications(){
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsApplication>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsApplication)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsApplication object) throws CoreException {
					if (object !== null) {
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						...
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsApplication(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def org.artop.ecuc.autosar442.accessors.Os.OsCounter getOsAlarmCounterRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsCounter), "OsAlarmCounterRef")
		}
		
		def void setOsAlarmCounterRef(org.artop.ecuc.autosar442.accessors.Os.OsCounter object){
			val containerDef = containerValue.gGetDefinition
		...
		static class OsAlarmAction implements IWrapper<GContainer> {
			...
			static class OsAlarmActivateTask implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsTask getOsAlarmActivateTaskRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsTask), "OsAlarmActivateTaskRef")
				}
				
				def void setOsAlarmActivateTaskRef(org.artop.ecuc.autosar442.accessors.Os.OsTask object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class OsAlarmIncrementCounter implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsCounter getOsAlarmIncrementCounterRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsCounter), "OsAlarmIncrementCounterRef")
				}
				
				def void setOsAlarmIncrementCounterRef(org.artop.ecuc.autosar442.accessors.Os.OsCounter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class OsAlarmSetEvent implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsEvent getOsAlarmSetEventRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsEvent), "OsAlarmSetEventRef")
				}
				
				def void setOsAlarmSetEventRef(org.artop.ecuc.autosar442.accessors.Os.OsEvent object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsTask getOsAlarmSetEventTaskRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsTask), "OsAlarmSetEventTaskRef")
				}
				
				def void setOsAlarmSetEventTaskRef(org.artop.ecuc.autosar442.accessors.Os.OsTask object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class OsAlarmAutostart implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Os.OsAppMode> getOsAlarmAppModeRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsAppMode>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsAppMode)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsAppMode object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Os.OsAppMode(referenceValueValue as GContainer)
							}
						}
					}
				}
	...
	static class OsApplication implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsAlarm> getOsAppAlarmRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsAlarm>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsAlarm)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsAlarm object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsAlarm(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsCounter> getOsAppCounterRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsCounter>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsCounter)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsCounter object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsCounter(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition getOsAppEcucPartitionRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition), "OsAppEcucPartitionRef")
		}
		
		def void setOsAppEcucPartitionRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsIsr> getOsAppIsrRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsIsr>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsIsr)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsIsr object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsIsr(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition getOsApplicationCoreRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition), "OsApplicationCoreRef")
		}
		
		def void setOsApplicationCoreRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable> getOsAppScheduleTableRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsTask> getOsAppTaskRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsTask>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsTask)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsTask object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsTask(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def org.artop.ecuc.autosar442.accessors.Os.OsTask getOsRestartTask(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsTask), "OsRestartTask")
		}
		
		def void setOsRestartTask(org.artop.ecuc.autosar442.accessors.Os.OsTask object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<OsApplicationTrustedFunction> getOsApplicationTrustedFunctions(){
			...
			return new BasicWrappingEList<OsApplicationTrustedFunction, GContainer>(filteredContainers, typeof(OsApplicationTrustedFunction), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsApplication.OsApplicationTrustedFunction osApplicationTrustedFunction) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsApplication.OsApplicationTrustedFunction osApplicationTrustedFunction) {
					osApplicationTrustedFunction.target?.gSetDefinition(containerValue.getContainerDefinition("OsApplicationTrustedFunction"))
	...
	static class OsCounter implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsCounterAccessingApplications(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		def List<OsTimeConstant> getOsTimeConstants(){
			...
			return new BasicWrappingEList<OsTimeConstant, GContainer>(filteredContainers, typeof(OsTimeConstant), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsCounter.OsTimeConstant osTimeConstant) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsCounter.OsTimeConstant osTimeConstant) {
					osTimeConstant.target?.gSetDefinition(containerValue.getContainerDefinition("OsTimeConstant"))
		...
		static class OsDriver implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration getOsGptChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration), "OsGptChannelRef")
			}
			
			def void setOsGptChannelRef(org.artop.ecuc.autosar442.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class OsIoc implements IWrapper<GContainer> {
		...
		def List<OsIocCommunication> getOsIocCommunications(){
			...
			return new BasicWrappingEList<OsIocCommunication, GContainer>(filteredContainers, typeof(OsIocCommunication), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication osIocCommunication) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication osIocCommunication) {
					osIocCommunication.target?.gSetDefinition(containerValue.getContainerDefinition("OsIocCommunication"))
		...
		static class OsIocCommunication implements IWrapper<GContainer> {
			...
			def List<OsIocDataProperties> getOsIocDataProperties(){
				...
				return new BasicWrappingEList<OsIocDataProperties, GContainer>(filteredContainers, typeof(OsIocDataProperties), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication.OsIocDataProperties osIocDataProperties) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication.OsIocDataProperties osIocDataProperties) {
						osIocDataProperties.target?.gSetDefinition(containerValue.getContainerDefinition("OsIocDataProperties"))
			...
			def List<OsIocReceiverProperties> getOsIocReceiverProperties(){
				...
				return new BasicWrappingEList<OsIocReceiverProperties, GContainer>(filteredContainers, typeof(OsIocReceiverProperties), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication.OsIocReceiverProperties osIocReceiverProperties) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication.OsIocReceiverProperties osIocReceiverProperties) {
						osIocReceiverProperties.target?.gSetDefinition(containerValue.getContainerDefinition("OsIocReceiverProperties"))
			...
			def List<OsIocSenderProperties> getOsIocSenderProperties(){
				...
				return new BasicWrappingEList<OsIocSenderProperties, GContainer>(filteredContainers, typeof(OsIocSenderProperties), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication.OsIocSenderProperties osIocSenderProperties) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsIoc.OsIocCommunication.OsIocSenderProperties osIocSenderProperties) {
						osIocSenderProperties.target?.gSetDefinition(containerValue.getContainerDefinition("OsIocSenderProperties"))
			...
			static class OsIocReceiverProperties implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsApplication getOsIocReceivingOsApplicationRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsApplication), "OsIocReceivingOsApplicationRef")
				}
				
				def void setOsIocReceivingOsApplicationRef(org.artop.ecuc.autosar442.accessors.Os.OsApplication object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class OsIocSenderProperties implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsApplication getOsIocSendingOsApplicationRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsApplication), "OsIocSendingOsApplicationRef")
				}
				
				def void setOsIocSendingOsApplicationRef(org.artop.ecuc.autosar442.accessors.Os.OsApplication object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class OsIsr implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsResource> getOsIsrResourceRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsResource>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsResource)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsResource object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsResource(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		static class OsIsrTimingProtection implements IWrapper<GContainer> {
			...
			def List<OsIsrResourceLock> getOsIsrResourceLocks(){
				...
				return new BasicWrappingEList<OsIsrResourceLock, GContainer>(filteredContainers, typeof(OsIsrResourceLock), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsIsr.OsIsrTimingProtection.OsIsrResourceLock osIsrResourceLock) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsIsr.OsIsrTimingProtection.OsIsrResourceLock osIsrResourceLock) {
						osIsrResourceLock.target?.gSetDefinition(containerValue.getContainerDefinition("OsIsrResourceLock"))
			...
			static class OsIsrResourceLock implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsResource getOsIsrResourceLockResourceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsResource), "OsIsrResourceLockResourceRef")
				}
				
				def void setOsIsrResourceLockResourceRef(org.artop.ecuc.autosar442.accessors.Os.OsResource object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class OsPeripheralArea implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsPeripheralAreaAccessingApplications(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
	...
	static class OsResource implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsResourceAccessingApplications(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		def org.artop.ecuc.autosar442.accessors.Os.OsResource getOsResourceLinkedResourceRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsResource), "OsResourceLinkedResourceRef")
		}
		
		def void setOsResourceLinkedResourceRef(org.artop.ecuc.autosar442.accessors.Os.OsResource object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class OsScheduleTable implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Os.OsCounter getOsScheduleTableCounterRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsCounter), "OsScheduleTableCounterRef")
		}
		
		def void setOsScheduleTableCounterRef(org.artop.ecuc.autosar442.accessors.Os.OsCounter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsSchTblAccessingApplications(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		def List<OsScheduleTableExpiryPoint> getOsScheduleTableExpiryPoints(){
			...
			return new BasicWrappingEList<OsScheduleTableExpiryPoint, GContainer>(filteredContainers, typeof(OsScheduleTableExpiryPoint), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint osScheduleTableExpiryPoint) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint osScheduleTableExpiryPoint) {
					osScheduleTableExpiryPoint.target?.gSetDefinition(containerValue.getContainerDefinition("OsScheduleTableExpiryPoint"))
		...
		static class OsScheduleTableAutostart implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Os.OsAppMode> getOsScheduleTableAppModeRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class OsScheduleTableExpiryPoint implements IWrapper<GContainer> {
			...
			def List<OsScheduleTableEventSetting> getOsScheduleTableEventSettings(){
				...
				return new BasicWrappingEList<OsScheduleTableEventSetting, GContainer>(filteredContainers, typeof(OsScheduleTableEventSetting), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint.OsScheduleTableEventSetting osScheduleTableEventSetting) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint.OsScheduleTableEventSetting osScheduleTableEventSetting) {
						osScheduleTableEventSetting.target?.gSetDefinition(containerValue.getContainerDefinition("OsScheduleTableEventSetting"))
			...
			def List<OsScheduleTableTaskActivation> getOsScheduleTableTaskActivations(){
				...
				return new BasicWrappingEList<OsScheduleTableTaskActivation, GContainer>(filteredContainers, typeof(OsScheduleTableTaskActivation), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint.OsScheduleTableTaskActivation osScheduleTableTaskActivation) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint.OsScheduleTableTaskActivation osScheduleTableTaskActivation) {
						osScheduleTableTaskActivation.target?.gSetDefinition(containerValue.getContainerDefinition("OsScheduleTableTaskActivation"))
			...
			static class OsScheduleTableEventSetting implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsEvent getOsScheduleTableSetEventRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsEvent), "OsScheduleTableSetEventRef")
				}
				
				def void setOsScheduleTableSetEventRef(org.artop.ecuc.autosar442.accessors.Os.OsEvent object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsTask getOsScheduleTableSetEventTaskRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsTask), "OsScheduleTableSetEventTaskRef")
				}
				
				def void setOsScheduleTableSetEventTaskRef(org.artop.ecuc.autosar442.accessors.Os.OsTask object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class OsScheduleTableTaskActivation implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsTask getOsScheduleTableActivateTaskRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsTask), "OsScheduleTableActivateTaskRef")
				}
				
				def void setOsScheduleTableActivateTaskRef(org.artop.ecuc.autosar442.accessors.Os.OsTask object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class OsSpinlock implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsSpinlockAccessingApplications(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		def org.artop.ecuc.autosar442.accessors.Os.OsSpinlock getOsSpinlockSuccessor(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsSpinlock), "OsSpinlockSuccessor")
		}
		
		def void setOsSpinlockSuccessor(org.artop.ecuc.autosar442.accessors.Os.OsSpinlock object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class OsTask implements IWrapper<GContainer> {
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsApplication> getOsTaskAccessingApplications(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsEvent> getOsTaskEventRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Os.OsEvent>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Os.OsEvent)) {
				override protected wrap(org.artop.ecuc.autosar442.accessors.Os.OsEvent object) throws CoreException {
					if (object !== null) {
						val container = object.getTarget()
						val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
						referenceValue.gSetDefinition(referenceValueDef)
				...
				override protected unwrap(GReferenceValue referenceValue) {
					if (referenceValue !== null) {
						val referenceValueValue = referenceValue.gGetValue
						if (referenceValueValue instanceof GContainer) {
							return new org.artop.ecuc.autosar442.accessors.Os.OsEvent(referenceValueValue as GContainer)
						}
					}
				}
			}
		...
		def List<org.artop.ecuc.autosar442.accessors.Os.OsResource> getOsTaskResourceRefs(){
			val containerDef = containerValue.gGetDefinition
			val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class OsTaskAutostart implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Os.OsAppMode> getOsTaskAppModeRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class OsTaskTimingProtection implements IWrapper<GContainer> {
			...
			def List<OsTaskResourceLock> getOsTaskResourceLocks(){
				...
				return new BasicWrappingEList<OsTaskResourceLock, GContainer>(filteredContainers, typeof(OsTaskResourceLock), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Os.OsTask.OsTaskTimingProtection.OsTaskResourceLock osTaskResourceLock) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Os.OsTask.OsTaskTimingProtection.OsTaskResourceLock osTaskResourceLock) {
						osTaskResourceLock.target?.gSetDefinition(containerValue.getContainerDefinition("OsTaskResourceLock"))
			...
			static class OsTaskResourceLock implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Os.OsResource getOsTaskResourceLockResourceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Os.OsResource), "OsTaskResourceLockResourceRef")
				}
				
				def void setOsTaskResourceLockResourceRef(org.artop.ecuc.autosar442.accessors.Os.OsResource object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
