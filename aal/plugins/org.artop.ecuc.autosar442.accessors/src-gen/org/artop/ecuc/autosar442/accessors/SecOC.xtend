...
class SecOC implements IWrapper<GModuleConfiguration> {
	...
	def List<SecOCRxPduProcessing> getSecOCRxPduProcessings(){
		...
		return new BasicWrappingEList<SecOCRxPduProcessing, GContainer>(filteredContainers, typeof(SecOCRxPduProcessing), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SecOC.SecOCRxPduProcessing secOCRxPduProcessing) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SecOC.SecOCRxPduProcessing secOCRxPduProcessing) {
				secOCRxPduProcessing.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SecOCRxPduProcessing"))
	...
	def List<SecOCSameBufferPduCollection> getSecOCSameBufferPduCollections(){
		...
		return new BasicWrappingEList<SecOCSameBufferPduCollection, GContainer>(filteredContainers, typeof(SecOCSameBufferPduCollection), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SecOC.SecOCSameBufferPduCollection secOCSameBufferPduCollection) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SecOC.SecOCSameBufferPduCollection secOCSameBufferPduCollection) {
				secOCSameBufferPduCollection.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SecOCSameBufferPduCollection"))
	...
	def List<SecOCTxPduProcessing> getSecOCTxPduProcessings(){
		...
		return new BasicWrappingEList<SecOCTxPduProcessing, GContainer>(filteredContainers, typeof(SecOCTxPduProcessing), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SecOC.SecOCTxPduProcessing secOCTxPduProcessing) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SecOC.SecOCTxPduProcessing secOCTxPduProcessing) {
				secOCTxPduProcessing.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SecOCTxPduProcessing"))
	...
	static class SecOCRxPduProcessing implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Csm.CsmJobs.CsmJob getSecOCRxAuthServiceConfigRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Csm.CsmJobs.CsmJob), "SecOCRxAuthServiceConfigRef")
		}
		
		def void setSecOCRxAuthServiceConfigRef(org.artop.ecuc.autosar442.accessors.Csm.CsmJobs.CsmJob object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar442.accessors.SecOC.SecOCSameBufferPduCollection getSecOCSameBufferPduRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SecOC.SecOCSameBufferPduCollection), "SecOCSameBufferPduRef")
		}
		
		def void setSecOCSameBufferPduRef(org.artop.ecuc.autosar442.accessors.SecOC.SecOCSameBufferPduCollection object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SecOCRxAuthenticPduLayer implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxAuthenticLayerPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxAuthenticLayerPduRef")
			}
			
			def void setSecOCRxAuthenticLayerPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SecOCRxSecuredPduLayer implements IWrapper<GContainer> {
			...
			static class SecOCRxSecuredPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxSecuredLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxSecuredLayerPduRef")
				}
				
				def void setSecOCRxSecuredLayerPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SecOCRxSecuredPduCollection implements IWrapper<GContainer> {
				...
				static class SecOCRxAuthenticPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxAuthenticPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxAuthenticPduRef")
					}
					
					def void setSecOCRxAuthenticPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class SecOCRxCryptographicPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxCryptographicPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxCryptographicPduRef")
					}
					
					def void setSecOCRxCryptographicPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
	...
	static class SecOCTxPduProcessing implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Csm.CsmJobs.CsmJob getSecOCTxAuthServiceConfigRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Csm.CsmJobs.CsmJob), "SecOCTxAuthServiceConfigRef")
		}
		
		def void setSecOCTxAuthServiceConfigRef(org.artop.ecuc.autosar442.accessors.Csm.CsmJobs.CsmJob object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SecOCTxAuthenticPduLayer implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxAuthenticLayerPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxAuthenticLayerPduRef")
			}
			
			def void setSecOCTxAuthenticLayerPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SecOCTxSecuredPduLayer implements IWrapper<GContainer> {
			...
			static class SecOCTxSecuredPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxSecuredLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxSecuredLayerPduRef")
				}
				
				def void setSecOCTxSecuredLayerPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SecOCTxSecuredPduCollection implements IWrapper<GContainer> {
				...
				static class SecOCTxAuthenticPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxAuthenticPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxAuthenticPduRef")
					}
					
					def void setSecOCTxAuthenticPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class SecOCTxCryptographicPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxCryptographicPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxCryptographicPduRef")
					}
					
					def void setSecOCTxCryptographicPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
