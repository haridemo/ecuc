...
class BswM implements IWrapper<GModuleConfiguration> {
	...
	def List<BswMConfig> getBswMConfigs(){
		...
		return new BasicWrappingEList<BswMConfig, GContainer>(filteredContainers, typeof(BswMConfig), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig bswMConfig) {
				bswMConfig.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("BswMConfig"))
				super.delegateAdd(bswMConfig)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig bswMConfig) {
				bswMConfig.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("BswMConfig"))
	...
	static class BswMConfig implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition getBswMPartitionRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition), "BswMPartitionRef")
		}
		
		def void setBswMPartitionRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
		...
		static class BswMArbitration implements IWrapper<GContainer> {
			...
			def List<BswMEventRequestPort> getBswMEventRequestPorts(){
				...
				return new BasicWrappingEList<BswMEventRequestPort, GContainer>(filteredContainers, typeof(BswMEventRequestPort), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMEventRequestPort bswMEventRequestPort) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMEventRequestPort bswMEventRequestPort) {
						bswMEventRequestPort.target?.gSetDefinition(containerValue.getContainerDefinition("BswMEventRequestPort"))
			...
			def List<BswMLogicalExpression> getBswMLogicalExpressions(){
				...
				return new BasicWrappingEList<BswMLogicalExpression, GContainer>(filteredContainers, typeof(BswMLogicalExpression), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMLogicalExpression bswMLogicalExpression) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMLogicalExpression bswMLogicalExpression) {
						bswMLogicalExpression.target?.gSetDefinition(containerValue.getContainerDefinition("BswMLogicalExpression"))
			...
			def List<BswMModeCondition> getBswMModeConditions(){
				...
				return new BasicWrappingEList<BswMModeCondition, GContainer>(filteredContainers, typeof(BswMModeCondition), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeCondition bswMModeCondition) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeCondition bswMModeCondition) {
						bswMModeCondition.target?.gSetDefinition(containerValue.getContainerDefinition("BswMModeCondition"))
			...
			def List<BswMModeRequestPort> getBswMModeRequestPorts(){
				...
				return new BasicWrappingEList<BswMModeRequestPort, GContainer>(filteredContainers, typeof(BswMModeRequestPort), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeRequestPort bswMModeRequestPort) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeRequestPort bswMModeRequestPort) {
						bswMModeRequestPort.target?.gSetDefinition(containerValue.getContainerDefinition("BswMModeRequestPort"))
			...
			def List<BswMRule> getBswMRules(){
				...
				return new BasicWrappingEList<BswMRule, GContainer>(filteredContainers, typeof(BswMRule), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMRule bswMRule) {
						bswMRule.target?.gSetDefinition(containerValue.getContainerDefinition("BswMRule"))
						super.delegateAdd(bswMRule)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMRule bswMRule) {
						bswMRule.target?.gSetDefinition(containerValue.getContainerDefinition("BswMRule"))
			...
			static class BswMEventRequestPort implements IWrapper<GContainer> {
				...
				static class BswMEventRequestSource implements IWrapper<GContainer> {
					...
					static class BswMModeSwitchErrorEvent implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMSwitchPort getBswMRteSwitchPortRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMSwitchPort), "BswMRteSwitchPortRef")
						}
						
						def void setBswMRteSwitchPortRef(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMSwitchPort object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMWdgMRequestPartitionReset implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition getBswMWdgMRequestPartitionResetRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition), "BswMWdgMRequestPartitionResetRef")
						}
						
						def void setBswMWdgMRequestPartitionResetRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
			...
			static class BswMModeRequestPort implements IWrapper<GContainer> {
				...
				static class BswMModeRequestSource implements IWrapper<GContainer> {
					...
					static class BswMCanSMIcomIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMCanSMChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMCanSMChannelRef")
						}
						
						def void setBswMCanSMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMComMIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMComMChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMComMChannelRef")
						}
						
						def void setBswMComMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMComMPncRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMPnc getBswMComMPncRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMPnc), "BswMComMPncRef")
						}
						
						def void setBswMComMPncRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMPnc object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMDcmComModeRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMDcmComMChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMDcmComMChannelRef")
						}
						
						def void setBswMDcmComMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMEcuMWakeupSource implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getBswMEcuMWakeupSrcRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "BswMEcuMWakeupSrcRef")
						}
						
						def void setBswMEcuMWakeupSrcRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMEthIfPortGroupLinkStateChg implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EthIf.EthIfConfigSet.EthIfSwitchPortGroup getBswMEthIfSwitchPortGroupRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EthIf.EthIfConfigSet.EthIfSwitchPortGroup), "BswMEthIfSwitchPortGroupRef")
						}
						
						def void setBswMEthIfSwitchPortGroupRef(org.artop.ecuc.autosar442.accessors.EthIf.EthIfConfigSet.EthIfSwitchPortGroup object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMEthSMIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMEthSMChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMEthSMChannelRef")
						}
						
						def void setBswMEthSMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMFrSMIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMFrSMChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMFrSMChannelRef")
						}
						
						def void setBswMFrSMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMJ1939DcmBroadcastStatus implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMJ1939DcmChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMJ1939DcmChannelRef")
						}
						
						def void setBswMJ1939DcmChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMJ1939NmIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMJ1939NmChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMJ1939NmChannelRef")
						}
						
						def void setBswMJ1939NmChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode getBswMJ1939NmNodeRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode), "BswMJ1939NmNodeRef")
						}
						
						def void setBswMJ1939NmNodeRef(org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMLinSMIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMLinSMChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMLinSMChannelRef")
						}
						
						def void setBswMLinSMChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMLinScheduleIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.LinSM.LinSMConfigSet.LinSMChannel.LinSMSchedule getBswMLinScheduleRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.LinSM.LinSMConfigSet.LinSMChannel.LinSMSchedule), "BswMLinScheduleRef")
						}
						
						def void setBswMLinScheduleRef(org.artop.ecuc.autosar442.accessors.LinSM.LinSMConfigSet.LinSMChannel.LinSMSchedule object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMLinTpModeRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMLinTpChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMLinTpChannelRef")
						}
						
						def void setBswMLinTpChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMNmIfCarWakeUpIndication implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMNmChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMNmChannelRef")
						}
						
						def void setBswMNmChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMNvMRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor getBswMNvMBlockRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor), "BswMNvMBlockRef")
						}
						
						def void setBswMNvMBlockRef(org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMSdClientServiceCurrentState implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService getBswMSdClientMethodsRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService), "BswMSdClientMethodsRef")
						}
						
						def void setBswMSdClientMethodsRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMSdConsumedEventGroupCurrentState implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdConsumedEventGroup getBswMSdConsumedEventGroupRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdConsumedEventGroup), "BswMSdConsumedEventGroupRef")
						}
						
						def void setBswMSdConsumedEventGroupRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdClientService.SdConsumedEventGroup object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMSdEventHandlerCurrentState implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdEventHandler getBswMSdEventHandlerRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdEventHandler), "BswMSdEventHandlerRef")
						}
						
						def void setBswMSdEventHandlerRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService.SdEventHandler object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
			...
			static class BswMRule implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMLogicalExpression getBswMRuleExpressionRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMLogicalExpression), "BswMRuleExpressionRef")
				}
				
				def void setBswMRuleExpressionRef(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMLogicalExpression object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList getBswMRuleFalseActionList(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList), "BswMRuleFalseActionList")
				}
				
				def void setBswMRuleFalseActionList(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList getBswMRuleTrueActionList(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList), "BswMRuleTrueActionList")
				}
				
				def void setBswMRuleTrueActionList(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class BswMModeControl implements IWrapper<GContainer> {
			...
			def List<BswMAction> getBswMActions(){
				...
				return new BasicWrappingEList<BswMAction, GContainer>(filteredContainers, typeof(BswMAction), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMAction bswMAction) {
						bswMAction.target?.gSetDefinition(containerValue.getContainerDefinition("BswMAction"))
						super.delegateAdd(bswMAction)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMAction bswMAction) {
						bswMAction.target?.gSetDefinition(containerValue.getContainerDefinition("BswMAction"))
			...
			def List<BswMActionList> getBswMActionLists(){
				...
				return new BasicWrappingEList<BswMActionList, GContainer>(filteredContainers, typeof(BswMActionList), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList bswMActionList) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList bswMActionList) {
						bswMActionList.target?.gSetDefinition(containerValue.getContainerDefinition("BswMActionList"))
			...
			def List<BswMRteModeRequestPort> getBswMRteModeRequestPorts(){
				...
				return new BasicWrappingEList<BswMRteModeRequestPort, GContainer>(filteredContainers, typeof(BswMRteModeRequestPort), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMRteModeRequestPort bswMRteModeRequestPort) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMRteModeRequestPort bswMRteModeRequestPort) {
						bswMRteModeRequestPort.target?.gSetDefinition(containerValue.getContainerDefinition("BswMRteModeRequestPort"))
			...
			def List<BswMSwitchPort> getBswMSwitchPorts(){
				...
				return new BasicWrappingEList<BswMSwitchPort, GContainer>(filteredContainers, typeof(BswMSwitchPort), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMSwitchPort bswMSwitchPort) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMSwitchPort bswMSwitchPort) {
						bswMSwitchPort.target?.gSetDefinition(containerValue.getContainerDefinition("BswMSwitchPort"))
			...
			static class BswMAction implements IWrapper<GContainer> {
				...
				static class BswMAvailableActions implements IWrapper<GContainer> {
					...
					static class BswMClearEventRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMEventRequestPort getBswMClearEventRequestPortRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMEventRequestPort), "BswMClearEventRequestPortRef")
						}
						
						def void setBswMClearEventRequestPortRef(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMEventRequestPort object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMComMAllowCom implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMComMAllowChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMComMAllowChannelRef")
						}
						
						def void setBswMComMAllowChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMComMModeLimitation implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMComMLimitChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMComMLimitChannelRef")
						}
						
						def void setBswMComMLimitChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMComMModeSwitch implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMUser getBswMComMUserRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMUser), "BswMComMUserRef")
						}
						
						def void setBswMComMUserRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMUser object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMCoreHaltMode implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition getBswMTargetCoreRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition), "BswMTargetCoreRef")
						}
						
						def void setBswMTargetCoreRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMDeadlineMonitoringControl implements IWrapper<GContainer> {
						...
						def List<org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup> getBswMDisabledDMPduGroupRefs(){
							val containerDef = containerValue.gGetDefinition
							...
							return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup)) {
								override protected wrap(org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup object) throws CoreException {
									if (object !== null) {
								...
								override protected unwrap(GReferenceValue referenceValue) {
									if (referenceValue !== null) {
										...
										if (referenceValueValue instanceof GContainer) {
											return new org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup(referenceValueValue as GContainer)
										}
									}
								}
							}
						...
						def List<org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup> getBswMEnabledDMPduGroupRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					static class BswMEcuMDriverInitListBswM implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMDriverInitListBswM getBswMEcuMDriverInitListBswMRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMDriverInitListBswM), "BswMEcuMDriverInitListBswMRef")
						}
						
						def void setBswMEcuMDriverInitListBswMRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMDriverInitListBswM object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMEcuMGoDown implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig getBswMEcuMUserIdRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig), "BswMEcuMUserIdRef")
						}
						
						def void setBswMEcuMUserIdRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMEcuMSelectShutdownTarget implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode getBswMEcuMResetModeRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode), "BswMEcuMResetModeRef")
						}
						
						def void setBswMEcuMResetModeRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode getBswMEcuMSleepModeRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode), "BswMEcuMSleepModeRef")
						}
						
						def void setBswMEcuMSleepModeRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMFrSMAllSlots implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMFrSMAllSlotsNetworkHandleRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMFrSMAllSlotsNetworkHandleRef")
						}
						
						def void setBswMFrSMAllSlotsNetworkHandleRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMJ1939DcmStateSwitch implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode getBswMJ1939DcmNodeRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode), "BswMJ1939DcmNodeRef")
						}
						
						def void setBswMJ1939DcmNodeRef(org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMJ1939RmStateSwitch implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMJ1939RmChannelRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMJ1939RmChannelRef")
						}
						
						def void setBswMJ1939RmChannelRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
						...
						def org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode getBswMJ1939RmNodeRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode), "BswMJ1939RmNodeRef")
						}
						
						def void setBswMJ1939RmNodeRef(org.artop.ecuc.autosar442.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMNMControl implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getBswMComMNetworkHandleRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "BswMComMNetworkHandleRef")
						}
						
						def void setBswMComMNetworkHandleRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMPduGroupSwitch implements IWrapper<GContainer> {
						...
						def List<org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup> getBswMDisabledPduGroupRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
						...
						def List<org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPduGroup> getBswMEnabledPduGroupRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					static class BswMPduRouterControl implements IWrapper<GContainer> {
						...
						def List<org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup> getBswMPduRoutingPathGroupRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
							...
							return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup)) {
								override protected wrap(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup object) throws CoreException {
									if (object !== null) {
										val container = object.getTarget()
										val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
										referenceValue.gSetDefinition(referenceValueDef)
								...
								override protected unwrap(GReferenceValue referenceValue) {
									if (referenceValue !== null) {
										val referenceValueValue = referenceValue.gGetValue
										if (referenceValueValue instanceof GContainer) {
											return new org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup(referenceValueValue as GContainer)
										}
									}
								}
							}
					...
					static class BswMRteModeRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMRteModeRequestPort getBswMRteModeRequestPortRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMRteModeRequestPort), "BswMRteModeRequestPortRef")
						}
						
						def void setBswMRteModeRequestPortRef(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMRteModeRequestPort object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMSdServerServiceModeRequest implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService getBswMSdServerMethodsRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService), "BswMSdServerMethodsRef")
						}
						
						def void setBswMSdServerMethodsRef(org.artop.ecuc.autosar442.accessors.Sd.SdConfig.SdInstance.SdServerService object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMSwitchIPduMode implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu getBswMSwitchIPduModeRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu), "BswMSwitchIPduModeRef")
						}
						
						def void setBswMSwitchIPduModeRef(org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMTimerControl implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeRequestPort.BswMModeRequestSource.BswMTimer getBswMTimerRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeRequestPort.BswMModeRequestSource.BswMTimer), "BswMTimerRef")
						}
						
						def void setBswMTimerRef(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMArbitration.BswMModeRequestPort.BswMModeRequestSource.BswMTimer object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class BswMTriggerIPduSend implements IWrapper<GContainer> {
						...
						def List<org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu> getBswMTriggeredIPduRefs(){
							val containerDef = containerValue.gGetDefinition
							val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
							...
							return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu)) {
								override protected wrap(org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu object) throws CoreException {
									if (object !== null) {
										val container = object.getTarget()
										val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
										referenceValue.gSetDefinition(referenceValueDef)
								...
								override protected unwrap(GReferenceValue referenceValue) {
									if (referenceValue !== null) {
										val referenceValueValue = referenceValue.gGetValue
										if (referenceValueValue instanceof GContainer) {
											return new org.artop.ecuc.autosar442.accessors.Com.ComConfig.ComIPdu(referenceValueValue as GContainer)
										}
									}
								}
							}
			...
			static class BswMActionList implements IWrapper<GContainer> {
				...
				def List<BswMActionListItem> getBswMActionListItems(){
					...
					return new BasicWrappingEList<BswMActionListItem, GContainer>(filteredContainers, typeof(BswMActionListItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList.BswMActionListItem bswMActionListItem) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.BswM.BswMConfig.BswMModeControl.BswMActionList.BswMActionListItem bswMActionListItem) {
							bswMActionListItem.target?.gSetDefinition(containerValue.getContainerDefinition("BswMActionListItem"))
