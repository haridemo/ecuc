...
class RamTst implements IWrapper<GModuleConfiguration> {
		...
		static class RamTstConfigParams implements IWrapper<GContainer> {
			...
			def List<RamTstAlgParams> getRamTstAlgParams(){
				...
				return new BasicWrappingEList<RamTstAlgParams, GContainer>(filteredContainers, typeof(RamTstAlgParams), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.RamTst.RamTstCommon.RamTstConfigParams.RamTstAlgParams ramTstAlgParams) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.RamTst.RamTstCommon.RamTstConfigParams.RamTstAlgParams ramTstAlgParams) {
						ramTstAlgParams.target?.gSetDefinition(containerValue.getContainerDefinition("RamTstAlgParams"))
			...
			static class RamTstAlgParams implements IWrapper<GContainer> {
				...
				def List<RamTstBlockParams> getRamTstBlockParams(){
					...
					return new BasicWrappingEList<RamTstBlockParams, GContainer>(filteredContainers, typeof(RamTstBlockParams), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.RamTst.RamTstCommon.RamTstConfigParams.RamTstAlgParams.RamTstBlockParams ramTstBlockParams) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.RamTst.RamTstCommon.RamTstConfigParams.RamTstAlgParams.RamTstBlockParams ramTstBlockParams) {
							ramTstBlockParams.target?.gSetDefinition(containerValue.getContainerDefinition("RamTstBlockParams"))
	...
	static class RamTstDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getRAMTST_E_RAM_FAILURE(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "RAMTST_E_RAM_FAILURE")
		}
		
		def void setRAMTST_E_RAM_FAILURE(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
