	...
	static class FrSMConfig implements IWrapper<GContainer> {
		...
		def List<FrSMCluster> getFrSMClusters(){
			...
			return new BasicWrappingEList<FrSMCluster, GContainer>(filteredContainers, typeof(FrSMCluster), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrSM.FrSMConfig.FrSMCluster frSMCluster) {
					frSMCluster.target?.gSetDefinition(containerValue.getContainerDefinition("FrSMCluster"))
					super.delegateAdd(frSMCluster)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrSM.FrSMConfig.FrSMCluster frSMCluster) {
					frSMCluster.target?.gSetDefinition(containerValue.getContainerDefinition("FrSMCluster"))
		...
		static class FrSMCluster implements IWrapper<GContainer> {
			...
			def BigDecimal getFrSMDurationT4(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FrSMDurationT4"].getBigDecimalValue()
			}
			
			def void setFrSMDurationT4(BigDecimal value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FrSMDurationT4"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "FrSMDurationT4"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getFrSMComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "FrSMComMNetworkHandleRef")
			}
			
			def void setFrSMComMNetworkHandleRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.FrIf.FrIfConfig.FrIfCluster getFrSMFrIfClusterRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.FrIf.FrIfConfig.FrIfCluster), "FrSMFrIfClusterRef")
			}
			
			def void setFrSMFrIfClusterRef(org.artop.ecuc.autosar442.accessors.FrIf.FrIfConfig.FrIfCluster object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrSMClusterDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getFRSM_E_CLUSTER_STARTUP(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "FRSM_E_CLUSTER_STARTUP")
				}
				
				def void setFRSM_E_CLUSTER_STARTUP(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getFRSM_E_CLUSTER_SYNC_LOSS(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "FRSM_E_CLUSTER_SYNC_LOSS")
				}
				
				def void setFRSM_E_CLUSTER_SYNC_LOSS(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
