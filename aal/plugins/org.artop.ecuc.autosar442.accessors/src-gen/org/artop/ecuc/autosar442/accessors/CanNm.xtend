...
class CanNm implements IWrapper<GModuleConfiguration> {
	...
	static class CanNmGlobalConfig implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanNmPnEiraRxNSduRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanNmPnEiraRxNSduRef")
		}
		
		def void setCanNmPnEiraRxNSduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<CanNmChannelConfig> getCanNmChannelConfigs(){
			...
			return new BasicWrappingEList<CanNmChannelConfig, GContainer>(filteredContainers, typeof(CanNmChannelConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.CanNm.CanNmGlobalConfig.CanNmChannelConfig canNmChannelConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.CanNm.CanNmGlobalConfig.CanNmChannelConfig canNmChannelConfig) {
					canNmChannelConfig.target?.gSetDefinition(containerValue.getContainerDefinition("CanNmChannelConfig"))
		...
		static class CanNmChannelConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getCanNmComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "CanNmComMNetworkHandleRef")
			}
			
			def void setCanNmComMNetworkHandleRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanNmPnEraRxNSduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanNmPnEraRxNSduRef")
			}
			
			def void setCanNmPnEraRxNSduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<CanNmRxPdu> getCanNmRxPdus(){
				...
				return new BasicWrappingEList<CanNmRxPdu, GContainer>(filteredContainers, typeof(CanNmRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.CanNm.CanNmGlobalConfig.CanNmChannelConfig.CanNmRxPdu canNmRxPdu) {
						canNmRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CanNmRxPdu"))
						super.delegateAdd(canNmRxPdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.CanNm.CanNmGlobalConfig.CanNmChannelConfig.CanNmRxPdu canNmRxPdu) {
						canNmRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CanNmRxPdu"))
			...
			static class CanNmRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanNmRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanNmRxPduRef")
				}
				
				def void setCanNmRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanNmTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanNmTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanNmTxPduRef")
				}
				
				def void setCanNmTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanNmUserDataTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanNmTxUserDataPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanNmTxUserDataPduRef")
				}
				
				def void setCanNmTxUserDataPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CanNmPnInfo implements IWrapper<GContainer> {
			...
			def List<CanNmPnFilterMaskByte> getCanNmPnFilterMaskBytes(){
				...
				return new BasicWrappingEList<CanNmPnFilterMaskByte, GContainer>(filteredContainers, typeof(CanNmPnFilterMaskByte), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.CanNm.CanNmGlobalConfig.CanNmPnInfo.CanNmPnFilterMaskByte canNmPnFilterMaskByte) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.CanNm.CanNmGlobalConfig.CanNmPnInfo.CanNmPnFilterMaskByte canNmPnFilterMaskByte) {
						canNmPnFilterMaskByte.target?.gSetDefinition(containerValue.getContainerDefinition("CanNmPnFilterMaskByte"))
