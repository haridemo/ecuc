	...
	static class LinIfGlobalConfig implements IWrapper<GContainer> {
		...
		def List<LinIfChannel> getLinIfChannels(){
			...
			return new BasicWrappingEList<LinIfChannel, GContainer>(filteredContainers, typeof(LinIfChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel linIfChannel) {
					linIfChannel.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfChannel"))
					super.delegateAdd(linIfChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel linIfChannel) {
					linIfChannel.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfChannel"))
		...
		static class LinIfChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Lin.LinGlobalConfig.LinChannel getLinIfChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Lin.LinGlobalConfig.LinChannel), "LinIfChannelRef")
			}
			
			def void setLinIfChannelRef(org.artop.ecuc.autosar442.accessors.Lin.LinGlobalConfig.LinChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getLinIfComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "LinIfComMNetworkHandleRef")
			}
			
			def void setLinIfComMNetworkHandleRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<LinIfFrame> getLinIfFrames(){
				...
				return new BasicWrappingEList<LinIfFrame, GContainer>(filteredContainers, typeof(LinIfFrame), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame linIfFrame) {
						linIfFrame.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfFrame"))
						super.delegateAdd(linIfFrame)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame linIfFrame) {
						linIfFrame.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfFrame"))
			...
			def List<LinIfScheduleTable> getLinIfScheduleTables(){
				...
				return new BasicWrappingEList<LinIfScheduleTable, GContainer>(filteredContainers, typeof(LinIfScheduleTable), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable linIfScheduleTable) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable linIfScheduleTable) {
						linIfScheduleTable.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfScheduleTable"))
			...
			static class LinIfFrame implements IWrapper<GContainer> {
				...
				def List<LinIfSubstitutionFrames> getLinIfSubstitutionFrames(){
					...
					return new BasicWrappingEList<LinIfSubstitutionFrames, GContainer>(filteredContainers, typeof(LinIfSubstitutionFrames), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame.LinIfSubstitutionFrames linIfSubstitutionFrames) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame.LinIfSubstitutionFrames linIfSubstitutionFrames) {
							linIfSubstitutionFrames.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfSubstitutionFrames"))
				...
				static class LinIfFixedFrameSdu implements IWrapper<GContainer> {
					...
					def List<LinIfFixedFrameSduByte> getLinIfFixedFrameSduBytes(){
						...
						return new BasicWrappingEList<LinIfFixedFrameSduByte, GContainer>(filteredContainers, typeof(LinIfFixedFrameSduByte), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame.LinIfFixedFrameSdu.LinIfFixedFrameSduByte linIfFixedFrameSduByte) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame.LinIfFixedFrameSdu.LinIfFixedFrameSduByte linIfFixedFrameSduByte) {
								linIfFixedFrameSduByte.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfFixedFrameSduByte"))
				...
				static class LinIfPduDirection implements IWrapper<GContainer> {
					...
					static class LinIfRxPdu implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getLinIfRxPduRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "LinIfRxPduRef")
						}
						
						def void setLinIfRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
					...
					static class LinIfTxPdu implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getLinIfTxPduRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "LinIfTxPduRef")
						}
						
						def void setLinIfTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
				...
				static class LinIfSubstitutionFrames implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame getLinIfSubstitutionFrameRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame), "LinIfSubstitutionFrameRef")
					}
					
					def void setLinIfSubstitutionFrameRef(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class LinIfScheduleTable implements IWrapper<GContainer> {
				...
				def List<LinIfEntry> getLinIfEntries(){
					...
					return new BasicWrappingEList<LinIfEntry, GContainer>(filteredContainers, typeof(LinIfEntry), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable.LinIfEntry linIfEntry) {
							linIfEntry.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfEntry"))
							super.delegateAdd(linIfEntry)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable.LinIfEntry linIfEntry) {
							linIfEntry.target?.gSetDefinition(containerValue.getContainerDefinition("LinIfEntry"))
				...
				static class LinIfEntry implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable getLinIfCollisionResolvingRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable), "LinIfCollisionResolvingRef")
					}
					
					def void setLinIfCollisionResolvingRef(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame getLinIfFrameRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame), "LinIfFrameRef")
					}
					
					def void setLinIfFrameRef(org.artop.ecuc.autosar442.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfFrame object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class LinIfTransceiverDrvConfig implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel getLinIfTrcvIdRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel), "LinIfTrcvIdRef")
				}
				
				def void setLinIfTrcvIdRef(org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
