...
class FrTrcv implements IWrapper<GModuleConfiguration> {
	...
	def List<FrTrcvChannel> getFrTrcvChannels(){
		...
		return new BasicWrappingEList<FrTrcvChannel, GContainer>(filteredContainers, typeof(FrTrcvChannel), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrTrcv.FrTrcvChannel frTrcvChannel) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrTrcv.FrTrcvChannel frTrcvChannel) {
				frTrcvChannel.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("FrTrcvChannel"))
	...
	static class FrTrcvChannel implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel getFrTrcvIcuChannelRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel), "FrTrcvIcuChannelRef")
		}
		
		def void setFrTrcvIcuChannelRef(org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getFrTrcvWakeupSourceRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "FrTrcvWakeupSourceRef")
		}
		
		def void setFrTrcvWakeupSourceRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<FrTrcvBranchIdContainer> getFrTrcvBranchIdContainers(){
			...
			return new BasicWrappingEList<FrTrcvBranchIdContainer, GContainer>(filteredContainers, typeof(FrTrcvBranchIdContainer), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrTrcv.FrTrcvChannel.FrTrcvBranchIdContainer frTrcvBranchIdContainer) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrTrcv.FrTrcvChannel.FrTrcvBranchIdContainer frTrcvBranchIdContainer) {
					frTrcvBranchIdContainer.target?.gSetDefinition(containerValue.getContainerDefinition("FrTrcvBranchIdContainer"))
		...
		static class FrTrcvAccess implements IWrapper<GContainer> {
			...
			static class FrTrcvDioAccess implements IWrapper<GContainer> {
				...
				def List<FrTrcvDioChannelAccess> getFrTrcvDioChannelAccess(){
					...
					return new BasicWrappingEList<FrTrcvDioChannelAccess, GContainer>(filteredContainers, typeof(FrTrcvDioChannelAccess), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrTrcv.FrTrcvChannel.FrTrcvAccess.FrTrcvDioAccess.FrTrcvDioChannelAccess frTrcvDioChannelAccess) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrTrcv.FrTrcvChannel.FrTrcvAccess.FrTrcvDioAccess.FrTrcvDioChannelAccess frTrcvDioChannelAccess) {
							frTrcvDioChannelAccess.target?.gSetDefinition(containerValue.getContainerDefinition("FrTrcvDioChannelAccess"))
			...
			static class FrTrcvSpiSequence implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence getFrTrcvSpiSequenceName(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence), "FrTrcvSpiSequenceName")
				}
				
				def void setFrTrcvSpiSequenceName(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class FrTrcvChannelDemEventParameterRefs implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getFRTRCV_E_FR_BUSERROR_TRCV(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "FRTRCV_E_FR_BUSERROR_TRCV")
			}
			
			def void setFRTRCV_E_FR_BUSERROR_TRCV(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getFRTRCV_E_FR_ERRN_TRCV(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "FRTRCV_E_FR_ERRN_TRCV")
			}
			
			def void setFRTRCV_E_FR_ERRN_TRCV(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
