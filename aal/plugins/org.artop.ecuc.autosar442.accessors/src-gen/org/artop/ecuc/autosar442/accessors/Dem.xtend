...
class Dem implements IWrapper<GModuleConfiguration> {
	...
	static class DemConfigSet implements IWrapper<GContainer> {
		...
		def List<DemComponent> getDemComponents(){
			...
			return new BasicWrappingEList<DemComponent, GContainer>(filteredContainers, typeof(DemComponent), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent demComponent) {
					demComponent.target?.gSetDefinition(containerValue.getContainerDefinition("DemComponent"))
					super.delegateAdd(demComponent)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent demComponent) {
					demComponent.target?.gSetDefinition(containerValue.getContainerDefinition("DemComponent"))
		...
		def List<DemDTC> getDemDTCs(){
			...
			return new BasicWrappingEList<DemDTC, GContainer>(filteredContainers, typeof(DemDTC), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTC demDTC) {
					demDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemDTC"))
					super.delegateAdd(demDTC)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTC demDTC) {
					demDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemDTC"))
		...
		def List<DemDTCAttributes> getDemDTCAttributes(){
			...
			return new BasicWrappingEList<DemDTCAttributes, GContainer>(filteredContainers, typeof(DemDTCAttributes), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTCAttributes demDTCAttributes) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTCAttributes demDTCAttributes) {
					demDTCAttributes.target?.gSetDefinition(containerValue.getContainerDefinition("DemDTCAttributes"))
		...
		def List<DemDebounceCounterBasedClass> getDemDebounceCounterBasedClass(){
			...
			return new BasicWrappingEList<DemDebounceCounterBasedClass, GContainer>(filteredContainers, typeof(DemDebounceCounterBasedClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass demDebounceCounterBasedClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass demDebounceCounterBasedClass) {
					demDebounceCounterBasedClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDebounceCounterBasedClass"))
		...
		def List<DemDebounceTimeBaseClass> getDemDebounceTimeBaseClass(){
			...
			return new BasicWrappingEList<DemDebounceTimeBaseClass, GContainer>(filteredContainers, typeof(DemDebounceTimeBaseClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass demDebounceTimeBaseClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass demDebounceTimeBaseClass) {
					demDebounceTimeBaseClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDebounceTimeBaseClass"))
		...
		def List<DemEventParameter> getDemEventParameters(){
			...
			return new BasicWrappingEList<DemEventParameter, GContainer>(filteredContainers, typeof(DemEventParameter), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter demEventParameter) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter demEventParameter) {
					demEventParameter.target?.gSetDefinition(containerValue.getContainerDefinition("DemEventParameter"))
		...
		def List<DemMultiEventTriggering> getDemMultiEventTriggerings(){
			...
			return new BasicWrappingEList<DemMultiEventTriggering, GContainer>(filteredContainers, typeof(DemMultiEventTriggering), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemMultiEventTriggering demMultiEventTriggering) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemMultiEventTriggering demMultiEventTriggering) {
					demMultiEventTriggering.target?.gSetDefinition(containerValue.getContainerDefinition("DemMultiEventTriggering"))
		...
		def List<DemObdDTC> getDemObdDTCs(){
			...
			return new BasicWrappingEList<DemObdDTC, GContainer>(filteredContainers, typeof(DemObdDTC), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemObdDTC demObdDTC) {
					demObdDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemObdDTC"))
					super.delegateAdd(demObdDTC)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemObdDTC demObdDTC) {
					demObdDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemObdDTC"))
		...
		def List<DemPidClass> getDemPidClass(){
			...
			return new BasicWrappingEList<DemPidClass, GContainer>(filteredContainers, typeof(DemPidClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass demPidClass) {
					demPidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemPidClass"))
					super.delegateAdd(demPidClass)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass demPidClass) {
					demPidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemPidClass"))
		...
		static class DemComponent implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent> getDemImmediateChildComponentRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemDTC implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTCAttributes getDemDTCAttributesRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTCAttributes), "DemDTCAttributesRef")
			}
			
			def void setDemDTCAttributesRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTCAttributes object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemObdDTC getDemObdDTCRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemObdDTC), "DemObdDTCRef")
			}
			
			def void setDemObdDTCRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemObdDTC object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemDTCAttributes implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle getDemAgingCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle), "DemAgingCycleRef")
			}
			
			def void setDemAgingCycleRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataClass getDemExtendedDataClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataClass), "DemExtendedDataClassRef")
			}
			
			def void setDemExtendedDataClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass getDemFreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass), "DemFreezeFrameClassRef")
			}
			
			def void setDemFreezeFrameClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass getDemFreezeFrameRecNumClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass), "DemFreezeFrameRecNumClassRef")
			}
			
			def void setDemFreezeFrameRecNumClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass getDemJ1939ExpandedFreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass), "DemJ1939ExpandedFreezeFrameClassRef")
			}
			
			def void setDemJ1939ExpandedFreezeFrameClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass getDemJ1939FreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass), "DemJ1939FreezeFrameClassRef")
			}
			
			def void setDemJ1939FreezeFrameClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass getDemWWHOBDFreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass), "DemWWHOBDFreezeFrameClassRef")
			}
			
			def void setDemWWHOBDFreezeFrameClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemDtrs implements IWrapper<GContainer> {
			...
			def List<DemDtr> getDemDtrs(){
				...
				return new BasicWrappingEList<DemDtr, GContainer>(filteredContainers, typeof(DemDtr), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDtrs.DemDtr demDtr) {
						demDtr.target?.gSetDefinition(containerValue.getContainerDefinition("DemDtr"))
						super.delegateAdd(demDtr)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDtrs.DemDtr demDtr) {
						demDtr.target?.gSetDefinition(containerValue.getContainerDefinition("DemDtr"))
			...
			static class DemDtr implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getDemDtrEventRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "DemDtrEventRef")
				}
				
				def void setDemDtrEventRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemEventParameter implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent getDemComponentClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent), "DemComponentClassRef")
			}
			
			def void setDemComponentClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemComponent object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTC getDemDTCRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTC), "DemDTCRef")
			}
			
			def void setDemDTCRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDTC object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableConditionGroup getDemEnableConditionGroupRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableConditionGroup), "DemEnableConditionGroupRef")
			}
			
			def void setDemEnableConditionGroupRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableConditionGroup object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getDemOBDGroupingAssociativeEventsRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "DemOBDGroupingAssociativeEventsRef")
			}
			
			def void setDemOBDGroupingAssociativeEventsRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle getDemOperationCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle), "DemOperationCycleRef")
			}
			
			def void setDemOperationCycleRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageConditionGroup getDemStorageConditionGroupRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageConditionGroup), "DemStorageConditionGroupRef")
			}
			
			def void setDemStorageConditionGroupRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageConditionGroup object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DemCallbackEventUdsStatusChanged> getDemCallbackEventUdsStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackEventUdsStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackEventUdsStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter.DemCallbackEventUdsStatusChanged demCallbackEventUdsStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter.DemCallbackEventUdsStatusChanged demCallbackEventUdsStatusChanged) {
						demCallbackEventUdsStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackEventUdsStatusChanged"))
			...
			def List<DemCallbackMonitorStatusChanged> getDemCallbackMonitorStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackMonitorStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackMonitorStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter.DemCallbackMonitorStatusChanged demCallbackMonitorStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter.DemCallbackMonitorStatusChanged demCallbackMonitorStatusChanged) {
						demCallbackMonitorStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackMonitorStatusChanged"))
			...
			def List<DemIndicatorAttribute> getDemIndicatorAttributes(){
				...
				return new BasicWrappingEList<DemIndicatorAttribute, GContainer>(filteredContainers, typeof(DemIndicatorAttribute), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter.DemIndicatorAttribute demIndicatorAttribute) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter.DemIndicatorAttribute demIndicatorAttribute) {
						demIndicatorAttribute.target?.gSetDefinition(containerValue.getContainerDefinition("DemIndicatorAttribute"))
			...
			static class DemDebounceAlgorithmClass implements IWrapper<GContainer> {
				...
				static class DemDebounceCounterBased implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass getDemDebounceCounterBasedClassRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass), "DemDebounceCounterBasedClassRef")
					}
					
					def void setDemDebounceCounterBasedClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class DemDebounceTimeBase implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass getDemDebounceTimeBaseRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass), "DemDebounceTimeBaseRef")
					}
					
					def void setDemDebounceTimeBaseRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DemIndicatorAttribute implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator getDemIndicatorRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator), "DemIndicatorRef")
				}
				
				def void setDemIndicatorRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemMultiEventTriggering implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getDemMultiEventTriggeringMasterEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "DemMultiEventTriggeringMasterEventRef")
			}
			
			def void setDemMultiEventTriggeringMasterEventRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter> getDemMultiEventTriggeringSlaveEventRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemPidClass implements IWrapper<GContainer> {
			...
			def List<DemPidDataElement> getDemPidDataElements(){
				...
				return new BasicWrappingEList<DemPidDataElement, GContainer>(filteredContainers, typeof(DemPidDataElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement demPidDataElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement demPidDataElement) {
						demPidDataElement.target?.gSetDefinition(containerValue.getContainerDefinition("DemPidDataElement"))
			...
			static class DemPidDataElement implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass getDemPidDataElementClassRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass), "DemPidDataElementClassRef")
				}
				
				def void setDemPidDataElementClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DemGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemPrimaryMemory getDemClearEventsWithoutDTCEventMemoryRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemPrimaryMemory), "DemClearEventsWithoutDTCEventMemoryRef")
		}
		
		def void setDemClearEventsWithoutDTCEventMemoryRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemPrimaryMemory object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet getDemOBDEventMemorySetRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet), "DemOBDEventMemorySetRef")
		}
		
		def void setDemOBDEventMemorySetRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<DemClient> getDemClients(){
			...
			return new BasicWrappingEList<DemClient, GContainer>(filteredContainers, typeof(DemClient), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient demClient) {
					demClient.target?.gSetDefinition(containerValue.getContainerDefinition("DemClient"))
					super.delegateAdd(demClient)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient demClient) {
					demClient.target?.gSetDefinition(containerValue.getContainerDefinition("DemClient"))
		...
		def List<DemDataElementClass> getDemDataElementClass(){
			...
			return new BasicWrappingEList<DemDataElementClass, GContainer>(filteredContainers, typeof(DemDataElementClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass demDataElementClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass demDataElementClass) {
					demDataElementClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDataElementClass"))
		...
		def List<DemDidClass> getDemDidClass(){
			...
			return new BasicWrappingEList<DemDidClass, GContainer>(filteredContainers, typeof(DemDidClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass demDidClass) {
					demDidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDidClass"))
					super.delegateAdd(demDidClass)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass demDidClass) {
					demDidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDidClass"))
		...
		def List<DemEnableCondition> getDemEnableConditions(){
			...
			return new BasicWrappingEList<DemEnableCondition, GContainer>(filteredContainers, typeof(DemEnableCondition), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition demEnableCondition) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition demEnableCondition) {
					demEnableCondition.target?.gSetDefinition(containerValue.getContainerDefinition("DemEnableCondition"))
		...
		def List<DemEnableConditionGroup> getDemEnableConditionGroups(){
			...
			return new BasicWrappingEList<DemEnableConditionGroup, GContainer>(filteredContainers, typeof(DemEnableConditionGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableConditionGroup demEnableConditionGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableConditionGroup demEnableConditionGroup) {
					demEnableConditionGroup.target?.gSetDefinition(containerValue.getContainerDefinition("DemEnableConditionGroup"))
		...
		def List<DemEventMemorySet> getDemEventMemorySets(){
			...
			return new BasicWrappingEList<DemEventMemorySet, GContainer>(filteredContainers, typeof(DemEventMemorySet), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet demEventMemorySet) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet demEventMemorySet) {
					demEventMemorySet.target?.gSetDefinition(containerValue.getContainerDefinition("DemEventMemorySet"))
		...
		def List<DemExtendedDataClass> getDemExtendedDataClass(){
			...
			return new BasicWrappingEList<DemExtendedDataClass, GContainer>(filteredContainers, typeof(DemExtendedDataClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataClass demExtendedDataClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataClass demExtendedDataClass) {
					demExtendedDataClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemExtendedDataClass"))
		...
		def List<DemExtendedDataRecordClass> getDemExtendedDataRecordClass(){
			...
			return new BasicWrappingEList<DemExtendedDataRecordClass, GContainer>(filteredContainers, typeof(DemExtendedDataRecordClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass demExtendedDataRecordClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass demExtendedDataRecordClass) {
					demExtendedDataRecordClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemExtendedDataRecordClass"))
		...
		def List<DemFreezeFrameClass> getDemFreezeFrameClass(){
			...
			return new BasicWrappingEList<DemFreezeFrameClass, GContainer>(filteredContainers, typeof(DemFreezeFrameClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass demFreezeFrameClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameClass demFreezeFrameClass) {
					demFreezeFrameClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemFreezeFrameClass"))
		...
		def List<DemFreezeFrameRecNumClass> getDemFreezeFrameRecNumClass(){
			...
			return new BasicWrappingEList<DemFreezeFrameRecNumClass, GContainer>(filteredContainers, typeof(DemFreezeFrameRecNumClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass demFreezeFrameRecNumClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass demFreezeFrameRecNumClass) {
					demFreezeFrameRecNumClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemFreezeFrameRecNumClass"))
		...
		def List<DemFreezeFrameRecordClass> getDemFreezeFrameRecordClass(){
			...
			return new BasicWrappingEList<DemFreezeFrameRecordClass, GContainer>(filteredContainers, typeof(DemFreezeFrameRecordClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass demFreezeFrameRecordClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass demFreezeFrameRecordClass) {
					demFreezeFrameRecordClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemFreezeFrameRecordClass"))
		...
		def List<DemGroupOfDTC> getDemGroupOfDTCs(){
			...
			return new BasicWrappingEList<DemGroupOfDTC, GContainer>(filteredContainers, typeof(DemGroupOfDTC), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGroupOfDTC demGroupOfDTC) {
					demGroupOfDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemGroupOfDTC"))
					super.delegateAdd(demGroupOfDTC)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGroupOfDTC demGroupOfDTC) {
					demGroupOfDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemGroupOfDTC"))
		...
		def List<DemNvRamBlockId> getDemNvRamBlockIds(){
			...
			return new BasicWrappingEList<DemNvRamBlockId, GContainer>(filteredContainers, typeof(DemNvRamBlockId), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemNvRamBlockId demNvRamBlockId) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemNvRamBlockId demNvRamBlockId) {
					demNvRamBlockId.target?.gSetDefinition(containerValue.getContainerDefinition("DemNvRamBlockId"))
		...
		def List<DemOperationCycle> getDemOperationCycles(){
			...
			return new BasicWrappingEList<DemOperationCycle, GContainer>(filteredContainers, typeof(DemOperationCycle), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle demOperationCycle) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle demOperationCycle) {
					demOperationCycle.target?.gSetDefinition(containerValue.getContainerDefinition("DemOperationCycle"))
		...
		def List<DemRatio> getDemRatios(){
			...
			return new BasicWrappingEList<DemRatio, GContainer>(filteredContainers, typeof(DemRatio), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemRatio demRatio) {
					demRatio.target?.gSetDefinition(containerValue.getContainerDefinition("DemRatio"))
					super.delegateAdd(demRatio)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemRatio demRatio) {
					demRatio.target?.gSetDefinition(containerValue.getContainerDefinition("DemRatio"))
		...
		def List<DemStorageCondition> getDemStorageConditions(){
			...
			return new BasicWrappingEList<DemStorageCondition, GContainer>(filteredContainers, typeof(DemStorageCondition), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition demStorageCondition) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition demStorageCondition) {
					demStorageCondition.target?.gSetDefinition(containerValue.getContainerDefinition("DemStorageCondition"))
		...
		def List<DemStorageConditionGroup> getDemStorageConditionGroups(){
			...
			return new BasicWrappingEList<DemStorageConditionGroup, GContainer>(filteredContainers, typeof(DemStorageConditionGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageConditionGroup demStorageConditionGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageConditionGroup demStorageConditionGroup) {
					demStorageConditionGroup.target?.gSetDefinition(containerValue.getContainerDefinition("DemStorageConditionGroup"))
		...
		static class DemClient implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet getDemEventMemorySetRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet), "DemEventMemorySetRef")
			}
			
			def void setDemEventMemorySetRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DemCallbackDTCStatusChanged> getDemCallbackDTCStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackDTCStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackDTCStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient.DemCallbackDTCStatusChanged demCallbackDTCStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemClient.DemCallbackDTCStatusChanged demCallbackDTCStatusChanged) {
						demCallbackDTCStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackDTCStatusChanged"))
					...
					static class DemAlternativeDataType implements IWrapper<GContainer> {
						...
						def List<DemTextTableMapping> getDemTextTableMappings(){
							...
							return new BasicWrappingEList<DemTextTableMapping, GContainer>(filteredContainers, typeof(DemTextTableMapping), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass.DemExternalSRDataElementClass.DemDiagnosisScaling.DemAlternativeDataType.DemTextTableMapping demTextTableMapping) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass.DemExternalSRDataElementClass.DemDiagnosisScaling.DemAlternativeDataType.DemTextTableMapping demTextTableMapping) {
									demTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DemTextTableMapping"))
		...
		static class DemDidClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass> getDemDidDataElementClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemEnableConditionGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition> getDemEnableConditionRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEnableCondition(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemEventMemorySet implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator getDemAmberWarningLampIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator), "DemAmberWarningLampIndicatorRef")
			}
			
			def void setDemAmberWarningLampIndicatorRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator getDemMILIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator), "DemMILIndicatorRef")
			}
			
			def void setDemMILIndicatorRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator getDemProtectLampIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator), "DemProtectLampIndicatorRef")
			}
			
			def void setDemProtectLampIndicatorRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator getDemRedStopLampIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator), "DemRedStopLampIndicatorRef")
			}
			
			def void setDemRedStopLampIndicatorRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DemClearDTCNotification> getDemClearDTCNotifications(){
				...
				return new BasicWrappingEList<DemClearDTCNotification, GContainer>(filteredContainers, typeof(DemClearDTCNotification), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemClearDTCNotification demClearDTCNotification) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemClearDTCNotification demClearDTCNotification) {
						demClearDTCNotification.target?.gSetDefinition(containerValue.getContainerDefinition("DemClearDTCNotification"))
			...
			def List<DemIndicator> getDemIndicators(){
				...
				return new BasicWrappingEList<DemIndicator, GContainer>(filteredContainers, typeof(DemIndicator), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator demIndicator) {
						demIndicator.target?.gSetDefinition(containerValue.getContainerDefinition("DemIndicator"))
						super.delegateAdd(demIndicator)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemIndicator demIndicator) {
						demIndicator.target?.gSetDefinition(containerValue.getContainerDefinition("DemIndicator"))
			...
			def List<DemUserDefinedMemory> getDemUserDefinedMemories(){
				...
				return new BasicWrappingEList<DemUserDefinedMemory, GContainer>(filteredContainers, typeof(DemUserDefinedMemory), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemUserDefinedMemory demUserDefinedMemory) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemEventMemorySet.DemUserDefinedMemory demUserDefinedMemory) {
						demUserDefinedMemory.target?.gSetDefinition(containerValue.getContainerDefinition("DemUserDefinedMemory"))
		...
		static class DemExtendedDataClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass> getDemExtendedDataRecordClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemExtendedDataRecordClass(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemExtendedDataRecordClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass> getDemDataElementClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemFreezeFrameClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass> getDemDidClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDidClass(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemFreezeFrameRecNumClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass> getDemFreezeFrameRecordClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemGeneralJ1939 implements IWrapper<GContainer> {
			...
			def List<DemCallbackJ1939DTCStatusChanged> getDemCallbackJ1939DTCStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackJ1939DTCStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackJ1939DTCStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemCallbackJ1939DTCStatusChanged demCallbackJ1939DTCStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemCallbackJ1939DTCStatusChanged demCallbackJ1939DTCStatusChanged) {
						demCallbackJ1939DTCStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackJ1939DTCStatusChanged"))
			...
			def List<DemJ1939FreezeFrameClass> getDemJ1939FreezeFrameClass(){
				...
				return new BasicWrappingEList<DemJ1939FreezeFrameClass, GContainer>(filteredContainers, typeof(DemJ1939FreezeFrameClass), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass demJ1939FreezeFrameClass) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass demJ1939FreezeFrameClass) {
						demJ1939FreezeFrameClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemJ1939FreezeFrameClass"))
			...
			def List<DemSPNClass> getDemSPNClass(){
				...
				return new BasicWrappingEList<DemSPNClass, GContainer>(filteredContainers, typeof(DemSPNClass), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass demSPNClass) {
						demSPNClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemSPNClass"))
						super.delegateAdd(demSPNClass)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass demSPNClass) {
						demSPNClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemSPNClass"))
			...
			static class DemJ1939FreezeFrameClass implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass> getDemSPNClassRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass)) {
						override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass object) throws CoreException {
							if (object !== null) {
								val container = object.getTarget()
								val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
								referenceValue.gSetDefinition(referenceValueDef)
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								val referenceValueValue = referenceValue.gGetValue
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass(referenceValueValue as GContainer)
								}
							}
						}
					}
			...
			static class DemSPNClass implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass getDemSPNDataElementClassRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass), "DemSPNDataElementClassRef")
				}
				
				def void setDemSPNDataElementClassRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemDataElementClass object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemGeneralOBD implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle getDemOBDDrivingCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle), "DemOBDDrivingCycleRef")
			}
			
			def void setDemOBDDrivingCycleRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle getDemOBDPFCCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle), "DemOBDPFCCycleRef")
			}
			
			def void setDemOBDPFCCycleRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle getDemOBDWarmUpCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle), "DemOBDWarmUpCycleRef")
			}
			
			def void setDemOBDWarmUpCycleRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DemCallbackOBDDTCStatusChanged> getDemCallbackOBDDTCStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackOBDDTCStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackOBDDTCStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralOBD.DemCallbackOBDDTCStatusChanged demCallbackOBDDTCStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemGeneralOBD.DemCallbackOBDDTCStatusChanged demCallbackOBDDTCStatusChanged) {
						demCallbackOBDDTCStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackOBDDTCStatusChanged"))
		...
		static class DemNvRamBlockId implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor getDemNvRamBlockIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor), "DemNvRamBlockIdRef")
			}
			
			def void setDemNvRamBlockIdRef(org.artop.ecuc.autosar442.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemOperationCycle implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle getDemLeadingCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle), "DemLeadingCycleRef")
			}
			
			def void setDemLeadingCycleRef(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemRatio implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getDemDiagnosticEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "DemDiagnosticEventRef")
			}
			
			def void setDemDiagnosticEventRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID getDemFunctionIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID), "DemFunctionIdRef")
			}
			
			def void setDemFunctionIdRef(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID> getDemSecondaryFunctionIdRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.FiM.FiMConfigSet.FiMFID(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DemStorageCondition implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getDemStorageConditionReplacementEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "DemStorageConditionReplacementEventRef")
			}
			
			def void setDemStorageConditionReplacementEventRef(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemStorageConditionGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition> getDemStorageConditionRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Dem.DemGeneral.DemStorageCondition(referenceValueValue as GContainer)
							}
						}
					}
				}
