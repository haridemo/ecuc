...
class FlsTst implements IWrapper<GModuleConfiguration> {
	...
	static class FlsTstConfigSet implements IWrapper<GContainer> {
		...
		static class FlsTstBlockBgndConfigSet implements IWrapper<GContainer> {
			...
			def List<FlsTstBlock> getFlsTstBlocks(){
				...
				return new BasicWrappingEList<FlsTstBlock, GContainer>(filteredContainers, typeof(FlsTstBlock), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockBgndConfigSet.FlsTstBlock flsTstBlock) {
						flsTstBlock.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlock"))
						super.delegateAdd(flsTstBlock)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockBgndConfigSet.FlsTstBlock flsTstBlock) {
						flsTstBlock.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlock"))
		...
		static class FlsTstBlockFgndConfigSet implements IWrapper<GContainer> {
			...
			def List<FlsTstBlock> getFlsTstBlocks(){
				...
				return new BasicWrappingEList<FlsTstBlock, GContainer>(filteredContainers, typeof(FlsTstBlock), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockFgndConfigSet.FlsTstBlock flsTstBlock) {
						flsTstBlock.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlock"))
						super.delegateAdd(flsTstBlock)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockFgndConfigSet.FlsTstBlock flsTstBlock) {
						flsTstBlock.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlock"))
						super.delegateAdd(index, flsTstBlock)
					}
				}
	...
	static class FlsTstDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getFLSTST_E_FLSTST_FAILURE(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "FLSTST_E_FLSTST_FAILURE")
		}
		
		def void setFLSTST_E_FLSTST_FAILURE(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
