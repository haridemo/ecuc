	...
	static class OcuConfigSet implements IWrapper<GContainer> {
		...
		def List<OcuChannel> getOcuChannels(){
			...
			return new BasicWrappingEList<OcuChannel, GContainer>(filteredContainers, typeof(OcuChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel ocuChannel) {
					ocuChannel.target?.gSetDefinition(containerValue.getContainerDefinition("OcuChannel"))
					super.delegateAdd(ocuChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel ocuChannel) {
					ocuChannel.target?.gSetDefinition(containerValue.getContainerDefinition("OcuChannel"))
		...
		def List<OcuGroup> getOcuGroups(){
			...
			return new BasicWrappingEList<OcuGroup, GContainer>(filteredContainers, typeof(OcuGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuGroup ocuGroup) {
					ocuGroup.target?.gSetDefinition(containerValue.getContainerDefinition("OcuGroup"))
					super.delegateAdd(ocuGroup)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuGroup ocuGroup) {
					ocuGroup.target?.gSetDefinition(containerValue.getContainerDefinition("OcuGroup"))
		...
		static class OcuGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel> getOcuGroupDefinitions(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Ocu.OcuConfigSet.OcuChannel(referenceValueValue as GContainer)
							}
						}
					}
				}
