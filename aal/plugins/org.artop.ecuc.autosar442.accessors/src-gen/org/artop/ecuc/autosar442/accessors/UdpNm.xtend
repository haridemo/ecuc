...
class UdpNm implements IWrapper<GModuleConfiguration> {
	...
	static class UdpNmGlobalConfig implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getUdpNmPnEiraRxNSduRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "UdpNmPnEiraRxNSduRef")
		}
		
		def void setUdpNmPnEiraRxNSduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<UdpNmChannelConfig> getUdpNmChannelConfigs(){
			...
			return new BasicWrappingEList<UdpNmChannelConfig, GContainer>(filteredContainers, typeof(UdpNmChannelConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.UdpNm.UdpNmGlobalConfig.UdpNmChannelConfig udpNmChannelConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.UdpNm.UdpNmGlobalConfig.UdpNmChannelConfig udpNmChannelConfig) {
					udpNmChannelConfig.target?.gSetDefinition(containerValue.getContainerDefinition("UdpNmChannelConfig"))
		...
		static class UdpNmChannelConfig implements IWrapper<GContainer> {
			...
			def Boolean getUdpNmAllNmMessagesKeepAwake(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmAllNmMessagesKeepAwake"].getBooleanValue()
			}
			
			def void setUdpNmAllNmMessagesKeepAwake(Boolean value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmAllNmMessagesKeepAwake"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "UdpNmAllNmMessagesKeepAwake"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(getBooleanParameterValueValue(value, true))
			...
			def BigInteger getUdpNmCarWakeUpBitPosition(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmCarWakeUpBitPosition"].getBigIntegerValue()
			}
			
			def void setUdpNmCarWakeUpBitPosition(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmCarWakeUpBitPosition"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "UdpNmCarWakeUpBitPosition"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def BigInteger getUdpNmCarWakeUpBytePosition(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmCarWakeUpBytePosition"].getBigIntegerValue()
			}
			
			def void setUdpNmCarWakeUpBytePosition(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmCarWakeUpBytePosition"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "UdpNmCarWakeUpBytePosition"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def BigDecimal getUdpNmImmediateNmCycleTime(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmImmediateNmCycleTime"].getBigDecimalValue()
			}
			
			def void setUdpNmImmediateNmCycleTime(BigDecimal value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmImmediateNmCycleTime"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "UdpNmImmediateNmCycleTime"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def Boolean getUdpNmRetryFirstMessageRequest(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmRetryFirstMessageRequest"].getBooleanValue()
			}
			
			def void setUdpNmRetryFirstMessageRequest(Boolean value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "UdpNmRetryFirstMessageRequest"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "UdpNmRetryFirstMessageRequest"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(getBooleanParameterValueValue(value, true))
			...
			def org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel getUdpNmComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel), "UdpNmComMNetworkHandleRef")
			}
			
			def void setUdpNmComMNetworkHandleRef(org.artop.ecuc.autosar442.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getUdpNmPnEraRxNSduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "UdpNmPnEraRxNSduRef")
			}
			
			def void setUdpNmPnEraRxNSduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<UdpNmRxPdu> getUdpNmRxPdus(){
				...
				return new BasicWrappingEList<UdpNmRxPdu, GContainer>(filteredContainers, typeof(UdpNmRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.UdpNm.UdpNmGlobalConfig.UdpNmChannelConfig.UdpNmRxPdu udpNmRxPdu) {
						udpNmRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("UdpNmRxPdu"))
						super.delegateAdd(udpNmRxPdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.UdpNm.UdpNmGlobalConfig.UdpNmChannelConfig.UdpNmRxPdu udpNmRxPdu) {
						udpNmRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("UdpNmRxPdu"))
			...
			static class UdpNmRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getUdpNmRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "UdpNmRxPduRef")
				}
				
				def void setUdpNmRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class UdpNmTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getUdpNmTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "UdpNmTxPduRef")
				}
				
				def void setUdpNmTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class UdpNmUserDataTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getUdpNmTxUserDataPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "UdpNmTxUserDataPduRef")
				}
				
				def void setUdpNmTxUserDataPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class UdpNmPnInfo implements IWrapper<GContainer> {
			...
			def List<UdpNmPnFilterMaskByte> getUdpNmPnFilterMaskBytes(){
				...
				return new BasicWrappingEList<UdpNmPnFilterMaskByte, GContainer>(filteredContainers, typeof(UdpNmPnFilterMaskByte), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.UdpNm.UdpNmGlobalConfig.UdpNmPnInfo.UdpNmPnFilterMaskByte udpNmPnFilterMaskByte) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.UdpNm.UdpNmGlobalConfig.UdpNmPnInfo.UdpNmPnFilterMaskByte udpNmPnFilterMaskByte) {
						udpNmPnFilterMaskByte.target?.gSetDefinition(containerValue.getContainerDefinition("UdpNmPnFilterMaskByte"))
