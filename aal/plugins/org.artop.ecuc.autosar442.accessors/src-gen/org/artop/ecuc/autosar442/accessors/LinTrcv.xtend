...
class LinTrcv implements IWrapper<GModuleConfiguration> {
	...
	def List<LinTrcvChannel> getLinTrcvChannels(){
		...
		return new BasicWrappingEList<LinTrcvChannel, GContainer>(filteredContainers, typeof(LinTrcvChannel), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel linTrcvChannel) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel linTrcvChannel) {
				linTrcvChannel.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("LinTrcvChannel"))
	...
	static class LinTrcvChannel implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel getLinTrcvIcuChannelRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel), "LinTrcvIcuChannelRef")
		}
		
		def void setLinTrcvIcuChannelRef(org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getLinTrcvWakeupSourceRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "LinTrcvWakeupSourceRef")
		}
		
		def void setLinTrcvWakeupSourceRef(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		static class LinTrcvAccess implements IWrapper<GContainer> {
			...
			static class LinTrcvDioAccess implements IWrapper<GContainer> {
				...
				def List<LinTrcvDioChannelAccess> getLinTrcvDioChannelAccess(){
					...
					return new BasicWrappingEList<LinTrcvDioChannelAccess, GContainer>(filteredContainers, typeof(LinTrcvDioChannelAccess), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel.LinTrcvAccess.LinTrcvDioAccess.LinTrcvDioChannelAccess linTrcvDioChannelAccess) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LinTrcv.LinTrcvChannel.LinTrcvAccess.LinTrcvDioAccess.LinTrcvDioChannelAccess linTrcvDioChannelAccess) {
							linTrcvDioChannelAccess.target?.gSetDefinition(containerValue.getContainerDefinition("LinTrcvDioChannelAccess"))
			...
			static class LinTrcvSpiSequence implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence getLinTrcvSpiSequenceName(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence), "LinTrcvSpiSequenceName")
				}
				
				def void setLinTrcvSpiSequenceName(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
