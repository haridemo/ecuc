		...
		static class EcucPduCollection implements IWrapper<GContainer> {
			...
			def List<MetaDataType> getMetaDataTypes(){
				...
				return new BasicWrappingEList<MetaDataType, GContainer>(filteredContainers, typeof(MetaDataType), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType metaDataType) {
						metaDataType.target?.gSetDefinition(containerValue.getContainerDefinition("MetaDataType"))
						super.delegateAdd(metaDataType)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType metaDataType) {
						metaDataType.target?.gSetDefinition(containerValue.getContainerDefinition("MetaDataType"))
			...
			def List<Pdu> getPdus(){
				...
				return new BasicWrappingEList<Pdu, GContainer>(filteredContainers, typeof(Pdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu pdu) {
						pdu.target?.gSetDefinition(containerValue.getContainerDefinition("Pdu"))
						super.delegateAdd(pdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu pdu) {
						pdu.target?.gSetDefinition(containerValue.getContainerDefinition("Pdu"))
			...
			static class MetaDataType implements IWrapper<GContainer> {
				...
				def List<MetaDataItem> getMetaDataItems(){
					...
					return new BasicWrappingEList<MetaDataItem, GContainer>(filteredContainers, typeof(MetaDataItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType.MetaDataItem metaDataItem) {
							metaDataItem.target?.gSetDefinition(containerValue.getContainerDefinition("MetaDataItem"))
							super.delegateAdd(metaDataItem)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType.MetaDataItem metaDataItem) {
							metaDataItem.target?.gSetDefinition(containerValue.getContainerDefinition("MetaDataItem"))
			...
			static class Pdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType getMetaDataTypeRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType), "MetaDataTypeRef")
				}
				
				def void setMetaDataTypeRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.MetaDataType object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class EcucHardware implements IWrapper<GContainer> {
		...
		def List<EcucCoreDefinition> getEcucCoreDefinitions(){
			...
			return new BasicWrappingEList<EcucCoreDefinition, GContainer>(filteredContainers, typeof(EcucCoreDefinition), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition ecucCoreDefinition) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.EcuC.EcucHardware.EcucCoreDefinition ecucCoreDefinition) {
					ecucCoreDefinition.target?.gSetDefinition(containerValue.getContainerDefinition("EcucCoreDefinition"))
	...
	static class EcucPartitionCollection implements IWrapper<GContainer> {
		...
		def List<EcucPartition> getEcucPartitions(){
			...
			return new BasicWrappingEList<EcucPartition, GContainer>(filteredContainers, typeof(EcucPartition), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition ecucPartition) {
					ecucPartition.target?.gSetDefinition(containerValue.getContainerDefinition("EcucPartition"))
					super.delegateAdd(ecucPartition)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.EcuC.EcucPartitionCollection.EcucPartition ecucPartition) {
					ecucPartition.target?.gSetDefinition(containerValue.getContainerDefinition("EcucPartition"))
