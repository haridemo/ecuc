...
class SoAd implements IWrapper<GModuleConfiguration> {
	...
	def List<SoAdBswModules> getSoAdBswModules(){
		...
		return new BasicWrappingEList<SoAdBswModules, GContainer>(filteredContainers, typeof(SoAdBswModules), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdBswModules soAdBswModules) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdBswModules soAdBswModules) {
				soAdBswModules.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SoAdBswModules"))
	...
	static class SoAdConfig implements IWrapper<GContainer> {
		...
		def List<SoAdPduRoute> getSoAdPduRoutes(){
			...
			return new BasicWrappingEList<SoAdPduRoute, GContainer>(filteredContainers, typeof(SoAdPduRoute), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdPduRoute soAdPduRoute) {
					soAdPduRoute.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdPduRoute"))
					super.delegateAdd(soAdPduRoute)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdPduRoute soAdPduRoute) {
					soAdPduRoute.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdPduRoute"))
		...
		def List<SoAdRoutingGroup> getSoAdRoutingGroups(){
			...
			return new BasicWrappingEList<SoAdRoutingGroup, GContainer>(filteredContainers, typeof(SoAdRoutingGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup soAdRoutingGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup soAdRoutingGroup) {
					soAdRoutingGroup.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdRoutingGroup"))
		...
		def List<SoAdSocketConnectionGroup> getSoAdSocketConnectionGroups(){
			...
			return new BasicWrappingEList<SoAdSocketConnectionGroup, GContainer>(filteredContainers, typeof(SoAdSocketConnectionGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup soAdSocketConnectionGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup soAdSocketConnectionGroup) {
					soAdSocketConnectionGroup.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdSocketConnectionGroup"))
		...
		def List<SoAdSocketRoute> getSoAdSocketRoutes(){
			...
			return new BasicWrappingEList<SoAdSocketRoute, GContainer>(filteredContainers, typeof(SoAdSocketRoute), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketRoute soAdSocketRoute) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketRoute soAdSocketRoute) {
					soAdSocketRoute.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdSocketRoute"))
		...
		static class SoAdPduRoute implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSoAdTxPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SoAdTxPduRef")
			}
			
			def void setSoAdTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<SoAdPduRouteDest> getSoAdPduRouteDests(){
				...
				return new BasicWrappingEList<SoAdPduRouteDest, GContainer>(filteredContainers, typeof(SoAdPduRouteDest), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdPduRoute.SoAdPduRouteDest soAdPduRouteDest) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdPduRoute.SoAdPduRouteDest soAdPduRouteDest) {
						soAdPduRouteDest.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdPduRouteDest"))
			...
			static class SoAdPduRouteDest implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup> getSoAdTxRoutingGroupRefs(){
					val containerDef = containerValue.gGetDefinition
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup)) {
						override protected wrap(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup object) throws CoreException {
							if (object !== null) {
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								...
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup(referenceValueValue as GContainer)
								}
							}
						}
					}
		...
		static class SoAdSocketConnectionGroup implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr getSoAdSocketLocalAddressRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr), "SoAdSocketLocalAddressRef")
			}
			
			def void setSoAdSocketLocalAddressRef(org.artop.ecuc.autosar442.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.SoAd.SoAdBswModules getSoAdSocketSoConModeChgNotifUpperLayerRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.SoAd.SoAdBswModules), "SoAdSocketSoConModeChgNotifUpperLayerRef")
			}
			
			def void setSoAdSocketSoConModeChgNotifUpperLayerRef(org.artop.ecuc.autosar442.accessors.SoAd.SoAdBswModules object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<SoAdSocketConnection> getSoAdSocketConnections(){
				...
				return new BasicWrappingEList<SoAdSocketConnection, GContainer>(filteredContainers, typeof(SoAdSocketConnection), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup.SoAdSocketConnection soAdSocketConnection) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdSocketConnectionGroup.SoAdSocketConnection soAdSocketConnection) {
						soAdSocketConnection.target?.gSetDefinition(containerValue.getContainerDefinition("SoAdSocketConnection"))
			...
			static class SoAdSocketProtocol implements IWrapper<GContainer> {
				...
				static class SoAdSocketTcp implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.TcpIp.TcpIpConfig.TcpIpTcpConfig.TcpIpTcpConfigOptionFilter getSoAdSocketTCPOptionFilterRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.TcpIp.TcpIpConfig.TcpIpTcpConfig.TcpIpTcpConfigOptionFilter), "SoAdSocketTCPOptionFilterRef")
					}
					
					def void setSoAdSocketTCPOptionFilterRef(org.artop.ecuc.autosar442.accessors.TcpIp.TcpIpConfig.TcpIpTcpConfig.TcpIpTcpConfigOptionFilter object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SoAdSocketRoute implements IWrapper<GContainer> {
			...
			static class SoAdSocketRouteDest implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSoAdRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SoAdRxPduRef")
				}
				
				def void setSoAdRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<org.artop.ecuc.autosar442.accessors.SoAd.SoAdConfig.SoAdRoutingGroup> getSoAdRxRoutingGroupRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
