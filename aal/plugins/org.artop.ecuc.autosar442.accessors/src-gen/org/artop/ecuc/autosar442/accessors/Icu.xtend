	...
	static class IcuConfigSet implements IWrapper<GContainer> {
		...
		def List<IcuChannel> getIcuChannels(){
			...
			return new BasicWrappingEList<IcuChannel, GContainer>(filteredContainers, typeof(IcuChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel icuChannel) {
					icuChannel.target?.gSetDefinition(containerValue.getContainerDefinition("IcuChannel"))
					super.delegateAdd(icuChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Icu.IcuConfigSet.IcuChannel icuChannel) {
					icuChannel.target?.gSetDefinition(containerValue.getContainerDefinition("IcuChannel"))
		...
		static class IcuChannel implements IWrapper<GContainer> {
			...
			static class IcuWakeup implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getIcuChannelWakeupInfo(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "IcuChannelWakeupInfo")
				}
				
				def void setIcuChannelWakeupInfo(org.artop.ecuc.autosar442.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
