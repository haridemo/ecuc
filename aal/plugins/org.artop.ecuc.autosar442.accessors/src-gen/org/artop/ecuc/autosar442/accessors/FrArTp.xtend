	...
	static class FrArTpMultipleConfig implements IWrapper<GContainer> {
		...
		def List<FrArTpChannel> getFrArTpChannels(){
			...
			return new BasicWrappingEList<FrArTpChannel, GContainer>(filteredContainers, typeof(FrArTpChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrArTp.FrArTpMultipleConfig.FrArTpChannel frArTpChannel) {
					frArTpChannel.target?.gSetDefinition(containerValue.getContainerDefinition("FrArTpChannel"))
					super.delegateAdd(frArTpChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrArTp.FrArTpMultipleConfig.FrArTpChannel frArTpChannel) {
					frArTpChannel.target?.gSetDefinition(containerValue.getContainerDefinition("FrArTpChannel"))
		...
		static class FrArTpChannel implements IWrapper<GContainer> {
			...
			def List<FrArTpConnection> getFrArTpConnections(){
				...
				return new BasicWrappingEList<FrArTpConnection, GContainer>(filteredContainers, typeof(FrArTpConnection), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrArTp.FrArTpMultipleConfig.FrArTpChannel.FrArTpConnection frArTpConnection) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrArTp.FrArTpMultipleConfig.FrArTpChannel.FrArTpConnection frArTpConnection) {
						frArTpConnection.target?.gSetDefinition(containerValue.getContainerDefinition("FrArTpConnection"))
			...
			def List<FrArTpPdu> getFrArTpPdus(){
				...
				return new BasicWrappingEList<FrArTpPdu, GContainer>(filteredContainers, typeof(FrArTpPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.FrArTp.FrArTpMultipleConfig.FrArTpChannel.FrArTpPdu frArTpPdu) {
						frArTpPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrArTpPdu"))
						super.delegateAdd(frArTpPdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.FrArTp.FrArTpMultipleConfig.FrArTpChannel.FrArTpPdu frArTpPdu) {
						frArTpPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrArTpPdu"))
			...
			static class FrArTpConnection implements IWrapper<GContainer> {
				...
				static class FrArTpRxSdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrArTpRxSduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrArTpRxSduRef")
					}
					
					def void setFrArTpRxSduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class FrArTpTxSdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrArTpTxSduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrArTpTxSduRef")
					}
					
					def void setFrArTpTxSduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrArTpPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrArTpPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrArTpPduRef")
				}
				
				def void setFrArTpPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
