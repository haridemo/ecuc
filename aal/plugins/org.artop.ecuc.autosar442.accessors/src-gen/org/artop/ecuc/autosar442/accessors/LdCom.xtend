	...
	static class LdComConfig implements IWrapper<GContainer> {
		...
		def List<LdComIPdu> getLdComIPdus(){
			...
			return new BasicWrappingEList<LdComIPdu, GContainer>(filteredContainers, typeof(LdComIPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.LdCom.LdComConfig.LdComIPdu ldComIPdu) {
					ldComIPdu.target?.gSetDefinition(containerValue.getContainerDefinition("LdComIPdu"))
					super.delegateAdd(ldComIPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.LdCom.LdComConfig.LdComIPdu ldComIPdu) {
					ldComIPdu.target?.gSetDefinition(containerValue.getContainerDefinition("LdComIPdu"))
		...
		static class LdComIPdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getLdComPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "LdComPduRef")
			}
			
			def void setLdComPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
