...
class Spi implements IWrapper<GModuleConfiguration> {
	...
	static class SpiDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getSPI_E_HARDWARE_ERROR(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "SPI_E_HARDWARE_ERROR")
		}
		
		def void setSPI_E_HARDWARE_ERROR(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
	...
	static class SpiDriver implements IWrapper<GContainer> {
		...
		def List<SpiChannel> getSpiChannels(){
			...
			return new BasicWrappingEList<SpiChannel, GContainer>(filteredContainers, typeof(SpiChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiChannel spiChannel) {
					spiChannel.target?.gSetDefinition(containerValue.getContainerDefinition("SpiChannel"))
					super.delegateAdd(spiChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiChannel spiChannel) {
					spiChannel.target?.gSetDefinition(containerValue.getContainerDefinition("SpiChannel"))
		...
		def List<SpiExternalDevice> getSpiExternalDevices(){
			...
			return new BasicWrappingEList<SpiExternalDevice, GContainer>(filteredContainers, typeof(SpiExternalDevice), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiExternalDevice spiExternalDevice) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiExternalDevice spiExternalDevice) {
					spiExternalDevice.target?.gSetDefinition(containerValue.getContainerDefinition("SpiExternalDevice"))
		...
		def List<SpiJob> getSpiJobs(){
			...
			return new BasicWrappingEList<SpiJob, GContainer>(filteredContainers, typeof(SpiJob), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob spiJob) {
					spiJob.target?.gSetDefinition(containerValue.getContainerDefinition("SpiJob"))
					super.delegateAdd(spiJob)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob spiJob) {
					spiJob.target?.gSetDefinition(containerValue.getContainerDefinition("SpiJob"))
		...
		def List<SpiSequence> getSpiSequences(){
			...
			return new BasicWrappingEList<SpiSequence, GContainer>(filteredContainers, typeof(SpiSequence), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence spiSequence) {
					spiSequence.target?.gSetDefinition(containerValue.getContainerDefinition("SpiSequence"))
					super.delegateAdd(spiSequence)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiSequence spiSequence) {
					spiSequence.target?.gSetDefinition(containerValue.getContainerDefinition("SpiSequence"))
		...
		static class SpiJob implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiExternalDevice getSpiDeviceAssignment(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiExternalDevice), "SpiDeviceAssignment")
			}
			
			def void setSpiDeviceAssignment(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiExternalDevice object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<SpiChannelList> getSpiChannelLists(){
				...
				return new BasicWrappingEList<SpiChannelList, GContainer>(filteredContainers, typeof(SpiChannelList), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob.SpiChannelList spiChannelList) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob.SpiChannelList spiChannelList) {
						spiChannelList.target?.gSetDefinition(containerValue.getContainerDefinition("SpiChannelList"))
			...
			static class SpiChannelList implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiChannel getSpiChannelAssignment(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiChannel), "SpiChannelAssignment")
				}
				
				def void setSpiChannelAssignment(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SpiSequence implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob> getSpiJobAssignments(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.Spi.SpiDriver.SpiJob(referenceValueValue as GContainer)
							}
						}
					}
				}
