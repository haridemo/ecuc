	...
	static class EthConfigSet implements IWrapper<GContainer> {
		...
		def List<EthCtrlConfig> getEthCtrlConfigs(){
			...
			return new BasicWrappingEList<EthCtrlConfig, GContainer>(filteredContainers, typeof(EthCtrlConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig ethCtrlConfig) {
					ethCtrlConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfig"))
					super.delegateAdd(ethCtrlConfig)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig ethCtrlConfig) {
					ethCtrlConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfig"))
		...
		static class EthCtrlConfig implements IWrapper<GContainer> {
			...
			static class EthCtrlConfigEgress implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler getEthCtrlConfigEgressLastSchedulerRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler), "EthCtrlConfigEgressLastSchedulerRef")
				}
				
				def void setEthCtrlConfigEgressLastSchedulerRef(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<EthCtrlConfigEgressFifo> getEthCtrlConfigEgressFifos(){
					...
					return new BasicWrappingEList<EthCtrlConfigEgressFifo, GContainer>(filteredContainers, typeof(EthCtrlConfigEgressFifo), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigEgressFifo ethCtrlConfigEgressFifo) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigEgressFifo ethCtrlConfigEgressFifo) {
							ethCtrlConfigEgressFifo.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfigEgressFifo"))
				...
				def List<EthCtrlConfigScheduler> getEthCtrlConfigSchedulers(){
					...
					return new BasicWrappingEList<EthCtrlConfigScheduler, GContainer>(filteredContainers, typeof(EthCtrlConfigScheduler), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler ethCtrlConfigScheduler) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler ethCtrlConfigScheduler) {
							ethCtrlConfigScheduler.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfigScheduler"))
				...
				def List<EthCtrlConfigShaper> getEthCtrlConfigShapers(){
					...
					return new BasicWrappingEList<EthCtrlConfigShaper, GContainer>(filteredContainers, typeof(EthCtrlConfigShaper), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigShaper ethCtrlConfigShaper) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigShaper ethCtrlConfigShaper) {
							ethCtrlConfigShaper.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfigShaper"))
				...
				static class EthCtrlConfigScheduler implements IWrapper<GContainer> {
					...
					def List<EthCtrlConfigSchedulerPredecessor> getEthCtrlConfigSchedulerPredecessors(){
						...
						return new BasicWrappingEList<EthCtrlConfigSchedulerPredecessor, GContainer>(filteredContainers, typeof(EthCtrlConfigSchedulerPredecessor), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler.EthCtrlConfigSchedulerPredecessor ethCtrlConfigSchedulerPredecessor) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigScheduler.EthCtrlConfigSchedulerPredecessor ethCtrlConfigSchedulerPredecessor) {
								ethCtrlConfigSchedulerPredecessor.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfigSchedulerPredecessor"))
				...
				static class EthCtrlConfigShaper implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigEgressFifo getEthCtrlConfigShaperPredecessorFifoRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigEgressFifo), "EthCtrlConfigShaperPredecessorFifoRef")
					}
					
					def void setEthCtrlConfigShaperPredecessorFifoRef(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigEgress.EthCtrlConfigEgressFifo object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EthCtrlConfigIngress implements IWrapper<GContainer> {
				...
				def List<EthCtrlConfigIngressFifo> getEthCtrlConfigIngressFifos(){
					...
					return new BasicWrappingEList<EthCtrlConfigIngressFifo, GContainer>(filteredContainers, typeof(EthCtrlConfigIngressFifo), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigIngress.EthCtrlConfigIngressFifo ethCtrlConfigIngressFifo) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigIngress.EthCtrlConfigIngressFifo ethCtrlConfigIngressFifo) {
							ethCtrlConfigIngressFifo.target?.gSetDefinition(containerValue.getContainerDefinition("EthCtrlConfigIngressFifo"))
			...
			static class EthDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_ACCESS(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_ACCESS")
				}
				
				def void setETH_E_ACCESS(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_ALIGNMENT(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_ALIGNMENT")
				}
				
				def void setETH_E_ALIGNMENT(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_CRC(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_CRC")
				}
				
				def void setETH_E_CRC(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_LATECOLLISION(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_LATECOLLISION")
				}
				
				def void setETH_E_LATECOLLISION(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_MULTIPLECOLLISION(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_MULTIPLECOLLISION")
				}
				
				def void setETH_E_MULTIPLECOLLISION(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_OVERSIZEFRAME(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_OVERSIZEFRAME")
				}
				
				def void setETH_E_OVERSIZEFRAME(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_RX_FRAMES_LOST(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_RX_FRAMES_LOST")
				}
				
				def void setETH_E_RX_FRAMES_LOST(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_SINGLECOLLISION(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_SINGLECOLLISION")
				}
				
				def void setETH_E_SINGLECOLLISION(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter getETH_E_UNDERSIZEFRAME(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter), "ETH_E_UNDERSIZEFRAME")
				}
				
				def void setETH_E_UNDERSIZEFRAME(org.artop.ecuc.autosar442.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
