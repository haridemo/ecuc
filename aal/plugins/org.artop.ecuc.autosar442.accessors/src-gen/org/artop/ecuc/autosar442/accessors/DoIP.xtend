	...
	static class DoIPConfigSet implements IWrapper<GContainer> {
		...
		def List<DoIPChannel> getDoIPChannels(){
			...
			return new BasicWrappingEList<DoIPChannel, GContainer>(filteredContainers, typeof(DoIPChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPChannel doIPChannel) {
					doIPChannel.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPChannel"))
					super.delegateAdd(doIPChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPChannel doIPChannel) {
					doIPChannel.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPChannel"))
		...
		def List<DoIPRoutingActivation> getDoIPRoutingActivations(){
			...
			return new BasicWrappingEList<DoIPRoutingActivation, GContainer>(filteredContainers, typeof(DoIPRoutingActivation), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation doIPRoutingActivation) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation doIPRoutingActivation) {
					doIPRoutingActivation.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPRoutingActivation"))
		...
		def List<DoIPTester> getDoIPTesters(){
			...
			return new BasicWrappingEList<DoIPTester, GContainer>(filteredContainers, typeof(DoIPTester), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPTester doIPTester) {
					doIPTester.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPTester"))
					super.delegateAdd(doIPTester)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPTester doIPTester) {
					doIPTester.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPTester"))
		...
		static class DoIPChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPTester getDoIPChannelSARef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPTester), "DoIPChannelSARef")
			}
			
			def void setDoIPChannelSARef(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPTester object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress getDoIPChannelTARef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress), "DoIPChannelTARef")
			}
			
			def void setDoIPChannelTARef(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DoIPPduRRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDoIPPduRRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DoIPPduRRxPduRef")
				}
				
				def void setDoIPPduRRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DoIPPduRTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDoIPPduRTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DoIPPduRTxPduRef")
				}
				
				def void setDoIPPduRTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DoIPConnections implements IWrapper<GContainer> {
			...
			def List<DoIPTargetAddress> getDoIPTargetAddress(){
				...
				return new BasicWrappingEList<DoIPTargetAddress, GContainer>(filteredContainers, typeof(DoIPTargetAddress), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress doIPTargetAddress) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress doIPTargetAddress) {
						doIPTargetAddress.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPTargetAddress"))
			...
			def List<DoIPTcpConnection> getDoIPTcpConnections(){
				...
				return new BasicWrappingEList<DoIPTcpConnection, GContainer>(filteredContainers, typeof(DoIPTcpConnection), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTcpConnection doIPTcpConnection) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTcpConnection doIPTcpConnection) {
						doIPTcpConnection.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPTcpConnection"))
			...
			def List<DoIPUdpConnection> getDoIPUdpConnections(){
				...
				return new BasicWrappingEList<DoIPUdpConnection, GContainer>(filteredContainers, typeof(DoIPUdpConnection), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPUdpConnection doIPUdpConnection) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPUdpConnection doIPUdpConnection) {
						doIPUdpConnection.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPUdpConnection"))
			...
			def List<DoIPUdpVehicleAnnouncementConnection> getDoIPUdpVehicleAnnouncementConnections(){
				...
				return new BasicWrappingEList<DoIPUdpVehicleAnnouncementConnection, GContainer>(filteredContainers, typeof(DoIPUdpVehicleAnnouncementConnection), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPUdpVehicleAnnouncementConnection doIPUdpVehicleAnnouncementConnection) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPUdpVehicleAnnouncementConnection doIPUdpVehicleAnnouncementConnection) {
						doIPUdpVehicleAnnouncementConnection.target?.gSetDefinition(containerValue.getContainerDefinition("DoIPUdpVehicleAnnouncementConnection"))
			...
			static class DoIPTcpConnection implements IWrapper<GContainer> {
				...
				static class DoIPSoAdRxPdu implements IWrapper<GContainer> {
					...
					def BigInteger getDoIPSoAdRxPduId(){
						containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DoIPSoAdRxPduId"].getBigIntegerValue()
					}
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDoIPSoAdRxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DoIPSoAdRxPduRef")
					}
					
					def void setDoIPSoAdRxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "DoIPSoAdRxPduRef"], object.getTarget())
						}
					}
				...
				static class DoIPSoAdTxPdu implements IWrapper<GContainer> {
					...
					def BigInteger getDoIPSoAdTxPduId(){
						containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DoIPSoAdTxPduId"].getBigIntegerValue()
					}
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDoIPSoAdTxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DoIPSoAdTxPduRef")
					}
					
					def void setDoIPSoAdTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "DoIPSoAdTxPduRef"], object.getTarget())
						}
					}
			...
			static class DoIPUdpVehicleAnnouncementConnection implements IWrapper<GContainer> {
				...
				static class DoIPSoAdUdpVehicleAnnouncementTxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDoIPSoAdUdpVehicleAnnouncementTxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DoIPSoAdUdpVehicleAnnouncementTxPduRef")
					}
					
					def void setDoIPSoAdUdpVehicleAnnouncementTxPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DoIPRoutingActivation implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress> getDoIPTargetAddressRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPConnections.DoIPTargetAddress(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class DoIPTester implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation> getDoIPRoutingActivationRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.DoIP.DoIPConfigSet.DoIPRoutingActivation(referenceValueValue as GContainer)
							}
						}
					}
				}
