...
class PduR implements IWrapper<GModuleConfiguration> {
	...
	def List<PduRBswModules> getPduRBswModules(){
		...
		return new BasicWrappingEList<PduRBswModules, GContainer>(filteredContainers, typeof(PduRBswModules), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRBswModules pduRBswModules) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRBswModules pduRBswModules) {
				pduRBswModules.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("PduRBswModules"))
	...
	static class PduRRoutingPaths implements IWrapper<GContainer> {
		...
		def List<PduRDestPdu> getPduRDestPdus(){
			...
			return new BasicWrappingEList<PduRDestPdu, GContainer>(filteredContainers, typeof(PduRDestPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRDestPdu pduRDestPdu) {
					pduRDestPdu.target?.gSetDefinition(containerValue.getContainerDefinition("PduRDestPdu"))
					super.delegateAdd(pduRDestPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRDestPdu pduRDestPdu) {
					pduRDestPdu.target?.gSetDefinition(containerValue.getContainerDefinition("PduRDestPdu"))
		...
		def List<PduRRoutingPath> getPduRRoutingPaths(){
			...
			return new BasicWrappingEList<PduRRoutingPath, GContainer>(filteredContainers, typeof(PduRRoutingPath), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPath pduRRoutingPath) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPath pduRRoutingPath) {
					pduRRoutingPath.target?.gSetDefinition(containerValue.getContainerDefinition("PduRRoutingPath"))
		...
		def List<PduRRoutingPathGroup> getPduRRoutingPathGroups(){
			...
			return new BasicWrappingEList<PduRRoutingPathGroup, GContainer>(filteredContainers, typeof(PduRRoutingPathGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup pduRRoutingPathGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup pduRRoutingPathGroup) {
					pduRRoutingPathGroup.target?.gSetDefinition(containerValue.getContainerDefinition("PduRRoutingPathGroup"))
		...
		def List<PduRSrcPdu> getPduRSrcPdus(){
			...
			return new BasicWrappingEList<PduRSrcPdu, GContainer>(filteredContainers, typeof(PduRSrcPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRSrcPdu pduRSrcPdu) {
					pduRSrcPdu.target?.gSetDefinition(containerValue.getContainerDefinition("PduRSrcPdu"))
					super.delegateAdd(pduRSrcPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRSrcPdu pduRSrcPdu) {
					pduRSrcPdu.target?.gSetDefinition(containerValue.getContainerDefinition("PduRSrcPdu"))
		...
		def List<PduRTxBuffer> getPduRTxBuffers(){
			...
			return new BasicWrappingEList<PduRTxBuffer, GContainer>(filteredContainers, typeof(PduRTxBuffer), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer pduRTxBuffer) {
					pduRTxBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("PduRTxBuffer"))
					super.delegateAdd(pduRTxBuffer)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer pduRTxBuffer) {
					pduRTxBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("PduRTxBuffer"))
		...
		static class PduRDestPdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getPduRDestPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "PduRDestPduRef")
			}
			
			def void setPduRDestPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class PduRRoutingPath implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRDestPdu getPduRDestPduRRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRDestPdu), "PduRDestPduRRef")
			}
			
			def void setPduRDestPduRRef(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRDestPdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer> getPduRDestTxBufferRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer)) {
					override protected wrap(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRTxBuffer(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup getPduRRoutingPathGroupRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup), "PduRRoutingPathGroupRef")
			}
			
			def void setPduRRoutingPathGroupRef(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPathGroup object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRSrcPdu getPduRSrcPduRRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRSrcPdu), "PduRSrcPduRRef")
			}
			
			def void setPduRSrcPduRRef(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRSrcPdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class PduRDefaultValue implements IWrapper<GContainer> {
				...
				def List<PduRDefaultValueElement> getPduRDefaultValueElements(){
					...
					return new BasicWrappingEList<PduRDefaultValueElement, GContainer>(filteredContainers, typeof(PduRDefaultValueElement), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPath.PduRDefaultValue.PduRDefaultValueElement pduRDefaultValueElement) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar442.accessors.PduR.PduRRoutingPaths.PduRRoutingPath.PduRDefaultValue.PduRDefaultValueElement pduRDefaultValueElement) {
							pduRDefaultValueElement.target?.gSetDefinition(containerValue.getContainerDefinition("PduRDefaultValueElement"))
		...
		static class PduRSrcPdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getPduRSrcPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "PduRSrcPduRef")
			}
			
			def void setPduRSrcPduRef(org.artop.ecuc.autosar442.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
