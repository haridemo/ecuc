	...
	static class GptChannelConfigSet implements IWrapper<GContainer> {
		...
		def List<GptChannelConfiguration> getGptChannelConfigurations(){
			...
			return new BasicWrappingEList<GptChannelConfiguration, GContainer>(filteredContainers, typeof(GptChannelConfiguration), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration gptChannelConfiguration) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration gptChannelConfiguration) {
					gptChannelConfiguration.target?.gSetDefinition(containerValue.getContainerDefinition("GptChannelConfiguration"))
		...
		static class GptChannelConfiguration implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.Gpt.GptDriverConfiguration.GptClockReferencePoint getGptChannelClkSrcRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Gpt.GptDriverConfiguration.GptClockReferencePoint), "GptChannelClkSrcRef")
			}
			
			def void setGptChannelClkSrcRef(org.artop.ecuc.autosar431.accessors.Gpt.GptDriverConfiguration.GptClockReferencePoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class GptWakeupConfiguration implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getGptWakeupSourceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "GptWakeupSourceRef")
				}
				
				def void setGptWakeupSourceRef(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class GptDriverConfiguration implements IWrapper<GContainer> {
		...
		def List<GptClockReferencePoint> getGptClockReferencePoints(){
			...
			return new BasicWrappingEList<GptClockReferencePoint, GContainer>(filteredContainers, typeof(GptClockReferencePoint), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Gpt.GptDriverConfiguration.GptClockReferencePoint gptClockReferencePoint) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Gpt.GptDriverConfiguration.GptClockReferencePoint gptClockReferencePoint) {
					gptClockReferencePoint.target?.gSetDefinition(containerValue.getContainerDefinition("GptClockReferencePoint"))
		...
		static class GptClockReferencePoint implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint getGptClockReference(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint), "GptClockReference")
			}
			
			def void setGptClockReference(org.artop.ecuc.autosar431.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
