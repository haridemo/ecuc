...
class Cdd implements IWrapper<GModuleConfiguration> {
		...
		static class CddComIfUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddComIfUpperLayerRxPdu> getCddComIfUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddComIfUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
						cddComIfUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerRxPdu"))
			...
			def List<CddComIfUpperLayerTxPdu> getCddComIfUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddComIfUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
						cddComIfUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerTxPdu"))
			...
			static class CddComIfUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddComIfPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddComIfPduRef")
				}
				
				def void setCddComIfPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddComMLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddComMLowerLayerChannel> getCddComMLowerLayerChannels(){
				...
				return new BasicWrappingEList<CddComMLowerLayerChannel, GContainer>(filteredContainers, typeof(CddComMLowerLayerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
						cddComMLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddComMLowerLayerChannel"))
			...
			static class CddComMLowerLayerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel getCddComMLowerLayerChannelRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel), "CddComMLowerLayerChannelRef")
				}
				
				def void setCddComMLowerLayerChannelRef(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddGenericNmLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddGenericNmLowerLayerChannel> getCddGenericNmLowerLayerChannels(){
				...
				return new BasicWrappingEList<CddGenericNmLowerLayerChannel, GContainer>(filteredContainers, typeof(CddGenericNmLowerLayerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
						cddGenericNmLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddGenericNmLowerLayerChannel"))
			...
			static class CddGenericNmLowerLayerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel getCddGenericNmComMNetworkHandleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel), "CddGenericNmComMNetworkHandleRef")
				}
				
				def void setCddGenericNmComMNetworkHandleRef(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddPduRLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddPduRLowerLayerRxPdu> getCddPduRLowerLayerRxPdus(){
				...
				return new BasicWrappingEList<CddPduRLowerLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
						cddPduRLowerLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerRxPdu"))
			...
			def List<CddPduRLowerLayerTxPdu> getCddPduRLowerLayerTxPdus(){
				...
				return new BasicWrappingEList<CddPduRLowerLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
						cddPduRLowerLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerTxPdu"))
			...
			static class CddPduRLowerLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddPduRLowerLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddPduRLowerLayerPduRef")
				}
				
				def void setCddPduRLowerLayerPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddPduRUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddPduRUpperLayerRxPdu> getCddPduRUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddPduRUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
						cddPduRUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerRxPdu"))
			...
			def List<CddPduRUpperLayerTxPdu> getCddPduRUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddPduRUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
						cddPduRUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerTxPdu"))
			...
			static class CddPduRUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddPduRUpperLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddPduRUpperLayerPduRef")
				}
				
				def void setCddPduRUpperLayerPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddSoAdUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddSoAdUpperLayerRxPdu> getCddSoAdUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddSoAdUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
						cddSoAdUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerRxPdu"))
			...
			def List<CddSoAdUpperLayerTxPdu> getCddSoAdUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddSoAdUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
						cddSoAdUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerTxPdu"))
			...
			static class CddSoAdUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddSoAdUpperLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddSoAdUpperLayerPduRef")
				}
				
				def void setCddSoAdUpperLayerPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CddEcucPartitionInteraction implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.EcuC.EcucPartitionCollection.EcucPartition getCddEcucPartitionRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucPartitionCollection.EcucPartition), "CddEcucPartitionRef")
		}
		
		def void setCddEcucPartitionRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CddGlobalTimeContribution implements IWrapper<GContainer> {
		...
		def List<CddGlobalTimeDomain> getCddGlobalTimeDomains(){
			...
			return new BasicWrappingEList<CddGlobalTimeDomain, GContainer>(filteredContainers, typeof(CddGlobalTimeDomain), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Cdd.CddGlobalTimeContribution.CddGlobalTimeDomain cddGlobalTimeDomain) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Cdd.CddGlobalTimeContribution.CddGlobalTimeDomain cddGlobalTimeDomain) {
					cddGlobalTimeDomain.target?.gSetDefinition(containerValue.getContainerDefinition("CddGlobalTimeDomain"))
		...
		static class CddGlobalTimeDomain implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase getCddSynSynchronizedTimeBaseRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase), "CddSynSynchronizedTimeBaseRef")
			}
			
			def void setCddSynSynchronizedTimeBaseRef(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CddGlobalTimeMaster implements IWrapper<GContainer> {
				...
				static class CddGlobalTimeMasterPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu getCddGlobalTimeMasterPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu), "CddGlobalTimeMasterPduRef")
					}
					
					def void setCddGlobalTimeMasterPduRef(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CddGlobalTimeSlave implements IWrapper<GContainer> {
				...
				static class CddGlobalTimeSlavePdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu getCddGlobalTimeSlavePduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu), "CddGlobalTimeSlavePduRef")
					}
					
					def void setCddGlobalTimeSlavePduRef(org.artop.ecuc.autosar431.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
