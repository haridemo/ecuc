	...
	static class CanTpConfig implements IWrapper<GContainer> {
		...
		def List<CanTpChannel> getCanTpChannels(){
			...
			return new BasicWrappingEList<CanTpChannel, GContainer>(filteredContainers, typeof(CanTpChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTp.CanTpConfig.CanTpChannel canTpChannel) {
					canTpChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CanTpChannel"))
					super.delegateAdd(canTpChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTp.CanTpConfig.CanTpChannel canTpChannel) {
					canTpChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CanTpChannel"))
		...
		static class CanTpChannel implements IWrapper<GContainer> {
			...
			def List<CanTpRxNSdu> getCanTpRxNSdus(){
				...
				return new BasicWrappingEList<CanTpRxNSdu, GContainer>(filteredContainers, typeof(CanTpRxNSdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTp.CanTpConfig.CanTpChannel.CanTpRxNSdu canTpRxNSdu) {
						canTpRxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("CanTpRxNSdu"))
						super.delegateAdd(canTpRxNSdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTp.CanTpConfig.CanTpChannel.CanTpRxNSdu canTpRxNSdu) {
						canTpRxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("CanTpRxNSdu"))
			...
			def List<CanTpTxNSdu> getCanTpTxNSdus(){
				...
				return new BasicWrappingEList<CanTpTxNSdu, GContainer>(filteredContainers, typeof(CanTpTxNSdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTp.CanTpConfig.CanTpChannel.CanTpTxNSdu canTpTxNSdu) {
						canTpTxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("CanTpTxNSdu"))
						super.delegateAdd(canTpTxNSdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTp.CanTpConfig.CanTpChannel.CanTpTxNSdu canTpTxNSdu) {
						canTpTxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("CanTpTxNSdu"))
			...
			static class CanTpRxNSdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTpRxNSduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTpRxNSduRef")
				}
				
				def void setCanTpRxNSduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				static class CanTpRxNPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTpRxNPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTpRxNPduRef")
					}
					
					def void setCanTpRxNPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class CanTpTxFcNPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTpTxFcNPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTpTxFcNPduRef")
					}
					
					def void setCanTpTxFcNPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanTpTxNSdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTpTxNSduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTpTxNSduRef")
				}
				
				def void setCanTpTxNSduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				static class CanTpRxFcNPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTpRxFcNPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTpRxFcNPduRef")
					}
					
					def void setCanTpRxFcNPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class CanTpTxNPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTpTxNPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTpTxNPduRef")
					}
					
					def void setCanTpTxNPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
