	...
	static class WEthConfigSet implements IWrapper<GContainer> {
		...
		def List<WEthCtrlConfig> getWEthCtrlConfigs(){
			...
			return new BasicWrappingEList<WEthCtrlConfig, GContainer>(filteredContainers, typeof(WEthCtrlConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.WEth.WEthConfigSet.WEthCtrlConfig wEthCtrlConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.WEth.WEthConfigSet.WEthCtrlConfig wEthCtrlConfig) {
					wEthCtrlConfig.target?.gSetDefinition(containerValue.getContainerDefinition("WEthCtrlConfig"))
		...
		static class WEthCtrlConfig implements IWrapper<GContainer> {
			...
			static class WEthDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter getWETH_E_ACCESS(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter), "WETH_E_ACCESS")
				}
				
				def void setWETH_E_ACCESS(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
