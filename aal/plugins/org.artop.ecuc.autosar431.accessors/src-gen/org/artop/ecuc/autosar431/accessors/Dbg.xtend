...
class Dbg implements IWrapper<GModuleConfiguration> {
	...
	static class DbgCommunication implements IWrapper<GContainer> {
		...
		static class DbgRxPdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDbgReceiveIPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DbgReceiveIPduRef")
			}
			
			def void setDbgReceiveIPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DbgTxPdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDbgSendIPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DbgSendIPduRef")
			}
			
			def void setDbgSendIPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DbgDIDConfiguration implements IWrapper<GContainer> {
		...
		def List<DbgPredefinedDID> getDbgPredefinedDIDs(){
			...
			return new BasicWrappingEList<DbgPredefinedDID, GContainer>(filteredContainers, typeof(DbgPredefinedDID), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgPredefinedDID dbgPredefinedDID) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgPredefinedDID dbgPredefinedDID) {
					dbgPredefinedDID.target?.gSetDefinition(containerValue.getContainerDefinition("DbgPredefinedDID"))
		...
		def List<DbgStaticDID> getDbgStaticDIDs(){
			...
			return new BasicWrappingEList<DbgStaticDID, GContainer>(filteredContainers, typeof(DbgStaticDID), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgStaticDID dbgStaticDID) {
					dbgStaticDID.target?.gSetDefinition(containerValue.getContainerDefinition("DbgStaticDID"))
					super.delegateAdd(dbgStaticDID)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgStaticDID dbgStaticDID) {
					dbgStaticDID.target?.gSetDefinition(containerValue.getContainerDefinition("DbgStaticDID"))
		...
		static class DbgPredefinedDID implements IWrapper<GContainer> {
			...
			def List<DbgPredefinedDIDAddInfo> getDbgPredefinedDIDAddInfos(){
				...
				return new BasicWrappingEList<DbgPredefinedDIDAddInfo, GContainer>(filteredContainers, typeof(DbgPredefinedDIDAddInfo), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgPredefinedDID.DbgPredefinedDIDAddInfo dbgPredefinedDIDAddInfo) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgPredefinedDID.DbgPredefinedDIDAddInfo dbgPredefinedDIDAddInfo) {
						dbgPredefinedDIDAddInfo.target?.gSetDefinition(containerValue.getContainerDefinition("DbgPredefinedDIDAddInfo"))
			...
			static class DbgPredefinedDIDAddInfo implements IWrapper<GContainer> {
				...
				static class DbgAddInfoComSignal implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar431.accessors.Com.ComConfig.ComSignal getDbgComSignalRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Com.ComConfig.ComSignal), "DbgComSignalRef")
					}
					
					def void setDbgComSignalRef(org.artop.ecuc.autosar431.accessors.Com.ComConfig.ComSignal object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DbgStaticDID implements IWrapper<GContainer> {
			...
			def List<DbgStaticDIDData> getDbgStaticDIDDatas(){
				...
				return new BasicWrappingEList<DbgStaticDIDData, GContainer>(filteredContainers, typeof(DbgStaticDIDData), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgStaticDID.DbgStaticDIDData dbgStaticDIDData) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Dbg.DbgDIDConfiguration.DbgStaticDID.DbgStaticDIDData dbgStaticDIDData) {
						dbgStaticDIDData.target?.gSetDefinition(containerValue.getContainerDefinition("DbgStaticDIDData"))
	...
	static class DbgPeriodicDataCollection implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.Os.OsAlarm getDbgAlarmReference(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Os.OsAlarm), "DbgAlarmReference")
		}
		
		def void setDbgAlarmReference(org.artop.ecuc.autosar431.accessors.Os.OsAlarm object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DbgTimestampConfiguration implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration getDbgGptChannel(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration), "DbgGptChannel")
		}
		
		def void setDbgGptChannel(org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
