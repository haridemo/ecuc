...
class StbM implements IWrapper<GModuleConfiguration> {
	...
	def List<StbMSynchronizedTimeBase> getStbMSynchronizedTimeBases(){
		...
		return new BasicWrappingEList<StbMSynchronizedTimeBase, GContainer>(filteredContainers, typeof(StbMSynchronizedTimeBase), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase stbMSynchronizedTimeBase) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase stbMSynchronizedTimeBase) {
				stbMSynchronizedTimeBase.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("StbMSynchronizedTimeBase"))
	...
	def List<StbMTriggeredCustomer> getStbMTriggeredCustomers(){
		...
		return new BasicWrappingEList<StbMTriggeredCustomer, GContainer>(filteredContainers, typeof(StbMTriggeredCustomer), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar431.accessors.StbM.StbMTriggeredCustomer stbMTriggeredCustomer) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.StbM.StbMTriggeredCustomer stbMTriggeredCustomer) {
				stbMTriggeredCustomer.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("StbMTriggeredCustomer"))
	...
	static class StbMGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration getStbMGptTimerRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration), "StbMGptTimerRef")
		}
		
		def void setStbMGptTimerRef(org.artop.ecuc.autosar431.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class StbMSynchronizedTimeBase implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase getStbMOffsetTimeBase(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase), "StbMOffsetTimeBase")
		}
		
		def void setStbMOffsetTimeBase(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<StbMNotificationCustomer> getStbMNotificationCustomers(){
			...
			return new BasicWrappingEList<StbMNotificationCustomer, GContainer>(filteredContainers, typeof(StbMNotificationCustomer), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase.StbMNotificationCustomer stbMNotificationCustomer) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase.StbMNotificationCustomer stbMNotificationCustomer) {
					stbMNotificationCustomer.target?.gSetDefinition(containerValue.getContainerDefinition("StbMNotificationCustomer"))
	...
	static class StbMTriggeredCustomer implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.Os.OsScheduleTable getStbMOSScheduleTableRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Os.OsScheduleTable), "StbMOSScheduleTableRef")
		}
		
		def void setStbMOSScheduleTableRef(org.artop.ecuc.autosar431.accessors.Os.OsScheduleTable object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase getStbMSynchronizedTimeBaseRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase), "StbMSynchronizedTimeBaseRef")
		}
		
		def void setStbMSynchronizedTimeBaseRef(org.artop.ecuc.autosar431.accessors.StbM.StbMSynchronizedTimeBase object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
