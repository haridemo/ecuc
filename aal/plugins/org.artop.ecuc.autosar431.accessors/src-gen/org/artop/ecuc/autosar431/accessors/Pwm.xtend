	...
	static class PwmChannelConfigSet implements IWrapper<GContainer> {
		...
		def List<PwmChannel> getPwmChannels(){
			...
			return new BasicWrappingEList<PwmChannel, GContainer>(filteredContainers, typeof(PwmChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Pwm.PwmChannelConfigSet.PwmChannel pwmChannel) {
					pwmChannel.target?.gSetDefinition(containerValue.getContainerDefinition("PwmChannel"))
					super.delegateAdd(pwmChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Pwm.PwmChannelConfigSet.PwmChannel pwmChannel) {
					pwmChannel.target?.gSetDefinition(containerValue.getContainerDefinition("PwmChannel"))
		...
		static class PwmChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint getPwmMcuClockReferencePoint(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint), "PwmMcuClockReferencePoint")
			}
			
			def void setPwmMcuClockReferencePoint(org.artop.ecuc.autosar431.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class PwmGeneral implements IWrapper<GContainer> {
		...
		def List<PwmPowerStateConfig> getPwmPowerStateConfigs(){
			...
			return new BasicWrappingEList<PwmPowerStateConfig, GContainer>(filteredContainers, typeof(PwmPowerStateConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Pwm.PwmGeneral.PwmPowerStateConfig pwmPowerStateConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Pwm.PwmGeneral.PwmPowerStateConfig pwmPowerStateConfig) {
					pwmPowerStateConfig.target?.gSetDefinition(containerValue.getContainerDefinition("PwmPowerStateConfig"))
