	...
	static class CanTrcvConfigSet implements IWrapper<GContainer> {
		...
		def List<CanTrcvChannel> getCanTrcvChannels(){
			...
			return new BasicWrappingEList<CanTrcvChannel, GContainer>(filteredContainers, typeof(CanTrcvChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel canTrcvChannel) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel canTrcvChannel) {
					canTrcvChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CanTrcvChannel"))
		...
		static class CanTrcvChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.Icu.IcuConfigSet.IcuChannel getCanTrcvIcuChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Icu.IcuConfigSet.IcuChannel), "CanTrcvIcuChannelRef")
			}
			
			def void setCanTrcvIcuChannelRef(org.artop.ecuc.autosar431.accessors.Icu.IcuConfigSet.IcuChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getCanTrcvPorWakeupSourceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "CanTrcvPorWakeupSourceRef")
			}
			
			def void setCanTrcvPorWakeupSourceRef(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getCanTrcvSyserrWakeupSourceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "CanTrcvSyserrWakeupSourceRef")
			}
			
			def void setCanTrcvSyserrWakeupSourceRef(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getCanTrcvWakeupSourceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "CanTrcvWakeupSourceRef")
			}
			
			def void setCanTrcvWakeupSourceRef(org.artop.ecuc.autosar431.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
				...
				static class CanTrcvDioAccess implements IWrapper<GContainer> {
					...
					def List<CanTrcvDioChannelAccess> getCanTrcvDioChannelAccess(){
						...
						return new BasicWrappingEList<CanTrcvDioChannelAccess, GContainer>(filteredContainers, typeof(CanTrcvDioChannelAccess), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel.CanTrcvAccess.CanTrcvDioAccess.CanTrcvDioChannelAccess canTrcvDioChannelAccess) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel.CanTrcvAccess.CanTrcvDioAccess.CanTrcvDioChannelAccess canTrcvDioChannelAccess) {
								canTrcvDioChannelAccess.target?.gSetDefinition(containerValue.getContainerDefinition("CanTrcvDioChannelAccess"))
				...
				static class CanTrcvSpiAccess implements IWrapper<GContainer> {
					...
					def List<CanTrcvSpiSequence> getCanTrcvSpiSequences(){
						...
						return new BasicWrappingEList<CanTrcvSpiSequence, GContainer>(filteredContainers, typeof(CanTrcvSpiSequence), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel.CanTrcvAccess.CanTrcvSpiAccess.CanTrcvSpiSequence canTrcvSpiSequence) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel.CanTrcvAccess.CanTrcvSpiAccess.CanTrcvSpiSequence canTrcvSpiSequence) {
								canTrcvSpiSequence.target?.gSetDefinition(containerValue.getContainerDefinition("CanTrcvSpiSequence"))
					...
					static class CanTrcvSpiSequence implements IWrapper<GContainer> {
						...
						def List<org.artop.ecuc.autosar431.accessors.Spi.SpiDriver.SpiSequence> getCanTrcvSpiSequenceNames(){
							val containerDef = containerValue.gGetDefinition
			...
			static class CanTrcvDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter getCANTRCV_E_BUS_ERROR(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter), "CANTRCV_E_BUS_ERROR")
				}
				
				def void setCANTRCV_E_BUS_ERROR(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanTrcvPartialNetwork implements IWrapper<GContainer> {
				...
				def List<CanTrcvPnFrameDataMaskSpec> getCanTrcvPnFrameDataMaskSpecs(){
					...
					return new BasicWrappingEList<CanTrcvPnFrameDataMaskSpec, GContainer>(filteredContainers, typeof(CanTrcvPnFrameDataMaskSpec), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel.CanTrcvPartialNetwork.CanTrcvPnFrameDataMaskSpec canTrcvPnFrameDataMaskSpec) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel.CanTrcvPartialNetwork.CanTrcvPnFrameDataMaskSpec canTrcvPnFrameDataMaskSpec) {
							canTrcvPnFrameDataMaskSpec.target?.gSetDefinition(containerValue.getContainerDefinition("CanTrcvPnFrameDataMaskSpec"))
