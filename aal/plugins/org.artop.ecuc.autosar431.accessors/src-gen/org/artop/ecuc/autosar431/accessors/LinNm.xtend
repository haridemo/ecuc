	...
	static class LinNmGlobalConfig implements IWrapper<GContainer> {
		...
		def List<LinNmChannelConfig> getLinNmChannelConfigs(){
			...
			return new BasicWrappingEList<LinNmChannelConfig, GContainer>(filteredContainers, typeof(LinNmChannelConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.LinNm.LinNmGlobalConfig.LinNmChannelConfig linNmChannelConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.LinNm.LinNmGlobalConfig.LinNmChannelConfig linNmChannelConfig) {
					linNmChannelConfig.target?.gSetDefinition(containerValue.getContainerDefinition("LinNmChannelConfig"))
		...
		static class LinNmChannelConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel getLinNmComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel), "LinNmComMNetworkHandleRef")
			}
			
			def void setLinNmComMNetworkHandleRef(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
