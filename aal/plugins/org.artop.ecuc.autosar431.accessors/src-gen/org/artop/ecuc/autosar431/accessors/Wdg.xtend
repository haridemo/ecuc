...
class Wdg implements IWrapper<GModuleConfiguration> {
	...
	static class WdgDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter getWDG_E_DISABLE_REJECTED(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter), "WDG_E_DISABLE_REJECTED")
		}
		
		def void setWDG_E_DISABLE_REJECTED(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter object){
		...
		def org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter getWDG_E_MODE_FAILED(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter), "WDG_E_MODE_FAILED")
		}
		
		def void setWDG_E_MODE_FAILED(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
