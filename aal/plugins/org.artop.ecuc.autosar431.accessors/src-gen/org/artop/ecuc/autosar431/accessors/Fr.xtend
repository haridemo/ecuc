	...
	static class FrMultipleConfiguration implements IWrapper<GContainer> {
		...
		def List<FrController> getFrControllers(){
			...
			return new BasicWrappingEList<FrController, GContainer>(filteredContainers, typeof(FrController), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController frController) {
					frController.target?.gSetDefinition(containerValue.getContainerDefinition("FrController"))
					super.delegateAdd(frController)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController frController) {
					frController.target?.gSetDefinition(containerValue.getContainerDefinition("FrController"))
		...
		static class FrController implements IWrapper<GContainer> {
			...
			def List<FrAbsoluteTimer> getFrAbsoluteTimers(){
				...
				return new BasicWrappingEList<FrAbsoluteTimer, GContainer>(filteredContainers, typeof(FrAbsoluteTimer), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController.FrAbsoluteTimer frAbsoluteTimer) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController.FrAbsoluteTimer frAbsoluteTimer) {
						frAbsoluteTimer.target?.gSetDefinition(containerValue.getContainerDefinition("FrAbsoluteTimer"))
			...
			def List<FrFifo> getFrFifos(){
				...
				return new BasicWrappingEList<FrFifo, GContainer>(filteredContainers, typeof(FrFifo), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController.FrFifo frFifo) {
						frFifo.target?.gSetDefinition(containerValue.getContainerDefinition("FrFifo"))
						super.delegateAdd(frFifo)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController.FrFifo frFifo) {
						frFifo.target?.gSetDefinition(containerValue.getContainerDefinition("FrFifo"))
			...
			static class FrControllerDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter getFR_E_CTRL_TESTRESULT(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter), "FR_E_CTRL_TESTRESULT")
				}
				
				def void setFR_E_CTRL_TESTRESULT(org.artop.ecuc.autosar431.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrFifo implements IWrapper<GContainer> {
				...
				def List<FrRange> getFrRanges(){
					...
					return new BasicWrappingEList<FrRange, GContainer>(filteredContainers, typeof(FrRange), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController.FrFifo.FrRange frRange) {
							frRange.target?.gSetDefinition(containerValue.getContainerDefinition("FrRange"))
							super.delegateAdd(frRange)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Fr.FrMultipleConfiguration.FrController.FrFifo.FrRange frRange) {
							frRange.target?.gSetDefinition(containerValue.getContainerDefinition("FrRange"))
