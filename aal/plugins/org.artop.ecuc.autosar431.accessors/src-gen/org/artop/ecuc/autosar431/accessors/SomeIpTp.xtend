...
class SomeIpTp implements IWrapper<GModuleConfiguration> {
	...
	def List<SomeIpTpChannel> getSomeIpTpChannels(){
		...
		return new BasicWrappingEList<SomeIpTpChannel, GContainer>(filteredContainers, typeof(SomeIpTpChannel), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar431.accessors.SomeIpTp.SomeIpTpChannel someIpTpChannel) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.SomeIpTp.SomeIpTpChannel someIpTpChannel) {
				someIpTpChannel.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SomeIpTpChannel"))
	...
	static class SomeIpTpChannel implements IWrapper<GContainer> {
		...
		def List<SomeIpTpRxNSdu> getSomeIpTpRxNSdus(){
			...
			return new BasicWrappingEList<SomeIpTpRxNSdu, GContainer>(filteredContainers, typeof(SomeIpTpRxNSdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.SomeIpTp.SomeIpTpChannel.SomeIpTpRxNSdu someIpTpRxNSdu) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.SomeIpTp.SomeIpTpChannel.SomeIpTpRxNSdu someIpTpRxNSdu) {
					someIpTpRxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("SomeIpTpRxNSdu"))
		...
		def List<SomeIpTpTxNSdu> getSomeIpTpTxNSdus(){
			...
			return new BasicWrappingEList<SomeIpTpTxNSdu, GContainer>(filteredContainers, typeof(SomeIpTpTxNSdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.SomeIpTp.SomeIpTpChannel.SomeIpTpTxNSdu someIpTpTxNSdu) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.SomeIpTp.SomeIpTpChannel.SomeIpTpTxNSdu someIpTpTxNSdu) {
					someIpTpTxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("SomeIpTpTxNSdu"))
		...
		static class SomeIpTpRxNSdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSomeIpTpRxSduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SomeIpTpRxSduRef")
			}
			
			def void setSomeIpTpRxSduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SomeIpTpRxNPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSomeIpTpRxNPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SomeIpTpRxNPduRef")
				}
				
				def void setSomeIpTpRxNPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SomeIpTpTxNSdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSomeIpTpTxNSduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SomeIpTpTxNSduRef")
			}
			
			def void setSomeIpTpTxNSduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SomeIpTpTxNPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSomeIpTpTxNPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SomeIpTpTxNPduRef")
				}
				
				def void setSomeIpTpTxNPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
