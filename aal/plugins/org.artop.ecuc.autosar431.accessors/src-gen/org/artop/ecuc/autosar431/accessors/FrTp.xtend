	...
	static class FrTpMultipleConfig implements IWrapper<GContainer> {
		...
		def List<FrTpConnection> getFrTpConnections(){
			...
			return new BasicWrappingEList<FrTpConnection, GContainer>(filteredContainers, typeof(FrTpConnection), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnection frTpConnection) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnection frTpConnection) {
					frTpConnection.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpConnection"))
		...
		def List<FrTpConnectionControl> getFrTpConnectionControls(){
			...
			return new BasicWrappingEList<FrTpConnectionControl, GContainer>(filteredContainers, typeof(FrTpConnectionControl), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnectionControl frTpConnectionControl) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnectionControl frTpConnectionControl) {
					frTpConnectionControl.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpConnectionControl"))
		...
		def List<FrTpRxPduPool> getFrTpRxPduPools(){
			...
			return new BasicWrappingEList<FrTpRxPduPool, GContainer>(filteredContainers, typeof(FrTpRxPduPool), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool frTpRxPduPool) {
					frTpRxPduPool.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpRxPduPool"))
					super.delegateAdd(frTpRxPduPool)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool frTpRxPduPool) {
					frTpRxPduPool.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpRxPduPool"))
		...
		def List<FrTpTxPduPool> getFrTpTxPduPools(){
			...
			return new BasicWrappingEList<FrTpTxPduPool, GContainer>(filteredContainers, typeof(FrTpTxPduPool), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool frTpTxPduPool) {
					frTpTxPduPool.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpTxPduPool"))
					super.delegateAdd(frTpTxPduPool)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool frTpTxPduPool) {
					frTpTxPduPool.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpTxPduPool"))
		...
		static class FrTpConnection implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnectionControl getFrTpConCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnectionControl), "FrTpConCtrlRef")
			}
			
			def void setFrTpConCtrlRef(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpConnectionControl object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool getFrTpRxPduPoolRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool), "FrTpRxPduPoolRef")
			}
			
			def void setFrTpRxPduPoolRef(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool getFrTpTxPduPoolRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool), "FrTpTxPduPoolRef")
			}
			
			def void setFrTpTxPduPoolRef(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrTpRxSdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrTpRxSduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrTpRxSduRef")
				}
				
				def void setFrTpRxSduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrTpTxSdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrTpTxSduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrTpTxSduRef")
				}
				
				def void setFrTpTxSduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class FrTpRxPduPool implements IWrapper<GContainer> {
			...
			def List<FrTpRxPdu> getFrTpRxPdus(){
				...
				return new BasicWrappingEList<FrTpRxPdu, GContainer>(filteredContainers, typeof(FrTpRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool.FrTpRxPdu frTpRxPdu) {
						frTpRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpRxPdu"))
						super.delegateAdd(frTpRxPdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpRxPduPool.FrTpRxPdu frTpRxPdu) {
						frTpRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpRxPdu"))
			...
			static class FrTpRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrTpRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrTpRxPduRef")
				}
				
				def void setFrTpRxPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class FrTpTxPduPool implements IWrapper<GContainer> {
			...
			def List<FrTpTxPdu> getFrTpTxPdus(){
				...
				return new BasicWrappingEList<FrTpTxPdu, GContainer>(filteredContainers, typeof(FrTpTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool.FrTpTxPdu frTpTxPdu) {
						frTpTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpTxPdu"))
						super.delegateAdd(frTpTxPdu)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.FrTp.FrTpMultipleConfig.FrTpTxPduPool.FrTpTxPdu frTpTxPdu) {
						frTpTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrTpTxPdu"))
			...
			static class FrTpTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrTpTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrTpTxPduRef")
				}
				
				def void setFrTpTxPduRef(org.artop.ecuc.autosar431.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
