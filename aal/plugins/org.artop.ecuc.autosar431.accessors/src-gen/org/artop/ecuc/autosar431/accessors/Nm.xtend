...
class Nm implements IWrapper<GModuleConfiguration> {
	...
	def List<NmChannelConfig> getNmChannelConfigs(){
		...
		return new BasicWrappingEList<NmChannelConfig, GContainer>(filteredContainers, typeof(NmChannelConfig), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar431.accessors.Nm.NmChannelConfig nmChannelConfig) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.Nm.NmChannelConfig nmChannelConfig) {
				nmChannelConfig.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("NmChannelConfig"))
	...
	static class NmChannelConfig implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel getNmComMChannelRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel), "NmComMChannelRef")
		}
		
		def void setNmComMChannelRef(org.artop.ecuc.autosar431.accessors.ComM.ComMConfigSet.ComMChannel object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar431.accessors.Com.ComConfig.ComSignal getNmStateReportSignalRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Com.ComConfig.ComSignal), "NmStateReportSignalRef")
		}
		
		def void setNmStateReportSignalRef(org.artop.ecuc.autosar431.accessors.Com.ComConfig.ComSignal object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
