	...
	static class EthIfConfigSet implements IWrapper<GContainer> {
		...
		def List<EthIfController> getEthIfControllers(){
			...
			return new BasicWrappingEList<EthIfController, GContainer>(filteredContainers, typeof(EthIfController), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfController ethIfController) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfController ethIfController) {
					ethIfController.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfController"))
		...
		def List<EthIfFrameOwnerConfig> getEthIfFrameOwnerConfigs(){
			...
			return new BasicWrappingEList<EthIfFrameOwnerConfig, GContainer>(filteredContainers, typeof(EthIfFrameOwnerConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfFrameOwnerConfig ethIfFrameOwnerConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfFrameOwnerConfig ethIfFrameOwnerConfig) {
					ethIfFrameOwnerConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfFrameOwnerConfig"))
		...
		def List<EthIfPhysController> getEthIfPhysControllers(){
			...
			return new BasicWrappingEList<EthIfPhysController, GContainer>(filteredContainers, typeof(EthIfPhysController), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController ethIfPhysController) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController ethIfPhysController) {
					ethIfPhysController.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfPhysController"))
		...
		def List<EthIfRxIndicationConfig> getEthIfRxIndicationConfigs(){
			...
			return new BasicWrappingEList<EthIfRxIndicationConfig, GContainer>(filteredContainers, typeof(EthIfRxIndicationConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfRxIndicationConfig ethIfRxIndicationConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfRxIndicationConfig ethIfRxIndicationConfig) {
					ethIfRxIndicationConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfRxIndicationConfig"))
		...
		def List<EthIfSwitch> getEthIfSwitchs(){
			...
			return new BasicWrappingEList<EthIfSwitch, GContainer>(filteredContainers, typeof(EthIfSwitch), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitch ethIfSwitch) {
					ethIfSwitch.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfSwitch"))
					super.delegateAdd(ethIfSwitch)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitch ethIfSwitch) {
					ethIfSwitch.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfSwitch"))
		...
		def List<EthIfSwitchMgmtInfoIndicationConfig> getEthIfSwitchMgmtInfoIndicationConfigs(){
			...
			return new BasicWrappingEList<EthIfSwitchMgmtInfoIndicationConfig, GContainer>(filteredContainers, typeof(EthIfSwitchMgmtInfoIndicationConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitchMgmtInfoIndicationConfig ethIfSwitchMgmtInfoIndicationConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitchMgmtInfoIndicationConfig ethIfSwitchMgmtInfoIndicationConfig) {
					ethIfSwitchMgmtInfoIndicationConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfSwitchMgmtInfoIndicationConfig"))
		...
		def List<EthIfSwitchPortGroup> getEthIfSwitchPortGroups(){
			...
			return new BasicWrappingEList<EthIfSwitchPortGroup, GContainer>(filteredContainers, typeof(EthIfSwitchPortGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitchPortGroup ethIfSwitchPortGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitchPortGroup ethIfSwitchPortGroup) {
					ethIfSwitchPortGroup.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfSwitchPortGroup"))
		...
		def List<EthIfSwitchTimeStampIndicationConfig> getEthIfSwitchTimeStampIndicationConfigs(){
			...
			return new BasicWrappingEList<EthIfSwitchTimeStampIndicationConfig, GContainer>(filteredContainers, typeof(EthIfSwitchTimeStampIndicationConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitchTimeStampIndicationConfig ethIfSwitchTimeStampIndicationConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfSwitchTimeStampIndicationConfig ethIfSwitchTimeStampIndicationConfig) {
					ethIfSwitchTimeStampIndicationConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfSwitchTimeStampIndicationConfig"))
		...
		def List<EthIfTransceiver> getEthIfTransceivers(){
			...
			return new BasicWrappingEList<EthIfTransceiver, GContainer>(filteredContainers, typeof(EthIfTransceiver), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTransceiver ethIfTransceiver) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTransceiver ethIfTransceiver) {
					ethIfTransceiver.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfTransceiver"))
		...
		def List<EthIfTrcvLinkStateChgConfig> getEthIfTrcvLinkStateChgConfigs(){
			...
			return new BasicWrappingEList<EthIfTrcvLinkStateChgConfig, GContainer>(filteredContainers, typeof(EthIfTrcvLinkStateChgConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTrcvLinkStateChgConfig ethIfTrcvLinkStateChgConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTrcvLinkStateChgConfig ethIfTrcvLinkStateChgConfig) {
					ethIfTrcvLinkStateChgConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfTrcvLinkStateChgConfig"))
		...
		def List<EthIfTxConfirmationConfig> getEthIfTxConfirmationConfigs(){
			...
			return new BasicWrappingEList<EthIfTxConfirmationConfig, GContainer>(filteredContainers, typeof(EthIfTxConfirmationConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTxConfirmationConfig ethIfTxConfirmationConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTxConfirmationConfig ethIfTxConfirmationConfig) {
					ethIfTxConfirmationConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfTxConfirmationConfig"))
		...
		static class EthIfController implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTransceiver getEthIfEthTrcvRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTransceiver), "EthIfEthTrcvRef")
			}
			
			def void setEthIfEthTrcvRef(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfTransceiver object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController getEthIfPhysControllerRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController), "EthIfPhysControllerRef")
			}
			
			def void setEthIfPhysControllerRef(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EthIfPhysController implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.Eth.EthConfigSet.EthCtrlConfig getEthIfEthCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Eth.EthConfigSet.EthCtrlConfig), "EthIfEthCtrlRef")
			}
			
			def void setEthIfEthCtrlRef(org.artop.ecuc.autosar431.accessors.Eth.EthConfigSet.EthCtrlConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar431.accessors.WEth.WEthConfigSet.WEthCtrlConfig getEthIfWEthCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.WEth.WEthConfigSet.WEthCtrlConfig), "EthIfWEthCtrlRef")
			}
			
			def void setEthIfWEthCtrlRef(org.artop.ecuc.autosar431.accessors.WEth.WEthConfigSet.WEthCtrlConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<EthIfPhysCtrlRxMainFunctionPriorityProcessing> getEthIfPhysCtrlRxMainFunctionPriorityProcessings(){
				...
				return new BasicWrappingEList<EthIfPhysCtrlRxMainFunctionPriorityProcessing, GContainer>(filteredContainers, typeof(EthIfPhysCtrlRxMainFunctionPriorityProcessing), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController.EthIfPhysCtrlRxMainFunctionPriorityProcessing ethIfPhysCtrlRxMainFunctionPriorityProcessing) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar431.accessors.EthIf.EthIfConfigSet.EthIfPhysController.EthIfPhysCtrlRxMainFunctionPriorityProcessing ethIfPhysCtrlRxMainFunctionPriorityProcessing) {
						ethIfPhysCtrlRxMainFunctionPriorityProcessing.target?.gSetDefinition(containerValue.getContainerDefinition("EthIfPhysCtrlRxMainFunctionPriorityProcessing"))
			...
			static class EthIfPhysCtrlRxMainFunctionPriorityProcessing implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar431.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigIngress.EthCtrlConfigIngressFifo getEthIfPhysCtrlRxIngressFifoRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigIngress.EthCtrlConfigIngressFifo), "EthIfPhysCtrlRxIngressFifoRef")
				}
				
				def void setEthIfPhysCtrlRxIngressFifoRef(org.artop.ecuc.autosar431.accessors.Eth.EthConfigSet.EthCtrlConfig.EthCtrlConfigIngress.EthCtrlConfigIngressFifo object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EthIfSwitch implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig getEthIfSwitchRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig), "EthIfSwitchRef")
			}
			
			def void setEthIfSwitchRef(org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EthIfSwitchPortGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig.EthSwtPort> getEthIfPortRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig.EthSwtPort>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig.EthSwtPort)) {
					override protected wrap(org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig.EthSwtPort object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar431.accessors.EthSwt.EthSwtConfig.EthSwtPort(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class EthIfTransceiver implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar431.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig getEthIfEthTrcvRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig), "EthIfEthTrcvRef")
			}
			
			def void setEthIfEthTrcvRef(org.artop.ecuc.autosar431.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "EthIfEthTrcvRef"], object.getTarget())
				}
			...
			def org.artop.ecuc.autosar431.accessors.WEthTrcv.WEthTrcvConfigSet.WEthTrcvConfig getEthIfWEthTrcvRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar431.accessors.WEthTrcv.WEthTrcvConfigSet.WEthTrcvConfig), "EthIfWEthTrcvRef")
			}
			
			def void setEthIfWEthTrcvRef(org.artop.ecuc.autosar431.accessors.WEthTrcv.WEthTrcvConfigSet.WEthTrcvConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
