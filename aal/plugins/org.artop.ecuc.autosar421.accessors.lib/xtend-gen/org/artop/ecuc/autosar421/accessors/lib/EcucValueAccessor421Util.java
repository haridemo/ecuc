...
public class EcucValueAccessor421Util {
  public static Integer getIntegerValue(final GParameterValue parameterValue) {
    if ((parameterValue instanceof EcucNumericalParamValue)) {
      final NumericalValueVariationPoint parameterValueValue = ((EcucNumericalParamValue)parameterValue).getValue();
      String _mixedText = null;
      if (parameterValueValue!=null) {
        _mixedText=parameterValueValue.getMixedText();
      }
  ...
  public static Float getFloatValue(final GParameterValue parameterValue) {
    ...
    if ((parameterValue instanceof EcucNumericalParamValue)) {
      Float _xblockexpression = null;
      {
        ...
        _xblockexpression = EcucValueAccessorUtil.toFloat(_mixedText);
      }
  ...
  public static Boolean getBooleanValue(final GParameterValue parameterValue) {
    ...
    if ((parameterValue instanceof EcucNumericalParamValue)) {
      Boolean _xblockexpression = null;
      {
        ...
        _xblockexpression = EcucValueAccessorUtil.toBoolean(_mixedText);
      }
      _xifexpression = _xblockexpression;
    }
    return _xifexpression;
