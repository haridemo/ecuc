...
class V2xM implements IWrapper<GModuleConfiguration> {
	...
	static class V2xMConfig implements IWrapper<GContainer> {
		...
		static class V2xMSecurityConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor getV2xMSecurityNvMBlockDescriptorLongTermCertificates(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor), "V2xMSecurityNvMBlockDescriptorLongTermCertificates")
			}
			
			def void setV2xMSecurityNvMBlockDescriptorLongTermCertificates(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor getV2xMSecurityNvMBlockDescriptorPseudonymCertificates(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor), "V2xMSecurityNvMBlockDescriptorPseudonymCertificates")
			}
			
			def void setV2xMSecurityNvMBlockDescriptorPseudonymCertificates(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives.CsmSignatureGenerate.CsmSignatureGenerateConfig getV2xMSignatureGenerationConfigRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives.CsmSignatureGenerate.CsmSignatureGenerateConfig), "V2xMSignatureGenerationConfigRef")
			}
			
			def void setV2xMSignatureGenerationConfigRef(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives.CsmSignatureGenerate.CsmSignatureGenerateConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives.CsmSignatureVerify.CsmSignatureVerifyConfig getV2xMSignatureVerifyConfigRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives.CsmSignatureVerify.CsmSignatureVerifyConfig), "V2xMSignatureVerifyConfigRef")
			}
			
			def void setV2xMSignatureVerifyConfigRef(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives.CsmSignatureVerify.CsmSignatureVerifyConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class V2xMGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.EthIf.EthIfConfigSet.EthIfController getV2xMEthIfCtrlRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EthIf.EthIfConfigSet.EthIfController), "V2xMEthIfCtrlRef")
		}
		
		def void setV2xMEthIfCtrlRef(org.artop.ecuc.autosar444.accessors.EthIf.EthIfConfigSet.EthIfController object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration getV2xMGptChannelConfigurationRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration), "V2xMGptChannelConfigurationRef")
		}
		
		def void setV2xMGptChannelConfigurationRef(org.artop.ecuc.autosar444.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor getV2xMNvMBlockDescriptor(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor), "V2xMNvMBlockDescriptor")
		}
		
		def void setV2xMNvMBlockDescriptor(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.StbM.StbMSynchronizedTimeBase getV2xMStbMSynchronizedTimeBaseRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.StbM.StbMSynchronizedTimeBase), "V2xMStbMSynchronizedTimeBaseRef")
		}
		
		def void setV2xMStbMSynchronizedTimeBaseRef(org.artop.ecuc.autosar444.accessors.StbM.StbMSynchronizedTimeBase object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
