...
class FlsTst implements IWrapper<GModuleConfiguration> {
	...
	static class FlsTstConfigSet implements IWrapper<GContainer> {
		...
		def List<FlsTstBlockBgnd> getFlsTstBlockBgnds(){
			val List<GContainer> filteredContainers = new AbstractFilteringEList<GContainer>(containerValue, getEContainingFeature(containerValue, GecucdescriptionPackage.eINSTANCE.getGContainer())) {
				override protected accept(GContainer item) {
					return accept(item, typeof(GContainerDef), "FlsTstBlockBgnd")
				}
			}
			return new BasicWrappingEList<FlsTstBlockBgnd, GContainer>(filteredContainers, typeof(FlsTstBlockBgnd), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockBgnd flsTstBlockBgnd) {
					flsTstBlockBgnd.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlockBgnd"))
					super.delegateAdd(flsTstBlockBgnd)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockBgnd flsTstBlockBgnd) {
					flsTstBlockBgnd.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlockBgnd"))
					super.delegateAdd(index, flsTstBlockBgnd)
				}
			}
		}
		...
		def List<FlsTstBlockFgnd> getFlsTstBlockFgnds(){
			val List<GContainer> filteredContainers = new AbstractFilteringEList<GContainer>(containerValue, getEContainingFeature(containerValue, GecucdescriptionPackage.eINSTANCE.getGContainer())) {
				override protected accept(GContainer item) {
					return accept(item, typeof(GContainerDef), "FlsTstBlockFgnd")
				}
			}
			return new BasicWrappingEList<FlsTstBlockFgnd, GContainer>(filteredContainers, typeof(FlsTstBlockFgnd), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockFgnd flsTstBlockFgnd) {
					flsTstBlockFgnd.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlockFgnd"))
					super.delegateAdd(flsTstBlockFgnd)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.FlsTst.FlsTstConfigSet.FlsTstBlockFgnd flsTstBlockFgnd) {
					flsTstBlockFgnd.target?.gSetDefinition(containerValue.getContainerDefinition("FlsTstBlockFgnd"))
					super.delegateAdd(index, flsTstBlockFgnd)
				}
			}
		}
		...
		static class FlsTstBlockBgnd implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof FlsTstBlockBgnd)){
					return false
				}
				this.target == (object as FlsTstBlockBgnd).target
			}
		
			def BigInteger getFlsTstBgndBlockIndex(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FlsTstBgndBlockIndex"].getBigIntegerValue()
			}
			
			def void setFlsTstBgndBlockIndex(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FlsTstBgndBlockIndex"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "FlsTstBgndBlockIndex"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
		...
		static class FlsTstBlockFgnd implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof FlsTstBlockFgnd)){
					return false
				}
				this.target == (object as FlsTstBlockFgnd).target
			}
			...
			def BigInteger getFlsTstFgndBlockIndex(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FlsTstFgndBlockIndex"].getBigIntegerValue()
			}
			
			def void setFlsTstFgndBlockIndex(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FlsTstFgndBlockIndex"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "FlsTstFgndBlockIndex"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
	...
	static class FlsTstDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getFLSTST_E_FLSTST_FAILURE(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "FLSTST_E_FLSTST_FAILURE")
		}
		
		def void setFLSTST_E_FLSTST_FAILURE(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class FlsTstGeneral implements IWrapper<GContainer> {
		...
		def BigDecimal getFlsTstMainFunctionPeriod(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FlsTstMainFunctionPeriod"].getBigDecimalValue()
		}
		
		def void setFlsTstMainFunctionPeriod(BigDecimal value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FlsTstMainFunctionPeriod"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "FlsTstMainFunctionPeriod"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(value)
