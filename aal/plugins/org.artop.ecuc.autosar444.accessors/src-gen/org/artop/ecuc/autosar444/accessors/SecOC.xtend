...
class SecOC implements IWrapper<GModuleConfiguration> {
	...
	def List<SecOCRxPduProcessing> getSecOCRxPduProcessings(){
		...
		return new BasicWrappingEList<SecOCRxPduProcessing, GContainer>(filteredContainers, typeof(SecOCRxPduProcessing), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.SecOC.SecOCRxPduProcessing secOCRxPduProcessing) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.SecOC.SecOCRxPduProcessing secOCRxPduProcessing) {
				secOCRxPduProcessing.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SecOCRxPduProcessing"))
	...
	def List<SecOCSameBufferPduCollection> getSecOCSameBufferPduCollections(){
		...
		return new BasicWrappingEList<SecOCSameBufferPduCollection, GContainer>(filteredContainers, typeof(SecOCSameBufferPduCollection), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.SecOC.SecOCSameBufferPduCollection secOCSameBufferPduCollection) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.SecOC.SecOCSameBufferPduCollection secOCSameBufferPduCollection) {
				secOCSameBufferPduCollection.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SecOCSameBufferPduCollection"))
	...
	def List<SecOCTxPduProcessing> getSecOCTxPduProcessings(){
		...
		return new BasicWrappingEList<SecOCTxPduProcessing, GContainer>(filteredContainers, typeof(SecOCTxPduProcessing), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.SecOC.SecOCTxPduProcessing secOCTxPduProcessing) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.SecOC.SecOCTxPduProcessing secOCTxPduProcessing) {
				secOCTxPduProcessing.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("SecOCTxPduProcessing"))
	...
	static class SecOCRxPduProcessing implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob getSecOCRxAuthServiceConfigRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob), "SecOCRxAuthServiceConfigRef")
		}
		
		def void setSecOCRxAuthServiceConfigRef(org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.SecOC.SecOCSameBufferPduCollection getSecOCSameBufferPduRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.SecOC.SecOCSameBufferPduCollection), "SecOCSameBufferPduRef")
		}
		
		def void setSecOCSameBufferPduRef(org.artop.ecuc.autosar444.accessors.SecOC.SecOCSameBufferPduCollection object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def SecOCRxPduSecuredArea getSecOCRxPduSecuredArea(){
			containerValue.getByType(typeof(SecOCRxPduSecuredArea))
		}
		
		def void setSecOCRxPduSecuredArea(SecOCRxPduSecuredArea secOCRxPduSecuredArea){
			val GContainer subContainer = secOCRxPduSecuredArea.getTarget()
			containerValue.setContainer(subContainer, "SecOCRxPduSecuredArea")
		}
		...
		static class SecOCRxAuthenticPduLayer implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxAuthenticLayerPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxAuthenticLayerPduRef")
			}
			
			def void setSecOCRxAuthenticLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SecOCRxPduSecuredArea implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof SecOCRxPduSecuredArea)){
					return false
				}
				this.target == (object as SecOCRxPduSecuredArea).target
			}
		
			def BigInteger getSecOCSecuredRxPduLength(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredRxPduLength"].getBigIntegerValue()
			}
			
			def void setSecOCSecuredRxPduLength(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredRxPduLength"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "SecOCSecuredRxPduLength"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def BigInteger getSecOCSecuredRxPduOffset(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredRxPduOffset"].getBigIntegerValue()
			}
			
			def void setSecOCSecuredRxPduOffset(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredRxPduOffset"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "SecOCSecuredRxPduOffset"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
		...
		static class SecOCRxSecuredPduLayer implements IWrapper<GContainer> {
			...
			static class SecOCRxSecuredPdu implements IWrapper<GContainer> {
				...
				def BigInteger getSecOCAuthPduHeaderLength(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCAuthPduHeaderLength"].getBigIntegerValue()
				}
				
				def void setSecOCAuthPduHeaderLength(BigInteger value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCAuthPduHeaderLength"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "SecOCAuthPduHeaderLength"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def Boolean getSecOCSecuredRxPduVerification(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredRxPduVerification"].getBooleanValue()
				}
				
				def void setSecOCSecuredRxPduVerification(Boolean value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredRxPduVerification"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "SecOCSecuredRxPduVerification"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(getBooleanParameterValueValue(value, true))
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxSecuredLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxSecuredLayerPduRef")
				}
				
				def void setSecOCRxSecuredLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SecOCRxSecuredPduCollection implements IWrapper<GContainer> {
				...
				static class SecOCRxAuthenticPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxAuthenticPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxAuthenticPduRef")
					}
					
					def void setSecOCRxAuthenticPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class SecOCRxCryptographicPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCRxCryptographicPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCRxCryptographicPduRef")
					}
					
					def void setSecOCRxCryptographicPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
	...
	static class SecOCTxPduProcessing implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob getSecOCTxAuthServiceConfigRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob), "SecOCTxAuthServiceConfigRef")
		}
		
		def void setSecOCTxAuthServiceConfigRef(org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def SecOCTxPduSecuredArea getSecOCTxPduSecuredArea(){
			containerValue.getByType(typeof(SecOCTxPduSecuredArea))
		}
		
		def void setSecOCTxPduSecuredArea(SecOCTxPduSecuredArea secOCTxPduSecuredArea){
			val GContainer subContainer = secOCTxPduSecuredArea.getTarget()
			containerValue.setContainer(subContainer, "SecOCTxPduSecuredArea")
		}
		...
		static class SecOCTxAuthenticPduLayer implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxAuthenticLayerPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxAuthenticLayerPduRef")
			}
			
			def void setSecOCTxAuthenticLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class SecOCTxPduSecuredArea implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof SecOCTxPduSecuredArea)){
					return false
				}
				this.target == (object as SecOCTxPduSecuredArea).target
			}
		
			def BigInteger getSecOCSecuredTxPduLength(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredTxPduLength"].getBigIntegerValue()
			}
			
			def void setSecOCSecuredTxPduLength(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredTxPduLength"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "SecOCSecuredTxPduLength"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def BigInteger getSecOCSecuredTxPduOffset(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredTxPduOffset"].getBigIntegerValue()
			}
			
			def void setSecOCSecuredTxPduOffset(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "SecOCSecuredTxPduOffset"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "SecOCSecuredTxPduOffset"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
		...
		static class SecOCTxSecuredPduLayer implements IWrapper<GContainer> {
			...
			static class SecOCTxSecuredPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxSecuredLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxSecuredLayerPduRef")
				}
				
				def void setSecOCTxSecuredLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class SecOCTxSecuredPduCollection implements IWrapper<GContainer> {
				...
				static class SecOCTxAuthenticPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxAuthenticPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxAuthenticPduRef")
					}
					
					def void setSecOCTxAuthenticPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class SecOCTxCryptographicPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getSecOCTxCryptographicPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "SecOCTxCryptographicPduRef")
					}
					
					def void setSecOCTxCryptographicPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
