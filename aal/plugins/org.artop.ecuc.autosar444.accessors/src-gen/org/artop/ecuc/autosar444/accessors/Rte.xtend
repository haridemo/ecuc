...
class Rte implements IWrapper<GModuleConfiguration> {
	...
	def List<RteBswModuleInstance> getRteBswModuleInstances(){
		...
		return new BasicWrappingEList<RteBswModuleInstance, GContainer>(filteredContainers, typeof(RteBswModuleInstance), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance rteBswModuleInstance) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance rteBswModuleInstance) {
				rteBswModuleInstance.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteBswModuleInstance"))
	...
	def List<RteImplicitCommunication> getRteImplicitCommunications(){
		...
		return new BasicWrappingEList<RteImplicitCommunication, GContainer>(filteredContainers, typeof(RteImplicitCommunication), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteImplicitCommunication rteImplicitCommunication) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteImplicitCommunication rteImplicitCommunication) {
				rteImplicitCommunication.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteImplicitCommunication"))
	...
	def List<RteInitializationBehavior> getRteInitializationBehaviors(){
		...
		return new BasicWrappingEList<RteInitializationBehavior, GContainer>(filteredContainers, typeof(RteInitializationBehavior), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteInitializationBehavior rteInitializationBehavior) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteInitializationBehavior rteInitializationBehavior) {
				rteInitializationBehavior.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteInitializationBehavior"))
	...
	def List<RteInitializationRunnableBatch> getRteInitializationRunnableBatchs(){
		...
		return new BasicWrappingEList<RteInitializationRunnableBatch, GContainer>(filteredContainers, typeof(RteInitializationRunnableBatch), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteInitializationRunnableBatch rteInitializationRunnableBatch) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteInitializationRunnableBatch rteInitializationRunnableBatch) {
				rteInitializationRunnableBatch.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteInitializationRunnableBatch"))
	...
	def List<RteOsInteraction> getRteOsInteractions(){
		...
		return new BasicWrappingEList<RteOsInteraction, GContainer>(filteredContainers, typeof(RteOsInteraction), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction rteOsInteraction) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction rteOsInteraction) {
				rteOsInteraction.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteOsInteraction"))
	...
	def List<RteSwComponentInstance> getRteSwComponentInstances(){
		...
		return new BasicWrappingEList<RteSwComponentInstance, GContainer>(filteredContainers, typeof(RteSwComponentInstance), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance rteSwComponentInstance) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance rteSwComponentInstance) {
				rteSwComponentInstance.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteSwComponentInstance"))
	...
	def List<RteSwComponentType> getRteSwComponentTypes(){
		...
		return new BasicWrappingEList<RteSwComponentType, GContainer>(filteredContainers, typeof(RteSwComponentType), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentType rteSwComponentType) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentType rteSwComponentType) {
				rteSwComponentType.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("RteSwComponentType"))
	...
	static class RteBswModuleInstance implements IWrapper<GContainer> {
		...
		def List<RteBswEventToTaskMapping> getRteBswEventToTaskMappings(){
			...
			return new BasicWrappingEList<RteBswEventToTaskMapping, GContainer>(filteredContainers, typeof(RteBswEventToTaskMapping), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswEventToTaskMapping rteBswEventToTaskMapping) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswEventToTaskMapping rteBswEventToTaskMapping) {
					rteBswEventToTaskMapping.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswEventToTaskMapping"))
		...
		def List<RteBswExclusiveAreaImpl> getRteBswExclusiveAreaImpls(){
			...
			return new BasicWrappingEList<RteBswExclusiveAreaImpl, GContainer>(filteredContainers, typeof(RteBswExclusiveAreaImpl), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswExclusiveAreaImpl rteBswExclusiveAreaImpl) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswExclusiveAreaImpl rteBswExclusiveAreaImpl) {
					rteBswExclusiveAreaImpl.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswExclusiveAreaImpl"))
		...
		def List<RteBswExternalTriggerConfig> getRteBswExternalTriggerConfigs(){
			...
			return new BasicWrappingEList<RteBswExternalTriggerConfig, GContainer>(filteredContainers, typeof(RteBswExternalTriggerConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswExternalTriggerConfig rteBswExternalTriggerConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswExternalTriggerConfig rteBswExternalTriggerConfig) {
					rteBswExternalTriggerConfig.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswExternalTriggerConfig"))
		...
		def List<RteBswInternalTriggerConfig> getRteBswInternalTriggerConfigs(){
			...
			return new BasicWrappingEList<RteBswInternalTriggerConfig, GContainer>(filteredContainers, typeof(RteBswInternalTriggerConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswInternalTriggerConfig rteBswInternalTriggerConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswInternalTriggerConfig rteBswInternalTriggerConfig) {
					rteBswInternalTriggerConfig.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswInternalTriggerConfig"))
		...
		def List<RteBswRequiredClientServerConnection> getRteBswRequiredClientServerConnections(){
			...
			return new BasicWrappingEList<RteBswRequiredClientServerConnection, GContainer>(filteredContainers, typeof(RteBswRequiredClientServerConnection), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredClientServerConnection rteBswRequiredClientServerConnection) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredClientServerConnection rteBswRequiredClientServerConnection) {
					rteBswRequiredClientServerConnection.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswRequiredClientServerConnection"))
		...
		def List<RteBswRequiredModeGroupConnection> getRteBswRequiredModeGroupConnections(){
			...
			return new BasicWrappingEList<RteBswRequiredModeGroupConnection, GContainer>(filteredContainers, typeof(RteBswRequiredModeGroupConnection), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredModeGroupConnection rteBswRequiredModeGroupConnection) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredModeGroupConnection rteBswRequiredModeGroupConnection) {
					rteBswRequiredModeGroupConnection.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswRequiredModeGroupConnection"))
		...
		def List<RteBswRequiredSenderReceiverConnection> getRteBswRequiredSenderReceiverConnections(){
			...
			return new BasicWrappingEList<RteBswRequiredSenderReceiverConnection, GContainer>(filteredContainers, typeof(RteBswRequiredSenderReceiverConnection), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredSenderReceiverConnection rteBswRequiredSenderReceiverConnection) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredSenderReceiverConnection rteBswRequiredSenderReceiverConnection) {
					rteBswRequiredSenderReceiverConnection.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswRequiredSenderReceiverConnection"))
		...
		def List<RteBswRequiredTriggerConnection> getRteBswRequiredTriggerConnections(){
			...
			return new BasicWrappingEList<RteBswRequiredTriggerConnection, GContainer>(filteredContainers, typeof(RteBswRequiredTriggerConnection), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredTriggerConnection rteBswRequiredTriggerConnection) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance.RteBswRequiredTriggerConnection rteBswRequiredTriggerConnection) {
					rteBswRequiredTriggerConnection.target?.gSetDefinition(containerValue.getContainerDefinition("RteBswRequiredTriggerConnection"))
		...
		static class RteBswEventToTaskMapping implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint getRteBswEventPredecessorSyncPointRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint), "RteBswEventPredecessorSyncPointRef")
			}
			
			def void setRteBswEventPredecessorSyncPointRef(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint getRteBswEventSuccessorSyncPointRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint), "RteBswEventSuccessorSyncPointRef")
			}
			
			def void setRteBswEventSuccessorSyncPointRef(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsTask getRteBswMappedToTaskRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsTask), "RteBswMappedToTaskRef")
			}
			
			def void setRteBswMappedToTaskRef(org.artop.ecuc.autosar444.accessors.Os.OsTask object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsAlarm getRteBswUsedOsAlarmRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsAlarm), "RteBswUsedOsAlarmRef")
			}
			
			def void setRteBswUsedOsAlarmRef(org.artop.ecuc.autosar444.accessors.Os.OsAlarm object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsEvent getRteBswUsedOsEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsEvent), "RteBswUsedOsEventRef")
			}
			
			def void setRteBswUsedOsEventRef(org.artop.ecuc.autosar444.accessors.Os.OsEvent object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint getRteBswUsedOsSchTblExpiryPointRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint), "RteBswUsedOsSchTblExpiryPointRef")
			}
			
			def void setRteBswUsedOsSchTblExpiryPointRef(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteBswExclusiveAreaImpl implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsResource getRteBswExclusiveAreaOsResourceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsResource), "RteBswExclusiveAreaOsResourceRef")
			}
			
			def void setRteBswExclusiveAreaOsResourceRef(org.artop.ecuc.autosar444.accessors.Os.OsResource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsSpinlock getRteBswExclusiveAreaOsSpinlockRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsSpinlock), "RteBswExclusiveAreaOsSpinlockRef")
			}
			
			def void setRteBswExclusiveAreaOsSpinlockRef(org.artop.ecuc.autosar444.accessors.Os.OsSpinlock object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteBswRequiredClientServerConnection implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance getRteBswProvidedClientServerEntryModInstRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance), "RteBswProvidedClientServerEntryModInstRef")
			}
			
			def void setRteBswProvidedClientServerEntryModInstRef(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteBswRequiredModeGroupConnection implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance getRteBswProvidedModeGrpModInstRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance), "RteBswProvidedModeGrpModInstRef")
			}
			
			def void setRteBswProvidedModeGrpModInstRef(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteBswRequiredSenderReceiverConnection implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance getRteBswProvidedDataModInstRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance), "RteBswProvidedDataModInstRef")
			}
			
			def void setRteBswProvidedDataModInstRef(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteBswRequiredTriggerConnection implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance getRteBswReleasedTriggerModInstRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance), "RteBswReleasedTriggerModInstRef")
			}
			
			def void setRteBswReleasedTriggerModInstRef(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class RteOsInteraction implements IWrapper<GContainer> {
		...
		def List<RteModeToScheduleTableMapping> getRteModeToScheduleTableMappings(){
			...
			return new BasicWrappingEList<RteModeToScheduleTableMapping, GContainer>(filteredContainers, typeof(RteModeToScheduleTableMapping), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteModeToScheduleTableMapping rteModeToScheduleTableMapping) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteModeToScheduleTableMapping rteModeToScheduleTableMapping) {
					rteModeToScheduleTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("RteModeToScheduleTableMapping"))
		...
		def List<RteSyncPoint> getRteSyncPoints(){
			...
			return new BasicWrappingEList<RteSyncPoint, GContainer>(filteredContainers, typeof(RteSyncPoint), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint rteSyncPoint) {
					rteSyncPoint.target?.gSetDefinition(containerValue.getContainerDefinition("RteSyncPoint"))
					super.delegateAdd(rteSyncPoint)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint rteSyncPoint) {
					rteSyncPoint.target?.gSetDefinition(containerValue.getContainerDefinition("RteSyncPoint"))
		...
		def List<RteUsedOsActivation> getRteUsedOsActivations(){
			...
			return new BasicWrappingEList<RteUsedOsActivation, GContainer>(filteredContainers, typeof(RteUsedOsActivation), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteUsedOsActivation rteUsedOsActivation) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteUsedOsActivation rteUsedOsActivation) {
					rteUsedOsActivation.target?.gSetDefinition(containerValue.getContainerDefinition("RteUsedOsActivation"))
		...
		static class RteModeToScheduleTableMapping implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable getRteModeScheduleTableRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable), "RteModeScheduleTableRef")
			}
			
			def void setRteModeScheduleTableRef(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class RteModeSchtblMapBsw implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance getRteModeSchtblMapBswInstanceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance), "RteModeSchtblMapBswInstanceRef")
				}
				
				def void setRteModeSchtblMapBswInstanceRef(org.artop.ecuc.autosar444.accessors.Rte.RteBswModuleInstance object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class RteModeSchtblMapSwc implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance getRteModeSchtblMapSwcInstanceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance), "RteModeSchtblMapSwcInstanceRef")
				}
				
				def void setRteModeSchtblMapSwcInstanceRef(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteUsedOsActivation implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsAlarm getRteActivationOsAlarmRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsAlarm), "RteActivationOsAlarmRef")
			}
			
			def void setRteActivationOsAlarmRef(org.artop.ecuc.autosar444.accessors.Os.OsAlarm object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable getRteActivationOsSchTblRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable), "RteActivationOsSchTblRef")
			}
			
			def void setRteActivationOsSchTblRef(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsTask getRteActivationOsTaskRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsTask), "RteActivationOsTaskRef")
			}
			
			def void setRteActivationOsTaskRef(org.artop.ecuc.autosar444.accessors.Os.OsTask object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class RteSwComponentInstance implements IWrapper<GContainer> {
		...
		def List<RteEventToTaskMapping> getRteEventToTaskMappings(){
			...
			return new BasicWrappingEList<RteEventToTaskMapping, GContainer>(filteredContainers, typeof(RteEventToTaskMapping), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteEventToTaskMapping rteEventToTaskMapping) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteEventToTaskMapping rteEventToTaskMapping) {
					rteEventToTaskMapping.target?.gSetDefinition(containerValue.getContainerDefinition("RteEventToTaskMapping"))
		...
		def List<RteExclusiveAreaImplementation> getRteExclusiveAreaImplementations(){
			...
			return new BasicWrappingEList<RteExclusiveAreaImplementation, GContainer>(filteredContainers, typeof(RteExclusiveAreaImplementation), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteExclusiveAreaImplementation rteExclusiveAreaImplementation) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteExclusiveAreaImplementation rteExclusiveAreaImplementation) {
					rteExclusiveAreaImplementation.target?.gSetDefinition(containerValue.getContainerDefinition("RteExclusiveAreaImplementation"))
		...
		def List<RteExternalTriggerConfig> getRteExternalTriggerConfigs(){
			...
			return new BasicWrappingEList<RteExternalTriggerConfig, GContainer>(filteredContainers, typeof(RteExternalTriggerConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteExternalTriggerConfig rteExternalTriggerConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteExternalTriggerConfig rteExternalTriggerConfig) {
					rteExternalTriggerConfig.target?.gSetDefinition(containerValue.getContainerDefinition("RteExternalTriggerConfig"))
		...
		def List<RteInternalTriggerConfig> getRteInternalTriggerConfigs(){
			...
			return new BasicWrappingEList<RteInternalTriggerConfig, GContainer>(filteredContainers, typeof(RteInternalTriggerConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteInternalTriggerConfig rteInternalTriggerConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteInternalTriggerConfig rteInternalTriggerConfig) {
					rteInternalTriggerConfig.target?.gSetDefinition(containerValue.getContainerDefinition("RteInternalTriggerConfig"))
		...
		def List<RteNvRamAllocation> getRteNvRamAllocations(){
			...
			return new BasicWrappingEList<RteNvRamAllocation, GContainer>(filteredContainers, typeof(RteNvRamAllocation), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteNvRamAllocation rteNvRamAllocation) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Rte.RteSwComponentInstance.RteNvRamAllocation rteNvRamAllocation) {
					rteNvRamAllocation.target?.gSetDefinition(containerValue.getContainerDefinition("RteNvRamAllocation"))
		...
		static class RteEventToTaskMapping implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint getRteEventPredecessorSyncPointRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint), "RteEventPredecessorSyncPointRef")
			}
			
			def void setRteEventPredecessorSyncPointRef(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint getRteEventSuccessorSyncPointRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint), "RteEventSuccessorSyncPointRef")
			}
			
			def void setRteEventSuccessorSyncPointRef(org.artop.ecuc.autosar444.accessors.Rte.RteOsInteraction.RteSyncPoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsTask getRteMappedToTaskRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsTask), "RteMappedToTaskRef")
			}
			
			def void setRteMappedToTaskRef(org.artop.ecuc.autosar444.accessors.Os.OsTask object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Rte.RteInitializationRunnableBatch getRteUsedInitFnc(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Rte.RteInitializationRunnableBatch), "RteUsedInitFnc")
			}
			
			def void setRteUsedInitFnc(org.artop.ecuc.autosar444.accessors.Rte.RteInitializationRunnableBatch object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsAlarm getRteUsedOsAlarmRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsAlarm), "RteUsedOsAlarmRef")
			}
			
			def void setRteUsedOsAlarmRef(org.artop.ecuc.autosar444.accessors.Os.OsAlarm object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsEvent getRteUsedOsEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsEvent), "RteUsedOsEventRef")
			}
			
			def void setRteUsedOsEventRef(org.artop.ecuc.autosar444.accessors.Os.OsEvent object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint getRteUsedOsSchTblExpiryPointRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint), "RteUsedOsSchTblExpiryPointRef")
			}
			
			def void setRteUsedOsSchTblExpiryPointRef(org.artop.ecuc.autosar444.accessors.Os.OsScheduleTable.OsScheduleTableExpiryPoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsTask getRteVirtuallyMappedToTaskRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsTask), "RteVirtuallyMappedToTaskRef")
			}
			
			def void setRteVirtuallyMappedToTaskRef(org.artop.ecuc.autosar444.accessors.Os.OsTask object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteExclusiveAreaImplementation implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Os.OsResource getRteExclusiveAreaOsResourceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsResource), "RteExclusiveAreaOsResourceRef")
			}
			
			def void setRteExclusiveAreaOsResourceRef(org.artop.ecuc.autosar444.accessors.Os.OsResource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class RteNvRamAllocation implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor getRteNvmBlockRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor), "RteNvmBlockRef")
			}
			
			def void setRteNvmBlockRef(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
