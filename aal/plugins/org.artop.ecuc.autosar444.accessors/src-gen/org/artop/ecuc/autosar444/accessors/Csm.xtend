...
class Csm implements IWrapper<GModuleConfiguration> {
	...
	def List<CsmPrimitives> getCsmPrimitives(){
		...
		return new BasicWrappingEList<CsmPrimitives, GContainer>(filteredContainers, typeof(CsmPrimitives), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives csmPrimitives) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives csmPrimitives) {
				csmPrimitives.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CsmPrimitives"))
	...
	static class CsmCallbacks implements IWrapper<GContainer> {
		...
		def List<CsmCallback> getCsmCallbacks(){
			...
			return new BasicWrappingEList<CsmCallback, GContainer>(filteredContainers, typeof(CsmCallback), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Csm.CsmCallbacks.CsmCallback csmCallback) {
					csmCallback.target?.gSetDefinition(containerValue.getContainerDefinition("CsmCallback"))
					super.delegateAdd(csmCallback)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Csm.CsmCallbacks.CsmCallback csmCallback) {
					csmCallback.target?.gSetDefinition(containerValue.getContainerDefinition("CsmCallback"))
	...
	static class CsmJobs implements IWrapper<GContainer> {
		...
		def List<CsmJob> getCsmJobs(){
			...
			return new BasicWrappingEList<CsmJob, GContainer>(filteredContainers, typeof(CsmJob), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob csmJob) {
					csmJob.target?.gSetDefinition(containerValue.getContainerDefinition("CsmJob"))
					super.delegateAdd(csmJob)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Csm.CsmJobs.CsmJob csmJob) {
					csmJob.target?.gSetDefinition(containerValue.getContainerDefinition("CsmJob"))
		...
		static class CsmJob implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey getCsmJobKeyRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey), "CsmJobKeyRef")
			}
			
			def void setCsmJobKeyRef(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Csm.CsmCallbacks.CsmCallback getCsmJobPrimitiveCallbackRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmCallbacks.CsmCallback), "CsmJobPrimitiveCallbackRef")
			}
			
			def void setCsmJobPrimitiveCallbackRef(org.artop.ecuc.autosar444.accessors.Csm.CsmCallbacks.CsmCallback object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives getCsmJobPrimitiveRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives), "CsmJobPrimitiveRef")
			}
			
			def void setCsmJobPrimitiveRef(org.artop.ecuc.autosar444.accessors.Csm.CsmPrimitives object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue getCsmJobQueueRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue), "CsmJobQueueRef")
			}
			
			def void setCsmJobQueueRef(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CsmKeys implements IWrapper<GContainer> {
		...
		def List<CsmKey> getCsmKeys(){
			...
			return new BasicWrappingEList<CsmKey, GContainer>(filteredContainers, typeof(CsmKey), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey csmKey) {
					csmKey.target?.gSetDefinition(containerValue.getContainerDefinition("CsmKey"))
					super.delegateAdd(csmKey)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey csmKey) {
					csmKey.target?.gSetDefinition(containerValue.getContainerDefinition("CsmKey"))
		...
		static class CsmKey implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.CryIf.CryIfKey getCsmKeyRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.CryIf.CryIfKey), "CsmKeyRef")
			}
			
			def void setCsmKeyRef(org.artop.ecuc.autosar444.accessors.CryIf.CryIfKey object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CsmPrimitives implements IWrapper<GContainer> {
		...
		static class CsmAEADDecrypt implements IWrapper<GContainer> {
			...
			static class CsmAEADDecryptConfig implements IWrapper<GContainer> {
				...
				def CsmAEADDecryptAlgorithmFamily getCsmAEADDecryptAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmAEADDecryptAlgorithmFamily"].getCsmAEADDecryptAlgorithmFamilyValue()
				}
				
				def void setCsmAEADDecryptAlgorithmFamily(CsmAEADDecryptAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmAEADDecryptAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmAEADDecryptAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmAEADDecryptAlgorithmFamily {
					CRYPTO_ALGOFAM_3DES, 
					CRYPTO_ALGOFAM_AES, 
					CRYPTO_ALGOFAM_CUSTOM
				}
				
				def CsmAEADDecryptAlgorithmFamily getCsmAEADDecryptAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_3DES" : CsmAEADDecryptAlgorithmFamily.CRYPTO_ALGOFAM_3DES
						case "CRYPTO_ALGOFAM_AES" : CsmAEADDecryptAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmAEADDecryptAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
					}
				}
				
				def void setCsmAEADDecryptAlgorithmFamilyValue(GParameterValue parameterValue, CsmAEADDecryptAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def CsmAEADDecryptAlgorithmMode getCsmAEADDecryptAlgorithmModeValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOMODE_CUSTOM" : CsmAEADDecryptAlgorithmMode.CRYPTO_ALGOMODE_CUSTOM
				...
				def org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey getCsmAEADDecryptKeyRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey), "CsmAEADDecryptKeyRef")
				}
				
				def void setCsmAEADDecryptKeyRef(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue getCsmAEADDecryptQueueRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue), "CsmAEADDecryptQueueRef")
				}
				
				def void setCsmAEADDecryptQueueRef(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CsmAEADEncrypt implements IWrapper<GContainer> {
			...
			static class CsmAEADEncryptConfig implements IWrapper<GContainer> {
				...
				def CsmAEADEncryptAlgorithmFamily getCsmAEADEncryptAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmAEADEncryptAlgorithmFamily"].getCsmAEADEncryptAlgorithmFamilyValue()
				}
				
				def void setCsmAEADEncryptAlgorithmFamily(CsmAEADEncryptAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmAEADEncryptAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmAEADEncryptAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmAEADEncryptAlgorithmFamily {
					CRYPTO_ALGOFAM_3DES, 
					CRYPTO_ALGOFAM_AES, 
					CRYPTO_ALGOFAM_CUSTOM
				}
				
				def CsmAEADEncryptAlgorithmFamily getCsmAEADEncryptAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_3DES" : CsmAEADEncryptAlgorithmFamily.CRYPTO_ALGOFAM_3DES
						case "CRYPTO_ALGOFAM_AES" : CsmAEADEncryptAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmAEADEncryptAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
					}
				}
				
				def void setCsmAEADEncryptAlgorithmFamilyValue(GParameterValue parameterValue, CsmAEADEncryptAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def CsmAEADEncryptAlgorithmMode getCsmAEADEncryptAlgorithmModeValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOMODE_CUSTOM" : CsmAEADEncryptAlgorithmMode.CRYPTO_ALGOMODE_CUSTOM
				...
				def org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey getCsmAEADEncryptKeyRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey), "CsmAEADEncryptKeyRef")
				}
				
				def void setCsmAEADEncryptKeyRef(org.artop.ecuc.autosar444.accessors.Csm.CsmKeys.CsmKey object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue getCsmAEADEncryptQueueRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue), "CsmAEADEncryptQueueRef")
				}
				
				def void setCsmAEADEncryptQueueRef(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CsmDecrypt implements IWrapper<GContainer> {
			...
			static class CsmDecryptConfig implements IWrapper<GContainer> {
				...
				def CsmDecryptAlgorithmFamily getCsmDecryptAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmDecryptAlgorithmFamily"].getCsmDecryptAlgorithmFamilyValue()
				}
				
				def void setCsmDecryptAlgorithmFamily(CsmDecryptAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmDecryptAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmDecryptAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmDecryptAlgorithmFamily {
					CRYPTO_ALGOFAM_3DES, 
					CRYPTO_ALGOFAM_AES, 
				...
				def CsmDecryptAlgorithmFamily getCsmDecryptAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_3DES" : CsmDecryptAlgorithmFamily.CRYPTO_ALGOFAM_3DES
						case "CRYPTO_ALGOFAM_AES" : CsmDecryptAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_CHACHA" : CsmDecryptAlgorithmFamily.CRYPTO_ALGOFAM_CHACHA
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmDecryptAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_ECIES" : CsmDecryptAlgorithmFamily.CRYPTO_ALGOFAM_ECIES
						case "CRYPTO_ALGOFAM_RSA" : CsmDecryptAlgorithmFamily.CRYPTO_ALGOFAM_RSA
					}
				}
				
				def void setCsmDecryptAlgorithmFamilyValue(GParameterValue parameterValue, CsmDecryptAlgorithmFamily value){
					parameterValue.setValue(value)
				}
		...
		static class CsmEncrypt implements IWrapper<GContainer> {
			...
			static class CsmEncryptConfig implements IWrapper<GContainer> {
				...
				def CsmEncryptAlgorithmFamily getCsmEncryptAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmEncryptAlgorithmFamily"].getCsmEncryptAlgorithmFamilyValue()
				}
				
				def void setCsmEncryptAlgorithmFamily(CsmEncryptAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmEncryptAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmEncryptAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmEncryptAlgorithmFamily {
					CRYPTO_ALGOFAM_3DES, 
					CRYPTO_ALGOFAM_AES, 
					CRYPTO_ALGOFAM_CHACHA, 
					CRYPTO_ALGOFAM_CUSTOM, 
				...
				def CsmEncryptAlgorithmFamily getCsmEncryptAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_3DES" : CsmEncryptAlgorithmFamily.CRYPTO_ALGOFAM_3DES
						case "CRYPTO_ALGOFAM_AES" : CsmEncryptAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_CHACHA" : CsmEncryptAlgorithmFamily.CRYPTO_ALGOFAM_CHACHA
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmEncryptAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_ECIES" : CsmEncryptAlgorithmFamily.CRYPTO_ALGOFAM_ECIES
						case "CRYPTO_ALGOFAM_RSA" : CsmEncryptAlgorithmFamily.CRYPTO_ALGOFAM_RSA
					}
				}
				
				def void setCsmEncryptAlgorithmFamilyValue(GParameterValue parameterValue, CsmEncryptAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def BigInteger getCsmEncryptAlgorithmKeyLength(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmEncryptAlgorithmKeyLength"].getBigIntegerValue()
				}
				
				def void setCsmEncryptAlgorithmKeyLength(BigInteger value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmEncryptAlgorithmKeyLength"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmEncryptAlgorithmKeyLength"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
		...
		static class CsmHash implements IWrapper<GContainer> {
			...
			static class CsmHashConfig implements IWrapper<GContainer> {
				...
				def CsmHashAlgorithmFamily getCsmHashAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmHashAlgorithmFamily"].getCsmHashAlgorithmFamilyValue()
				}
				
				def void setCsmHashAlgorithmFamily(CsmHashAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmHashAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmHashAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def CsmHashAlgorithmFamily getCsmHashAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_BLAKE_1_256" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_256
						case "CRYPTO_ALGOFAM_BLAKE_1_512" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_512
						case "CRYPTO_ALGOFAM_BLAKE_2s_256" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_256
						case "CRYPTO_ALGOFAM_BLAKE_2s_512" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_512
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_RIPEMD160" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_RIPEMD160
						case "CRYPTO_ALGOFAM_SHA1" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA1
						case "CRYPTO_ALGOFAM_SHA2_224" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_224
						case "CRYPTO_ALGOFAM_SHA2_256" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_256
						case "CRYPTO_ALGOFAM_SHA2_384" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_384
						case "CRYPTO_ALGOFAM_SHA2_512" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512
						case "CRYPTO_ALGOFAM_SHA2_512_224" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_224
						case "CRYPTO_ALGOFAM_SHA2_512_256" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_256
						case "CRYPTO_ALGOFAM_SHA3_224" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_224
						case "CRYPTO_ALGOFAM_SHA3_256" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_256
						case "CRYPTO_ALGOFAM_SHA3_384" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_384
						case "CRYPTO_ALGOFAM_SHA3_512" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_512
						case "CRYPTO_ALGOFAM_SHA3_SHAKE128" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE128
						case "CRYPTO_ALGOFAM_SHA3_SHAKE256" : CsmHashAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE256
					}
				}
				
				def void setCsmHashAlgorithmFamilyValue(GParameterValue parameterValue, CsmHashAlgorithmFamily value){
					parameterValue.setValue(value)
				}
		...
		static class CsmMacGenerate implements IWrapper<GContainer> {
			...
			static class CsmMacGenerateConfig implements IWrapper<GContainer> {
				...
				def CsmMacGenerateAlgorithmFamily getCsmMacGenerateAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacGenerateAlgorithmFamily"].getCsmMacGenerateAlgorithmFamilyValue()
				}
				
				def void setCsmMacGenerateAlgorithmFamily(CsmMacGenerateAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacGenerateAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmMacGenerateAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmMacGenerateAlgorithmFamily {
					CRYPTO_ALGOFAM_3DES, 
					CRYPTO_ALGOFAM_AES, 
					CRYPTO_ALGOFAM_BLAKE_1_256, 
					CRYPTO_ALGOFAM_BLAKE_1_512, 
				...
				def CsmMacGenerateAlgorithmFamily getCsmMacGenerateAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_3DES" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_3DES
						case "CRYPTO_ALGOFAM_AES" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_BLAKE_1_256" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_256
						case "CRYPTO_ALGOFAM_BLAKE_1_512" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_512
						case "CRYPTO_ALGOFAM_BLAKE_2s_256" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_256
						case "CRYPTO_ALGOFAM_BLAKE_2s_512" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_512
						case "CRYPTO_ALGOFAM_CHACHA" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_CHACHA
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_RIPEMD160" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_RIPEMD160
						case "CRYPTO_ALGOFAM_RNG" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_RNG
						case "CRYPTO_ALGOFAM_SHA1" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA1
						case "CRYPTO_ALGOFAM_SHA2_224" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_224
						case "CRYPTO_ALGOFAM_SHA2_256" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_256
						case "CRYPTO_ALGOFAM_SHA2_384" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_384
						case "CRYPTO_ALGOFAM_SHA2_512" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512
						case "CRYPTO_ALGOFAM_SHA2_512_224" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_224
						case "CRYPTO_ALGOFAM_SHA2_512_256" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_256
						case "CRYPTO_ALGOFAM_SHA3_224" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_224
						case "CRYPTO_ALGOFAM_SHA3_256" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_256
						case "CRYPTO_ALGOFAM_SHA3_384" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_384
						case "CRYPTO_ALGOFAM_SHA3_512" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_512
						case "CRYPTO_ALGOFAM_SHA3_SHAKE128" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE128
						case "CRYPTO_ALGOFAM_SHA3_SHAKE256" : CsmMacGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE256
					}
				}
				
				def void setCsmMacGenerateAlgorithmFamilyValue(GParameterValue parameterValue, CsmMacGenerateAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def CsmMacGenerateAlgorithmSecondaryFamily getCsmMacGenerateAlgorithmSecondaryFamilyValue(GParameterValue parameterValue){
					...
					switch (castedParameterValue.value){
						...
						case "CRYPTO_ALGOMODE_CUSTOM" : CsmMacGenerateAlgorithmSecondaryFamily.CRYPTO_ALGOMODE_CUSTOM
					}
				}
		...
		static class CsmMacVerify implements IWrapper<GContainer> {
			...
			static class CsmMacVerifyConfig implements IWrapper<GContainer> {
				...
				def CsmMacVerifyAlgorithmFamily getCsmMacVerifyAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmFamily"].getCsmMacVerifyAlgorithmFamilyValue()
				}
				
				def void setCsmMacVerifyAlgorithmFamily(CsmMacVerifyAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmMacVerifyAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmMacVerifyAlgorithmFamily {
					CRYPTO_ALGOFAM_AES, 
					CRYPTO_ALGOFAM_BLAKE_1_256, 
					CRYPTO_ALGOFAM_BLAKE_1_512, 
					CRYPTO_ALGOFAM_BLAKE_2s_256, 
				...
				def CsmMacVerifyAlgorithmFamily getCsmMacVerifyAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_AES" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_BLAKE_1_256" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_256
						case "CRYPTO_ALGOFAM_BLAKE_1_512" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_512
						case "CRYPTO_ALGOFAM_BLAKE_2s_256" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_256
						case "CRYPTO_ALGOFAM_BLAKE_2s_512" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_512
						case "CRYPTO_ALGOFAM_RIPEMD160" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_RIPEMD160
						case "CRYPTO_ALGOFAM_SHA1" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA1
						case "CRYPTO_ALGOFAM_SHA2_224" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_224
						case "CRYPTO_ALGOFAM_SHA2_256" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_256
						case "CRYPTO_ALGOFAM_SHA2_384" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_384
						case "CRYPTO_ALGOFAM_SHA2_512" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512
						case "CRYPTO_ALGOFAM_SHA2_512_224" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_224
						case "CRYPTO_ALGOFAM_SHA2_512_256" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_256
						case "CRYPTO_ALGOFAM_SHA3_224" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_224
						case "CRYPTO_ALGOFAM_SHA3_256" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_256
						case "CRYPTO_ALGOFAM_SHA3_384" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_384
						case "CRYPTO_ALGOFAM_SHA3_512" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_512
						case "CRYPTO_ALGOFAM_SHA3_SHAKE128" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE128
						case "CRYPTO_ALGOFAM_SHA3_SHAKE256" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE256
						case "CRYPTO_ALGOFAM_SIPHASH" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOFAM_SIPHASH
						case "CRYPTO_ALGOMODE_CUSTOM" : CsmMacVerifyAlgorithmFamily.CRYPTO_ALGOMODE_CUSTOM
					}
				}
				
				def void setCsmMacVerifyAlgorithmFamilyValue(GParameterValue parameterValue, CsmMacVerifyAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def BigInteger getCsmMacVerifyAlgorithmKeyLength(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmKeyLength"].getBigIntegerValue()
				}
				
				def void setCsmMacVerifyAlgorithmKeyLength(BigInteger value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmKeyLength"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmMacVerifyAlgorithmKeyLength"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def CsmMacVerifyAlgorithmMode getCsmMacVerifyAlgorithmMode(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmMode"].getCsmMacVerifyAlgorithmModeValue()
				}
				
				def void setCsmMacVerifyAlgorithmMode(CsmMacVerifyAlgorithmMode value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmMode"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmMacVerifyAlgorithmMode"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmMacVerifyAlgorithmMode {
					CRYPTO_ALGOMODE_CMAC, 
					CRYPTO_ALGOMODE_CTRDRBG, 
					CRYPTO_ALGOMODE_CUSTOM, 
					CRYPTO_ALGOMODE_GMAC, 
				...
				def CsmMacVerifyAlgorithmMode getCsmMacVerifyAlgorithmModeValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOMODE_CMAC" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_CMAC
						case "CRYPTO_ALGOMODE_CTRDRBG" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_CTRDRBG
						case "CRYPTO_ALGOMODE_CUSTOM" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_CUSTOM
						case "CRYPTO_ALGOMODE_GMAC" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_GMAC
						case "CRYPTO_ALGOMODE_HMAC" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_HMAC
						case "CRYPTO_ALGOMODE_NOT_SET" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_NOT_SET
						case "CRYPTO_ALGOMODE_SIPHASH_2_4" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_SIPHASH_2_4
						case "CRYPTO_ALGOMODE_SIPHASH_4_8" : CsmMacVerifyAlgorithmMode.CRYPTO_ALGOMODE_SIPHASH_4_8
					}
				}
				
				def void setCsmMacVerifyAlgorithmModeValue(GParameterValue parameterValue, CsmMacVerifyAlgorithmMode value){
					parameterValue.setValue(value)
				}
				
				def String getCsmMacVerifyAlgorithmModeCustom(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmModeCustom"].getStringValue()
				}
				
				def void setCsmMacVerifyAlgorithmModeCustom(String value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmMacVerifyAlgorithmModeCustom"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmMacVerifyAlgorithmModeCustom"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
		...
		static class CsmRandomGenerate implements IWrapper<GContainer> {
			...
			static class CsmRandomGenerateConfig implements IWrapper<GContainer> {
				...
				def CsmRandomGenerateAlgorithmFamily getCsmRandomGenerateAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmRandomGenerateAlgorithmFamily"].getCsmRandomGenerateAlgorithmFamilyValue()
				}
				
				def void setCsmRandomGenerateAlgorithmFamily(CsmRandomGenerateAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmRandomGenerateAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmRandomGenerateAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmRandomGenerateAlgorithmFamily {
					CRYPTO_ALGOFAM_3DES, 
					CRYPTO_ALGOFAM_AES, 
					CRYPTO_ALGOFAM_BLAKE_1_256, 
					CRYPTO_ALGOFAM_BLAKE_1_512, 
				...
				def CsmRandomGenerateAlgorithmFamily getCsmRandomGenerateAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_3DES" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_3DES
						case "CRYPTO_ALGOFAM_AES" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_AES
						case "CRYPTO_ALGOFAM_BLAKE_1_256" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_256
						case "CRYPTO_ALGOFAM_BLAKE_1_512" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_1_512
						case "CRYPTO_ALGOFAM_BLAKE_2s_256" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_256
						case "CRYPTO_ALGOFAM_BLAKE_2s_512" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BLAKE_2s_512
						case "CRYPTO_ALGOFAM_CHACHA" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_CHACHA
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_RIPEMD160" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_RIPEMD160
						case "CRYPTO_ALGOFAM_RNG" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_RNG
						case "CRYPTO_ALGOFAM_SHA1" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA1
						case "CRYPTO_ALGOFAM_SHA2_224" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_224
						case "CRYPTO_ALGOFAM_SHA2_256" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_256
						case "CRYPTO_ALGOFAM_SHA2_384" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_384
						case "CRYPTO_ALGOFAM_SHA2_512" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512
						case "CRYPTO_ALGOFAM_SHA2_512_224" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_224
						case "CRYPTO_ALGOFAM_SHA2_512_256" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA2_512_256
						case "CRYPTO_ALGOFAM_SHA3_224" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_224
						case "CRYPTO_ALGOFAM_SHA3_256" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_256
						case "CRYPTO_ALGOFAM_SHA3_384" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_384
						case "CRYPTO_ALGOFAM_SHA3_512" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_512
						case "CRYPTO_ALGOFAM_SHA3_SHAKE128" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE128
						case "CRYPTO_ALGOFAM_SHA3_SHAKE256" : CsmRandomGenerateAlgorithmFamily.CRYPTO_ALGOFAM_SHA3_SHAKE256
					}
				}
				
				def void setCsmRandomGenerateAlgorithmFamilyValue(GParameterValue parameterValue, CsmRandomGenerateAlgorithmFamily value){
					parameterValue.setValue(value)
				}
		...
		static class CsmSecureCounter implements IWrapper<GContainer> {
			...
			static class CsmSecureCounterConfig implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue getCsmSecureCounterQueueRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue), "CsmSecureCounterQueueRef")
				}
				
				def void setCsmSecureCounterQueueRef(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CsmSignatureGenerate implements IWrapper<GContainer> {
			...
			static class CsmSignatureGenerateConfig implements IWrapper<GContainer> {
				...
				def CsmSignatureGenerateAlgorithmFamily getCsmSignatureGenerateAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmSignatureGenerateAlgorithmFamily"].getCsmSignatureGenerateAlgorithmFamilyValue()
				}
				
				def void setCsmSignatureGenerateAlgorithmFamily(CsmSignatureGenerateAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmSignatureGenerateAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmSignatureGenerateAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmSignatureGenerateAlgorithmFamily {
				...
				def CsmSignatureGenerateAlgorithmFamily getCsmSignatureGenerateAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_BRAINPOOL" : CsmSignatureGenerateAlgorithmFamily.CRYPTO_ALGOFAM_BRAINPOOL
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmSignatureGenerateAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_ECCNIST" : CsmSignatureGenerateAlgorithmFamily.CRYPTO_ALGOFAM_ECCNIST
						case "CRYPTO_ALGOFAM_ED25519" : CsmSignatureGenerateAlgorithmFamily.CRYPTO_ALGOFAM_ED25519
						case "CRYPTO_ALGOFAM_RSA" : CsmSignatureGenerateAlgorithmFamily.CRYPTO_ALGOFAM_RSA
					}
				}
				
				def void setCsmSignatureGenerateAlgorithmFamilyValue(GParameterValue parameterValue, CsmSignatureGenerateAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def CsmSignatureGenerateAlgorithmSecondaryFamily getCsmSignatureGenerateAlgorithmSecondaryFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_BLAKE_1_256" : CsmSignatureGenerateAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_1_256
						case "CRYPTO_ALGOFAM_BLAKE_1_512" : CsmSignatureGenerateAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_1_512
						case "CRYPTO_ALGOFAM_BLAKE_2s_256" : CsmSignatureGenerateAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_2s_256
						case "CRYPTO_ALGOFAM_BLAKE_2s_512" : CsmSignatureGenerateAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_2s_512
		...
		static class CsmSignatureVerify implements IWrapper<GContainer> {
			...
			static class CsmSignatureVerifyConfig implements IWrapper<GContainer> {
				...
				def CsmSignatureVerifyAlgorithmFamily getCsmSignatureVerifyAlgorithmFamily(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmSignatureVerifyAlgorithmFamily"].getCsmSignatureVerifyAlgorithmFamilyValue()
				}
				
				def void setCsmSignatureVerifyAlgorithmFamily(CsmSignatureVerifyAlgorithmFamily value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmSignatureVerifyAlgorithmFamily"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmSignatureVerifyAlgorithmFamily"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				enum CsmSignatureVerifyAlgorithmFamily {
					CRYPTO_ALGOFAM_BRAINPOOL, 
					CRYPTO_ALGOFAM_CUSTOM, 
					CRYPTO_ALGOFAM_ECCNIST, 
					CRYPTO_ALGOFAM_ED25519, 
				...
				def CsmSignatureVerifyAlgorithmFamily getCsmSignatureVerifyAlgorithmFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_BRAINPOOL" : CsmSignatureVerifyAlgorithmFamily.CRYPTO_ALGOFAM_BRAINPOOL
						case "CRYPTO_ALGOFAM_CUSTOM" : CsmSignatureVerifyAlgorithmFamily.CRYPTO_ALGOFAM_CUSTOM
						case "CRYPTO_ALGOFAM_ECCNIST" : CsmSignatureVerifyAlgorithmFamily.CRYPTO_ALGOFAM_ECCNIST
						case "CRYPTO_ALGOFAM_ED25519" : CsmSignatureVerifyAlgorithmFamily.CRYPTO_ALGOFAM_ED25519
						case "CRYPTO_ALGOFAM_RSA" : CsmSignatureVerifyAlgorithmFamily.CRYPTO_ALGOFAM_RSA
					}
				}
				
				def void setCsmSignatureVerifyAlgorithmFamilyValue(GParameterValue parameterValue, CsmSignatureVerifyAlgorithmFamily value){
					parameterValue.setValue(value)
				}
				...
				def CsmSignatureVerifyAlgorithmSecondaryFamily getCsmSignatureVerifyAlgorithmSecondaryFamilyValue(GParameterValue parameterValue){
					val castedParameterValue = parameterValue as EcucTextualParamValue
					switch (castedParameterValue.value){
						case "CRYPTO_ALGOFAM_BLAKE_1_256" : CsmSignatureVerifyAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_1_256
						case "CRYPTO_ALGOFAM_BLAKE_1_512" : CsmSignatureVerifyAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_1_512
						case "CRYPTO_ALGOFAM_BLAKE_2s_256" : CsmSignatureVerifyAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_2s_256
						case "CRYPTO_ALGOFAM_BLAKE_2s_512" : CsmSignatureVerifyAlgorithmSecondaryFamily.CRYPTO_ALGOFAM_BLAKE_2s_512
				...
				def BigInteger getCsmSignatureVerifyKeyLength(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmSignatureVerifyKeyLength"].getBigIntegerValue()
				}
				
				def void setCsmSignatureVerifyKeyLength(BigInteger value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CsmSignatureVerifyKeyLength"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CsmSignatureVerifyKeyLength"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
	...
	static class CsmQueues implements IWrapper<GContainer> {
		...
		def List<CsmQueue> getCsmQueues(){
			...
			return new BasicWrappingEList<CsmQueue, GContainer>(filteredContainers, typeof(CsmQueue), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue csmQueue) {
					csmQueue.target?.gSetDefinition(containerValue.getContainerDefinition("CsmQueue"))
					super.delegateAdd(csmQueue)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Csm.CsmQueues.CsmQueue csmQueue) {
					csmQueue.target?.gSetDefinition(containerValue.getContainerDefinition("CsmQueue"))
		...
		static class CsmQueue implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.CryIf.CryIfChannel getCsmChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.CryIf.CryIfChannel), "CsmChannelRef")
			}
			
			def void setCsmChannelRef(org.artop.ecuc.autosar444.accessors.CryIf.CryIfChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
