...
class Xcp implements IWrapper<GModuleConfiguration> {
	...
	static class XcpConfig implements IWrapper<GContainer> {
		...
		def List<XcpCommunicationChannel> getXcpCommunicationChannels(){
			val List<GContainer> filteredContainers = new AbstractFilteringEList<GContainer>(containerValue, getEContainingFeature(containerValue, GecucdescriptionPackage.eINSTANCE.getGContainer())) {
				override protected accept(GContainer item) {
					return accept(item, typeof(GContainerDef), "XcpCommunicationChannel")
				}
			}
			return new BasicWrappingEList<XcpCommunicationChannel, GContainer>(filteredContainers, typeof(XcpCommunicationChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpCommunicationChannel xcpCommunicationChannel) {
					xcpCommunicationChannel.target?.gSetDefinition(containerValue.getContainerDefinition("XcpCommunicationChannel"))
					super.delegateAdd(xcpCommunicationChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpCommunicationChannel xcpCommunicationChannel) {
					xcpCommunicationChannel.target?.gSetDefinition(containerValue.getContainerDefinition("XcpCommunicationChannel"))
					super.delegateAdd(index, xcpCommunicationChannel)
				}
			}
		}
		...
		def List<XcpDaqList> getXcpDaqLists(){
			...
			return new BasicWrappingEList<XcpDaqList, GContainer>(filteredContainers, typeof(XcpDaqList), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList xcpDaqList) {
					xcpDaqList.target?.gSetDefinition(containerValue.getContainerDefinition("XcpDaqList"))
					super.delegateAdd(xcpDaqList)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList xcpDaqList) {
					xcpDaqList.target?.gSetDefinition(containerValue.getContainerDefinition("XcpDaqList"))
		...
		def List<XcpEventChannel> getXcpEventChannels(){
			...
			return new BasicWrappingEList<XcpEventChannel, GContainer>(filteredContainers, typeof(XcpEventChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpEventChannel xcpEventChannel) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpEventChannel xcpEventChannel) {
					xcpEventChannel.target?.gSetDefinition(containerValue.getContainerDefinition("XcpEventChannel"))
		...
		def List<XcpPdu> getXcpPdus(){
			...
			return new BasicWrappingEList<XcpPdu, GContainer>(filteredContainers, typeof(XcpPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu xcpPdu) {
					xcpPdu.target?.gSetDefinition(containerValue.getContainerDefinition("XcpPdu"))
					super.delegateAdd(xcpPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu xcpPdu) {
					xcpPdu.target?.gSetDefinition(containerValue.getContainerDefinition("XcpPdu"))
		...
		static class XcpCommunicationChannel implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof XcpCommunicationChannel)){
					return false
				}
				this.target == (object as XcpCommunicationChannel).target
			}
		
			
			def org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu.XcpRxPdu getXcpChannelRxPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu.XcpRxPdu), "XcpChannelRxPduRef")
			}
			
			def void setXcpChannelRxPduRef(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu.XcpRxPdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "XcpChannelRxPduRef"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu.XcpTxPdu getXcpChannelTxPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu.XcpTxPdu), "XcpChannelTxPduRef")
			}
			
			def void setXcpChannelTxPduRef(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpPdu.XcpTxPdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "XcpChannelTxPduRef"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel getXcpComMChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel), "XcpComMChannelRef")
			}
			
			def void setXcpComMChannelRef(org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "XcpComMChannelRef"], object.getTarget())
				}
			}
		...
		static class XcpDaqList implements IWrapper<GContainer> {
			...
			def List<XcpDto> getXcpDtos(){
				...
				return new BasicWrappingEList<XcpDto, GContainer>(filteredContainers, typeof(XcpDto), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpDto xcpDto) {
						xcpDto.target?.gSetDefinition(containerValue.getContainerDefinition("XcpDto"))
						super.delegateAdd(xcpDto)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpDto xcpDto) {
						xcpDto.target?.gSetDefinition(containerValue.getContainerDefinition("XcpDto"))
			...
			def List<XcpOdt> getXcpOdts(){
				...
				return new BasicWrappingEList<XcpOdt, GContainer>(filteredContainers, typeof(XcpOdt), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpOdt xcpOdt) {
						xcpOdt.target?.gSetDefinition(containerValue.getContainerDefinition("XcpOdt"))
						super.delegateAdd(xcpOdt)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpOdt xcpOdt) {
						xcpOdt.target?.gSetDefinition(containerValue.getContainerDefinition("XcpOdt"))
			...
			static class XcpOdt implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpDto getXcpOdt2DtoMapping(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpDto), "XcpOdt2DtoMapping")
				}
				
				def void setXcpOdt2DtoMapping(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpDto object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<XcpOdtEntry> getXcpOdtEntries(){
					...
					return new BasicWrappingEList<XcpOdtEntry, GContainer>(filteredContainers, typeof(XcpOdtEntry), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpOdt.XcpOdtEntry xcpOdtEntry) {
							xcpOdtEntry.target?.gSetDefinition(containerValue.getContainerDefinition("XcpOdtEntry"))
							super.delegateAdd(xcpOdtEntry)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList.XcpOdt.XcpOdtEntry xcpOdtEntry) {
							xcpOdtEntry.target?.gSetDefinition(containerValue.getContainerDefinition("XcpOdtEntry"))
		...
		static class XcpEventChannel implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList> getXcpEventChannelTriggeredDaqListRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList)) {
					override protected wrap(org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar444.accessors.Xcp.XcpConfig.XcpDaqList(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class XcpPdu implements IWrapper<GContainer> {
			...
			static class XcpRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getXcpRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "XcpRxPduRef")
				}
				
				def void setXcpRxPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class XcpTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getXcpTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "XcpTxPduRef")
				}
				
				def void setXcpTxPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class XcpGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.Os.OsCounter getXcpCounterRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Os.OsCounter), "XcpCounterRef")
		}
		
		def void setXcpCounterRef(org.artop.ecuc.autosar444.accessors.Os.OsCounter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor getXcpNvRamBlockIdRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor), "XcpNvRamBlockIdRef")
		}
		
		def void setXcpNvRamBlockIdRef(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
