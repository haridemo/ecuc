...
class EthTrcv implements IWrapper<GModuleConfiguration> {
	...
	static class EthTrcvConfigSet implements IWrapper<GContainer> {
		...
		def List<EthTrcvConfig> getEthTrcvConfigs(){
			...
			return new BasicWrappingEList<EthTrcvConfig, GContainer>(filteredContainers, typeof(EthTrcvConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig ethTrcvConfig) {
					ethTrcvConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthTrcvConfig"))
					super.delegateAdd(ethTrcvConfig)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig ethTrcvConfig) {
					ethTrcvConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthTrcvConfig"))
		...
		static class EthTrcvConfig implements IWrapper<GContainer> {
			...
			def EthTrcvPhysLayerType getEthTrcvPhysLayerTypeValue(GParameterValue parameterValue){
				val castedParameterValue = parameterValue as EcucTextualParamValue
				switch (castedParameterValue.value){
					case "TRCV_PHYS_LAYER_TYPE_1000BASE_T" : EthTrcvPhysLayerType.TRCV_PHYS_LAYER_TYPE_1000BASE_T
					case "TRCV_PHYS_LAYER_TYPE_1000BASE_T1" : EthTrcvPhysLayerType.TRCV_PHYS_LAYER_TYPE_1000BASE_T1
					case "TRCV_PHYS_LAYER_TYPE_100BASE_T1" : EthTrcvPhysLayerType.TRCV_PHYS_LAYER_TYPE_100BASE_T1
					case "TRCV_PHYS_LAYER_TYPE_100BASE_TX" : EthTrcvPhysLayerType.TRCV_PHYS_LAYER_TYPE_100BASE_TX
				}
			}
			...
			def EthTrcvPortMacLayerSpeed getEthTrcvPortMacLayerSpeed(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvPortMacLayerSpeed"].getEthTrcvPortMacLayerSpeedValue()
			}
			
			def void setEthTrcvPortMacLayerSpeed(EthTrcvPortMacLayerSpeed value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvPortMacLayerSpeed"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvPortMacLayerSpeed"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def EthTrcvPortMacLayerSpeed getEthTrcvPortMacLayerSpeedValue(GParameterValue parameterValue){
				val castedParameterValue = parameterValue as EcucTextualParamValue
				switch (castedParameterValue.value){
					case "ETH_MAC_LAYER_SPEED_100M" : EthTrcvPortMacLayerSpeed.ETH_MAC_LAYER_SPEED_100M
					case "ETH_MAC_LAYER_SPEED_10G" : EthTrcvPortMacLayerSpeed.ETH_MAC_LAYER_SPEED_10G
					case "ETH_MAC_LAYER_SPEED_10M" : EthTrcvPortMacLayerSpeed.ETH_MAC_LAYER_SPEED_10M
					case "ETH_MAC_LAYER_SPEED_1G" : EthTrcvPortMacLayerSpeed.ETH_MAC_LAYER_SPEED_1G
				}
			}
			
			def void setEthTrcvPortMacLayerSpeedValue(GParameterValue parameterValue, EthTrcvPortMacLayerSpeed value){
				parameterValue.setValue(value)
			}
			
			def EthTrcvPortMacLayerSubType getEthTrcvPortMacLayerSubType(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvPortMacLayerSubType"].getEthTrcvPortMacLayerSubTypeValue()
			}
			
			def void setEthTrcvPortMacLayerSubType(EthTrcvPortMacLayerSubType value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvPortMacLayerSubType"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvPortMacLayerSubType"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			enum EthTrcvPortMacLayerSubType {
				REDUCED, 
				REVERSED, 
				SERIAL, 
				STANDARD, 
			...
			def EthTrcvPortMacLayerSubType getEthTrcvPortMacLayerSubTypeValue(GParameterValue parameterValue){
				val castedParameterValue = parameterValue as EcucTextualParamValue
				switch (castedParameterValue.value){
					case "REDUCED" : EthTrcvPortMacLayerSubType.REDUCED
					case "REVERSED" : EthTrcvPortMacLayerSubType.REVERSED
					case "SERIAL" : EthTrcvPortMacLayerSubType.SERIAL
					case "STANDARD" : EthTrcvPortMacLayerSubType.STANDARD
					case "UNIVERSAL_SERIAL" : EthTrcvPortMacLayerSubType.UNIVERSAL_SERIAL
				}
			}
			
			def void setEthTrcvPortMacLayerSubTypeValue(GParameterValue parameterValue, EthTrcvPortMacLayerSubType value){
				parameterValue.setValue(value)
			}
			
			def EthTrcvPortMacLayerType getEthTrcvPortMacLayerType(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvPortMacLayerType"].getEthTrcvPortMacLayerTypeValue()
			}
			
			def void setEthTrcvPortMacLayerType(EthTrcvPortMacLayerType value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvPortMacLayerType"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvPortMacLayerType"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			enum EthTrcvPortMacLayerType {
				TRCV_MAC_LAYER_TYPE_XGMII, 
				TRCV_MAC_LAYER_TYPE_XMII, 
				TRCV_MAC_LAYER_TYPE_XXGMII
			}
			
			def EthTrcvPortMacLayerType getEthTrcvPortMacLayerTypeValue(GParameterValue parameterValue){
				val castedParameterValue = parameterValue as EcucTextualParamValue
				switch (castedParameterValue.value){
					case "TRCV_MAC_LAYER_TYPE_XGMII" : EthTrcvPortMacLayerType.TRCV_MAC_LAYER_TYPE_XGMII
					case "TRCV_MAC_LAYER_TYPE_XMII" : EthTrcvPortMacLayerType.TRCV_MAC_LAYER_TYPE_XMII
					case "TRCV_MAC_LAYER_TYPE_XXGMII" : EthTrcvPortMacLayerType.TRCV_MAC_LAYER_TYPE_XXGMII
				}
			}
			
			def void setEthTrcvPortMacLayerTypeValue(GParameterValue parameterValue, EthTrcvPortMacLayerType value){
				parameterValue.setValue(value)
			}
			...
			def org.artop.ecuc.autosar444.accessors.Icu.IcuConfigSet.IcuChannel getEthTrcvIcuChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Icu.IcuConfigSet.IcuChannel), "EthTrcvIcuChannelRef")
			}
			
			def void setEthTrcvIcuChannelRef(org.artop.ecuc.autosar444.accessors.Icu.IcuConfigSet.IcuChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def EthTrcvMgmtInterface getEthTrcvMgmtInterface(){
				containerValue.getByType(typeof(EthTrcvMgmtInterface))
			}
			
			def void setEthTrcvMgmtInterface(EthTrcvMgmtInterface ethTrcvMgmtInterface){
				val GContainer subContainer = ethTrcvMgmtInterface.getTarget()
				containerValue.setContainer(subContainer, "EthTrcvMgmtInterface")
			}
			...
			def List<EthTrcvWakeupMap> getEthTrcvWakeupMaps(){
				...
				return new BasicWrappingEList<EthTrcvWakeupMap, GContainer>(filteredContainers, typeof(EthTrcvWakeupMap), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig.EthTrcvWakeupMap ethTrcvWakeupMap) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig.EthTrcvWakeupMap ethTrcvWakeupMap) {
						ethTrcvWakeupMap.target?.gSetDefinition(containerValue.getContainerDefinition("EthTrcvWakeupMap"))
			...
			static class EthTrcvDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getETHTRCV_E_ACCESS(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "ETHTRCV_E_ACCESS")
				}
				
				def void setETHTRCV_E_ACCESS(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EthTrcvMgmtInterface implements IWrapper<GContainer> {
				private GContainer containerValue
				...
				override def boolean equals(Object object) {
			        if (!(object instanceof EthTrcvMgmtInterface)){
						return false
					}
					this.target == (object as EthTrcvMgmtInterface).target
				}
			
				def EthTrcvMiiInterface getEthTrcvMiiInterface(){
					containerValue.getByType(typeof(EthTrcvMiiInterface))
				}
				
				def void setEthTrcvMiiInterface(EthTrcvMiiInterface ethTrcvMiiInterface){
					val GContainer subContainer = ethTrcvMiiInterface.getTarget()
					containerValue.setContainer(subContainer, "EthTrcvMiiInterface")
				}
				def EthTrcvSwitchInterface getEthTrcvSwitchInterface(){
					containerValue.getByType(typeof(EthTrcvSwitchInterface))
				}
				
				def void setEthTrcvSwitchInterface(EthTrcvSwitchInterface ethTrcvSwitchInterface){
					val GContainer subContainer = ethTrcvSwitchInterface.getTarget()
					containerValue.setContainer(subContainer, "EthTrcvSwitchInterface")
				}
				
				static class EthTrcvMiiInterface implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof EthTrcvMiiInterface)){
							return false
						}
						this.target == (object as EthTrcvMiiInterface).target
					}
					...
					def EthTrcvMiiSelection getEthTrcvMiiSelection(){
						containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvMiiSelection"].getEthTrcvMiiSelectionValue()
					}
					
					def void setEthTrcvMiiSelection(EthTrcvMiiSelection value){
						var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvMiiSelection"]
						if (parameterValue === null) {
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
								parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvMiiSelection"].createParameterValue()
								containerValue.gGetParameterValues += parameterValue
							}
						}
						parameterValue.setValue(value)
					...
					enum EthTrcvMiiSelection {
						LIGHT_MII, 
						MII, 
						RGMII
					}
					
					def EthTrcvMiiSelection getEthTrcvMiiSelectionValue(GParameterValue parameterValue){
						val castedParameterValue = parameterValue as EcucTextualParamValue
						switch (castedParameterValue.value){
							case "LIGHT_MII" : EthTrcvMiiSelection.LIGHT_MII
							case "MII" : EthTrcvMiiSelection.MII
							case "RGMII" : EthTrcvMiiSelection.RGMII
						}
					}
					
					def void setEthTrcvMiiSelectionValue(GParameterValue parameterValue, EthTrcvMiiSelection value){
						parameterValue.setValue(value)
					}
				...
				static class EthTrcvSwitchInterface implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof EthTrcvSwitchInterface)){
							return false
						}
						this.target == (object as EthTrcvSwitchInterface).target
					}
				
					
					def org.artop.ecuc.autosar444.accessors.EthSwt.EthSwtConfig.EthSwtPort getEthTrcvSwitchPortRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EthSwt.EthSwtConfig.EthSwtPort), "EthTrcvSwitchPortRef")
					}
					
					def void setEthTrcvSwitchPortRef(org.artop.ecuc.autosar444.accessors.EthSwt.EthSwtConfig.EthSwtPort object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "EthTrcvSwitchPortRef"], object.getTarget())
						}
					}
					
					def org.artop.ecuc.autosar444.accessors.EthSwt.EthSwtConfig getEthTrcvSwitchRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EthSwt.EthSwtConfig), "EthTrcvSwitchRef")
					}
					
					def void setEthTrcvSwitchRef(org.artop.ecuc.autosar444.accessors.EthSwt.EthSwtConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "EthTrcvSwitchRef"], object.getTarget())
						}
					}
			...
			static class EthTrcvWakeupMap implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getEthTrcvWakeupSourceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "EthTrcvWakeupSourceRef")
				}
				
				def void setEthTrcvWakeupSourceRef(org.artop.ecuc.autosar444.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class EthTrcvGeneral implements IWrapper<GContainer> {
		...
		def Boolean getEthTrcvGetCableDiagnosticsResultApi(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvGetCableDiagnosticsResultApi"].getBooleanValue()
		}
		
		def void setEthTrcvGetCableDiagnosticsResultApi(Boolean value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvGetCableDiagnosticsResultApi"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvGetCableDiagnosticsResultApi"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		def Boolean getEthTrcvGetPhyIdentifierApi(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvGetPhyIdentifierApi"].getBooleanValue()
		}
		
		def void setEthTrcvGetPhyIdentifierApi(Boolean value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvGetPhyIdentifierApi"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvGetPhyIdentifierApi"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		def Boolean getEthTrcvGetPhySignalQualityApi(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvGetPhySignalQualityApi"].getBooleanValue()
		}
		
		def void setEthTrcvGetPhySignalQualityApi(Boolean value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvGetPhySignalQualityApi"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvGetPhySignalQualityApi"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		def Boolean getEthTrcvSetPhyTestModeApi(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvSetPhyTestModeApi"].getBooleanValue()
		}
		
		def void setEthTrcvSetPhyTestModeApi(Boolean value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvSetPhyTestModeApi"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvSetPhyTestModeApi"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		def Boolean getEthTrcvSetPhyTxModeApi(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvSetPhyTxModeApi"].getBooleanValue()
		}
		
		def void setEthTrcvSetPhyTxModeApi(Boolean value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EthTrcvSetPhyTxModeApi"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EthTrcvSetPhyTxModeApi"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
