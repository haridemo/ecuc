...
class Cdd implements IWrapper<GModuleConfiguration> {
	...
	def CddGeneral getCddGeneral(){
		moduleConfiguration.getByType(typeof(CddGeneral))
	}

	def void setCddGeneral(CddGeneral cddGeneral){
		val GContainer container = cddGeneral.getTarget()
	    moduleConfiguration.setContainer(container, "CddGeneral")
	}
	def CddGlobalTimeContribution getCddGlobalTimeContribution(){
		moduleConfiguration.getByType(typeof(CddGlobalTimeContribution))
	}

	def void setCddGlobalTimeContribution(CddGlobalTimeContribution cddGlobalTimeContribution){
		val GContainer container = cddGlobalTimeContribution.getTarget()
	    moduleConfiguration.setContainer(container, "CddGlobalTimeContribution")
	}
	...
	static class CddComStackContribution implements IWrapper<GContainer> {
		...
		def CddJ1939RmContribution getCddJ1939RmContribution(){
			containerValue.getByType(typeof(CddJ1939RmContribution))
		}
		
		def void setCddJ1939RmContribution(CddJ1939RmContribution cddJ1939RmContribution){
			val GContainer subContainer = cddJ1939RmContribution.getTarget()
			containerValue.setContainer(subContainer, "CddJ1939RmContribution")
		}
		...
		static class CddComIfUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddComIfUpperLayerRxPdu> getCddComIfUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddComIfUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
						cddComIfUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerRxPdu"))
			...
			def List<CddComIfUpperLayerTxPdu> getCddComIfUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddComIfUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
						cddComIfUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerTxPdu"))
			...
			static class CddComIfUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddComIfPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddComIfPduRef")
				}
				
				def void setCddComIfPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddComMLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddComMLowerLayerChannel> getCddComMLowerLayerChannels(){
				...
				return new BasicWrappingEList<CddComMLowerLayerChannel, GContainer>(filteredContainers, typeof(CddComMLowerLayerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
						cddComMLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddComMLowerLayerChannel"))
			...
			static class CddComMLowerLayerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel getCddComMLowerLayerChannelRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel), "CddComMLowerLayerChannelRef")
				}
				
				def void setCddComMLowerLayerChannelRef(org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddGenericNmLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddGenericNmLowerLayerChannel> getCddGenericNmLowerLayerChannels(){
				...
				return new BasicWrappingEList<CddGenericNmLowerLayerChannel, GContainer>(filteredContainers, typeof(CddGenericNmLowerLayerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
						cddGenericNmLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddGenericNmLowerLayerChannel"))
			...
			static class CddGenericNmLowerLayerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel getCddGenericNmComMNetworkHandleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel), "CddGenericNmComMNetworkHandleRef")
				}
				
				def void setCddGenericNmComMNetworkHandleRef(org.artop.ecuc.autosar444.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddJ1939RmContribution implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof CddJ1939RmContribution)){
					return false
				}
				this.target == (object as CddJ1939RmContribution).target
			}
		
			def Boolean getCddJ1939RmAckIndication(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddJ1939RmAckIndication"].getBooleanValue()
			}
			
			def void setCddJ1939RmAckIndication(Boolean value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddJ1939RmAckIndication"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CddJ1939RmAckIndication"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
			...
			def Boolean getCddJ1939RmRequestIndication(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddJ1939RmRequestIndication"].getBooleanValue()
			}
			
			def void setCddJ1939RmRequestIndication(Boolean value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddJ1939RmRequestIndication"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CddJ1939RmRequestIndication"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(getBooleanParameterValueValue(value, true))
			...
			def Boolean getCddJ1939RmRequestTimeoutIndication(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddJ1939RmRequestTimeoutIndication"].getBooleanValue()
			}
			
			def void setCddJ1939RmRequestTimeoutIndication(Boolean value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddJ1939RmRequestTimeoutIndication"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CddJ1939RmRequestTimeoutIndication"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		static class CddPduRLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddPduRLowerLayerRxPdu> getCddPduRLowerLayerRxPdus(){
				...
				return new BasicWrappingEList<CddPduRLowerLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
						cddPduRLowerLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerRxPdu"))
			...
			def List<CddPduRLowerLayerTxPdu> getCddPduRLowerLayerTxPdus(){
				...
				return new BasicWrappingEList<CddPduRLowerLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
						cddPduRLowerLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerTxPdu"))
			...
			static class CddPduRLowerLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddPduRLowerLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddPduRLowerLayerPduRef")
				}
				
				def void setCddPduRLowerLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddPduRUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddPduRUpperLayerRxPdu> getCddPduRUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddPduRUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
						cddPduRUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerRxPdu"))
			...
			def List<CddPduRUpperLayerTxPdu> getCddPduRUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddPduRUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
						cddPduRUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerTxPdu"))
			...
			static class CddPduRUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddPduRUpperLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddPduRUpperLayerPduRef")
				}
				
				def void setCddPduRUpperLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddSoAdUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddSoAdUpperLayerRxPdu> getCddSoAdUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddSoAdUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
						cddSoAdUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerRxPdu"))
			...
			def List<CddSoAdUpperLayerTxPdu> getCddSoAdUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddSoAdUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
						cddSoAdUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerTxPdu"))
			...
			static class CddSoAdUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddSoAdUpperLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddSoAdUpperLayerPduRef")
				}
				
				def void setCddSoAdUpperLayerPduRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CddEcucPartitionInteraction implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.EcuC.EcucPartitionCollection.EcucPartition getCddEcucPartitionRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.EcuC.EcucPartitionCollection.EcucPartition), "CddEcucPartitionRef")
		}
		
		def void setCddEcucPartitionRef(org.artop.ecuc.autosar444.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CddGeneral implements IWrapper<GContainer> {
		private GContainer containerValue
		...
		override def boolean equals(Object object) {
	        if (!(object instanceof CddGeneral)){
				return false
			}
			this.target == (object as CddGeneral).target
		}
	
		def BigInteger getCddInstanceId(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddInstanceId"].getBigIntegerValue()
		}
		
		def void setCddInstanceId(BigInteger value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddInstanceId"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CddInstanceId"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(value)
	...
	static class CddGlobalTimeContribution implements IWrapper<GContainer> {
		private GContainer containerValue
		...
		override def boolean equals(Object object) {
	        if (!(object instanceof CddGlobalTimeContribution)){
				return false
			}
			this.target == (object as CddGlobalTimeContribution).target
		}
	
		
		
		def List<CddGlobalTimeDomain> getCddGlobalTimeDomains(){
			val List<GContainer> filteredContainers = new AbstractFilteringEList<GContainer>(containerValue, getEContainingFeature(containerValue, GecucdescriptionPackage.eINSTANCE.getGContainer())) {
				override protected accept(GContainer item) {
					return accept(item, typeof(GContainerDef), "CddGlobalTimeDomain")
				}
			}
			return new BasicWrappingEList<CddGlobalTimeDomain, GContainer>(filteredContainers, typeof(CddGlobalTimeDomain), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Cdd.CddGlobalTimeContribution.CddGlobalTimeDomain cddGlobalTimeDomain) {
					cddGlobalTimeDomain.target?.gSetDefinition(containerValue.getContainerDefinition("CddGlobalTimeDomain"))
					super.delegateAdd(cddGlobalTimeDomain)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Cdd.CddGlobalTimeContribution.CddGlobalTimeDomain cddGlobalTimeDomain) {
					cddGlobalTimeDomain.target?.gSetDefinition(containerValue.getContainerDefinition("CddGlobalTimeDomain"))
					super.delegateAdd(index, cddGlobalTimeDomain)
				}
			}
		}
		
		
		static class CddGlobalTimeDomain implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof CddGlobalTimeDomain)){
					return false
				}
				this.target == (object as CddGlobalTimeDomain).target
			}
		
			def BigInteger getCddGlobalTimeDomainId(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddGlobalTimeDomainId"].getBigIntegerValue()
			}
			
			def void setCddGlobalTimeDomainId(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddGlobalTimeDomainId"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CddGlobalTimeDomainId"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def org.artop.ecuc.autosar444.accessors.StbM.StbMSynchronizedTimeBase getCddSynSynchronizedTimeBaseRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.StbM.StbMSynchronizedTimeBase), "CddSynSynchronizedTimeBaseRef")
			}
			
			def void setCddSynSynchronizedTimeBaseRef(org.artop.ecuc.autosar444.accessors.StbM.StbMSynchronizedTimeBase object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "CddSynSynchronizedTimeBaseRef"], object.getTarget())
				}
			}
			
			
			def CddGlobalTimeMaster getCddGlobalTimeMaster(){
				containerValue.getByType(typeof(CddGlobalTimeMaster))
			}
			
			def void setCddGlobalTimeMaster(CddGlobalTimeMaster cddGlobalTimeMaster){
				val GContainer subContainer = cddGlobalTimeMaster.getTarget()
				containerValue.setContainer(subContainer, "CddGlobalTimeMaster")
			}
			
			def CddGlobalTimeSlave getCddGlobalTimeSlave(){
				containerValue.getByType(typeof(CddGlobalTimeSlave))
			}
			
			def void setCddGlobalTimeSlave(CddGlobalTimeSlave cddGlobalTimeSlave){
				val GContainer subContainer = cddGlobalTimeSlave.getTarget()
				containerValue.setContainer(subContainer, "CddGlobalTimeSlave")
			}
			
			
			static class CddGlobalTimeMaster implements IWrapper<GContainer> {
				private GContainer containerValue
				...
				override def boolean equals(Object object) {
			        if (!(object instanceof CddGlobalTimeMaster)){
						return false
					}
					this.target == (object as CddGlobalTimeMaster).target
				}
			
				def BigDecimal getCddGlobalTimeTxPeriod(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddGlobalTimeTxPeriod"].getBigDecimalValue()
				}
				
				def void setCddGlobalTimeTxPeriod(BigDecimal value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CddGlobalTimeTxPeriod"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CddGlobalTimeTxPeriod"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def CddGlobalTimeMasterPdu getCddGlobalTimeMasterPdu(){
					containerValue.getByType(typeof(CddGlobalTimeMasterPdu))
				}
				
				def void setCddGlobalTimeMasterPdu(CddGlobalTimeMasterPdu cddGlobalTimeMasterPdu){
					val GContainer subContainer = cddGlobalTimeMasterPdu.getTarget()
					containerValue.setContainer(subContainer, "CddGlobalTimeMasterPdu")
				}
				
				
				static class CddGlobalTimeMasterPdu implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof CddGlobalTimeMasterPdu)){
							return false
						}
						this.target == (object as CddGlobalTimeMasterPdu).target
					}
				
					
					def org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu getCddGlobalTimeMasterPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu), "CddGlobalTimeMasterPduRef")
					}
					
					def void setCddGlobalTimeMasterPduRef(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "CddGlobalTimeMasterPduRef"], object.getTarget())
						}
					}
			...
			static class CddGlobalTimeSlave implements IWrapper<GContainer> {
				private GContainer containerValue
				...
				override def boolean equals(Object object) {
			        if (!(object instanceof CddGlobalTimeSlave)){
						return false
					}
					this.target == (object as CddGlobalTimeSlave).target
				}
			
				
				
				def CddGlobalTimeSlavePdu getCddGlobalTimeSlavePdu(){
					containerValue.getByType(typeof(CddGlobalTimeSlavePdu))
				}
				
				def void setCddGlobalTimeSlavePdu(CddGlobalTimeSlavePdu cddGlobalTimeSlavePdu){
					val GContainer subContainer = cddGlobalTimeSlavePdu.getTarget()
					containerValue.setContainer(subContainer, "CddGlobalTimeSlavePdu")
				}
				
				
				static class CddGlobalTimeSlavePdu implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof CddGlobalTimeSlavePdu)){
							return false
						}
						this.target == (object as CddGlobalTimeSlavePdu).target
					}
				
					
					def org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu getCddGlobalTimeSlavePduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu), "CddGlobalTimeSlavePduRef")
					}
					
					def void setCddGlobalTimeSlavePduRef(org.artop.ecuc.autosar444.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "CddGlobalTimeSlavePduRef"], object.getTarget())
						}
					}
