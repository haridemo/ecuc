...
class NvM implements IWrapper<GModuleConfiguration> {
	...
	def List<NvMBlockDescriptor> getNvMBlockDescriptors(){
		...
		return new BasicWrappingEList<NvMBlockDescriptor, GContainer>(filteredContainers, typeof(NvMBlockDescriptor), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor nvMBlockDescriptor) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.NvM.NvMBlockDescriptor nvMBlockDescriptor) {
				nvMBlockDescriptor.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("NvMBlockDescriptor"))
	...
	static class NvMBlockDescriptor implements IWrapper<GContainer> {
		...
		static class NvMTargetBlockReference implements IWrapper<GContainer> {
			...
			static class NvMEaRef implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Ea.EaBlockConfiguration getNvMNameOfEaBlock(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Ea.EaBlockConfiguration), "NvMNameOfEaBlock")
				}
				
				def void setNvMNameOfEaBlock(org.artop.ecuc.autosar444.accessors.Ea.EaBlockConfiguration object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class NvMFeeRef implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Fee.FeeBlockConfiguration getNvMNameOfFeeBlock(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Fee.FeeBlockConfiguration), "NvMNameOfFeeBlock")
				}
				
				def void setNvMNameOfFeeBlock(org.artop.ecuc.autosar444.accessors.Fee.FeeBlockConfiguration object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class NvmDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_HARDWARE(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_HARDWARE")
		}
		
		def void setNVM_E_HARDWARE(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_INTEGRITY_FAILED(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_INTEGRITY_FAILED")
		}
		
		def void setNVM_E_INTEGRITY_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_LOSS_OF_REDUNDANCY(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_LOSS_OF_REDUNDANCY")
		}
		
		def void setNVM_E_LOSS_OF_REDUNDANCY(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_REQ_FAILED(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_REQ_FAILED")
		}
		
		def void setNVM_E_REQ_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_VERIFY_FAILED(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_VERIFY_FAILED")
		}
		
		def void setNVM_E_VERIFY_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_WRITE_PROTECTED(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_WRITE_PROTECTED")
		}
		
		def void setNVM_E_WRITE_PROTECTED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getNVM_E_WRONG_BLOCK_ID(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "NVM_E_WRONG_BLOCK_ID")
		}
		
		def void setNVM_E_WRONG_BLOCK_ID(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
