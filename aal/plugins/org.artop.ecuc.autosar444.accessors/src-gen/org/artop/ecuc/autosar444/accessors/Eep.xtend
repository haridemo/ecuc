...
class Eep implements IWrapper<GModuleConfiguration> {
	...
	static class EepInitConfiguration implements IWrapper<GContainer> {
		...
		static class EepDemEventParameterRefs implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getEEP_E_COMPARE_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "EEP_E_COMPARE_FAILED")
			}
			
			def void setEEP_E_COMPARE_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getEEP_E_ERASE_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "EEP_E_ERASE_FAILED")
			}
			
			def void setEEP_E_ERASE_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getEEP_E_READ_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "EEP_E_READ_FAILED")
			}
			
			def void setEEP_E_READ_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getEEP_E_WRITE_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "EEP_E_WRITE_FAILED")
			}
			
			def void setEEP_E_WRITE_FAILED(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EepExternalDriver implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar444.accessors.Spi.SpiDriver.SpiSequence> getEepSpiReferences(){
				val containerDef = containerValue.gGetDefinition
