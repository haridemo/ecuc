...
class WEthTrcv implements IWrapper<GModuleConfiguration> {
	...
	def List<WEthTrcvRadioConfigSet> getWEthTrcvRadioConfigSets(){
		...
		return new BasicWrappingEList<WEthTrcvRadioConfigSet, GContainer>(filteredContainers, typeof(WEthTrcvRadioConfigSet), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet wEthTrcvRadioConfigSet) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet wEthTrcvRadioConfigSet) {
				wEthTrcvRadioConfigSet.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("WEthTrcvRadioConfigSet"))
	...
	static class WEthTrcvAntennaConfigSet implements IWrapper<GContainer> {
		...
		def List<WEthTrcvAntennaConfig> getWEthTrcvAntennaConfigs(){
			...
			return new BasicWrappingEList<WEthTrcvAntennaConfig, GContainer>(filteredContainers, typeof(WEthTrcvAntennaConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig wEthTrcvAntennaConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig wEthTrcvAntennaConfig) {
					wEthTrcvAntennaConfig.target?.gSetDefinition(containerValue.getContainerDefinition("WEthTrcvAntennaConfig"))
	...
	static class WEthTrcvConfigSet implements IWrapper<GContainer> {
		...
		def List<WEthTrcvConfig> getWEthTrcvConfigs(){
			...
			return new BasicWrappingEList<WEthTrcvConfig, GContainer>(filteredContainers, typeof(WEthTrcvConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvConfigSet.WEthTrcvConfig wEthTrcvConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvConfigSet.WEthTrcvConfig wEthTrcvConfig) {
					wEthTrcvConfig.target?.gSetDefinition(containerValue.getContainerDefinition("WEthTrcvConfig"))
		...
		static class WEthTrcvConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.WEth.WEthConfigSet.WEthCtrlConfig getWEthTrcvCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.WEth.WEthConfigSet.WEthCtrlConfig), "WEthTrcvCtrlRef")
			}
			
			def void setWEthTrcvCtrlRef(org.artop.ecuc.autosar444.accessors.WEth.WEthConfigSet.WEthCtrlConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet getWEthTrcvRadioConfigSetRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet), "WEthTrcvRadioConfigSetRef")
			}
			
			def void setWEthTrcvRadioConfigSetRef(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class WEthTrcvDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getWETHTRCV_E_ACCESS(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "WETHTRCV_E_ACCESS")
				}
				
				def void setWETHTRCV_E_ACCESS(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class WEthTrcvRadioConfigSet implements IWrapper<GContainer> {
		...
		def List<WEthTrcvRadioConfig> getWEthTrcvRadioConfigs(){
			...
			return new BasicWrappingEList<WEthTrcvRadioConfig, GContainer>(filteredContainers, typeof(WEthTrcvRadioConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet.WEthTrcvRadioConfig wEthTrcvRadioConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet.WEthTrcvRadioConfig wEthTrcvRadioConfig) {
					wEthTrcvRadioConfig.target?.gSetDefinition(containerValue.getContainerDefinition("WEthTrcvRadioConfig"))
		...
		static class WEthTrcvRadioConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig getWEthTrcvRadioChannelRxAntenna(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig), "WEthTrcvRadioChannelRxAntenna")
			}
			
			def void setWEthTrcvRadioChannelRxAntenna(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig getWEthTrcvRadioChannelTxAntenna(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig), "WEthTrcvRadioChannelTxAntenna")
			}
			
			def void setWEthTrcvRadioChannelTxAntenna(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvAntennaConfigSet.WEthTrcvAntennaConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<WEthTrcvRadioChannelTxQueueConfig> getWEthTrcvRadioChannelTxQueueConfigs(){
				...
				return new BasicWrappingEList<WEthTrcvRadioChannelTxQueueConfig, GContainer>(filteredContainers, typeof(WEthTrcvRadioChannelTxQueueConfig), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet.WEthTrcvRadioConfig.WEthTrcvRadioChannelTxQueueConfig wEthTrcvRadioChannelTxQueueConfig) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.WEthTrcv.WEthTrcvRadioConfigSet.WEthTrcvRadioConfig.WEthTrcvRadioChannelTxQueueConfig wEthTrcvRadioChannelTxQueueConfig) {
						wEthTrcvRadioChannelTxQueueConfig.target?.gSetDefinition(containerValue.getContainerDefinition("WEthTrcvRadioChannelTxQueueConfig"))
