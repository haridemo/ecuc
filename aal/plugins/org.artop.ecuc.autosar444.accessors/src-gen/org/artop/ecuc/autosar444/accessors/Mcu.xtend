	...
	static class McuModuleConfiguration implements IWrapper<GContainer> {
		...
		def List<McuClockSettingConfig> getMcuClockSettingConfigs(){
			...
			return new BasicWrappingEList<McuClockSettingConfig, GContainer>(filteredContainers, typeof(McuClockSettingConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig mcuClockSettingConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig mcuClockSettingConfig) {
					mcuClockSettingConfig.target?.gSetDefinition(containerValue.getContainerDefinition("McuClockSettingConfig"))
		...
		def List<McuModeSettingConf> getMcuModeSettingConfs(){
			...
			return new BasicWrappingEList<McuModeSettingConf, GContainer>(filteredContainers, typeof(McuModeSettingConf), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf mcuModeSettingConf) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf mcuModeSettingConf) {
					mcuModeSettingConf.target?.gSetDefinition(containerValue.getContainerDefinition("McuModeSettingConf"))
		...
		def List<McuRamSectorSettingConf> getMcuRamSectorSettingConfs(){
			...
			return new BasicWrappingEList<McuRamSectorSettingConf, GContainer>(filteredContainers, typeof(McuRamSectorSettingConf), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuRamSectorSettingConf mcuRamSectorSettingConf) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuRamSectorSettingConf mcuRamSectorSettingConf) {
					mcuRamSectorSettingConf.target?.gSetDefinition(containerValue.getContainerDefinition("McuRamSectorSettingConf"))
		...
		static class McuClockSettingConfig implements IWrapper<GContainer> {
			...
			def List<McuClockReferencePoint> getMcuClockReferencePoints(){
				...
				return new BasicWrappingEList<McuClockReferencePoint, GContainer>(filteredContainers, typeof(McuClockReferencePoint), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint mcuClockReferencePoint) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint mcuClockReferencePoint) {
						mcuClockReferencePoint.target?.gSetDefinition(containerValue.getContainerDefinition("McuClockReferencePoint"))
		...
		static class McuDemEventParameterRefs implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter getMCU_E_CLOCK_FAILURE(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter), "MCU_E_CLOCK_FAILURE")
			}
			
			def void setMCU_E_CLOCK_FAILURE(org.artop.ecuc.autosar444.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class McuRamSectorSettingConf implements IWrapper<GContainer> {
			...
			def BigInteger getMcuRamSectionWriteSize(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "McuRamSectionWriteSize"].getBigIntegerValue()
			}
			
			def void setMcuRamSectionWriteSize(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "McuRamSectionWriteSize"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "McuRamSectionWriteSize"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
	...
	static class McuPublishedInformation implements IWrapper<GContainer> {
		...
		def List<McuResetReasonConf> getMcuResetReasonConfs(){
			...
			return new BasicWrappingEList<McuResetReasonConf, GContainer>(filteredContainers, typeof(McuResetReasonConf), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar444.accessors.Mcu.McuPublishedInformation.McuResetReasonConf mcuResetReasonConf) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar444.accessors.Mcu.McuPublishedInformation.McuResetReasonConf mcuResetReasonConf) {
					mcuResetReasonConf.target?.gSetDefinition(containerValue.getContainerDefinition("McuResetReasonConf"))
