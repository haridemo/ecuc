...
public class IntegerValueUnwrappingEList extends AbstractUnwrappingEList<EcucNumericalParamValue, Integer> {
  private GConfigParameter parameterDef;
  
  public IntegerValueUnwrappingEList(final List<EcucNumericalParamValue> delegateList, final Class<EcucNumericalParamValue> wrapperType, final Class<Integer> targetType, final GConfigParameter parameterDef) {
    super(delegateList, wrapperType, targetType);
    this.parameterDef = parameterDef;
  }
  
  protected EcucNumericalParamValue wrap(final Integer object) throws CoreException {
  ...
  protected Integer unwrap(final EcucNumericalParamValue parameterValue) {
