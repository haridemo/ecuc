...
class J1939Nm implements IWrapper<GModuleConfiguration> {
	...
	static class J1939NmConfigSet implements IWrapper<GContainer> {
		...
		def List<J1939NmChannel> getJ1939NmChannels(){
			...
			return new BasicWrappingEList<J1939NmChannel, GContainer>(filteredContainers, typeof(J1939NmChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel j1939NmChannel) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel j1939NmChannel) {
					j1939NmChannel.target?.gSetDefinition(containerValue.getContainerDefinition("J1939NmChannel"))
		...
		def List<J1939NmNode> getJ1939NmNodes(){
			...
			return new BasicWrappingEList<J1939NmNode, GContainer>(filteredContainers, typeof(J1939NmNode), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode j1939NmNode) {
					j1939NmNode.target?.gSetDefinition(containerValue.getContainerDefinition("J1939NmNode"))
					super.delegateAdd(j1939NmNode)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode j1939NmNode) {
					j1939NmNode.target?.gSetDefinition(containerValue.getContainerDefinition("J1939NmNode"))
		...
		static class J1939NmChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getJ1939NmComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "J1939NmComMNetworkHandleRef")
			}
			
			def void setJ1939NmComMNetworkHandleRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class J1939NmRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939NmRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939NmRxPduRef")
				}
				
				def void setJ1939NmRxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class J1939NmTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939NmTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939NmTxPduRef")
				}
				
				def void setJ1939NmTxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class J1939NmNode implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel> getJ1939NmNodeChannelRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel object) throws CoreException {
						if (object != null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue != null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmChannel(referenceValueValue as GContainer)
							}
						}
					}
				}
	...
	static class J1939NmDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getJ1939NM_E_ADDRESS_LOST(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "J1939NM_E_ADDRESS_LOST")
		}
		
		def void setJ1939NM_E_ADDRESS_LOST(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
