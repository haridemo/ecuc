	...
	static class EthTrcvConfigSet implements IWrapper<GContainer> {
		...
		def List<EthTrcvConfig> getEthTrcvConfigs(){
			...
			return new BasicWrappingEList<EthTrcvConfig, GContainer>(filteredContainers, typeof(EthTrcvConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig ethTrcvConfig) {
					ethTrcvConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthTrcvConfig"))
					super.delegateAdd(ethTrcvConfig)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig ethTrcvConfig) {
					ethTrcvConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthTrcvConfig"))
		...
		static class EthTrcvConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Icu.IcuConfigSet.IcuChannel getEthTrcvIcuChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Icu.IcuConfigSet.IcuChannel), "EthTrcvIcuChannelRef")
			}
			
			def void setEthTrcvIcuChannelRef(org.artop.ecuc.autosar422.accessors.Icu.IcuConfigSet.IcuChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<EthTrcvWakeupMap> getEthTrcvWakeupMaps(){
				...
				return new BasicWrappingEList<EthTrcvWakeupMap, GContainer>(filteredContainers, typeof(EthTrcvWakeupMap), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig.EthTrcvWakeupMap ethTrcvWakeupMap) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig.EthTrcvWakeupMap ethTrcvWakeupMap) {
						ethTrcvWakeupMap.target?.gSetDefinition(containerValue.getContainerDefinition("EthTrcvWakeupMap"))
			...
			static class EthTrcvDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getETHTRCV_E_ACCESS(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "ETHTRCV_E_ACCESS")
				}
				
				def void setETHTRCV_E_ACCESS(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EthTrcvWakeupMap implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getEthTrcvWakeupSourceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "EthTrcvWakeupSourceRef")
				}
				
				def void setEthTrcvWakeupSourceRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
