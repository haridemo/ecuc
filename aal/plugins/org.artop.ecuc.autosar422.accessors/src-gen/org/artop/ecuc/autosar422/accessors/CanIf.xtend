...
class CanIf implements IWrapper<GModuleConfiguration> {
	...
	def List<CanIfCtrlDrvCfg> getCanIfCtrlDrvCfgs(){
		...
		return new BasicWrappingEList<CanIfCtrlDrvCfg, GContainer>(filteredContainers, typeof(CanIfCtrlDrvCfg), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg canIfCtrlDrvCfg) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg canIfCtrlDrvCfg) {
				canIfCtrlDrvCfg.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CanIfCtrlDrvCfg"))
	...
	def List<CanIfTrcvDrvCfg> getCanIfTrcvDrvCfgs(){
		...
		return new BasicWrappingEList<CanIfTrcvDrvCfg, GContainer>(filteredContainers, typeof(CanIfTrcvDrvCfg), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg canIfTrcvDrvCfg) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg canIfTrcvDrvCfg) {
				canIfTrcvDrvCfg.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CanIfTrcvDrvCfg"))
	...
	static class CanIfCtrlDrvCfg implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg getCanIfCtrlDrvInitHohConfigRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg), "CanIfCtrlDrvInitHohConfigRef")
		}
		
		def void setCanIfCtrlDrvInitHohConfigRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg object){
		...
		def org.artop.ecuc.autosar422.accessors.Can.CanGeneral getCanIfCtrlDrvNameRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanGeneral), "CanIfCtrlDrvNameRef")
		}
		
		def void setCanIfCtrlDrvNameRef(org.artop.ecuc.autosar422.accessors.Can.CanGeneral object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<CanIfCtrlCfg> getCanIfCtrlCfgs(){
			...
			return new BasicWrappingEList<CanIfCtrlCfg, GContainer>(filteredContainers, typeof(CanIfCtrlCfg), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg canIfCtrlCfg) {
					canIfCtrlCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfCtrlCfg"))
					super.delegateAdd(canIfCtrlCfg)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg canIfCtrlCfg) {
					canIfCtrlCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfCtrlCfg"))
		...
		static class CanIfCtrlCfg implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController getCanIfCtrlCanCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController), "CanIfCtrlCanCtrlRef")
			}
			
			def void setCanIfCtrlCanCtrlRef(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CanIfInitCfg implements IWrapper<GContainer> {
		...
		def List<CanIfBufferCfg> getCanIfBufferCfgs(){
			...
			return new BasicWrappingEList<CanIfBufferCfg, GContainer>(filteredContainers, typeof(CanIfBufferCfg), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfBufferCfg canIfBufferCfg) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfBufferCfg canIfBufferCfg) {
					canIfBufferCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfBufferCfg"))
		...
		def List<CanIfInitHohCfg> getCanIfInitHohCfgs(){
			...
			return new BasicWrappingEList<CanIfInitHohCfg, GContainer>(filteredContainers, typeof(CanIfInitHohCfg), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg canIfInitHohCfg) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg canIfInitHohCfg) {
					canIfInitHohCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfInitHohCfg"))
		...
		def List<CanIfRxPduCfg> getCanIfRxPduCfgs(){
			...
			return new BasicWrappingEList<CanIfRxPduCfg, GContainer>(filteredContainers, typeof(CanIfRxPduCfg), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfRxPduCfg canIfRxPduCfg) {
					canIfRxPduCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfRxPduCfg"))
					super.delegateAdd(canIfRxPduCfg)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfRxPduCfg canIfRxPduCfg) {
					canIfRxPduCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfRxPduCfg"))
		...
		def List<CanIfTxPduCfg> getCanIfTxPduCfgs(){
			...
			return new BasicWrappingEList<CanIfTxPduCfg, GContainer>(filteredContainers, typeof(CanIfTxPduCfg), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfTxPduCfg canIfTxPduCfg) {
					canIfTxPduCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfTxPduCfg"))
					super.delegateAdd(canIfTxPduCfg)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfTxPduCfg canIfTxPduCfg) {
					canIfTxPduCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfTxPduCfg"))
		...
		static class CanIfBufferCfg implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHthCfg getCanIfBufferHthRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHthCfg), "CanIfBufferHthRef")
			}
			
			def void setCanIfBufferHthRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHthCfg object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CanIfInitHohCfg implements IWrapper<GContainer> {
			...
			def List<CanIfHrhCfg> getCanIfHrhCfgs(){
				...
				return new BasicWrappingEList<CanIfHrhCfg, GContainer>(filteredContainers, typeof(CanIfHrhCfg), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg canIfHrhCfg) {
						canIfHrhCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfHrhCfg"))
						super.delegateAdd(canIfHrhCfg)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg canIfHrhCfg) {
						canIfHrhCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfHrhCfg"))
			...
			def List<CanIfHthCfg> getCanIfHthCfgs(){
				...
				return new BasicWrappingEList<CanIfHthCfg, GContainer>(filteredContainers, typeof(CanIfHthCfg), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHthCfg canIfHthCfg) {
						canIfHthCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfHthCfg"))
						super.delegateAdd(canIfHthCfg)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHthCfg canIfHthCfg) {
						canIfHthCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfHthCfg"))
			...
			static class CanIfHrhCfg implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg getCanIfHrhCanCtrlIdRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg), "CanIfHrhCanCtrlIdRef")
				}
				
				def void setCanIfHrhCanCtrlIdRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject getCanIfHrhIdSymRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject), "CanIfHrhIdSymRef")
				}
				
				def void setCanIfHrhIdSymRef(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<CanIfHrhRangeCfg> getCanIfHrhRangeCfgs(){
					...
					return new BasicWrappingEList<CanIfHrhRangeCfg, GContainer>(filteredContainers, typeof(CanIfHrhRangeCfg), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg.CanIfHrhRangeCfg canIfHrhRangeCfg) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg.CanIfHrhRangeCfg canIfHrhRangeCfg) {
							canIfHrhRangeCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfHrhRangeCfg"))
			...
			static class CanIfHthCfg implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg getCanIfHthCanCtrlIdRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg), "CanIfHthCanCtrlIdRef")
				}
				
				def void setCanIfHthCanCtrlIdRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject getCanIfHthIdSymRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject), "CanIfHthIdSymRef")
				}
				
				def void setCanIfHthIdSymRef(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CanIfRxPduCfg implements IWrapper<GContainer> {
			...
			def BigInteger getCanIfRxPduDlc(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CanIfRxPduDlc"].getBigIntegerValue()
			}
			...
			def void setCanIfRxPduDlc(BigInteger value){
				...
				if (parameterValue == null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CanIfRxPduDlc"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg getCanIfRxPduHrhIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg), "CanIfRxPduHrhIdRef")
			}
			
			def void setCanIfRxPduHrhIdRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfInitHohCfg.CanIfHrhCfg object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanIfRxPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanIfRxPduRef")
			}
			
			def void setCanIfRxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanIfTTRxFrameTriggering implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger getCanIfTTRxHwObjectTriggerIdRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger), "CanIfTTRxHwObjectTriggerIdRef")
				}
				
				def void setCanIfTTRxHwObjectTriggerIdRef(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CanIfTxPduCfg implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfBufferCfg getCanIfTxPduBufferRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfBufferCfg), "CanIfTxPduBufferRef")
			}
			
			def void setCanIfTxPduBufferRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfInitCfg.CanIfBufferCfg object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanIfTxPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanIfTxPduRef")
			}
			
			def void setCanIfTxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanIfTTTxFrameTriggering implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger getCanIfTTTxHwObjectTriggerIdRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger), "CanIfTTTxHwObjectTriggerIdRef")
				}
				
				def void setCanIfTTTxHwObjectTriggerIdRef(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CanIfPrivateCfg implements IWrapper<GContainer> {
		...
		def Boolean getCanIfPrivateDlcCheck(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CanIfPrivateDlcCheck"].getBooleanValue()
		}
		...
		def void setCanIfPrivateDlcCheck(Boolean value){
			...
			if (parameterValue == null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CanIfPrivateDlcCheck"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		static class CanIfTTGeneral implements IWrapper<GContainer> {
			...
			static class CanIfTTDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getCANIF_TT_E_JLE_SYNC(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "CANIF_TT_E_JLE_SYNC")
				}
				
				def void setCANIF_TT_E_JLE_SYNC(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CanIfPublicCfg implements IWrapper<GContainer> {
		...
		def Boolean getCanIfPublicDevErrorDetect(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CanIfPublicDevErrorDetect"].getBooleanValue()
		}
		...
		def void setCanIfPublicDevErrorDetect(Boolean value){
			...
			if (parameterValue == null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CanIfPublicDevErrorDetect"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		def Boolean getCanIfPublicVersionInfoApi(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CanIfPublicVersionInfoApi"].getBooleanValue()
		}
		...
		def void setCanIfPublicVersionInfoApi(Boolean value){
			...
			if (parameterValue == null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CanIfPublicVersionInfoApi"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
	...
	static class CanIfTrcvDrvCfg implements IWrapper<GContainer> {
		...
		def List<CanIfTrcvCfg> getCanIfTrcvCfgs(){
			...
			return new BasicWrappingEList<CanIfTrcvCfg, GContainer>(filteredContainers, typeof(CanIfTrcvCfg), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg.CanIfTrcvCfg canIfTrcvCfg) {
					canIfTrcvCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfTrcvCfg"))
					super.delegateAdd(canIfTrcvCfg)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg.CanIfTrcvCfg canIfTrcvCfg) {
					canIfTrcvCfg.target?.gSetDefinition(containerValue.getContainerDefinition("CanIfTrcvCfg"))
		...
		static class CanIfTrcvCfg implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel getCanIfTrcvCanTrcvRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel), "CanIfTrcvCanTrcvRef")
			}
			
			def void setCanIfTrcvCanTrcvRef(org.artop.ecuc.autosar422.accessors.CanTrcv.CanTrcvConfigSet.CanTrcvChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
