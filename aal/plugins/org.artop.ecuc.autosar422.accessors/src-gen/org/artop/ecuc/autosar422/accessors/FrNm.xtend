	...
	static class FrNmChannelConfig implements IWrapper<GContainer> {
		...
		def List<FrNmChannel> getFrNmChannels(){
			...
			return new BasicWrappingEList<FrNmChannel, GContainer>(filteredContainers, typeof(FrNmChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrNm.FrNmChannelConfig.FrNmChannel frNmChannel) {
					frNmChannel.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmChannel"))
					super.delegateAdd(frNmChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrNm.FrNmChannelConfig.FrNmChannel frNmChannel) {
					frNmChannel.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmChannel"))
		...
		static class FrNmChannel implements IWrapper<GContainer> {
			...
			static class FrNmChannelIdentifiers implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrNmPnEraRxNSduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrNmPnEraRxNSduRef")
				}
				
				def void setFrNmPnEraRxNSduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster getFrNmChannelHandle(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster), "FrNmChannelHandle")
				}
				
				def void setFrNmChannelHandle(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getFrNmComMNetworkHandleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "FrNmComMNetworkHandleRef")
				}
				
				def void setFrNmComMNetworkHandleRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<FrNmRxPdu> getFrNmRxPdus(){
					...
					return new BasicWrappingEList<FrNmRxPdu, GContainer>(filteredContainers, typeof(FrNmRxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrNm.FrNmChannelConfig.FrNmChannel.FrNmChannelIdentifiers.FrNmRxPdu frNmRxPdu) {
							frNmRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmRxPdu"))
							super.delegateAdd(frNmRxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrNm.FrNmChannelConfig.FrNmChannel.FrNmChannelIdentifiers.FrNmRxPdu frNmRxPdu) {
							frNmRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmRxPdu"))
				...
				def List<FrNmTxPdu> getFrNmTxPdus(){
					...
					return new BasicWrappingEList<FrNmTxPdu, GContainer>(filteredContainers, typeof(FrNmTxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrNm.FrNmChannelConfig.FrNmChannel.FrNmChannelIdentifiers.FrNmTxPdu frNmTxPdu) {
							frNmTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmTxPdu"))
							super.delegateAdd(frNmTxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrNm.FrNmChannelConfig.FrNmChannel.FrNmChannelIdentifiers.FrNmTxPdu frNmTxPdu) {
							frNmTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmTxPdu"))
				...
				static class FrNmRxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrNmRxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrNmRxPduRef")
					}
					
					def void setFrNmRxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class FrNmTxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrNmTxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrNmTxPduRef")
					}
					
					def void setFrNmTxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class FrNmUserDataTxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrNmTxUserDataPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrNmTxUserDataPduRef")
					}
					
					def void setFrNmTxUserDataPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
	...
	static class FrNmGlobalConfig implements IWrapper<GContainer> {
		...
		static class FrNmGlobalConstants implements IWrapper<GContainer> {
			...
			def BigInteger getFrNmNumberOfClusters(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FrNmNumberOfClusters"].getBigIntegerValue()
			}
			...
			def void setFrNmNumberOfClusters(BigInteger value){
				...
				if (parameterValue == null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "FrNmNumberOfClusters"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
		...
		static class FrNmGlobalFeatures implements IWrapper<GContainer> {
			...
			def Boolean getFrNmRepeatMessageBitEnabled(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "FrNmRepeatMessageBitEnabled"].getBooleanValue()
			}
			...
			def void setFrNmRepeatMessageBitEnabled(Boolean value){
				...
				if (parameterValue == null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "FrNmRepeatMessageBitEnabled"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(getBooleanParameterValueValue(value, true))
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrNmPnEiraRxNSduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrNmPnEiraRxNSduRef")
			}
			
			def void setFrNmPnEiraRxNSduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrNmPnInfo implements IWrapper<GContainer> {
				...
				def List<FrNmPnFilterMaskByte> getFrNmPnFilterMaskBytes(){
					...
					return new BasicWrappingEList<FrNmPnFilterMaskByte, GContainer>(filteredContainers, typeof(FrNmPnFilterMaskByte), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrNm.FrNmGlobalConfig.FrNmGlobalFeatures.FrNmPnInfo.FrNmPnFilterMaskByte frNmPnFilterMaskByte) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrNm.FrNmGlobalConfig.FrNmGlobalFeatures.FrNmPnInfo.FrNmPnFilterMaskByte frNmPnFilterMaskByte) {
							frNmPnFilterMaskByte.target?.gSetDefinition(containerValue.getContainerDefinition("FrNmPnFilterMaskByte"))
