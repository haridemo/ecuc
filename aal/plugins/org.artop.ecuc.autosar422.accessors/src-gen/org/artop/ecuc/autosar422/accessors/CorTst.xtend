...
class CorTst implements IWrapper<GModuleConfiguration> {
	...
	def List<CorTstBackgroundConfigSet> getCorTstBackgroundConfigSets(){
		...
		return new BasicWrappingEList<CorTstBackgroundConfigSet, GContainer>(filteredContainers, typeof(CorTstBackgroundConfigSet), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CorTst.CorTstBackgroundConfigSet corTstBackgroundConfigSet) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CorTst.CorTstBackgroundConfigSet corTstBackgroundConfigSet) {
				corTstBackgroundConfigSet.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CorTstBackgroundConfigSet"))
	...
	def List<CorTstForegroundConfigSet> getCorTstForegroundConfigSets(){
		...
		return new BasicWrappingEList<CorTstForegroundConfigSet, GContainer>(filteredContainers, typeof(CorTstForegroundConfigSet), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CorTst.CorTstForegroundConfigSet corTstForegroundConfigSet) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CorTst.CorTstForegroundConfigSet corTstForegroundConfigSet) {
				corTstForegroundConfigSet.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CorTstForegroundConfigSet"))
	...
	static class CorTstDemEventParameterRefs implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getCORTST_E_CORE_FAILURE(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "CORTST_E_CORE_FAILURE")
		}
		
		def void setCORTST_E_CORE_FAILURE(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
