...
class Dem implements IWrapper<GModuleConfiguration> {
	...
	static class DemConfigSet implements IWrapper<GContainer> {
		...
		def List<DemComponent> getDemComponents(){
			...
			return new BasicWrappingEList<DemComponent, GContainer>(filteredContainers, typeof(DemComponent), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemComponent demComponent) {
					demComponent.target?.gSetDefinition(containerValue.getContainerDefinition("DemComponent"))
					super.delegateAdd(demComponent)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemComponent demComponent) {
					demComponent.target?.gSetDefinition(containerValue.getContainerDefinition("DemComponent"))
		...
		def List<DemDTC> getDemDTCs(){
			...
			return new BasicWrappingEList<DemDTC, GContainer>(filteredContainers, typeof(DemDTC), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTC demDTC) {
					demDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemDTC"))
					super.delegateAdd(demDTC)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTC demDTC) {
					demDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemDTC"))
		...
		def List<DemDTCAttributes> getDemDTCAttributes(){
			...
			return new BasicWrappingEList<DemDTCAttributes, GContainer>(filteredContainers, typeof(DemDTCAttributes), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTCAttributes demDTCAttributes) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTCAttributes demDTCAttributes) {
					demDTCAttributes.target?.gSetDefinition(containerValue.getContainerDefinition("DemDTCAttributes"))
		...
		def List<DemDebounceCounterBasedClass> getDemDebounceCounterBasedClass(){
			...
			return new BasicWrappingEList<DemDebounceCounterBasedClass, GContainer>(filteredContainers, typeof(DemDebounceCounterBasedClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass demDebounceCounterBasedClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass demDebounceCounterBasedClass) {
					demDebounceCounterBasedClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDebounceCounterBasedClass"))
		...
		def List<DemDebounceTimeBaseClass> getDemDebounceTimeBaseClass(){
			...
			return new BasicWrappingEList<DemDebounceTimeBaseClass, GContainer>(filteredContainers, typeof(DemDebounceTimeBaseClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass demDebounceTimeBaseClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass demDebounceTimeBaseClass) {
					demDebounceTimeBaseClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDebounceTimeBaseClass"))
		...
		def List<DemEventParameter> getDemEventParameters(){
			...
			return new BasicWrappingEList<DemEventParameter, GContainer>(filteredContainers, typeof(DemEventParameter), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter demEventParameter) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter demEventParameter) {
					demEventParameter.target?.gSetDefinition(containerValue.getContainerDefinition("DemEventParameter"))
		...
		def List<DemJ1939Node> getDemJ1939Nodes(){
			val List<GContainer> filteredContainers = new AbstractFilteringEList<GContainer>(containerValue, getEContainingFeature(containerValue, GecucdescriptionPackage.eINSTANCE.getGContainer())) {
				override protected accept(GContainer item) {
					return accept(item, typeof(GContainerDef), "DemJ1939Node")
				}
			}
			return new BasicWrappingEList<DemJ1939Node, GContainer>(filteredContainers, typeof(DemJ1939Node), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemJ1939Node demJ1939Node) {
					demJ1939Node.target?.gSetDefinition(containerValue.getContainerDefinition("DemJ1939Node"))
					super.delegateAdd(demJ1939Node)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemJ1939Node demJ1939Node) {
					demJ1939Node.target?.gSetDefinition(containerValue.getContainerDefinition("DemJ1939Node"))
					super.delegateAdd(index, demJ1939Node)
				}
			}
		}
		...
		def List<DemObdDTC> getDemObdDTCs(){
			...
			return new BasicWrappingEList<DemObdDTC, GContainer>(filteredContainers, typeof(DemObdDTC), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemObdDTC demObdDTC) {
					demObdDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemObdDTC"))
					super.delegateAdd(demObdDTC)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemObdDTC demObdDTC) {
					demObdDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemObdDTC"))
		...
		def List<DemPidClass> getDemPidClass(){
			...
			return new BasicWrappingEList<DemPidClass, GContainer>(filteredContainers, typeof(DemPidClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemPidClass demPidClass) {
					demPidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemPidClass"))
					super.delegateAdd(demPidClass)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemPidClass demPidClass) {
					demPidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemPidClass"))
		...
		static class DemComponent implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemComponent> getDemImmediateChildComponentRefs(){
				val containerDef = containerValue.gGetDefinition
		...
		static class DemDTC implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTCAttributes getDemDTCAttributesRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTCAttributes), "DemDTCAttributesRef")
			}
			
			def void setDemDTCAttributesRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTCAttributes object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemObdDTC getDemObdDTCRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemObdDTC), "DemObdDTCRef")
			}
			
			def void setDemObdDTCRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemObdDTC object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemDTCAttributes implements IWrapper<GContainer> {
			...
			def BigInteger getDemEventMemoryEntryFdcThresholdStorageValue(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemEventMemoryEntryFdcThresholdStorageValue"].getBigIntegerValue()
			}
			...
			def Boolean getDemImmediateNvStorage(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemImmediateNvStorage"].getBooleanValue()
			}
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle getDemAgingCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle), "DemAgingCycleRef")
			}
			
			def void setDemAgingCycleRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataClass getDemExtendedDataClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataClass), "DemExtendedDataClassRef")
			}
			
			def void setDemExtendedDataClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass getDemFreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass), "DemFreezeFrameClassRef")
			}
			
			def void setDemFreezeFrameClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass getDemFreezeFrameRecNumClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass), "DemFreezeFrameRecNumClassRef")
			}
			
			def void setDemFreezeFrameRecNumClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemJ1939Node getDemJ1939DTC_J1939NodeRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemJ1939Node), "DemJ1939DTC_J1939NodeRef")
			}
			
			def void setDemJ1939DTC_J1939NodeRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemJ1939Node object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "DemJ1939DTC_J1939NodeRef"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass getDemJ1939ExpandedFreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass), "DemJ1939ExpandedFreezeFrameClassRef")
			}
			
			def void setDemJ1939ExpandedFreezeFrameClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass getDemJ1939FreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass), "DemJ1939FreezeFrameClassRef")
			}
			
			def void setDemJ1939FreezeFrameClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass getDemWWHOBDFreezeFrameClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass), "DemWWHOBDFreezeFrameClassRef")
			}
			
			def void setDemWWHOBDFreezeFrameClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemDtrs implements IWrapper<GContainer> {
			...
			def List<DemDtr> getDemDtrs(){
				...
				return new BasicWrappingEList<DemDtr, GContainer>(filteredContainers, typeof(DemDtr), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDtrs.DemDtr demDtr) {
						demDtr.target?.gSetDefinition(containerValue.getContainerDefinition("DemDtr"))
						super.delegateAdd(demDtr)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDtrs.DemDtr demDtr) {
						demDtr.target?.gSetDefinition(containerValue.getContainerDefinition("DemDtr"))
			...
			static class DemDtr implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getDemDtrEventRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "DemDtrEventRef")
				}
				
				def void setDemDtrEventRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemEventParameter implements IWrapper<GContainer> {
			...
			def BigInteger getDemEventFailureCycleCounterThreshold(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemEventFailureCycleCounterThreshold"].getBigIntegerValue()
			}
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemComponent getDemComponentClassRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemComponent), "DemComponentClassRef")
			}
			
			def void setDemComponentClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemComponent object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTC getDemDTCRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTC), "DemDTCRef")
			}
			
			def void setDemDTCRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDTC object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableConditionGroup getDemEnableConditionGroupRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableConditionGroup), "DemEnableConditionGroupRef")
			}
			
			def void setDemEnableConditionGroupRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableConditionGroup object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getDemOBDGroupingAssociativeEventsRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "DemOBDGroupingAssociativeEventsRef")
			}
			
			def void setDemOBDGroupingAssociativeEventsRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle getDemOperationCycleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle), "DemOperationCycleRef")
			}
			
			def void setDemOperationCycleRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageConditionGroup getDemStorageConditionGroupRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageConditionGroup), "DemStorageConditionGroupRef")
			}
			
			def void setDemStorageConditionGroupRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageConditionGroup object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DemCallbackEventStatusChanged> getDemCallbackEventStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackEventStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackEventStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter.DemCallbackEventStatusChanged demCallbackEventStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter.DemCallbackEventStatusChanged demCallbackEventStatusChanged) {
						demCallbackEventStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackEventStatusChanged"))
			...
			def List<DemIndicatorAttribute> getDemIndicatorAttributes(){
				...
				return new BasicWrappingEList<DemIndicatorAttribute, GContainer>(filteredContainers, typeof(DemIndicatorAttribute), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter.DemIndicatorAttribute demIndicatorAttribute) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter.DemIndicatorAttribute demIndicatorAttribute) {
						demIndicatorAttribute.target?.gSetDefinition(containerValue.getContainerDefinition("DemIndicatorAttribute"))
			...
			static class DemCallbackEventStatusChanged implements IWrapper<GContainer> {
				...
				def String getDemCallbackEventStatusChangedFnc(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemCallbackEventStatusChangedFnc"].getStringValue()
				}
			...
			static class DemDebounceAlgorithmClass implements IWrapper<GContainer> {
				...
				static class DemDebounceCounterBased implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass getDemDebounceCounterBasedClassRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass), "DemDebounceCounterBasedClassRef")
					}
					
					def void setDemDebounceCounterBasedClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceCounterBasedClass object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class DemDebounceTimeBase implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass getDemDebounceTimeBaseRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass), "DemDebounceTimeBaseRef")
					}
					
					def void setDemDebounceTimeBaseRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemDebounceTimeBaseClass object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DemIndicatorAttribute implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator getDemIndicatorRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator), "DemIndicatorRef")
				}
				
				def void setDemIndicatorRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemJ1939Node implements IWrapper<GContainer> {
			private GContainer containerValue
			...
			override def boolean equals(Object object) {
		        if (!(object instanceof DemJ1939Node)){
					return false
				}
				this.target == (object as DemJ1939Node).target
			}
		
			
			def List<org.artop.ecuc.autosar422.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode> getDemJ1939NmNodeRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemPidClass implements IWrapper<GContainer> {
			...
			def List<DemPidDataElement> getDemPidDataElements(){
				...
				return new BasicWrappingEList<DemPidDataElement, GContainer>(filteredContainers, typeof(DemPidDataElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement demPidDataElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemPidClass.DemPidDataElement demPidDataElement) {
						demPidDataElement.target?.gSetDefinition(containerValue.getContainerDefinition("DemPidDataElement"))
			...
			static class DemPidDataElement implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass getDemPidDataElementClassRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass), "DemPidDataElementClassRef")
				}
				
				def void setDemPidDataElementClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DemGeneral implements IWrapper<GContainer> {
		...
		def DemAgingCycleCounterProcessing getDemAgingCycleCounterProcessing(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemAgingCycleCounterProcessing"].getDemAgingCycleCounterProcessingValue()
		}
		...
		def DemAgingCycleCounterProcessing getDemAgingCycleCounterProcessingValue(GParameterValue parameterValue){
			val castedParameterValue = parameterValue as EcucTextualParamValue
			switch (castedParameterValue.value){
		...
		def void setDemAgingCycleCounterProcessingValue(GParameterValue parameterValue, DemAgingCycleCounterProcessing value){
			parameterValue.setValue(value)
		}
		
		def Boolean getDemAgingRequieresTestedCycle(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemAgingRequieresTestedCycle"].getBooleanValue()
		}
		...
		def BigInteger getDemImmediateNvStorageLimit(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemImmediateNvStorageLimit"].getBigIntegerValue()
		}
		...
		def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator getDemMILIndicatorRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator), "DemMILIndicatorRef")
		}
		
		def void setDemMILIndicatorRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<DemCallbackDTCStatusChanged> getDemCallbackDTCStatusChangeds(){
			...
			return new BasicWrappingEList<DemCallbackDTCStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackDTCStatusChanged), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemCallbackDTCStatusChanged demCallbackDTCStatusChanged) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemCallbackDTCStatusChanged demCallbackDTCStatusChanged) {
					demCallbackDTCStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackDTCStatusChanged"))
		...
		def List<DemDataElementClass> getDemDataElementClass(){
			...
			return new BasicWrappingEList<DemDataElementClass, GContainer>(filteredContainers, typeof(DemDataElementClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass demDataElementClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass demDataElementClass) {
					demDataElementClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDataElementClass"))
		...
		def List<DemDidClass> getDemDidClass(){
			...
			return new BasicWrappingEList<DemDidClass, GContainer>(filteredContainers, typeof(DemDidClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDidClass demDidClass) {
					demDidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDidClass"))
					super.delegateAdd(demDidClass)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDidClass demDidClass) {
					demDidClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemDidClass"))
		...
		def List<DemEnableCondition> getDemEnableConditions(){
			...
			return new BasicWrappingEList<DemEnableCondition, GContainer>(filteredContainers, typeof(DemEnableCondition), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableCondition demEnableCondition) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableCondition demEnableCondition) {
					demEnableCondition.target?.gSetDefinition(containerValue.getContainerDefinition("DemEnableCondition"))
		...
		def List<DemEnableConditionGroup> getDemEnableConditionGroups(){
			...
			return new BasicWrappingEList<DemEnableConditionGroup, GContainer>(filteredContainers, typeof(DemEnableConditionGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableConditionGroup demEnableConditionGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableConditionGroup demEnableConditionGroup) {
					demEnableConditionGroup.target?.gSetDefinition(containerValue.getContainerDefinition("DemEnableConditionGroup"))
		...
		def List<DemExtendedDataClass> getDemExtendedDataClass(){
			...
			return new BasicWrappingEList<DemExtendedDataClass, GContainer>(filteredContainers, typeof(DemExtendedDataClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataClass demExtendedDataClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataClass demExtendedDataClass) {
					demExtendedDataClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemExtendedDataClass"))
		...
		def List<DemExtendedDataRecordClass> getDemExtendedDataRecordClass(){
			...
			return new BasicWrappingEList<DemExtendedDataRecordClass, GContainer>(filteredContainers, typeof(DemExtendedDataRecordClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataRecordClass demExtendedDataRecordClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataRecordClass demExtendedDataRecordClass) {
					demExtendedDataRecordClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemExtendedDataRecordClass"))
		...
		def List<DemFreezeFrameClass> getDemFreezeFrameClass(){
			...
			return new BasicWrappingEList<DemFreezeFrameClass, GContainer>(filteredContainers, typeof(DemFreezeFrameClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass demFreezeFrameClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameClass demFreezeFrameClass) {
					demFreezeFrameClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemFreezeFrameClass"))
		...
		def List<DemFreezeFrameRecNumClass> getDemFreezeFrameRecNumClass(){
			...
			return new BasicWrappingEList<DemFreezeFrameRecNumClass, GContainer>(filteredContainers, typeof(DemFreezeFrameRecNumClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass demFreezeFrameRecNumClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecNumClass demFreezeFrameRecNumClass) {
					demFreezeFrameRecNumClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemFreezeFrameRecNumClass"))
		...
		def List<DemFreezeFrameRecordClass> getDemFreezeFrameRecordClass(){
			...
			return new BasicWrappingEList<DemFreezeFrameRecordClass, GContainer>(filteredContainers, typeof(DemFreezeFrameRecordClass), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass demFreezeFrameRecordClass) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass demFreezeFrameRecordClass) {
					demFreezeFrameRecordClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemFreezeFrameRecordClass"))
		...
		def List<DemGroupOfDTC> getDemGroupOfDTCs(){
			...
			return new BasicWrappingEList<DemGroupOfDTC, GContainer>(filteredContainers, typeof(DemGroupOfDTC), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGroupOfDTC demGroupOfDTC) {
					demGroupOfDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemGroupOfDTC"))
					super.delegateAdd(demGroupOfDTC)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGroupOfDTC demGroupOfDTC) {
					demGroupOfDTC.target?.gSetDefinition(containerValue.getContainerDefinition("DemGroupOfDTC"))
		...
		def List<DemIndicator> getDemIndicators(){
			...
			return new BasicWrappingEList<DemIndicator, GContainer>(filteredContainers, typeof(DemIndicator), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator demIndicator) {
					demIndicator.target?.gSetDefinition(containerValue.getContainerDefinition("DemIndicator"))
					super.delegateAdd(demIndicator)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator demIndicator) {
					demIndicator.target?.gSetDefinition(containerValue.getContainerDefinition("DemIndicator"))
		...
		def List<DemNvRamBlockId> getDemNvRamBlockIds(){
			...
			return new BasicWrappingEList<DemNvRamBlockId, GContainer>(filteredContainers, typeof(DemNvRamBlockId), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemNvRamBlockId demNvRamBlockId) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemNvRamBlockId demNvRamBlockId) {
					demNvRamBlockId.target?.gSetDefinition(containerValue.getContainerDefinition("DemNvRamBlockId"))
		...
		def List<DemOperationCycle> getDemOperationCycles(){
			...
			return new BasicWrappingEList<DemOperationCycle, GContainer>(filteredContainers, typeof(DemOperationCycle), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle demOperationCycle) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemOperationCycle demOperationCycle) {
					demOperationCycle.target?.gSetDefinition(containerValue.getContainerDefinition("DemOperationCycle"))
		...
		def List<DemRatio> getDemRatios(){
			...
			return new BasicWrappingEList<DemRatio, GContainer>(filteredContainers, typeof(DemRatio), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemRatio demRatio) {
					demRatio.target?.gSetDefinition(containerValue.getContainerDefinition("DemRatio"))
					super.delegateAdd(demRatio)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemRatio demRatio) {
					demRatio.target?.gSetDefinition(containerValue.getContainerDefinition("DemRatio"))
		...
		def List<DemStorageCondition> getDemStorageConditions(){
			...
			return new BasicWrappingEList<DemStorageCondition, GContainer>(filteredContainers, typeof(DemStorageCondition), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageCondition demStorageCondition) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageCondition demStorageCondition) {
					demStorageCondition.target?.gSetDefinition(containerValue.getContainerDefinition("DemStorageCondition"))
		...
		def List<DemStorageConditionGroup> getDemStorageConditionGroups(){
			...
			return new BasicWrappingEList<DemStorageConditionGroup, GContainer>(filteredContainers, typeof(DemStorageConditionGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageConditionGroup demStorageConditionGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageConditionGroup demStorageConditionGroup) {
					demStorageConditionGroup.target?.gSetDefinition(containerValue.getContainerDefinition("DemStorageConditionGroup"))
		...
		def List<DemUserDefinedMemory> getDemUserDefinedMemories(){
			...
			return new BasicWrappingEList<DemUserDefinedMemory, GContainer>(filteredContainers, typeof(DemUserDefinedMemory), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemUserDefinedMemory demUserDefinedMemory) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemUserDefinedMemory demUserDefinedMemory) {
					demUserDefinedMemory.target?.gSetDefinition(containerValue.getContainerDefinition("DemUserDefinedMemory"))
				...
				static class DemDiagnosisScaling implements IWrapper<GContainer> {
					...
					static class DemAlternativeDataProps implements IWrapper<GContainer> {
						...
						def DemDataTypeCategory getDemDataTypeCategory(){
							containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemDataTypeCategory"].getDemDataTypeCategoryValue()
						}
						...
						def DemDataTypeCategory getDemDataTypeCategoryValue(GParameterValue parameterValue){
							val castedParameterValue = parameterValue as EcucTextualParamValue
							switch (castedParameterValue.value){
						...
						def void setDemDataTypeCategoryValue(GParameterValue parameterValue, DemDataTypeCategory value){
							parameterValue.setValue(value)
						}
						...
						def List<DemTextTableMapping> getDemTextTableMappings(){
							...
							return new BasicWrappingEList<DemTextTableMapping, GContainer>(filteredContainers, typeof(DemTextTableMapping), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass.DemExternalSRDataElementClass.DemDiagnosisScaling.DemAlternativeDataProps.DemTextTableMapping demTextTableMapping) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass.DemExternalSRDataElementClass.DemDiagnosisScaling.DemAlternativeDataProps.DemTextTableMapping demTextTableMapping) {
									demTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DemTextTableMapping"))
						...
						static class DemLinearScale implements IWrapper<GContainer> {
							...
							def BigDecimal getDemDiagnosisRepresentationDataLowerRange(){
								containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemDiagnosisRepresentationDataLowerRange"].getBigDecimalValue()
							}
							...
							def BigDecimal getDemDiagnosisRepresentationDataOffset(){
								containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemDiagnosisRepresentationDataOffset"].getBigDecimalValue()
							}
							...
							def BigDecimal getDemDiagnosisRepresentationDataResolution(){
								containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemDiagnosisRepresentationDataResolution"].getBigDecimalValue()
							}
							...
							def BigDecimal getDemDiagnosisRepresentationDataUpperRange(){
								containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemDiagnosisRepresentationDataUpperRange"].getBigDecimalValue()
							}
					...
					static class DemAlternativeDataType implements IWrapper<GContainer> {
						...
						def List<DemTextTableMapping> getDemTextTableMappings(){
							...
							return new BasicWrappingEList<DemTextTableMapping, GContainer>(filteredContainers, typeof(DemTextTableMapping), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass.DemExternalSRDataElementClass.DemDiagnosisScaling.DemAlternativeDataType.DemTextTableMapping demTextTableMapping) {
									demTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DemTextTableMapping"))
									super.delegateAdd(demTextTableMapping)
								}
						
								override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass.DemExternalSRDataElementClass.DemDiagnosisScaling.DemAlternativeDataType.DemTextTableMapping demTextTableMapping) {
									demTextTableMapping.target?.gSetDefinition(containerValue.getContainerDefinition("DemTextTableMapping"))
									super.delegateAdd(index, demTextTableMapping)
								}
							}
		...
		static class DemDidClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass> getDemDidDataElementClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemEnableConditionGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemEnableCondition> getDemEnableConditionRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemExtendedDataClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemExtendedDataRecordClass> getDemExtendedDataRecordClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemExtendedDataRecordClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass> getDemDataElementClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemFreezeFrameClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDidClass> getDemDidClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemFreezeFrameRecNumClass implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemFreezeFrameRecordClass> getDemFreezeFrameRecordClassRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemGeneralJ1939 implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator getDemAmberWarningLampIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator), "DemAmberWarningLampIndicatorRef")
			}
			
			def void setDemAmberWarningLampIndicatorRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator getDemProtectLampIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator), "DemProtectLampIndicatorRef")
			}
			
			def void setDemProtectLampIndicatorRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator getDemRedStopLampIndicatorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator), "DemRedStopLampIndicatorRef")
			}
			
			def void setDemRedStopLampIndicatorRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemIndicator object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DemCallbackJ1939DTCStatusChanged> getDemCallbackJ1939DTCStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackJ1939DTCStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackJ1939DTCStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemCallbackJ1939DTCStatusChanged demCallbackJ1939DTCStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemCallbackJ1939DTCStatusChanged demCallbackJ1939DTCStatusChanged) {
						demCallbackJ1939DTCStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackJ1939DTCStatusChanged"))
			...
			def List<DemJ1939FreezeFrameClass> getDemJ1939FreezeFrameClass(){
				...
				return new BasicWrappingEList<DemJ1939FreezeFrameClass, GContainer>(filteredContainers, typeof(DemJ1939FreezeFrameClass), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass demJ1939FreezeFrameClass) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemJ1939FreezeFrameClass demJ1939FreezeFrameClass) {
						demJ1939FreezeFrameClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemJ1939FreezeFrameClass"))
			...
			def List<DemSPNClass> getDemSPNClass(){
				...
				return new BasicWrappingEList<DemSPNClass, GContainer>(filteredContainers, typeof(DemSPNClass), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass demSPNClass) {
						demSPNClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemSPNClass"))
						super.delegateAdd(demSPNClass)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass demSPNClass) {
						demSPNClass.target?.gSetDefinition(containerValue.getContainerDefinition("DemSPNClass"))
			...
			static class DemJ1939FreezeFrameClass implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralJ1939.DemSPNClass> getDemSPNClassRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			static class DemSPNClass implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass getDemSPNDataElementClassRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass), "DemSPNDataElementClassRef")
				}
				
				def void setDemSPNDataElementClassRef(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemDataElementClass object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemGeneralOBD implements IWrapper<GContainer> {
			...
			def List<DemCallbackOBDDTCStatusChanged> getDemCallbackOBDDTCStatusChangeds(){
				...
				return new BasicWrappingEList<DemCallbackOBDDTCStatusChanged, GContainer>(filteredContainers, typeof(DemCallbackOBDDTCStatusChanged), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralOBD.DemCallbackOBDDTCStatusChanged demCallbackOBDDTCStatusChanged) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemGeneralOBD.DemCallbackOBDDTCStatusChanged demCallbackOBDDTCStatusChanged) {
						demCallbackOBDDTCStatusChanged.target?.gSetDefinition(containerValue.getContainerDefinition("DemCallbackOBDDTCStatusChanged"))
		...
		static class DemNvRamBlockId implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor getDemNvRamBlockIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor), "DemNvRamBlockIdRef")
			}
			
			def void setDemNvRamBlockIdRef(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemOperationCycle implements IWrapper<GContainer> {
			...
			def Boolean getDemOperationCycleAutomaticEnd(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemOperationCycleAutomaticEnd"].getBooleanValue()
			}
			...
			def DemOperationCycleType getDemOperationCycleType(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "DemOperationCycleType"].getDemOperationCycleTypeValue()
			}
			...
			def DemOperationCycleType getDemOperationCycleTypeValue(GParameterValue parameterValue){
				val castedParameterValue = parameterValue as EcucTextualParamValue
				switch (castedParameterValue.value){
			...
			def void setDemOperationCycleTypeValue(GParameterValue parameterValue, DemOperationCycleType value){
				parameterValue.setValue(value)
			}
		...
		static class DemRatio implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getDemDiagnosticEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "DemDiagnosticEventRef")
			}
			
			def void setDemDiagnosticEventRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.FiM.FiMConfigSet.FiMFID getDemFunctionIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FiM.FiMConfigSet.FiMFID), "DemFunctionIdRef")
			}
			
			def void setDemFunctionIdRef(org.artop.ecuc.autosar422.accessors.FiM.FiMConfigSet.FiMFID object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar422.accessors.FiM.FiMConfigSet.FiMFID> getDemSecondaryFunctionIdRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class DemStorageCondition implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getDemStorageConditionReplacementEventRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "DemStorageConditionReplacementEventRef")
			}
			
			def void setDemStorageConditionReplacementEventRef(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DemStorageConditionGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Dem.DemGeneral.DemStorageCondition> getDemStorageConditionRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
