...
class EcuM implements IWrapper<GModuleConfiguration> {
	...
	static class EcuMConfiguration implements IWrapper<GContainer> {
		...
		static class EcuMCommonConfiguration implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Os.OsAppMode getEcuMDefaultAppMode(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Os.OsAppMode), "EcuMDefaultAppMode")
			}
			
			def void setEcuMDefaultAppMode(org.artop.ecuc.autosar422.accessors.Os.OsAppMode object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar422.accessors.Os.OsResource> getEcuMOSResources(){
				val containerDef = containerValue.gGetDefinition
			...
			def List<EcuMSleepMode> getEcuMSleepModes(){
				...
				return new BasicWrappingEList<EcuMSleepMode, GContainer>(filteredContainers, typeof(EcuMSleepMode), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode ecuMSleepMode) {
						ecuMSleepMode.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMSleepMode"))
						super.delegateAdd(ecuMSleepMode)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode ecuMSleepMode) {
						ecuMSleepMode.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMSleepMode"))
			...
			def List<EcuMWakeupSource> getEcuMWakeupSources(){
				...
				return new BasicWrappingEList<EcuMWakeupSource, GContainer>(filteredContainers, typeof(EcuMWakeupSource), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource ecuMWakeupSource) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource ecuMWakeupSource) {
						ecuMWakeupSource.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMWakeupSource"))
			...
			static class EcuMDefaultShutdownTarget implements IWrapper<GContainer> {
				...
				def EcuMDefaultState getEcuMDefaultState(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EcuMDefaultState"].getEcuMDefaultStateValue()
				}
				...
				def void setEcuMDefaultState(EcuMDefaultState value){
					...
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EcuMDefaultState"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def EcuMDefaultState getEcuMDefaultStateValue(GParameterValue parameterValue){
				...
				def void setEcuMDefaultStateValue(GParameterValue parameterValue, EcuMDefaultState value){
					parameterValue.setValue(value)
				}
				
				
				def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode getEcuMDefaultResetModeRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode), "EcuMDefaultResetModeRef")
				}
				
				def void setEcuMDefaultResetModeRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode getEcuMDefaultSleepModeRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode), "EcuMDefaultSleepModeRef")
				}
				
				def void setEcuMDefaultSleepModeRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EcuMDriverInitListOne implements IWrapper<GContainer> {
				...
				def List<EcuMDriverInitItem> getEcuMDriverInitItems(){
					...
					return new BasicWrappingEList<EcuMDriverInitItem, GContainer>(filteredContainers, typeof(EcuMDriverInitItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMDriverInitListOne.EcuMDriverInitItem ecuMDriverInitItem) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMDriverInitListOne.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
				...
				static class EcuMDriverInitItem implements IWrapper<GContainer> {
					...
					def String getEcuMModuleID(){
						containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "EcuMModuleID"].getStringValue()
					}
					...
					def void setEcuMModuleID(String value){
						...
						if (parameterValue === null) {
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
								parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "EcuMModuleID"].createParameterValue()
								containerValue.gGetParameterValues += parameterValue
							}
						}
						parameterValue.setValue(value)
			...
			static class EcuMDriverInitListZero implements IWrapper<GContainer> {
				...
				def List<EcuMDriverInitItem> getEcuMDriverInitItems(){
					...
					return new BasicWrappingEList<EcuMDriverInitItem, GContainer>(filteredContainers, typeof(EcuMDriverInitItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMDriverInitListZero.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(ecuMDriverInitItem)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMDriverInitListZero.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(index, ecuMDriverInitItem)
						}
					}
			...
			static class EcuMDriverRestartList implements IWrapper<GContainer> {
				...
				def List<EcuMDriverInitItem> getEcuMDriverInitItems(){
					...
					return new BasicWrappingEList<EcuMDriverInitItem, GContainer>(filteredContainers, typeof(EcuMDriverInitItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMDriverRestartList.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(ecuMDriverInitItem)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMDriverRestartList.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(index, ecuMDriverInitItem)
						}
					}
			...
			static class EcuMSleepMode implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf getEcuMSleepModeMcuModeRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf), "EcuMSleepModeMcuModeRef")
				}
				
				def void setEcuMSleepModeMcuModeRef(org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource> getEcuMWakeupSourceMasks(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource)) {
						override protected wrap(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object) throws CoreException {
							if (object !== null) {
								val container = object.getTarget()
								val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
								referenceValue.gSetDefinition(referenceValueDef)
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								val referenceValueValue = referenceValue.gGetValue
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource(referenceValueValue as GContainer)
								}
							}
						}
					}
			...
			static class EcuMWakeupSource implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getEcuMComMChannelRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "EcuMComMChannelRef")
				}
				
				def void setEcuMComMChannelRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<org.artop.ecuc.autosar422.accessors.Mcu.McuPublishedInformation.McuResetReasonConf> getEcuMResetReasonRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.Mcu.McuPublishedInformation.McuResetReasonConf>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.Mcu.McuPublishedInformation.McuResetReasonConf)) {
						override protected wrap(org.artop.ecuc.autosar422.accessors.Mcu.McuPublishedInformation.McuResetReasonConf object) throws CoreException {
							if (object !== null) {
								val container = object.getTarget()
								val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
								referenceValue.gSetDefinition(referenceValueDef)
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								val referenceValueValue = referenceValue.gGetValue
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar422.accessors.Mcu.McuPublishedInformation.McuResetReasonConf(referenceValueValue as GContainer)
								}
							}
						}
					}
		...
		static class EcuMFixedConfiguration implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel> getEcuMComMCommunicationAllowedLists(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf getEcuMNormalMcuModeRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf), "EcuMNormalMcuModeRef")
			}
			
			def void setEcuMNormalMcuModeRef(org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuModeSettingConf object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<EcuMFixedUserConfig> getEcuMFixedUserConfigs(){
				...
				return new BasicWrappingEList<EcuMFixedUserConfig, GContainer>(filteredContainers, typeof(EcuMFixedUserConfig), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMFixedUserConfig ecuMFixedUserConfig) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMFixedUserConfig ecuMFixedUserConfig) {
						ecuMFixedUserConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMFixedUserConfig"))
			...
			def List<EcuMTTII> getEcuMTTIIs(){
				...
				return new BasicWrappingEList<EcuMTTII, GContainer>(filteredContainers, typeof(EcuMTTII), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMTTII ecuMTTII) {
						ecuMTTII.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMTTII"))
						super.delegateAdd(ecuMTTII)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMTTII ecuMTTII) {
						ecuMTTII.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMTTII"))
			...
			static class EcuMDriverInitListThree implements IWrapper<GContainer> {
				...
				def List<EcuMDriverInitItem> getEcuMDriverInitItems(){
					...
					return new BasicWrappingEList<EcuMDriverInitItem, GContainer>(filteredContainers, typeof(EcuMDriverInitItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMDriverInitListThree.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(ecuMDriverInitItem)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMDriverInitListThree.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(index, ecuMDriverInitItem)
						}
					}
			...
			static class EcuMDriverInitListTwo implements IWrapper<GContainer> {
				...
				def List<EcuMDriverInitItem> getEcuMDriverInitItems(){
					...
					return new BasicWrappingEList<EcuMDriverInitItem, GContainer>(filteredContainers, typeof(EcuMDriverInitItem), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMDriverInitListTwo.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(ecuMDriverInitItem)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFixedConfiguration.EcuMDriverInitListTwo.EcuMDriverInitItem ecuMDriverInitItem) {
							ecuMDriverInitItem.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMDriverInitItem"))
							super.delegateAdd(index, ecuMDriverInitItem)
						}
					}
			...
			static class EcuMTTII implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode getEcuMSleepModeRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode), "EcuMSleepModeRef")
				}
				
				def void setEcuMSleepModeRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode getEcuMSuccessorRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode), "EcuMSuccessorRef")
				}
				
				def void setEcuMSuccessorRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMSleepMode object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EcuMFlexConfiguration implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition> getEcuMPartitionRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def List<EcuMAlarmClock> getEcuMAlarmClocks(){
				...
				return new BasicWrappingEList<EcuMAlarmClock, GContainer>(filteredContainers, typeof(EcuMAlarmClock), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMAlarmClock ecuMAlarmClock) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMAlarmClock ecuMAlarmClock) {
						ecuMAlarmClock.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMAlarmClock"))
			...
			def List<EcuMFlexUserConfig> getEcuMFlexUserConfigs(){
				...
				return new BasicWrappingEList<EcuMFlexUserConfig, GContainer>(filteredContainers, typeof(EcuMFlexUserConfig), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig ecuMFlexUserConfig) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig ecuMFlexUserConfig) {
						ecuMFlexUserConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMFlexUserConfig"))
			...
			def List<EcuMResetMode> getEcuMResetModes(){
				...
				return new BasicWrappingEList<EcuMResetMode, GContainer>(filteredContainers, typeof(EcuMResetMode), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode ecuMResetMode) {
						ecuMResetMode.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMResetMode"))
						super.delegateAdd(ecuMResetMode)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMResetMode ecuMResetMode) {
						ecuMResetMode.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMResetMode"))
			...
			def List<EcuMShutdownCause> getEcuMShutdownCauses(){
				...
				return new BasicWrappingEList<EcuMShutdownCause, GContainer>(filteredContainers, typeof(EcuMShutdownCause), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMShutdownCause ecuMShutdownCause) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMShutdownCause ecuMShutdownCause) {
						ecuMShutdownCause.target?.gSetDefinition(containerValue.getContainerDefinition("EcuMShutdownCause"))
			...
			static class EcuMAlarmClock implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig getEcuMAlarmClockUser(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig), "EcuMAlarmClockUser")
				}
				
				def void setEcuMAlarmClockUser(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EcuMFlexUserConfig implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition getEcuMFlexEcucPartitionRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition), "EcuMFlexEcucPartitionRef")
				}
				
				def void setEcuMFlexEcucPartitionRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EcuMGoDownAllowedUsers implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig> getEcuMGoDownAllowedUserRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig)) {
						override protected wrap(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig object) throws CoreException {
							if (object !== null) {
								val container = object.getTarget()
								val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
								referenceValue.gSetDefinition(referenceValueDef)
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								val referenceValueValue = referenceValue.gGetValue
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig(referenceValueValue as GContainer)
								}
							}
						}
					}
			...
			static class EcuMSetClockAllowedUsers implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMFlexConfiguration.EcuMFlexUserConfig> getEcuMSetClockAllowedUserRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
	...
	static class EcuMFixedGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getEcuMTTIIWakeupSourceRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "EcuMTTIIWakeupSourceRef")
		}
		
		def void setEcuMTTIIWakeupSourceRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class EcuMFlexGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getEcuMAlarmWakeupSource(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "EcuMAlarmWakeupSource")
		}
		
		def void setEcuMAlarmWakeupSource(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
