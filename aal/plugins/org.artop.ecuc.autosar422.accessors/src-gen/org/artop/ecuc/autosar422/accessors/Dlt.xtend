...
class Dlt implements IWrapper<GModuleConfiguration> {
	...
	def List<DltVfbTrace> getDltVfbTraces(){
		...
		return new BasicWrappingEList<DltVfbTrace, GContainer>(filteredContainers, typeof(DltVfbTrace), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Dlt.DltVfbTrace dltVfbTrace) {
				dltVfbTrace.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("DltVfbTrace"))
				super.delegateAdd(dltVfbTrace)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Dlt.DltVfbTrace dltVfbTrace) {
				dltVfbTrace.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("DltVfbTrace"))
	...
	static class DltGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration getDltGptChannel(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration), "DltGptChannel")
		}
		
		def void setDltGptChannel(org.artop.ecuc.autosar422.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DltMultipleConfigurationContainer implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor getDltNvRamBlockRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor), "DltNvRamBlockRef")
		}
		
		def void setDltNvRamBlockRef(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
