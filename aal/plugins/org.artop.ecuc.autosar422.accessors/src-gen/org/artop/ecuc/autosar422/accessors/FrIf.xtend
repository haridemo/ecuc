	...
	static class FrIfConfig implements IWrapper<GContainer> {
		...
		def List<FrIfCluster> getFrIfClusters(){
			...
			return new BasicWrappingEList<FrIfCluster, GContainer>(filteredContainers, typeof(FrIfCluster), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster frIfCluster) {
					frIfCluster.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfCluster"))
					super.delegateAdd(frIfCluster)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster frIfCluster) {
					frIfCluster.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfCluster"))
		...
		def List<FrIfFrameStructure> getFrIfFrameStructures(){
			...
			return new BasicWrappingEList<FrIfFrameStructure, GContainer>(filteredContainers, typeof(FrIfFrameStructure), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure frIfFrameStructure) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure frIfFrameStructure) {
					frIfFrameStructure.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfFrameStructure"))
		...
		def List<FrIfPdu> getFrIfPdus(){
			...
			return new BasicWrappingEList<FrIfPdu, GContainer>(filteredContainers, typeof(FrIfPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfPdu frIfPdu) {
					frIfPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfPdu"))
					super.delegateAdd(frIfPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfPdu frIfPdu) {
					frIfPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfPdu"))
		...
		static class FrIfCluster implements IWrapper<GContainer> {
			...
			def List<FrIfController> getFrIfControllers(){
				...
				return new BasicWrappingEList<FrIfController, GContainer>(filteredContainers, typeof(FrIfController), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController frIfController) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController frIfController) {
						frIfController.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfController"))
			...
			static class FrIfClusterDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_ACS_CH_A(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_ACS_CH_A")
				}
				
				def void setFRIF_E_ACS_CH_A(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_ACS_CH_B(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_ACS_CH_B")
				}
				
				def void setFRIF_E_ACS_CH_B(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_NIT_CH_A(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_NIT_CH_A")
				}
				
				def void setFRIF_E_NIT_CH_A(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_NIT_CH_B(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_NIT_CH_B")
				}
				
				def void setFRIF_E_NIT_CH_B(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_SW_CH_A(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_SW_CH_A")
				}
				
				def void setFRIF_E_SW_CH_A(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_SW_CH_B(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_SW_CH_B")
				}
				
				def void setFRIF_E_SW_CH_B(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrIfController implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Fr.FrMultipleConfiguration.FrController getFrIfFrCtrlRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Fr.FrMultipleConfiguration.FrController), "FrIfFrCtrlRef")
				}
				
				def void setFrIfFrCtrlRef(org.artop.ecuc.autosar422.accessors.Fr.FrMultipleConfiguration.FrController object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<FrIfFrameTriggering> getFrIfFrameTriggerings(){
					...
					return new BasicWrappingEList<FrIfFrameTriggering, GContainer>(filteredContainers, typeof(FrIfFrameTriggering), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfFrameTriggering frIfFrameTriggering) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfFrameTriggering frIfFrameTriggering) {
							frIfFrameTriggering.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfFrameTriggering"))
				...
				def List<FrIfLPdu> getFrIfLPdus(){
					...
					return new BasicWrappingEList<FrIfLPdu, GContainer>(filteredContainers, typeof(FrIfLPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfLPdu frIfLPdu) {
							frIfLPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfLPdu"))
							super.delegateAdd(frIfLPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfLPdu frIfLPdu) {
							frIfLPdu.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfLPdu"))
				...
				def List<FrIfTransceiver> getFrIfTransceivers(){
					...
					return new BasicWrappingEList<FrIfTransceiver, GContainer>(filteredContainers, typeof(FrIfTransceiver), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfTransceiver frIfTransceiver) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfTransceiver frIfTransceiver) {
							frIfTransceiver.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfTransceiver"))
				...
				static class FrIfFrameTriggering implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure getFrIfFrameStructureRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure), "FrIfFrameStructureRef")
					}
					
					def void setFrIfFrameStructureRef(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class FrIfFrameTriggeringDemEventParameterRefs implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFRIF_E_LPDU_SLOTSTATUS(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FRIF_E_LPDU_SLOTSTATUS")
						}
						
						def void setFRIF_E_LPDU_SLOTSTATUS(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
				...
				static class FrIfLPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfFrameTriggering getFrIfVBTriggeringRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfFrameTriggering), "FrIfVBTriggeringRef")
					}
					
					def void setFrIfVBTriggeringRef(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfFrameTriggering object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class FrIfTransceiver implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.FrTrcv.FrTrcvChannel getFrIfFrTrcvChannelRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FrTrcv.FrTrcvChannel), "FrIfFrTrcvChannelRef")
					}
					
					def void setFrIfFrTrcvChannelRef(org.artop.ecuc.autosar422.accessors.FrTrcv.FrTrcvChannel object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class FrIfJobList implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Fr.FrMultipleConfiguration.FrController.FrAbsoluteTimer getFrIfAbsTimerRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Fr.FrMultipleConfiguration.FrController.FrAbsoluteTimer), "FrIfAbsTimerRef")
				}
				
				def void setFrIfAbsTimerRef(org.artop.ecuc.autosar422.accessors.Fr.FrMultipleConfiguration.FrController.FrAbsoluteTimer object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<FrIfJob> getFrIfJobs(){
					...
					return new BasicWrappingEList<FrIfJob, GContainer>(filteredContainers, typeof(FrIfJob), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfJobList.FrIfJob frIfJob) {
							frIfJob.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfJob"))
							super.delegateAdd(frIfJob)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfJobList.FrIfJob frIfJob) {
							frIfJob.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfJob"))
				...
				static class FrIfJob implements IWrapper<GContainer> {
					...
					def List<FrIfCommunicationOperation> getFrIfCommunicationOperations(){
						...
						return new BasicWrappingEList<FrIfCommunicationOperation, GContainer>(filteredContainers, typeof(FrIfCommunicationOperation), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfJobList.FrIfJob.FrIfCommunicationOperation frIfCommunicationOperation) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfJobList.FrIfJob.FrIfCommunicationOperation frIfCommunicationOperation) {
								frIfCommunicationOperation.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfCommunicationOperation"))
					...
					static class FrIfCommunicationOperation implements IWrapper<GContainer> {
						...
						def org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfLPdu getFrIfLPduIdxRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfLPdu), "FrIfLPduIdxRef")
						}
						
						def void setFrIfLPduIdxRef(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfCluster.FrIfController.FrIfLPdu object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
		...
		static class FrIfFrameStructure implements IWrapper<GContainer> {
			...
			def List<FrIfPdusInFrame> getFrIfPdusInFrames(){
				...
				return new BasicWrappingEList<FrIfPdusInFrame, GContainer>(filteredContainers, typeof(FrIfPdusInFrame), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure.FrIfPdusInFrame frIfPdusInFrame) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfFrameStructure.FrIfPdusInFrame frIfPdusInFrame) {
						frIfPdusInFrame.target?.gSetDefinition(containerValue.getContainerDefinition("FrIfPdusInFrame"))
			...
			static class FrIfPdusInFrame implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfPdu getFrIfPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfPdu), "FrIfPduRef")
				}
				
				def void setFrIfPduRef(org.artop.ecuc.autosar422.accessors.FrIf.FrIfConfig.FrIfPdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class FrIfPdu implements IWrapper<GContainer> {
			...
			static class FrIfPduDirection implements IWrapper<GContainer> {
				...
				static class FrIfRxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrIfRxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrIfRxPduRef")
					}
					
					def void setFrIfRxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class FrIfTxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getFrIfTxPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "FrIfTxPduRef")
					}
					
					def void setFrIfTxPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
