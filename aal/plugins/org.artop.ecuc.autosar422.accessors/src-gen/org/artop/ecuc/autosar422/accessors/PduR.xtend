...
class PduR implements IWrapper<GModuleConfiguration> {
	...
	def List<PduRBswModules> getPduRBswModules(){
		...
		return new BasicWrappingEList<PduRBswModules, GContainer>(filteredContainers, typeof(PduRBswModules), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRBswModules pduRBswModules) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRBswModules pduRBswModules) {
				pduRBswModules.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("PduRBswModules"))
	...
	static class PduRRoutingTables implements IWrapper<GContainer> {
		...
		def List<PduRRoutingPathGroup> getPduRRoutingPathGroups(){
			...
			return new BasicWrappingEList<PduRRoutingPathGroup, GContainer>(filteredContainers, typeof(PduRRoutingPathGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingPathGroup pduRRoutingPathGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingPathGroup pduRRoutingPathGroup) {
					pduRRoutingPathGroup.target?.gSetDefinition(containerValue.getContainerDefinition("PduRRoutingPathGroup"))
		...
		def List<PduRRoutingTable> getPduRRoutingTables(){
			...
			return new BasicWrappingEList<PduRRoutingTable, GContainer>(filteredContainers, typeof(PduRRoutingTable), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable pduRRoutingTable) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable pduRRoutingTable) {
					pduRRoutingTable.target?.gSetDefinition(containerValue.getContainerDefinition("PduRRoutingTable"))
		...
		static class PduRRoutingPathGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu> getPduRDestPduRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu object) throws CoreException {
						if (object != null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue != null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu(referenceValueValue as GContainer)
							}
						}
					}
				}
		...
		static class PduRRoutingTable implements IWrapper<GContainer> {
			...
			def List<PduRRoutingPath> getPduRRoutingPaths(){
				...
				return new BasicWrappingEList<PduRRoutingPath, GContainer>(filteredContainers, typeof(PduRRoutingPath), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath pduRRoutingPath) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath pduRRoutingPath) {
						pduRRoutingPath.target?.gSetDefinition(containerValue.getContainerDefinition("PduRRoutingPath"))
			...
			static class PduRRoutingPath implements IWrapper<GContainer> {
				...
				def List<PduRDestPdu> getPduRDestPdus(){
					...
					return new BasicWrappingEList<PduRDestPdu, GContainer>(filteredContainers, typeof(PduRDestPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu pduRDestPdu) {
							pduRDestPdu.target?.gSetDefinition(containerValue.getContainerDefinition("PduRDestPdu"))
							super.delegateAdd(pduRDestPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu pduRDestPdu) {
							pduRDestPdu.target?.gSetDefinition(containerValue.getContainerDefinition("PduRDestPdu"))
				...
				static class PduRDestPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getPduRDestPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "PduRDestPduRef")
					}
					
					def void setPduRDestPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTxBufferTable.PduRTxBuffer getPduRDestTxBufferRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTxBufferTable.PduRTxBuffer), "PduRDestTxBufferRef")
					}
					
					def void setPduRDestTxBufferRef(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTxBufferTable.PduRTxBuffer object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class PduRDefaultValue implements IWrapper<GContainer> {
						...
						def List<PduRDefaultValueElement> getPduRDefaultValueElements(){
							...
							return new BasicWrappingEList<PduRDefaultValueElement, GContainer>(filteredContainers, typeof(PduRDefaultValueElement), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu.PduRDefaultValue.PduRDefaultValueElement pduRDefaultValueElement) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRRoutingTable.PduRRoutingPath.PduRDestPdu.PduRDefaultValue.PduRDefaultValueElement pduRDefaultValueElement) {
									pduRDefaultValueElement.target?.gSetDefinition(containerValue.getContainerDefinition("PduRDefaultValueElement"))
				...
				static class PduRSrcPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getPduRSrcPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "PduRSrcPduRef")
					}
					
					def void setPduRSrcPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
		...
		static class PduRTpBufferTable implements IWrapper<GContainer> {
			...
			def List<PduRTpBuffer> getPduRTpBuffers(){
				...
				return new BasicWrappingEList<PduRTpBuffer, GContainer>(filteredContainers, typeof(PduRTpBuffer), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTpBufferTable.PduRTpBuffer pduRTpBuffer) {
						pduRTpBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("PduRTpBuffer"))
						super.delegateAdd(pduRTpBuffer)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTpBufferTable.PduRTpBuffer pduRTpBuffer) {
						pduRTpBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("PduRTpBuffer"))
		...
		static class PduRTxBufferTable implements IWrapper<GContainer> {
			...
			def List<PduRTxBuffer> getPduRTxBuffers(){
				...
				return new BasicWrappingEList<PduRTxBuffer, GContainer>(filteredContainers, typeof(PduRTxBuffer), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTxBufferTable.PduRTxBuffer pduRTxBuffer) {
						pduRTxBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("PduRTxBuffer"))
						super.delegateAdd(pduRTxBuffer)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.PduR.PduRRoutingTables.PduRTxBufferTable.PduRTxBuffer pduRTxBuffer) {
						pduRTxBuffer.target?.gSetDefinition(containerValue.getContainerDefinition("PduRTxBuffer"))
