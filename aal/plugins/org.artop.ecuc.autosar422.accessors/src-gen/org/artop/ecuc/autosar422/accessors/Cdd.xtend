...
class Cdd implements IWrapper<GModuleConfiguration> {
		...
		static class CddComIfUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddComIfUpperLayerRxPdu> getCddComIfUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddComIfUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
						cddComIfUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerRxPdu"))
			...
			def List<CddComIfUpperLayerTxPdu> getCddComIfUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddComIfUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
						cddComIfUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerTxPdu"))
			...
			static class CddComIfUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddComIfPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddComIfPduRef")
				}
				
				def void setCddComIfPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddComMLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddComMLowerLayerChannel> getCddComMLowerLayerChannels(){
				...
				return new BasicWrappingEList<CddComMLowerLayerChannel, GContainer>(filteredContainers, typeof(CddComMLowerLayerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
						cddComMLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddComMLowerLayerChannel"))
			...
			static class CddComMLowerLayerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getCddComMLowerLayerChannelRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "CddComMLowerLayerChannelRef")
				}
				
				def void setCddComMLowerLayerChannelRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddGenericNmLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddGenericNmLowerLayerChannel> getCddGenericNmLowerLayerChannels(){
				...
				return new BasicWrappingEList<CddGenericNmLowerLayerChannel, GContainer>(filteredContainers, typeof(CddGenericNmLowerLayerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
						cddGenericNmLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddGenericNmLowerLayerChannel"))
			...
			static class CddGenericNmLowerLayerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getCddGenericNmComMNetworkHandleRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "CddGenericNmComMNetworkHandleRef")
				}
				
				def void setCddGenericNmComMNetworkHandleRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddPduRLowerLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddPduRLowerLayerRxPdu> getCddPduRLowerLayerRxPdus(){
				...
				return new BasicWrappingEList<CddPduRLowerLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
						cddPduRLowerLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerRxPdu"))
			...
			def List<CddPduRLowerLayerTxPdu> getCddPduRLowerLayerTxPdus(){
				...
				return new BasicWrappingEList<CddPduRLowerLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
						cddPduRLowerLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerTxPdu"))
			...
			static class CddPduRLowerLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddPduRLowerLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddPduRLowerLayerPduRef")
				}
				
				def void setCddPduRLowerLayerPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddPduRUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddPduRUpperLayerRxPdu> getCddPduRUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddPduRUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
						cddPduRUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerRxPdu"))
			...
			def List<CddPduRUpperLayerTxPdu> getCddPduRUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddPduRUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
						cddPduRUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerTxPdu"))
			...
			static class CddPduRUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddPduRUpperLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddPduRUpperLayerPduRef")
				}
				
				def void setCddPduRUpperLayerPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CddSoAdUpperLayerContribution implements IWrapper<GContainer> {
			...
			def List<CddSoAdUpperLayerRxPdu> getCddSoAdUpperLayerRxPdus(){
				...
				return new BasicWrappingEList<CddSoAdUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerRxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
						cddSoAdUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerRxPdu"))
			...
			def List<CddSoAdUpperLayerTxPdu> getCddSoAdUpperLayerTxPdus(){
				...
				return new BasicWrappingEList<CddSoAdUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerTxPdu), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
						cddSoAdUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerTxPdu"))
			...
			static class CddSoAdUpperLayerRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCddSoAdUpperLayerPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CddSoAdUpperLayerPduRef")
				}
				
				def void setCddSoAdUpperLayerPduRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CddConfigSet implements IWrapper<GContainer> {
		...
		static class CddComStackContribution implements IWrapper<GContainer> {
			...
			static class CddComIfUpperLayerContribution implements IWrapper<GContainer> {
				...
				def List<CddComIfUpperLayerRxPdu> getCddComIfUpperLayerRxPdus(){
					...
					return new BasicWrappingEList<CddComIfUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerRxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
							cddComIfUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerRxPdu"))
							super.delegateAdd(cddComIfUpperLayerRxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerRxPdu cddComIfUpperLayerRxPdu) {
							cddComIfUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerRxPdu"))
							super.delegateAdd(index, cddComIfUpperLayerRxPdu)
						}
					}
				...
				def List<CddComIfUpperLayerTxPdu> getCddComIfUpperLayerTxPdus(){
					...
					return new BasicWrappingEList<CddComIfUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddComIfUpperLayerTxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
							cddComIfUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerTxPdu"))
							super.delegateAdd(cddComIfUpperLayerTxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddComIfUpperLayerContribution.CddComIfUpperLayerTxPdu cddComIfUpperLayerTxPdu) {
							cddComIfUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddComIfUpperLayerTxPdu"))
							super.delegateAdd(index, cddComIfUpperLayerTxPdu)
						}
					}
			...
			static class CddComMLowerLayerContribution implements IWrapper<GContainer> {
				...
				def List<CddComMLowerLayerChannel> getCddComMLowerLayerChannels(){
					...
					return new BasicWrappingEList<CddComMLowerLayerChannel, GContainer>(filteredContainers, typeof(CddComMLowerLayerChannel), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
							cddComMLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddComMLowerLayerChannel"))
							super.delegateAdd(cddComMLowerLayerChannel)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddComMLowerLayerContribution.CddComMLowerLayerChannel cddComMLowerLayerChannel) {
							cddComMLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddComMLowerLayerChannel"))
							super.delegateAdd(index, cddComMLowerLayerChannel)
						}
					}
			...
			static class CddGenericNmLowerLayerContribution implements IWrapper<GContainer> {
				...
				def List<CddGenericNmLowerLayerChannel> getCddGenericNmLowerLayerChannels(){
					...
					return new BasicWrappingEList<CddGenericNmLowerLayerChannel, GContainer>(filteredContainers, typeof(CddGenericNmLowerLayerChannel), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
							cddGenericNmLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddGenericNmLowerLayerChannel"))
							super.delegateAdd(cddGenericNmLowerLayerChannel)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddGenericNmLowerLayerContribution.CddGenericNmLowerLayerChannel cddGenericNmLowerLayerChannel) {
							cddGenericNmLowerLayerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("CddGenericNmLowerLayerChannel"))
							super.delegateAdd(index, cddGenericNmLowerLayerChannel)
						}
					}
			...
			static class CddPduRLowerLayerContribution implements IWrapper<GContainer> {
				...
				def List<CddPduRLowerLayerRxPdu> getCddPduRLowerLayerRxPdus(){
					...
					return new BasicWrappingEList<CddPduRLowerLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerRxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
							cddPduRLowerLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerRxPdu"))
							super.delegateAdd(cddPduRLowerLayerRxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerRxPdu cddPduRLowerLayerRxPdu) {
							cddPduRLowerLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerRxPdu"))
							super.delegateAdd(index, cddPduRLowerLayerRxPdu)
						}
					}
				...
				def List<CddPduRLowerLayerTxPdu> getCddPduRLowerLayerTxPdus(){
					...
					return new BasicWrappingEList<CddPduRLowerLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRLowerLayerTxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
							cddPduRLowerLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerTxPdu"))
							super.delegateAdd(cddPduRLowerLayerTxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRLowerLayerContribution.CddPduRLowerLayerTxPdu cddPduRLowerLayerTxPdu) {
							cddPduRLowerLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRLowerLayerTxPdu"))
							super.delegateAdd(index, cddPduRLowerLayerTxPdu)
						}
					}
			...
			static class CddPduRUpperLayerContribution implements IWrapper<GContainer> {
				...
				def List<CddPduRUpperLayerRxPdu> getCddPduRUpperLayerRxPdus(){
					...
					return new BasicWrappingEList<CddPduRUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerRxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
							cddPduRUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerRxPdu"))
							super.delegateAdd(cddPduRUpperLayerRxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerRxPdu cddPduRUpperLayerRxPdu) {
							cddPduRUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerRxPdu"))
							super.delegateAdd(index, cddPduRUpperLayerRxPdu)
						}
					}
				...
				def List<CddPduRUpperLayerTxPdu> getCddPduRUpperLayerTxPdus(){
					...
					return new BasicWrappingEList<CddPduRUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddPduRUpperLayerTxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
							cddPduRUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerTxPdu"))
							super.delegateAdd(cddPduRUpperLayerTxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddPduRUpperLayerContribution.CddPduRUpperLayerTxPdu cddPduRUpperLayerTxPdu) {
							cddPduRUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddPduRUpperLayerTxPdu"))
							super.delegateAdd(index, cddPduRUpperLayerTxPdu)
						}
					}
			...
			static class CddSoAdUpperLayerContribution implements IWrapper<GContainer> {
				...
				def List<CddSoAdUpperLayerRxPdu> getCddSoAdUpperLayerRxPdus(){
					...
					return new BasicWrappingEList<CddSoAdUpperLayerRxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerRxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
							cddSoAdUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerRxPdu"))
							super.delegateAdd(cddSoAdUpperLayerRxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerRxPdu cddSoAdUpperLayerRxPdu) {
							cddSoAdUpperLayerRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerRxPdu"))
							super.delegateAdd(index, cddSoAdUpperLayerRxPdu)
						}
					}
				...
				def List<CddSoAdUpperLayerTxPdu> getCddSoAdUpperLayerTxPdus(){
					...
					return new BasicWrappingEList<CddSoAdUpperLayerTxPdu, GContainer>(filteredContainers, typeof(CddSoAdUpperLayerTxPdu), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
							cddSoAdUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerTxPdu"))
							super.delegateAdd(cddSoAdUpperLayerTxPdu)
						}
				
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Cdd.CddConfigSet.CddComStackContribution.CddSoAdUpperLayerContribution.CddSoAdUpperLayerTxPdu cddSoAdUpperLayerTxPdu) {
							cddSoAdUpperLayerTxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("CddSoAdUpperLayerTxPdu"))
							super.delegateAdd(index, cddSoAdUpperLayerTxPdu)
						}
					}
		...
		static class CddEcucPartitionInteraction implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition getCddEcucPartitionRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition), "CddEcucPartitionRef")
			}
			
			def void setCddEcucPartitionRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
