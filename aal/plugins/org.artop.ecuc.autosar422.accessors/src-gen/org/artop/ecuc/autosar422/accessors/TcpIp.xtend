	...
	static class TcpIpConfig implements IWrapper<GContainer> {
		...
		def List<TcpIpCtrl> getTcpIpCtrls(){
			...
			return new BasicWrappingEList<TcpIpCtrl, GContainer>(filteredContainers, typeof(TcpIpCtrl), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpCtrl tcpIpCtrl) {
					tcpIpCtrl.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpCtrl"))
					super.delegateAdd(tcpIpCtrl)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpCtrl tcpIpCtrl) {
					tcpIpCtrl.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpCtrl"))
		...
		def List<TcpIpDhcpServerConfig> getTcpIpDhcpServerConfigs(){
			...
			return new BasicWrappingEList<TcpIpDhcpServerConfig, GContainer>(filteredContainers, typeof(TcpIpDhcpServerConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig tcpIpDhcpServerConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig tcpIpDhcpServerConfig) {
					tcpIpDhcpServerConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpDhcpServerConfig"))
		...
		def List<TcpIpLocalAddr> getTcpIpLocalAddrs(){
			...
			return new BasicWrappingEList<TcpIpLocalAddr, GContainer>(filteredContainers, typeof(TcpIpLocalAddr), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr tcpIpLocalAddr) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr tcpIpLocalAddr) {
					tcpIpLocalAddr.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpLocalAddr"))
		...
		static class TcpIpCtrl implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig getTcpIpDhcpServerConfigRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig), "TcpIpDhcpServerConfigRef")
			}
			
			def void setTcpIpDhcpServerConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.EthIf.EthIfConfigSet.EthIfController getTcpIpEthIfCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EthIf.EthIfConfigSet.EthIfController), "TcpIpEthIfCtrlRef")
			}
			
			def void setTcpIpEthIfCtrlRef(org.artop.ecuc.autosar422.accessors.EthIf.EthIfConfigSet.EthIfController object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class TcpIpCtrlDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getTCPIP_E_CONNREFUSED(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "TCPIP_E_CONNREFUSED")
				}
				
				def void setTCPIP_E_CONNREFUSED(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "TCPIP_E_CONNREFUSED"], object.getTarget())
					}
				}
				
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getTCPIP_E_HOSTUNREACH(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "TCPIP_E_HOSTUNREACH")
				}
				
				def void setTCPIP_E_HOSTUNREACH(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "TCPIP_E_HOSTUNREACH"], object.getTarget())
					}
				}
				
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getTCPIP_E_PACKETTOBIG(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "TCPIP_E_PACKETTOBIG")
				}
				
				def void setTCPIP_E_PACKETTOBIG(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "TCPIP_E_PACKETTOBIG"], object.getTarget())
					}
				}
				
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getTCPIP_E_TIMEDOUT(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "TCPIP_E_TIMEDOUT")
				}
				
				def void setTCPIP_E_TIMEDOUT(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "TCPIP_E_TIMEDOUT"], object.getTarget())
					}
				}
			...
			static class TcpIpIpVXCtrl implements IWrapper<GContainer> {
				...
				static class TcpIpIpV4Ctrl implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpArpConfig getTcpIpArpConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpArpConfig), "TcpIpArpConfigRef")
					}
					
					def void setTcpIpArpConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpArpConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpAutoIpConfig getTcpIpAutoIpConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpAutoIpConfig), "TcpIpAutoIpConfigRef")
					}
					
					def void setTcpIpAutoIpConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpAutoIpConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpDhcpConfig getTcpIpDhcpConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpDhcpConfig), "TcpIpDhcpConfigRef")
					}
					
					def void setTcpIpDhcpConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpDhcpConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpIpFragmentationConfig getTcpIpFragmentationConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpIpFragmentationConfig), "TcpIpFragmentationConfigRef")
					}
					
					def void setTcpIpFragmentationConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpIpFragmentationConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
				...
				static class TcpIpIpV6Ctrl implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpDhcpV6Config getTcpIpIpV6DhcpConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpDhcpV6Config), "TcpIpIpV6DhcpConfigRef")
					}
					
					def void setTcpIpIpV6DhcpConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpDhcpV6Config object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpIpV6FragmentationConfig getTcpIpIpV6FragmentationConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpIpV6FragmentationConfig), "TcpIpIpV6FragmentationConfigRef")
					}
					
					def void setTcpIpIpV6FragmentationConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpIpV6FragmentationConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpNdpConfig getTcpIpIpV6NdpConfigRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpNdpConfig), "TcpIpIpV6NdpConfigRef")
					}
					
					def void setTcpIpIpV6NdpConfigRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpNdpConfig object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					static class TcpIpIpV6MtuConfig implements IWrapper<GContainer> {
						...
						def BigInteger getTcpIpIpV6DefaultMtuSize(){
							containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "TcpIpIpV6DefaultMtuSize"].getBigIntegerValue()
						}
		...
		static class TcpIpDhcpServerConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.EthIf.EthIfConfigSet.EthIfSwitch getTcpIpDhcpEthIfSwitchRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EthIf.EthIfConfigSet.EthIfSwitch), "TcpIpDhcpEthIfSwitchRef")
			}
			
			def void setTcpIpDhcpEthIfSwitchRef(org.artop.ecuc.autosar422.accessors.EthIf.EthIfConfigSet.EthIfSwitch object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<TcpIpDhcpAddressAssignment> getTcpIpDhcpAddressAssignments(){
				...
				return new BasicWrappingEList<TcpIpDhcpAddressAssignment, GContainer>(filteredContainers, typeof(TcpIpDhcpAddressAssignment), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig.TcpIpDhcpAddressAssignment tcpIpDhcpAddressAssignment) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpDhcpServerConfig.TcpIpDhcpAddressAssignment tcpIpDhcpAddressAssignment) {
						tcpIpDhcpAddressAssignment.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpDhcpAddressAssignment"))
			...
			static class TcpIpDhcpAddressAssignment implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.EthSwt.EthSwtConfig.EthSwtPort getTcpIpDhcpSwitchPortRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EthSwt.EthSwtConfig.EthSwtPort), "TcpIpDhcpSwitchPortRef")
				}
				
				def void setTcpIpDhcpSwitchPortRef(org.artop.ecuc.autosar422.accessors.EthSwt.EthSwtConfig.EthSwtPort object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class TcpIpIpV4Config implements IWrapper<GContainer> {
				...
				def List<TcpIpArpConfig> getTcpIpArpConfigs(){
					...
					return new BasicWrappingEList<TcpIpArpConfig, GContainer>(filteredContainers, typeof(TcpIpArpConfig), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpArpConfig tcpIpArpConfig) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpArpConfig tcpIpArpConfig) {
							tcpIpArpConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpArpConfig"))
				...
				def List<TcpIpAutoIpConfig> getTcpIpAutoIpConfigs(){
					...
					return new BasicWrappingEList<TcpIpAutoIpConfig, GContainer>(filteredContainers, typeof(TcpIpAutoIpConfig), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpAutoIpConfig tcpIpAutoIpConfig) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpAutoIpConfig tcpIpAutoIpConfig) {
							tcpIpAutoIpConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpAutoIpConfig"))
				...
				def List<TcpIpDhcpConfig> getTcpIpDhcpConfigs(){
					...
					return new BasicWrappingEList<TcpIpDhcpConfig, GContainer>(filteredContainers, typeof(TcpIpDhcpConfig), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpDhcpConfig tcpIpDhcpConfig) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpDhcpConfig tcpIpDhcpConfig) {
							tcpIpDhcpConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpDhcpConfig"))
				...
				def List<TcpIpIpFragmentationConfig> getTcpIpIpFragmentationConfigs(){
					...
					return new BasicWrappingEList<TcpIpIpFragmentationConfig, GContainer>(filteredContainers, typeof(TcpIpIpFragmentationConfig), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpIpFragmentationConfig tcpIpIpFragmentationConfig) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV4Config.TcpIpIpFragmentationConfig tcpIpIpFragmentationConfig) {
							tcpIpIpFragmentationConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpIpFragmentationConfig"))
			...
			static class TcpIpIpV6Config implements IWrapper<GContainer> {
				...
				def List<TcpIpDhcpV6Config> getTcpIpDhcpV6Configs(){
					...
					return new BasicWrappingEList<TcpIpDhcpV6Config, GContainer>(filteredContainers, typeof(TcpIpDhcpV6Config), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpDhcpV6Config tcpIpDhcpV6Config) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpDhcpV6Config tcpIpDhcpV6Config) {
							tcpIpDhcpV6Config.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpDhcpV6Config"))
				...
				def List<TcpIpIpV6FragmentationConfig> getTcpIpIpV6FragmentationConfigs(){
					...
					return new BasicWrappingEList<TcpIpIpV6FragmentationConfig, GContainer>(filteredContainers, typeof(TcpIpIpV6FragmentationConfig), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpIpV6FragmentationConfig tcpIpIpV6FragmentationConfig) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpIpV6FragmentationConfig tcpIpIpV6FragmentationConfig) {
							tcpIpIpV6FragmentationConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpIpV6FragmentationConfig"))
				...
				def List<TcpIpNdpConfig> getTcpIpNdpConfigs(){
					...
					return new BasicWrappingEList<TcpIpNdpConfig, GContainer>(filteredContainers, typeof(TcpIpNdpConfig), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpNdpConfig tcpIpNdpConfig) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpIpConfig.TcpIpIpV6Config.TcpIpNdpConfig tcpIpNdpConfig) {
							tcpIpNdpConfig.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpNdpConfig"))
				...
				static class TcpIpIcmpV6Config implements IWrapper<GContainer> {
					...
					def BigInteger getTcpIpIcmpV6EchoDataBufferSize(){
						containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "TcpIpIcmpV6EchoDataBufferSize"].getBigIntegerValue()
					}
		...
		static class TcpIpLocalAddr implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpCtrl getTcpIpCtrlRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpCtrl), "TcpIpCtrlRef")
			}
			
			def void setTcpIpCtrlRef(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpCtrl object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<TcpIpAddrAssignment> getTcpIpAddrAssignments(){
				...
				return new BasicWrappingEList<TcpIpAddrAssignment, GContainer>(filteredContainers, typeof(TcpIpAddrAssignment), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr.TcpIpAddrAssignment tcpIpAddrAssignment) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpLocalAddr.TcpIpAddrAssignment tcpIpAddrAssignment) {
						tcpIpAddrAssignment.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpAddrAssignment"))
		...
		static class TcpIpNvmBlock implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor getTcpIpNvmBlockDescriptorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor), "TcpIpNvmBlockDescriptorRef")
			}
			
			def void setTcpIpNvmBlockDescriptorRef(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class TcpIpSocketOwnerConfig implements IWrapper<GContainer> {
			...
			def List<TcpIpSocketOwner> getTcpIpSocketOwners(){
				...
				return new BasicWrappingEList<TcpIpSocketOwner, GContainer>(filteredContainers, typeof(TcpIpSocketOwner), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpSocketOwnerConfig.TcpIpSocketOwner tcpIpSocketOwner) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.TcpIp.TcpIpConfig.TcpIpSocketOwnerConfig.TcpIpSocketOwner tcpIpSocketOwner) {
						tcpIpSocketOwner.target?.gSetDefinition(containerValue.getContainerDefinition("TcpIpSocketOwner"))
