	...
	static class ComConfig implements IWrapper<GContainer> {
		...
		def List<ComGwMapping> getComGwMappings(){
			...
			return new BasicWrappingEList<ComGwMapping, GContainer>(filteredContainers, typeof(ComGwMapping), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComGwMapping comGwMapping) {
					comGwMapping.target?.gSetDefinition(containerValue.getContainerDefinition("ComGwMapping"))
					super.delegateAdd(comGwMapping)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComGwMapping comGwMapping) {
					comGwMapping.target?.gSetDefinition(containerValue.getContainerDefinition("ComGwMapping"))
		...
		def List<ComIPdu> getComIPdus(){
			...
			return new BasicWrappingEList<ComIPdu, GContainer>(filteredContainers, typeof(ComIPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPdu comIPdu) {
					comIPdu.target?.gSetDefinition(containerValue.getContainerDefinition("ComIPdu"))
					super.delegateAdd(comIPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPdu comIPdu) {
					comIPdu.target?.gSetDefinition(containerValue.getContainerDefinition("ComIPdu"))
		...
		def List<ComIPduGroup> getComIPduGroups(){
			...
			return new BasicWrappingEList<ComIPduGroup, GContainer>(filteredContainers, typeof(ComIPduGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPduGroup comIPduGroup) {
					comIPduGroup.target?.gSetDefinition(containerValue.getContainerDefinition("ComIPduGroup"))
					super.delegateAdd(comIPduGroup)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPduGroup comIPduGroup) {
					comIPduGroup.target?.gSetDefinition(containerValue.getContainerDefinition("ComIPduGroup"))
		...
		def List<ComSignal> getComSignals(){
			...
			return new BasicWrappingEList<ComSignal, GContainer>(filteredContainers, typeof(ComSignal), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal comSignal) {
					comSignal.target?.gSetDefinition(containerValue.getContainerDefinition("ComSignal"))
					super.delegateAdd(comSignal)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal comSignal) {
					comSignal.target?.gSetDefinition(containerValue.getContainerDefinition("ComSignal"))
		...
		def List<ComSignalGroup> getComSignalGroups(){
			...
			return new BasicWrappingEList<ComSignalGroup, GContainer>(filteredContainers, typeof(ComSignalGroup), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup comSignalGroup) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup comSignalGroup) {
					comSignalGroup.target?.gSetDefinition(containerValue.getContainerDefinition("ComSignalGroup"))
		...
		static class ComGwMapping implements IWrapper<GContainer> {
			...
			def List<ComGwDestination> getComGwDestinations(){
				...
				return new BasicWrappingEList<ComGwDestination, GContainer>(filteredContainers, typeof(ComGwDestination), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComGwMapping.ComGwDestination comGwDestination) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComGwMapping.ComGwDestination comGwDestination) {
						comGwDestination.target?.gSetDefinition(containerValue.getContainerDefinition("ComGwDestination"))
			...
			static class ComGwDestination implements IWrapper<GContainer> {
				...
				static class ComGwDestinationDescription implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPdu getComGwIPduRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPdu), "ComGwIPduRef")
					}
					
					def void setComGwIPduRef(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
		...
		static class ComIPdu implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPduGroup> getComIPduGroupRefs(){
				val containerDef = containerValue.gGetDefinition
			...
			def List<org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup> getComIPduSignalGroupRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def List<org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal> getComIPduSignalRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal object) throws CoreException {
						if (object !== null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getComPduIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "ComPduIdRef")
			}
			
			def void setComPduIdRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			static class ComIPduReplication implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu> getComIPduReplicaRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
					...
					return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu)) {
						override protected wrap(org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object) throws CoreException {
							if (object !== null) {
								val container = object.getTarget()
								val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
								referenceValue.gSetDefinition(referenceValueDef)
						...
						override protected unwrap(GReferenceValue referenceValue) {
							if (referenceValue !== null) {
								val referenceValueValue = referenceValue.gGetValue
								if (referenceValueValue instanceof GContainer) {
									return new org.artop.ecuc.autosar422.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu(referenceValueValue as GContainer)
								}
							}
						}
					}
		...
		static class ComIPduGroup implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComIPduGroup> getComIPduGroupGroupRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
		...
		static class ComSignalGroup implements IWrapper<GContainer> {
			...
			def List<ComGroupSignal> getComGroupSignals(){
				...
				return new BasicWrappingEList<ComGroupSignal, GContainer>(filteredContainers, typeof(ComGroupSignal), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup.ComGroupSignal comGroupSignal) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignalGroup.ComGroupSignal comGroupSignal) {
						comGroupSignal.target?.gSetDefinition(containerValue.getContainerDefinition("ComGroupSignal"))
