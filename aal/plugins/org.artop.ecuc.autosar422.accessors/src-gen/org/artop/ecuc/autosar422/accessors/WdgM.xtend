...
class WdgM implements IWrapper<GModuleConfiguration> {
	...
	static class WdgMConfigSet implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode getWdgMInitialMode(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode), "WdgMInitialMode")
		}
		
		def void setWdgMInitialMode(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode object){
		...
		def List<WdgMMode> getWdgMModes(){
			...
			return new BasicWrappingEList<WdgMMode, GContainer>(filteredContainers, typeof(WdgMMode), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode wdgMMode) {
					wdgMMode.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMMode"))
					super.delegateAdd(wdgMMode)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode wdgMMode) {
					wdgMMode.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMMode"))
		...
		static class WdgMDemEventParameterRefs implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getWDGM_E_IMPROPER_CALLER(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "WDGM_E_IMPROPER_CALLER")
			}
			
			def void setWDGM_E_IMPROPER_CALLER(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "WDGM_E_IMPROPER_CALLER"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getWDGM_E_MONITORING(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "WDGM_E_MONITORING")
			}
			
			def void setWDGM_E_MONITORING(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "WDGM_E_MONITORING"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getWDGM_E_SET_MODE(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "WDGM_E_SET_MODE")
			}
			
			def void setWDGM_E_SET_MODE(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getWDGM_E_SUPERVISION(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "WDGM_E_SUPERVISION")
			}
			
			def void setWDGM_E_SUPERVISION(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class WdgMMode implements IWrapper<GContainer> {
			...
			def List<WdgMAliveSupervision> getWdgMAliveSupervisions(){
				...
				return new BasicWrappingEList<WdgMAliveSupervision, GContainer>(filteredContainers, typeof(WdgMAliveSupervision), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMAliveSupervision wdgMAliveSupervision) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMAliveSupervision wdgMAliveSupervision) {
						wdgMAliveSupervision.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMAliveSupervision"))
			...
			def List<WdgMDeadlineSupervision> getWdgMDeadlineSupervisions(){
				...
				return new BasicWrappingEList<WdgMDeadlineSupervision, GContainer>(filteredContainers, typeof(WdgMDeadlineSupervision), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMDeadlineSupervision wdgMDeadlineSupervision) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMDeadlineSupervision wdgMDeadlineSupervision) {
						wdgMDeadlineSupervision.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMDeadlineSupervision"))
			...
			def List<WdgMExternalLogicalSupervision> getWdgMExternalLogicalSupervisions(){
				...
				return new BasicWrappingEList<WdgMExternalLogicalSupervision, GContainer>(filteredContainers, typeof(WdgMExternalLogicalSupervision), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMExternalLogicalSupervision wdgMExternalLogicalSupervision) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMExternalLogicalSupervision wdgMExternalLogicalSupervision) {
						wdgMExternalLogicalSupervision.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMExternalLogicalSupervision"))
			...
			def List<WdgMLocalStatusParams> getWdgMLocalStatusParams(){
				...
				return new BasicWrappingEList<WdgMLocalStatusParams, GContainer>(filteredContainers, typeof(WdgMLocalStatusParams), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMLocalStatusParams wdgMLocalStatusParams) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMLocalStatusParams wdgMLocalStatusParams) {
						wdgMLocalStatusParams.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMLocalStatusParams"))
			...
			def List<WdgMTrigger> getWdgMTriggers(){
				...
				return new BasicWrappingEList<WdgMTrigger, GContainer>(filteredContainers, typeof(WdgMTrigger), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMTrigger wdgMTrigger) {
						wdgMTrigger.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMTrigger"))
						super.delegateAdd(wdgMTrigger)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMTrigger wdgMTrigger) {
						wdgMTrigger.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMTrigger"))
			...
			static class WdgMAliveSupervision implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMAliveSupervisionCheckpointRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMAliveSupervisionCheckpointRef")
				}
				
				def void setWdgMAliveSupervisionCheckpointRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class WdgMDeadlineSupervision implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMDeadlineStartRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMDeadlineStartRef")
				}
				
				def void setWdgMDeadlineStartRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMDeadlineStopRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMDeadlineStopRef")
				}
				
				def void setWdgMDeadlineStopRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class WdgMExternalLogicalSupervision implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint> getWdgMExternalCheckpointFinalRefs(){
					val containerDef = containerValue.gGetDefinition
				...
				def List<org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint> getWdgMExternalCheckpointInitialRefs(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				def List<WdgMExternalTransition> getWdgMExternalTransitions(){
					...
					return new BasicWrappingEList<WdgMExternalTransition, GContainer>(filteredContainers, typeof(WdgMExternalTransition), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMExternalLogicalSupervision.WdgMExternalTransition wdgMExternalTransition) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMConfigSet.WdgMMode.WdgMExternalLogicalSupervision.WdgMExternalTransition wdgMExternalTransition) {
							wdgMExternalTransition.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMExternalTransition"))
				...
				static class WdgMExternalTransition implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMExternalTransitionDestRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMExternalTransitionDestRef")
					}
					
					def void setWdgMExternalTransitionDestRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
					...
					def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMExternalTransitionSourceRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMExternalTransitionSourceRef")
					}
					
					def void setWdgMExternalTransitionSourceRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class WdgMLocalStatusParams implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity getWdgMLocalStatusSupervisedEntityRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity), "WdgMLocalStatusSupervisedEntityRef")
				}
				
				def void setWdgMLocalStatusSupervisedEntityRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class WdgMTrigger implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMWatchdog getWdgMTriggerWatchdogRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMWatchdog), "WdgMTriggerWatchdogRef")
				}
				
				def void setWdgMTriggerWatchdogRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMWatchdog object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class WdgMGeneral implements IWrapper<GContainer> {
		...
		def Boolean getWdgMDefensiveBehavior(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "WdgMDefensiveBehavior"].getBooleanValue()
		}
		...
		def List<WdgMSupervisedEntity> getWdgMSupervisedEntities(){
			...
			return new BasicWrappingEList<WdgMSupervisedEntity, GContainer>(filteredContainers, typeof(WdgMSupervisedEntity), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity wdgMSupervisedEntity) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity wdgMSupervisedEntity) {
					wdgMSupervisedEntity.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMSupervisedEntity"))
		...
		def List<WdgMWatchdog> getWdgMWatchdogs(){
			...
			return new BasicWrappingEList<WdgMWatchdog, GContainer>(filteredContainers, typeof(WdgMWatchdog), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMWatchdog wdgMWatchdog) {
					wdgMWatchdog.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMWatchdog"))
					super.delegateAdd(wdgMWatchdog)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMWatchdog wdgMWatchdog) {
					wdgMWatchdog.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMWatchdog"))
		...
		static class WdgMSupervisedEntity implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition getWdgMEcucPartitionRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition), "WdgMEcucPartitionRef")
			}
			
			def void setWdgMEcucPartitionRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Os.OsCounter getWdgMOSCounter(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Os.OsCounter), "WdgMOSCounter")
			}
			
			def void setWdgMOSCounter(org.artop.ecuc.autosar422.accessors.Os.OsCounter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Os.OsApplication getWdgMOsApplicationRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Os.OsApplication), "WdgMOsApplicationRef")
			}
			
			def void setWdgMOsApplicationRef(org.artop.ecuc.autosar422.accessors.Os.OsApplication object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMInternalCheckpointInitialRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMInternalCheckpointInitialRef")
			}
			
			def void setWdgMInternalCheckpointInitialRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "WdgMInternalCheckpointInitialRef"], object.getTarget())
				}
			}
			
			def List<org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint> getWdgMInternallCheckpointFinalRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
			...
			def List<WdgMCheckpoint> getWdgMCheckpoints(){
				...
				return new BasicWrappingEList<WdgMCheckpoint, GContainer>(filteredContainers, typeof(WdgMCheckpoint), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint wdgMCheckpoint) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint wdgMCheckpoint) {
						wdgMCheckpoint.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMCheckpoint"))
			...
			def List<WdgMInternalTransition> getWdgMInternalTransitions(){
				...
				return new BasicWrappingEList<WdgMInternalTransition, GContainer>(filteredContainers, typeof(WdgMInternalTransition), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMInternalTransition wdgMInternalTransition) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMInternalTransition wdgMInternalTransition) {
						wdgMInternalTransition.target?.gSetDefinition(containerValue.getContainerDefinition("WdgMInternalTransition"))
			...
			static class WdgMInternalTransition implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMInternalTransitionDestRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMInternalTransitionDestRef")
				}
				
				def void setWdgMInternalTransitionDestRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint getWdgMInternalTransitionSourceRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint), "WdgMInternalTransitionSourceRef")
				}
				
				def void setWdgMInternalTransitionSourceRef(org.artop.ecuc.autosar422.accessors.WdgM.WdgMGeneral.WdgMSupervisedEntity.WdgMCheckpoint object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class WdgMWatchdog implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.WdgIf.WdgIfDevice getWdgMWatchdogDeviceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.WdgIf.WdgIfDevice), "WdgMWatchdogDeviceRef")
			}
			
			def void setWdgMWatchdogDeviceRef(org.artop.ecuc.autosar422.accessors.WdgIf.WdgIfDevice object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
