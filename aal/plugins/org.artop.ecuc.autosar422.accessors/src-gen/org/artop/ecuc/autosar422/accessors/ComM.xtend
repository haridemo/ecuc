...
class ComM implements IWrapper<GModuleConfiguration> {
	...
	static class ComMConfigSet implements IWrapper<GContainer> {
		...
		def List<ComMChannel> getComMChannels(){
			...
			return new BasicWrappingEList<ComMChannel, GContainer>(filteredContainers, typeof(ComMChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel comMChannel) {
					comMChannel.target?.gSetDefinition(containerValue.getContainerDefinition("ComMChannel"))
					super.delegateAdd(comMChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel comMChannel) {
					comMChannel.target?.gSetDefinition(containerValue.getContainerDefinition("ComMChannel"))
		...
		def List<ComMPnc> getComMPncs(){
			...
			return new BasicWrappingEList<ComMPnc, GContainer>(filteredContainers, typeof(ComMPnc), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMPnc comMPnc) {
					comMPnc.target?.gSetDefinition(containerValue.getContainerDefinition("ComMPnc"))
					super.delegateAdd(comMPnc)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMPnc comMPnc) {
					comMPnc.target?.gSetDefinition(containerValue.getContainerDefinition("ComMPnc"))
		...
		def List<ComMUser> getComMUsers(){
			...
			return new BasicWrappingEList<ComMUser, GContainer>(filteredContainers, typeof(ComMUser), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser comMUser) {
					comMUser.target?.gSetDefinition(containerValue.getContainerDefinition("ComMUser"))
					super.delegateAdd(comMUser)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser comMUser) {
					comMUser.target?.gSetDefinition(containerValue.getContainerDefinition("ComMUser"))
		...
		static class ComMChannel implements IWrapper<GContainer> {
			...
			def List<ComMUserPerChannel> getComMUserPerChannels(){
				...
				return new BasicWrappingEList<ComMUserPerChannel, GContainer>(filteredContainers, typeof(ComMUserPerChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel.ComMUserPerChannel comMUserPerChannel) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel.ComMUserPerChannel comMUserPerChannel) {
						comMUserPerChannel.target?.gSetDefinition(containerValue.getContainerDefinition("ComMUserPerChannel"))
			...
			static class ComMUserPerChannel implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser getComMUserChannel(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser), "ComMUserChannel")
				}
				
				def void setComMUserChannel(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class ComMPnc implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel> getComMChannelPerPncs(){
				val containerDef = containerValue.gGetDefinition
			...
			def List<org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser> getComMUserPerPncs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser)) {
					override protected wrap(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser object) throws CoreException {
						if (object != null) {
							val container = object.getTarget()
							val referenceValue = Autosar40Factory.eINSTANCE.createEcucReferenceValue
							referenceValue.gSetDefinition(referenceValueDef)
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue != null) {
							val referenceValueValue = referenceValue.gGetValue
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMUser(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def List<ComMPncComSignal> getComMPncComSignals(){
				...
				return new BasicWrappingEList<ComMPncComSignal, GContainer>(filteredContainers, typeof(ComMPncComSignal), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMPnc.ComMPncComSignal comMPncComSignal) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMPnc.ComMPncComSignal comMPncComSignal) {
						comMPncComSignal.target?.gSetDefinition(containerValue.getContainerDefinition("ComMPncComSignal"))
			...
			static class ComMPncComSignal implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getComMPncComSignalChannelRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "ComMPncComSignalChannelRef")
				}
				
				def void setComMPncComSignalChannelRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal getComMPncComSignalRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal), "ComMPncComSignalRef")
				}
				
				def void setComMPncComSignalRef(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class ComMUser implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition getComMUserEcucPartitionRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition), "ComMUserEcucPartitionRef")
			}
			
			def void setComMUserEcucPartitionRef(org.artop.ecuc.autosar422.accessors.EcuC.EcucPartitionCollection.EcucPartition object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class ComMGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor getComMGlobalNvMBlockDescriptor(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor), "ComMGlobalNvMBlockDescriptor")
		}
		
		def void setComMGlobalNvMBlockDescriptor(org.artop.ecuc.autosar422.accessors.NvM.NvMBlockDescriptor object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
