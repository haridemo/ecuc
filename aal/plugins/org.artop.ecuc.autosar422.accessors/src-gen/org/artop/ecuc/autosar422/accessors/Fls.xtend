...
class Fls implements IWrapper<GModuleConfiguration> {
	...
	static class FlsConfigSet implements IWrapper<GContainer> {
		...
		static class FlsDemEventParameterRefs implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFLS_E_COMPARE_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FLS_E_COMPARE_FAILED")
			}
			
			def void setFLS_E_COMPARE_FAILED(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "FLS_E_COMPARE_FAILED"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFLS_E_ERASE_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FLS_E_ERASE_FAILED")
			}
			
			def void setFLS_E_ERASE_FAILED(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "FLS_E_ERASE_FAILED"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFLS_E_READ_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FLS_E_READ_FAILED")
			}
			
			def void setFLS_E_READ_FAILED(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "FLS_E_READ_FAILED"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFLS_E_UNEXPECTED_FLASH_ID(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FLS_E_UNEXPECTED_FLASH_ID")
			}
			
			def void setFLS_E_UNEXPECTED_FLASH_ID(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "FLS_E_UNEXPECTED_FLASH_ID"], object.getTarget())
				}
			}
			
			def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getFLS_E_WRITE_FAILED(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "FLS_E_WRITE_FAILED")
			}
			
			def void setFLS_E_WRITE_FAILED(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "FLS_E_WRITE_FAILED"], object.getTarget())
				}
			}
		...
		static class FlsExternalDriver implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar422.accessors.Spi.SpiDriver.SpiSequence> getFlsSpiReferences(){
				val containerDef = containerValue.gGetDefinition
		...
		static class FlsSectorList implements IWrapper<GContainer> {
			...
			def List<FlsSector> getFlsSectors(){
				...
				return new BasicWrappingEList<FlsSector, GContainer>(filteredContainers, typeof(FlsSector), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Fls.FlsConfigSet.FlsSectorList.FlsSector flsSector) {
						flsSector.target?.gSetDefinition(containerValue.getContainerDefinition("FlsSector"))
						super.delegateAdd(flsSector)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Fls.FlsConfigSet.FlsSectorList.FlsSector flsSector) {
						flsSector.target?.gSetDefinition(containerValue.getContainerDefinition("FlsSector"))
