...
class Can implements IWrapper<GModuleConfiguration> {
	...
	static class CanConfigSet implements IWrapper<GContainer> {
		...
		def List<CanController> getCanControllers(){
			...
			return new BasicWrappingEList<CanController, GContainer>(filteredContainers, typeof(CanController), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController canController) {
					canController.target?.gSetDefinition(containerValue.getContainerDefinition("CanController"))
					super.delegateAdd(canController)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController canController) {
					canController.target?.gSetDefinition(containerValue.getContainerDefinition("CanController"))
		...
		def List<CanHardwareObject> getCanHardwareObjects(){
			...
			return new BasicWrappingEList<CanHardwareObject, GContainer>(filteredContainers, typeof(CanHardwareObject), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject canHardwareObject) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject canHardwareObject) {
					canHardwareObject.target?.gSetDefinition(containerValue.getContainerDefinition("CanHardwareObject"))
		...
		static class CanController implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController.CanControllerBaudrateConfig getCanControllerDefaultBaudrate(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController.CanControllerBaudrateConfig), "CanControllerDefaultBaudrate")
			}
			
			def void setCanControllerDefaultBaudrate(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController.CanControllerBaudrateConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint getCanCpuClockRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint), "CanCpuClockRef")
			}
			
			def void setCanCpuClockRef(org.artop.ecuc.autosar422.accessors.Mcu.McuModuleConfiguration.McuClockSettingConfig.McuClockReferencePoint object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource getCanWakeupSourceRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource), "CanWakeupSourceRef")
			}
			
			def void setCanWakeupSourceRef(org.artop.ecuc.autosar422.accessors.EcuM.EcuMConfiguration.EcuMCommonConfiguration.EcuMWakeupSource object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<CanControllerBaudrateConfig> getCanControllerBaudrateConfigs(){
				...
				return new BasicWrappingEList<CanControllerBaudrateConfig, GContainer>(filteredContainers, typeof(CanControllerBaudrateConfig), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController.CanControllerBaudrateConfig canControllerBaudrateConfig) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController.CanControllerBaudrateConfig canControllerBaudrateConfig) {
						canControllerBaudrateConfig.target?.gSetDefinition(containerValue.getContainerDefinition("CanControllerBaudrateConfig"))
		...
		static class CanHardwareObject implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController getCanControllerRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController), "CanControllerRef")
			}
			
			def void setCanControllerRef(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanController object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.Can.CanGeneral.CanMainFunctionRWPeriods getCanMainFunctionRWPeriodRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Can.CanGeneral.CanMainFunctionRWPeriods), "CanMainFunctionRWPeriodRef")
			}
			
			def void setCanMainFunctionRWPeriodRef(org.artop.ecuc.autosar422.accessors.Can.CanGeneral.CanMainFunctionRWPeriods object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<CanHwFilter> getCanHwFilters(){
				...
				return new BasicWrappingEList<CanHwFilter, GContainer>(filteredContainers, typeof(CanHwFilter), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanHwFilter canHwFilter) {
						canHwFilter.target?.gSetDefinition(containerValue.getContainerDefinition("CanHwFilter"))
						super.delegateAdd(canHwFilter)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanHwFilter canHwFilter) {
						canHwFilter.target?.gSetDefinition(containerValue.getContainerDefinition("CanHwFilter"))
			...
			def List<CanTTHardwareObjectTrigger> getCanTTHardwareObjectTriggers(){
				...
				return new BasicWrappingEList<CanTTHardwareObjectTrigger, GContainer>(filteredContainers, typeof(CanTTHardwareObjectTrigger), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger canTTHardwareObjectTrigger) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanHardwareObject.CanTTHardwareObjectTrigger canTTHardwareObjectTrigger) {
						canTTHardwareObjectTrigger.target?.gSetDefinition(containerValue.getContainerDefinition("CanTTHardwareObjectTrigger"))
		...
		static class CanIcom implements IWrapper<GContainer> {
			...
			def List<CanIcomConfig> getCanIcomConfigs(){
				...
				return new BasicWrappingEList<CanIcomConfig, GContainer>(filteredContainers, typeof(CanIcomConfig), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanIcom.CanIcomConfig canIcomConfig) {
						canIcomConfig.target?.gSetDefinition(containerValue.getContainerDefinition("CanIcomConfig"))
						super.delegateAdd(canIcomConfig)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanIcom.CanIcomConfig canIcomConfig) {
						canIcomConfig.target?.gSetDefinition(containerValue.getContainerDefinition("CanIcomConfig"))
				...
				static class CanIcomWakeupCauses implements IWrapper<GContainer> {
					...
					def List<CanIcomRxMessage> getCanIcomRxMessages(){
						...
						return new BasicWrappingEList<CanIcomRxMessage, GContainer>(filteredContainers, typeof(CanIcomRxMessage), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanIcom.CanIcomConfig.CanIcomWakeupCauses.CanIcomRxMessage canIcomRxMessage) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanIcom.CanIcomConfig.CanIcomWakeupCauses.CanIcomRxMessage canIcomRxMessage) {
								canIcomRxMessage.target?.gSetDefinition(containerValue.getContainerDefinition("CanIcomRxMessage"))
					...
					static class CanIcomRxMessage implements IWrapper<GContainer> {
						...
						def List<CanIcomRxMessageSignalConfig> getCanIcomRxMessageSignalConfigs(){
							...
							return new BasicWrappingEList<CanIcomRxMessageSignalConfig, GContainer>(filteredContainers, typeof(CanIcomRxMessageSignalConfig), typeof(GContainer)) {
								override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanIcom.CanIcomConfig.CanIcomWakeupCauses.CanIcomRxMessage.CanIcomRxMessageSignalConfig canIcomRxMessageSignalConfig) {
								...
								override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanConfigSet.CanIcom.CanIcomConfig.CanIcomWakeupCauses.CanIcomRxMessage.CanIcomRxMessageSignalConfig canIcomRxMessageSignalConfig) {
									canIcomRxMessageSignalConfig.target?.gSetDefinition(containerValue.getContainerDefinition("CanIcomRxMessageSignalConfig"))
						...
						static class CanIcomRxMessageSignalConfig implements IWrapper<GContainer> {
							...
							def org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal getCanIcomSignalRef(){
								containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal), "CanIcomSignalRef")
							}
							
							def void setCanIcomSignalRef(org.artop.ecuc.autosar422.accessors.Com.ComConfig.ComSignal object){
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CanGeneral implements IWrapper<GContainer> {
		...
		def Boolean getCanDevErrorDetection(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "CanDevErrorDetection"].getBooleanValue()
		}
		...
		def void setCanDevErrorDetection(Boolean value){
			...
			if (parameterValue == null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "CanDevErrorDetection"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
		...
		def org.artop.ecuc.autosar422.accessors.Os.OsCounter getCanOsCounterRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Os.OsCounter), "CanOsCounterRef")
		}
		
		def void setCanOsCounterRef(org.artop.ecuc.autosar422.accessors.Os.OsCounter object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar422.accessors.CanIf.CanIfPrivateCfg getCanSupportTTCANRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfPrivateCfg), "CanSupportTTCANRef")
		}
		
		def void setCanSupportTTCANRef(org.artop.ecuc.autosar422.accessors.CanIf.CanIfPrivateCfg object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<CanMainFunctionRWPeriods> getCanMainFunctionRWPeriods(){
			...
			return new BasicWrappingEList<CanMainFunctionRWPeriods, GContainer>(filteredContainers, typeof(CanMainFunctionRWPeriods), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.Can.CanGeneral.CanMainFunctionRWPeriods canMainFunctionRWPeriods) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.Can.CanGeneral.CanMainFunctionRWPeriods canMainFunctionRWPeriods) {
					canMainFunctionRWPeriods.target?.gSetDefinition(containerValue.getContainerDefinition("CanMainFunctionRWPeriods"))
