	...
	static class CanSMConfiguration implements IWrapper<GContainer> {
		...
		def List<CanSMManagerNetwork> getCanSMManagerNetworks(){
			...
			return new BasicWrappingEList<CanSMManagerNetwork, GContainer>(filteredContainers, typeof(CanSMManagerNetwork), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanSM.CanSMConfiguration.CanSMManagerNetwork canSMManagerNetwork) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanSM.CanSMConfiguration.CanSMManagerNetwork canSMManagerNetwork) {
					canSMManagerNetwork.target?.gSetDefinition(containerValue.getContainerDefinition("CanSMManagerNetwork"))
		...
		static class CanSMManagerNetwork implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel getCanSMComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel), "CanSMComMNetworkHandleRef")
			}
			
			def void setCanSMComMNetworkHandleRef(org.artop.ecuc.autosar422.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg.CanIfTrcvCfg getCanSMTransceiverId(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg.CanIfTrcvCfg), "CanSMTransceiverId")
			}
			
			def void setCanSMTransceiverId(org.artop.ecuc.autosar422.accessors.CanIf.CanIfTrcvDrvCfg.CanIfTrcvCfg object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<CanSMController> getCanSMControllers(){
				...
				return new BasicWrappingEList<CanSMController, GContainer>(filteredContainers, typeof(CanSMController), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar422.accessors.CanSM.CanSMConfiguration.CanSMManagerNetwork.CanSMController canSMController) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar422.accessors.CanSM.CanSMConfiguration.CanSMManagerNetwork.CanSMController canSMController) {
						canSMController.target?.gSetDefinition(containerValue.getContainerDefinition("CanSMController"))
			...
			static class CanSMController implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg getCanSMControllerId(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg), "CanSMControllerId")
				}
				
				def void setCanSMControllerId(org.artop.ecuc.autosar422.accessors.CanIf.CanIfCtrlDrvCfg.CanIfCtrlCfg object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class CanSMDemEventParameterRefs implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter getCANSM_E_BUS_OFF(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter), "CANSM_E_BUS_OFF")
				}
				
				def void setCANSM_E_BUS_OFF(org.artop.ecuc.autosar422.accessors.Dem.DemConfigSet.DemEventParameter object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
