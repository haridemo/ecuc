...
public class InstanceReferenceDefTypeImpl extends ConfigReferenceTypeImpl implements InstanceReferenceDefType {

	public InstanceReferenceDefTypeImpl(final EcucContext context) {
		this(context, InstanceReferenceDefType.TYPE_NAME);
	}

	private InstanceReferenceDefTypeImpl(EcucContext context, String typeName) {
