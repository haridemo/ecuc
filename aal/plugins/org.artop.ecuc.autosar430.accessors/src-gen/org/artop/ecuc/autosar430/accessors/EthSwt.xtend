...
class EthSwt implements IWrapper<GModuleConfiguration> {
	...
	def List<EthSwtConfig> getEthSwtConfigs(){
		...
		return new BasicWrappingEList<EthSwtConfig, GContainer>(filteredContainers, typeof(EthSwtConfig), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig ethSwtConfig) {
				ethSwtConfig.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("EthSwtConfig"))
				super.delegateAdd(ethSwtConfig)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig ethSwtConfig) {
				ethSwtConfig.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("EthSwtConfig"))
	...
	static class EthSwtConfig implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar430.accessors.Eth.EthConfigSet.EthCtrlConfig getEthSwtManagementEthCtrlRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Eth.EthConfigSet.EthCtrlConfig), "EthSwtManagementEthCtrlRef")
		}
		
		def void setEthSwtManagementEthCtrlRef(org.artop.ecuc.autosar430.accessors.Eth.EthConfigSet.EthCtrlConfig object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort getEthSwtManagementPortRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort), "EthSwtManagementPortRef")
		}
		
		def void setEthSwtManagementPortRef(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<EthSwtPort> getEthSwtPorts(){
			...
			return new BasicWrappingEList<EthSwtPort, GContainer>(filteredContainers, typeof(EthSwtPort), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort ethSwtPort) {
					ethSwtPort.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPort"))
					super.delegateAdd(ethSwtPort)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort ethSwtPort) {
					ethSwtPort.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPort"))
		...
		static class EthSwtDemEventParameterRefs implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.Dem.DemConfigSet.DemEventParameter getETHSWT_E_ACCESS(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Dem.DemConfigSet.DemEventParameter), "ETHSWT_E_ACCESS")
			}
			
			def void setETHSWT_E_ACCESS(org.artop.ecuc.autosar430.accessors.Dem.DemConfigSet.DemEventParameter object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EthSwtNvm implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor getEthSwtNvmBlockDescriptorRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor), "EthSwtNvmBlockDescriptorRef")
			}
			
			def void setEthSwtNvmBlockDescriptorRef(org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class EthSwtPort implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig getEthSwtPortTrcvRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig), "EthSwtPortTrcvRef")
			}
			
			def void setEthSwtPortTrcvRef(org.artop.ecuc.autosar430.accessors.EthTrcv.EthTrcvConfigSet.EthTrcvConfig object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<EthSwtPortVlanMembership> getEthSwtPortVlanMemberships(){
				...
				return new BasicWrappingEList<EthSwtPortVlanMembership, GContainer>(filteredContainers, typeof(EthSwtPortVlanMembership), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortVlanMembership ethSwtPortVlanMembership) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortVlanMembership ethSwtPortVlanMembership) {
						ethSwtPortVlanMembership.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPortVlanMembership"))
			...
			static class EthSwtPortEgress implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler getEthSwtPortEgressLastSchedulerRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler), "EthSwtPortEgressLastSchedulerRef")
				}
				
				def void setEthSwtPortEgressLastSchedulerRef(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def List<EthSwtPortFifo> getEthSwtPortFifos(){
					...
					return new BasicWrappingEList<EthSwtPortFifo, GContainer>(filteredContainers, typeof(EthSwtPortFifo), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortFifo ethSwtPortFifo) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortFifo ethSwtPortFifo) {
							ethSwtPortFifo.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPortFifo"))
				...
				def List<EthSwtPortScheduler> getEthSwtPortSchedulers(){
					...
					return new BasicWrappingEList<EthSwtPortScheduler, GContainer>(filteredContainers, typeof(EthSwtPortScheduler), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler ethSwtPortScheduler) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler ethSwtPortScheduler) {
							ethSwtPortScheduler.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPortScheduler"))
				...
				def List<EthSwtPortShaper> getEthSwtPortShapers(){
					...
					return new BasicWrappingEList<EthSwtPortShaper, GContainer>(filteredContainers, typeof(EthSwtPortShaper), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortShaper ethSwtPortShaper) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortShaper ethSwtPortShaper) {
							ethSwtPortShaper.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPortShaper"))
				...
				static class EthSwtPortScheduler implements IWrapper<GContainer> {
					...
					def List<EthSwtPortSchedulerPredecessor> getEthSwtPortSchedulerPredecessors(){
						...
						return new BasicWrappingEList<EthSwtPortSchedulerPredecessor, GContainer>(filteredContainers, typeof(EthSwtPortSchedulerPredecessor), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler.EthSwtPortSchedulerPredecessor ethSwtPortSchedulerPredecessor) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortScheduler.EthSwtPortSchedulerPredecessor ethSwtPortSchedulerPredecessor) {
								ethSwtPortSchedulerPredecessor.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPortSchedulerPredecessor"))
				...
				static class EthSwtPortShaper implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortFifo getEthSwtPortEgressPredecessorFifoRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortFifo), "EthSwtPortEgressPredecessorFifoRef")
					}
					
					def void setEthSwtPortEgressPredecessorFifoRef(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortEgress.EthSwtPortFifo object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class EthSwtPortIngress implements IWrapper<GContainer> {
				...
				def List<EthSwtPortPolicer> getEthSwtPortPolicers(){
					...
					return new BasicWrappingEList<EthSwtPortPolicer, GContainer>(filteredContainers, typeof(EthSwtPortPolicer), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortIngress.EthSwtPortPolicer ethSwtPortPolicer) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortIngress.EthSwtPortPolicer ethSwtPortPolicer) {
							ethSwtPortPolicer.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPortPolicer"))
				...
				def List<EthSwtPriorityRegeneration> getEthSwtPriorityRegenerations(){
					...
					return new BasicWrappingEList<EthSwtPriorityRegeneration, GContainer>(filteredContainers, typeof(EthSwtPriorityRegeneration), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortIngress.EthSwtPriorityRegeneration ethSwtPriorityRegeneration) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortIngress.EthSwtPriorityRegeneration ethSwtPriorityRegeneration) {
							ethSwtPriorityRegeneration.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPriorityRegeneration"))
				...
				def List<EthSwtPriorityTrafficClassAssignment> getEthSwtPriorityTrafficClassAssignments(){
					...
					return new BasicWrappingEList<EthSwtPriorityTrafficClassAssignment, GContainer>(filteredContainers, typeof(EthSwtPriorityTrafficClassAssignment), typeof(GContainer)) {
						override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortIngress.EthSwtPriorityTrafficClassAssignment ethSwtPriorityTrafficClassAssignment) {
						...
						override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortIngress.EthSwtPriorityTrafficClassAssignment ethSwtPriorityTrafficClassAssignment) {
							ethSwtPriorityTrafficClassAssignment.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtPriorityTrafficClassAssignment"))
				...
				static class EthSwtPortPolicer implements IWrapper<GContainer> {
					...
					def List<org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort.EthSwtPortVlanMembership> getEthSwtPortRateVlanMembershipRefs(){
						val containerDef = containerValue.gGetDefinition
		...
		static class EthSwtSpi implements IWrapper<GContainer> {
			...
			def List<EthSwtSpiSequence> getEthSwtSpiSequences(){
				...
				return new BasicWrappingEList<EthSwtSpiSequence, GContainer>(filteredContainers, typeof(EthSwtSpiSequence), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtSpi.EthSwtSpiSequence ethSwtSpiSequence) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtSpi.EthSwtSpiSequence ethSwtSpiSequence) {
						ethSwtSpiSequence.target?.gSetDefinition(containerValue.getContainerDefinition("EthSwtSpiSequence"))
			...
			static class EthSwtSpiSequence implements IWrapper<GContainer> {
				...
				def List<org.artop.ecuc.autosar430.accessors.Spi.SpiDriver.SpiSequence> getEthSwtSpiSequenceNames(){
					val containerDef = containerValue.gGetDefinition
					val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
