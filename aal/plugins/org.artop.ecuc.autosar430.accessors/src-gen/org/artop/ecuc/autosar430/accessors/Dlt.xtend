...
class Dlt implements IWrapper<GModuleConfiguration> {
	...
	def List<DltSwc> getDltSwcs(){
		...
		return new BasicWrappingEList<DltSwc, GContainer>(filteredContainers, typeof(DltSwc), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Dlt.DltSwc dltSwc) {
				dltSwc.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("DltSwc"))
				super.delegateAdd(dltSwc)
			}

			override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Dlt.DltSwc dltSwc) {
				dltSwc.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("DltSwc"))
	...
	static class DltConfigSet implements IWrapper<GContainer> {
		...
		def List<DltRxPdu> getDltRxPdus(){
			...
			return new BasicWrappingEList<DltRxPdu, GContainer>(filteredContainers, typeof(DltRxPdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltRxPdu dltRxPdu) {
					dltRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("DltRxPdu"))
					super.delegateAdd(dltRxPdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltRxPdu dltRxPdu) {
					dltRxPdu.target?.gSetDefinition(containerValue.getContainerDefinition("DltRxPdu"))
		...
		static class DltLogOutput implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel getDltDefaultLogChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel), "DltDefaultLogChannelRef")
			}
			
			def void setDltDefaultLogChannelRef(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<DltLogChannel> getDltLogChannels(){
				...
				return new BasicWrappingEList<DltLogChannel, GContainer>(filteredContainers, typeof(DltLogChannel), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel dltLogChannel) {
						dltLogChannel.target?.gSetDefinition(containerValue.getContainerDefinition("DltLogChannel"))
						super.delegateAdd(dltLogChannel)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel dltLogChannel) {
						dltLogChannel.target?.gSetDefinition(containerValue.getContainerDefinition("DltLogChannel"))
			...
			def List<DltLogChannelAssignment> getDltLogChannelAssignments(){
				...
				return new BasicWrappingEList<DltLogChannelAssignment, GContainer>(filteredContainers, typeof(DltLogChannelAssignment), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannelAssignment dltLogChannelAssignment) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannelAssignment dltLogChannelAssignment) {
						dltLogChannelAssignment.target?.gSetDefinition(containerValue.getContainerDefinition("DltLogChannelAssignment"))
			...
			static class DltLogChannel implements IWrapper<GContainer> {
				...
				static class DltTxPdu implements IWrapper<GContainer> {
					...
					def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDltTxPduIdRef(){
						containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DltTxPduIdRef")
					}
					
					def void setDltTxPduIdRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
			...
			static class DltLogChannelAssignment implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext getDltLogChannelAssignmentSwcContextRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext), "DltLogChannelAssignmentSwcContextRef")
				}
				
				def void setDltLogChannelAssignmentSwcContextRef(org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel getDltLogChannelRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel), "DltLogChannelRef")
				}
				
				def void setDltLogChannelRef(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltLogOutput.DltLogChannel object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DltRxPdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getDltRxPduIdRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "DltRxPduIdRef")
			}
			
			def void setDltRxPduIdRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class DltTraceStatusSetting implements IWrapper<GContainer> {
			...
			def List<DltTraceStatusAssignment> getDltTraceStatusAssignments(){
				...
				return new BasicWrappingEList<DltTraceStatusAssignment, GContainer>(filteredContainers, typeof(DltTraceStatusAssignment), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltTraceStatusSetting.DltTraceStatusAssignment dltTraceStatusAssignment) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Dlt.DltConfigSet.DltTraceStatusSetting.DltTraceStatusAssignment dltTraceStatusAssignment) {
						dltTraceStatusAssignment.target?.gSetDefinition(containerValue.getContainerDefinition("DltTraceStatusAssignment"))
			...
			static class DltTraceStatusAssignment implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext getDltTraceStatusAssignmentSwcContextRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext), "DltTraceStatusAssignmentSwcContextRef")
				}
				
				def void setDltTraceStatusAssignmentSwcContextRef(org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DltGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar430.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration getDltGeneralGptChannelRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration), "DltGeneralGptChannelRef")
		}
		
		def void setDltGeneralGptChannelRef(org.artop.ecuc.autosar430.accessors.Gpt.GptChannelConfigSet.GptChannelConfiguration object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor getDltGeneralNvRamRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor), "DltGeneralNvRamRef")
		}
		
		def void setDltGeneralNvRamRef(org.artop.ecuc.autosar430.accessors.NvM.NvMBlockDescriptor object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class DltSwc implements IWrapper<GContainer> {
		...
		def List<DltSwcContext> getDltSwcContexts(){
			...
			return new BasicWrappingEList<DltSwcContext, GContainer>(filteredContainers, typeof(DltSwcContext), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext dltSwcContext) {
					dltSwcContext.target?.gSetDefinition(containerValue.getContainerDefinition("DltSwcContext"))
					super.delegateAdd(dltSwcContext)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Dlt.DltSwc.DltSwcContext dltSwcContext) {
					dltSwcContext.target?.gSetDefinition(containerValue.getContainerDefinition("DltSwcContext"))
