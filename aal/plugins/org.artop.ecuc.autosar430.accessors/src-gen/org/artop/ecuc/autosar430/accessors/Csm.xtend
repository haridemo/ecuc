...
class Csm implements IWrapper<GModuleConfiguration> {
	...
	def List<CsmPrimitives> getCsmPrimitives(){
		...
		return new BasicWrappingEList<CsmPrimitives, GContainer>(filteredContainers, typeof(CsmPrimitives), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Csm.CsmPrimitives csmPrimitives) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Csm.CsmPrimitives csmPrimitives) {
				csmPrimitives.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CsmPrimitives"))
	...
	static class CsmCallbacks implements IWrapper<GContainer> {
		...
		def List<CsmCallback> getCsmCallbacks(){
			...
			return new BasicWrappingEList<CsmCallback, GContainer>(filteredContainers, typeof(CsmCallback), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Csm.CsmCallbacks.CsmCallback csmCallback) {
					csmCallback.target?.gSetDefinition(containerValue.getContainerDefinition("CsmCallback"))
					super.delegateAdd(csmCallback)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Csm.CsmCallbacks.CsmCallback csmCallback) {
					csmCallback.target?.gSetDefinition(containerValue.getContainerDefinition("CsmCallback"))
	...
	static class CsmJobs implements IWrapper<GContainer> {
		...
		def List<CsmJob> getCsmJobs(){
			...
			return new BasicWrappingEList<CsmJob, GContainer>(filteredContainers, typeof(CsmJob), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Csm.CsmJobs.CsmJob csmJob) {
					csmJob.target?.gSetDefinition(containerValue.getContainerDefinition("CsmJob"))
					super.delegateAdd(csmJob)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Csm.CsmJobs.CsmJob csmJob) {
					csmJob.target?.gSetDefinition(containerValue.getContainerDefinition("CsmJob"))
		...
		static class CsmJob implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey getCsmJobKeyRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey), "CsmJobKeyRef")
			}
			
			def void setCsmJobKeyRef(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar430.accessors.Csm.CsmCallbacks.CsmCallback getCsmJobPrimitiveCallbackRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmCallbacks.CsmCallback), "CsmJobPrimitiveCallbackRef")
			}
			
			def void setCsmJobPrimitiveCallbackRef(org.artop.ecuc.autosar430.accessors.Csm.CsmCallbacks.CsmCallback object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar430.accessors.Csm.CsmPrimitives getCsmJobPrimitiveRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmPrimitives), "CsmJobPrimitiveRef")
			}
			
			def void setCsmJobPrimitiveRef(org.artop.ecuc.autosar430.accessors.Csm.CsmPrimitives object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue getCsmJobQueueRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue), "CsmJobQueueRef")
			}
			
			def void setCsmJobQueueRef(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CsmKeys implements IWrapper<GContainer> {
		...
		def List<CsmKey> getCsmKeys(){
			...
			return new BasicWrappingEList<CsmKey, GContainer>(filteredContainers, typeof(CsmKey), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey csmKey) {
					csmKey.target?.gSetDefinition(containerValue.getContainerDefinition("CsmKey"))
					super.delegateAdd(csmKey)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey csmKey) {
					csmKey.target?.gSetDefinition(containerValue.getContainerDefinition("CsmKey"))
		...
		static class CsmKey implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.CryIf.CryIfKey getCsmKeyRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.CryIf.CryIfKey), "CsmKeyRef")
			}
			
			def void setCsmKeyRef(org.artop.ecuc.autosar430.accessors.CryIf.CryIfKey object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CsmPrimitives implements IWrapper<GContainer> {
		...
		static class CsmAEADDecrypt implements IWrapper<GContainer> {
			...
			static class CsmAEADDecryptConfig implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey getCsmAEADDecryptKeyRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey), "CsmAEADDecryptKeyRef")
				}
				
				def void setCsmAEADDecryptKeyRef(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue getCsmAEADDecryptQueueRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue), "CsmAEADDecryptQueueRef")
				}
				
				def void setCsmAEADDecryptQueueRef(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CsmAEADEncrypt implements IWrapper<GContainer> {
			...
			static class CsmAEADEncryptConfig implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey getCsmAEADEncryptKeyRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey), "CsmAEADEncryptKeyRef")
				}
				
				def void setCsmAEADEncryptKeyRef(org.artop.ecuc.autosar430.accessors.Csm.CsmKeys.CsmKey object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
				...
				def org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue getCsmAEADEncryptQueueRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue), "CsmAEADEncryptQueueRef")
				}
				
				def void setCsmAEADEncryptQueueRef(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CsmSecureCounter implements IWrapper<GContainer> {
			...
			static class CsmSecureCounterConfig implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue getCsmSecureCounterQueueRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue), "CsmSecureCounterQueueRef")
				}
				
				def void setCsmSecureCounterQueueRef(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CsmQueues implements IWrapper<GContainer> {
		...
		def List<CsmQueue> getCsmQueues(){
			...
			return new BasicWrappingEList<CsmQueue, GContainer>(filteredContainers, typeof(CsmQueue), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue csmQueue) {
					csmQueue.target?.gSetDefinition(containerValue.getContainerDefinition("CsmQueue"))
					super.delegateAdd(csmQueue)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Csm.CsmQueues.CsmQueue csmQueue) {
					csmQueue.target?.gSetDefinition(containerValue.getContainerDefinition("CsmQueue"))
		...
		static class CsmQueue implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.CryIf.CryIfChannel getCsmChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.CryIf.CryIfChannel), "CsmChannelRef")
			}
			
			def void setCsmChannelRef(org.artop.ecuc.autosar430.accessors.CryIf.CryIfChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
