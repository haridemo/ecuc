...
class J1939Rm implements IWrapper<GModuleConfiguration> {
	...
	static class J1939RmConfigSet implements IWrapper<GContainer> {
		...
		def List<J1939RmChannel> getJ1939RmChannels(){
			...
			return new BasicWrappingEList<J1939RmChannel, GContainer>(filteredContainers, typeof(J1939RmChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel j1939RmChannel) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel j1939RmChannel) {
					j1939RmChannel.target?.gSetDefinition(containerValue.getContainerDefinition("J1939RmChannel"))
		...
		def List<J1939RmNode> getJ1939RmNodes(){
			...
			return new BasicWrappingEList<J1939RmNode, GContainer>(filteredContainers, typeof(J1939RmNode), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmNode j1939RmNode) {
					j1939RmNode.target?.gSetDefinition(containerValue.getContainerDefinition("J1939RmNode"))
					super.delegateAdd(j1939RmNode)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmNode j1939RmNode) {
					j1939RmNode.target?.gSetDefinition(containerValue.getContainerDefinition("J1939RmNode"))
		...
		static class J1939RmChannel implements IWrapper<GContainer> {
			...
			def BigInteger getJ1939RmRequestQueue2Size(){
				containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmRequestQueue2Size"].getBigIntegerValue()
			}
			
			def void setJ1939RmRequestQueue2Size(BigInteger value){
				var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmRequestQueue2Size"]
				if (parameterValue === null) {
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmRequestQueue2Size"].createParameterValue()
						containerValue.gGetParameterValues += parameterValue
					}
				}
				parameterValue.setValue(value)
			...
			def org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel getJ1939RmComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel), "J1939RmComMNetworkHandleRef")
			}
			
			def void setJ1939RmComMNetworkHandleRef(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def J1939RmRqst2RxPdu getJ1939RmRqst2RxPdu(){
				containerValue.getByType(typeof(J1939RmRqst2RxPdu))
			}
			
			def void setJ1939RmRqst2RxPdu(J1939RmRqst2RxPdu j1939RmRqst2RxPdu){
				val GContainer subContainer = j1939RmRqst2RxPdu.getTarget()
				containerValue.setContainer(subContainer, "J1939RmRqst2RxPdu")
			}
			
			def J1939RmRqst2TxPdu getJ1939RmRqst2TxPdu(){
				containerValue.getByType(typeof(J1939RmRqst2TxPdu))
			}
			
			def void setJ1939RmRqst2TxPdu(J1939RmRqst2TxPdu j1939RmRqst2TxPdu){
				val GContainer subContainer = j1939RmRqst2TxPdu.getTarget()
				containerValue.setContainer(subContainer, "J1939RmRqst2TxPdu")
			}
			...
			static class J1939RmAckmRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmAckmRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmAckmRxPduRef")
				}
				
				def void setJ1939RmAckmRxPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class J1939RmAckmTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmAckmTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmAckmTxPduRef")
				}
				
				def void setJ1939RmAckmTxPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class J1939RmRqst2RxPdu implements IWrapper<GContainer> {
				private GContainer containerValue
				...
				override def boolean equals(Object object) {
			        if (!(object instanceof J1939RmRqst2RxPdu)){
						return false
					}
					this.target == (object as J1939RmRqst2RxPdu).target
				}
			
				def BigInteger getJ1939RmRqst2RxPduId(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmRqst2RxPduId"].getBigIntegerValue()
				}
				
				def void setJ1939RmRqst2RxPduId(BigInteger value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmRqst2RxPduId"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmRqst2RxPduId"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmRqst2RxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmRqst2RxPduRef")
				}
				
				def void setJ1939RmRqst2RxPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "J1939RmRqst2RxPduRef"], object.getTarget())
					}
				}
			...
			static class J1939RmRqst2TxPdu implements IWrapper<GContainer> {
				private GContainer containerValue
				...
				override def boolean equals(Object object) {
			        if (!(object instanceof J1939RmRqst2TxPdu)){
						return false
					}
					this.target == (object as J1939RmRqst2TxPdu).target
				}
			
				def BigInteger getJ1939RmRqst2TxPduId(){
					containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmRqst2TxPduId"].getBigIntegerValue()
				}
				
				def void setJ1939RmRqst2TxPduId(BigInteger value){
					var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmRqst2TxPduId"]
					if (parameterValue === null) {
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmRqst2TxPduId"].createParameterValue()
							containerValue.gGetParameterValues += parameterValue
						}
					}
					parameterValue.setValue(value)
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmRqst2TxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmRqst2TxPduRef")
				}
				
				def void setJ1939RmRqst2TxPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
						containerValue.setReferenceValue(containerDef.gGetReferences.findFirst[gGetShortName == "J1939RmRqst2TxPduRef"], object.getTarget())
					}
				}
			...
			static class J1939RmRqstRxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmRqstRxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmRqstRxPduRef")
				}
				
				def void setJ1939RmRqstRxPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
			...
			static class J1939RmRqstTxPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmRqstTxPduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmRqstTxPduRef")
				}
				
				def void setJ1939RmRqstTxPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class J1939RmNode implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode getJ1939RmNmNodeRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode), "J1939RmNmNodeRef")
			}
			
			def void setJ1939RmNmNodeRef(org.artop.ecuc.autosar430.accessors.J1939Nm.J1939NmConfigSet.J1939NmNode object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel> getJ1939RmNodeChannelRefs(){
				val containerDef = containerValue.gGetDefinition
				...
				return new AbstractUnwrappingEList<GReferenceValue, org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel>(filteredReferenceValues, typeof(GReferenceValue), typeof(org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel)) {
					override protected wrap(org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel object) throws CoreException {
						if (object !== null) {
					...
					override protected unwrap(GReferenceValue referenceValue) {
						if (referenceValue !== null) {
							...
							if (referenceValueValue instanceof GContainer) {
								return new org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmChannel(referenceValueValue as GContainer)
							}
						}
					}
				}
			...
			def List<J1939RmUser> getJ1939RmUsers(){
				...
				return new BasicWrappingEList<J1939RmUser, GContainer>(filteredContainers, typeof(J1939RmUser), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmNode.J1939RmUser j1939RmUser) {
						j1939RmUser.target?.gSetDefinition(containerValue.getContainerDefinition("J1939RmUser"))
						super.delegateAdd(j1939RmUser)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmNode.J1939RmUser j1939RmUser) {
						j1939RmUser.target?.gSetDefinition(containerValue.getContainerDefinition("J1939RmUser"))
			...
			static class J1939RmUser implements IWrapper<GContainer> {
				...
				def J1939RmCddUser getJ1939RmCddUser(){
					containerValue.getByType(typeof(J1939RmCddUser))
				}
				
				def void setJ1939RmCddUser(J1939RmCddUser j1939RmCddUser){
					val GContainer subContainer = j1939RmCddUser.getTarget()
					containerValue.setContainer(subContainer, "J1939RmCddUser")
				}
				def J1939RmComUser getJ1939RmComUser(){
					containerValue.getByType(typeof(J1939RmComUser))
				}
				
				def void setJ1939RmComUser(J1939RmComUser j1939RmComUser){
					val GContainer subContainer = j1939RmComUser.getTarget()
					containerValue.setContainer(subContainer, "J1939RmComUser")
				}
				def J1939RmDcmUser getJ1939RmDcmUser(){
					containerValue.getByType(typeof(J1939RmDcmUser))
				}
				
				def void setJ1939RmDcmUser(J1939RmDcmUser j1939RmDcmUser){
					val GContainer subContainer = j1939RmDcmUser.getTarget()
					containerValue.setContainer(subContainer, "J1939RmDcmUser")
				}
				def J1939RmNmUser getJ1939RmNmUser(){
					containerValue.getByType(typeof(J1939RmNmUser))
				}
				
				def void setJ1939RmNmUser(J1939RmNmUser j1939RmNmUser){
					val GContainer subContainer = j1939RmNmUser.getTarget()
					containerValue.setContainer(subContainer, "J1939RmNmUser")
				}
				def J1939RmRteUser getJ1939RmRteUser(){
					containerValue.getByType(typeof(J1939RmRteUser))
				}
				
				def void setJ1939RmRteUser(J1939RmRteUser j1939RmRteUser){
					val GContainer subContainer = j1939RmRteUser.getTarget()
					containerValue.setContainer(subContainer, "J1939RmRteUser")
				}
				
				static class J1939RmCddUser implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof J1939RmCddUser)){
							return false
						}
						this.target == (object as J1939RmCddUser).target
					}
					...
					def List<BigInteger> getJ1939RmUserRequestPGNs(){
						val List<EcucNumericalParamValue> filteredParameterValues = new AbstractFilteringEList<EcucNumericalParamValue>(containerValue, getEContainingFeature(containerValue, GecucdescriptionPackage.eINSTANCE.GParameterValue)) {
							override protected accept(EcucNumericalParamValue item) {
								return accept(item, typeof(GConfigParameter), "J1939RmUserRequestPGN")
							}
						}
						val containerDef = containerValue.gGetDefinition
						if (containerDef instanceof GParamConfContainerDef) {
							val parameterDef = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmUserRequestPGN"]
							return new BigIntegerValueUnwrappingEList(filteredParameterValues, typeof(EcucNumericalParamValue), typeof(BigInteger), parameterDef)
						}
					}
				...
				static class J1939RmComUser implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof J1939RmComUser)){
							return false
						}
						this.target == (object as J1939RmComUser).target
					}
					...
					def List<J1939RmComIPdu> getJ1939RmComIPdus(){
						...
						return new BasicWrappingEList<J1939RmComIPdu, GContainer>(filteredContainers, typeof(J1939RmComIPdu), typeof(GContainer)) {
							override protected delegateAdd(org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmNode.J1939RmUser.J1939RmComUser.J1939RmComIPdu j1939RmComIPdu) {
							...
							override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.J1939Rm.J1939RmConfigSet.J1939RmNode.J1939RmUser.J1939RmComUser.J1939RmComIPdu j1939RmComIPdu) {
								j1939RmComIPdu.target?.gSetDefinition(containerValue.getContainerDefinition("J1939RmComIPdu"))
					...
					static class J1939RmComIPdu implements IWrapper<GContainer> {
						...
						def BigInteger getJ1939RmComIPduExtId1(){
							containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmComIPduExtId1"].getBigIntegerValue()
						}
						
						def void setJ1939RmComIPduExtId1(BigInteger value){
							var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmComIPduExtId1"]
							if (parameterValue === null) {
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
									parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmComIPduExtId1"].createParameterValue()
									containerValue.gGetParameterValues += parameterValue
								}
							}
							parameterValue.setValue(value)
						...
						def BigInteger getJ1939RmComIPduExtId2(){
							containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmComIPduExtId2"].getBigIntegerValue()
						}
						
						def void setJ1939RmComIPduExtId2(BigInteger value){
							var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmComIPduExtId2"]
							if (parameterValue === null) {
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
									parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmComIPduExtId2"].createParameterValue()
									containerValue.gGetParameterValues += parameterValue
								}
							}
							parameterValue.setValue(value)
						...
						def BigInteger getJ1939RmComIPduExtId3(){
							containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmComIPduExtId3"].getBigIntegerValue()
						}
						
						def void setJ1939RmComIPduExtId3(BigInteger value){
							var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmComIPduExtId3"]
							if (parameterValue === null) {
								val containerDef = containerValue.gGetDefinition
								if (containerDef instanceof GParamConfContainerDef) {
									parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmComIPduExtId3"].createParameterValue()
									containerValue.gGetParameterValues += parameterValue
								}
							}
							parameterValue.setValue(value)
						...
						def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getJ1939RmComIPduRef(){
							containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "J1939RmComIPduRef")
						}
						
						def void setJ1939RmComIPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
							val containerDef = containerValue.gGetDefinition
							if (containerDef instanceof GParamConfContainerDef) {
				...
				static class J1939RmDcmUser implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof J1939RmDcmUser)){
							return false
						}
						this.target == (object as J1939RmDcmUser).target
					}
				...
				static class J1939RmNmUser implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof J1939RmNmUser)){
							return false
						}
						this.target == (object as J1939RmNmUser).target
					}
				...
				static class J1939RmRteUser implements IWrapper<GContainer> {
					private GContainer containerValue
					...
					override def boolean equals(Object object) {
				        if (!(object instanceof J1939RmRteUser)){
							return false
						}
						this.target == (object as J1939RmRteUser).target
					}
	...
	static class J1939RmGeneral implements IWrapper<GContainer> {
		...
		def Boolean getJ1939RmSupportRequest2(){
			containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmSupportRequest2"].getBooleanValue()
		}
		
		def void setJ1939RmSupportRequest2(Boolean value){
			var GParameterValue parameterValue = containerValue.gGetParameterValues.findFirst[gGetDefinition?.gGetShortName == "J1939RmSupportRequest2"]
			if (parameterValue === null) {
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
					parameterValue = containerDef.gGetParameters.findFirst[gGetShortName == "J1939RmSupportRequest2"].createParameterValue()
					containerValue.gGetParameterValues += parameterValue
				}
			}
			parameterValue.setValue(getBooleanParameterValueValue(value, true))
