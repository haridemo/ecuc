...
class Crypto implements IWrapper<GModuleConfiguration> {
	...
	def List<CryptoPrimitives> getCryptoPrimitives(){
		...
		return new BasicWrappingEList<CryptoPrimitives, GContainer>(filteredContainers, typeof(CryptoPrimitives), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives cryptoPrimitives) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives cryptoPrimitives) {
				cryptoPrimitives.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CryptoPrimitives"))
	...
	static class CryptoDriverObjects implements IWrapper<GContainer> {
		...
		def List<CryptoDriverObject> getCryptoDriverObjects(){
			...
			return new BasicWrappingEList<CryptoDriverObject, GContainer>(filteredContainers, typeof(CryptoDriverObject), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Crypto.CryptoDriverObjects.CryptoDriverObject cryptoDriverObject) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Crypto.CryptoDriverObjects.CryptoDriverObject cryptoDriverObject) {
					cryptoDriverObject.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoDriverObject"))
		...
		static class CryptoDriverObject implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives.CryptoPrimitive getCryptoPrimitiveRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives.CryptoPrimitive), "CryptoPrimitiveRef")
			}
			
			def void setCryptoPrimitiveRef(org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives.CryptoPrimitive object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CryptoKeyElements implements IWrapper<GContainer> {
		...
		def List<CryptoKeyElement> getCryptoKeyElements(){
			...
			return new BasicWrappingEList<CryptoKeyElement, GContainer>(filteredContainers, typeof(CryptoKeyElement), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyElements.CryptoKeyElement cryptoKeyElement) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyElements.CryptoKeyElement cryptoKeyElement) {
					cryptoKeyElement.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoKeyElement"))
		...
		static class CryptoKeyElement implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyElements.CryptoKeyElement> getCryptoKeyElementVirtualTargetRefs(){
				val containerDef = containerValue.gGetDefinition
	...
	static class CryptoKeyTypes implements IWrapper<GContainer> {
		...
		def List<CryptoKeyType> getCryptoKeyTypes(){
			...
			return new BasicWrappingEList<CryptoKeyType, GContainer>(filteredContainers, typeof(CryptoKeyType), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyTypes.CryptoKeyType cryptoKeyType) {
					cryptoKeyType.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoKeyType"))
					super.delegateAdd(cryptoKeyType)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyTypes.CryptoKeyType cryptoKeyType) {
					cryptoKeyType.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoKeyType"))
		...
		static class CryptoKeyType implements IWrapper<GContainer> {
			...
			def List<org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyElements.CryptoKeyElement> getCryptoKeyElementRefs(){
				val containerDef = containerValue.gGetDefinition
				val GConfigReference referenceValueDef = if (containerDef instanceof GParamConfContainerDef)
	...
	static class CryptoKeys implements IWrapper<GContainer> {
		...
		def List<CryptoKey> getCryptoKeys(){
			...
			return new BasicWrappingEList<CryptoKey, GContainer>(filteredContainers, typeof(CryptoKey), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeys.CryptoKey cryptoKey) {
					cryptoKey.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoKey"))
					super.delegateAdd(cryptoKey)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeys.CryptoKey cryptoKey) {
					cryptoKey.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoKey"))
		...
		static class CryptoKey implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyTypes.CryptoKeyType getCryptoKeyTypeRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyTypes.CryptoKeyType), "CryptoKeyTypeRef")
			}
			
			def void setCryptoKeyTypeRef(org.artop.ecuc.autosar430.accessors.Crypto.CryptoKeyTypes.CryptoKeyType object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
	...
	static class CryptoPrimitives implements IWrapper<GContainer> {
		...
		def List<CryptoPrimitive> getCryptoPrimitives(){
			...
			return new BasicWrappingEList<CryptoPrimitive, GContainer>(filteredContainers, typeof(CryptoPrimitive), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives.CryptoPrimitive cryptoPrimitive) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.Crypto.CryptoPrimitives.CryptoPrimitive cryptoPrimitive) {
					cryptoPrimitive.target?.gSetDefinition(containerValue.getContainerDefinition("CryptoPrimitive"))
