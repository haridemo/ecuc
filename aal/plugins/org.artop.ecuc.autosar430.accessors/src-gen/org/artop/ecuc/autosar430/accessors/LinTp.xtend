	...
	static class LinTpGlobalConfig implements IWrapper<GContainer> {
		...
		def List<LinTpChannelConfig> getLinTpChannelConfigs(){
			...
			return new BasicWrappingEList<LinTpChannelConfig, GContainer>(filteredContainers, typeof(LinTpChannelConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.LinTp.LinTpGlobalConfig.LinTpChannelConfig linTpChannelConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.LinTp.LinTpGlobalConfig.LinTpChannelConfig linTpChannelConfig) {
					linTpChannelConfig.target?.gSetDefinition(containerValue.getContainerDefinition("LinTpChannelConfig"))
		...
		def List<LinTpRxNSdu> getLinTpRxNSdus(){
			...
			return new BasicWrappingEList<LinTpRxNSdu, GContainer>(filteredContainers, typeof(LinTpRxNSdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.LinTp.LinTpGlobalConfig.LinTpRxNSdu linTpRxNSdu) {
					linTpRxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("LinTpRxNSdu"))
					super.delegateAdd(linTpRxNSdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.LinTp.LinTpGlobalConfig.LinTpRxNSdu linTpRxNSdu) {
					linTpRxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("LinTpRxNSdu"))
		...
		def List<LinTpTxNSdu> getLinTpTxNSdus(){
			...
			return new BasicWrappingEList<LinTpTxNSdu, GContainer>(filteredContainers, typeof(LinTpTxNSdu), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.LinTp.LinTpGlobalConfig.LinTpTxNSdu linTpTxNSdu) {
					linTpTxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("LinTpTxNSdu"))
					super.delegateAdd(linTpTxNSdu)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.LinTp.LinTpGlobalConfig.LinTpTxNSdu linTpTxNSdu) {
					linTpTxNSdu.target?.gSetDefinition(containerValue.getContainerDefinition("LinTpTxNSdu"))
		...
		static class LinTpChannelConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel getLinTpChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel), "LinTpChannelRef")
			}
			
			def void setLinTpChannelRef(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class LinTpRxNSdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel getLinTpRxNSduChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel), "LinTpRxNSduChannelRef")
			}
			
			def void setLinTpRxNSduChannelRef(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getLinTpRxNSduPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "LinTpRxNSduPduRef")
			}
			
			def void setLinTpRxNSduPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
		...
		static class LinTpTxNSdu implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel getLinTpTxNSduChannelRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel), "LinTpTxNSduChannelRef")
			}
			
			def void setLinTpTxNSduChannelRef(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getLinTpTxNSduPduRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "LinTpTxNSduPduRef")
			}
			
			def void setLinTpTxNSduPduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
