...
class EthTSyn implements IWrapper<GModuleConfiguration> {
	...
	def List<EthTSynGlobalTimeDomain> getEthTSynGlobalTimeDomains(){
		...
		return new BasicWrappingEList<EthTSynGlobalTimeDomain, GContainer>(filteredContainers, typeof(EthTSynGlobalTimeDomain), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthTSyn.EthTSynGlobalTimeDomain ethTSynGlobalTimeDomain) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthTSyn.EthTSynGlobalTimeDomain ethTSynGlobalTimeDomain) {
				ethTSynGlobalTimeDomain.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("EthTSynGlobalTimeDomain"))
	...
	static class EthTSynGeneral implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar430.accessors.EthIf.EthIfConfigSet.EthIfFrameOwnerConfig getEthTSynEthIfFrameType(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthIf.EthIfConfigSet.EthIfFrameOwnerConfig), "EthTSynEthIfFrameType")
		}
		
		def void setEthTSynEthIfFrameType(org.artop.ecuc.autosar430.accessors.EthIf.EthIfConfigSet.EthIfFrameOwnerConfig object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
	...
	static class EthTSynGlobalTimeDomain implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar430.accessors.StbM.StbMSynchronizedTimeBase getEthTSynSynchronizedTimeBaseRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.StbM.StbMSynchronizedTimeBase), "EthTSynSynchronizedTimeBaseRef")
		}
		
		def void setEthTSynSynchronizedTimeBaseRef(org.artop.ecuc.autosar430.accessors.StbM.StbMSynchronizedTimeBase object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		def List<EthTSynPortConfig> getEthTSynPortConfigs(){
			...
			return new BasicWrappingEList<EthTSynPortConfig, GContainer>(filteredContainers, typeof(EthTSynPortConfig), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthTSyn.EthTSynGlobalTimeDomain.EthTSynPortConfig ethTSynPortConfig) {
				...
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthTSyn.EthTSynGlobalTimeDomain.EthTSynPortConfig ethTSynPortConfig) {
					ethTSynPortConfig.target?.gSetDefinition(containerValue.getContainerDefinition("EthTSynPortConfig"))
		...
		static class EthTSynGlobalTimeFollowUpDataIDList implements IWrapper<GContainer> {
			...
			def List<EthTSynGlobalTimeFollowUpDataIDListElement> getEthTSynGlobalTimeFollowUpDataIDListElements(){
				...
				return new BasicWrappingEList<EthTSynGlobalTimeFollowUpDataIDListElement, GContainer>(filteredContainers, typeof(EthTSynGlobalTimeFollowUpDataIDListElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.EthTSyn.EthTSynGlobalTimeDomain.EthTSynGlobalTimeFollowUpDataIDList.EthTSynGlobalTimeFollowUpDataIDListElement ethTSynGlobalTimeFollowUpDataIDListElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.EthTSyn.EthTSynGlobalTimeDomain.EthTSynGlobalTimeFollowUpDataIDList.EthTSynGlobalTimeFollowUpDataIDListElement ethTSynGlobalTimeFollowUpDataIDListElement) {
						ethTSynGlobalTimeFollowUpDataIDListElement.target?.gSetDefinition(containerValue.getContainerDefinition("EthTSynGlobalTimeFollowUpDataIDListElement"))
		...
		static class EthTSynPortConfig implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.EthIf.EthIfConfigSet.EthIfController getEthTSynGlobalTimeEthIfRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthIf.EthIfConfigSet.EthIfController), "EthTSynGlobalTimeEthIfRef")
			}
			
			def void setEthTSynGlobalTimeEthIfRef(org.artop.ecuc.autosar430.accessors.EthIf.EthIfConfigSet.EthIfController object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort getEthTSynSwitchManagementEthSwitchPortRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort), "EthTSynSwitchManagementEthSwitchPortRef")
			}
			
			def void setEthTSynSwitchManagementEthSwitchPortRef(org.artop.ecuc.autosar430.accessors.EthSwt.EthSwtConfig.EthSwtPort object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
