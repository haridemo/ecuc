...
class CanTSyn implements IWrapper<GModuleConfiguration> {
	...
	def List<CanTSynGlobalTimeDomain> getCanTSynGlobalTimeDomains(){
		...
		return new BasicWrappingEList<CanTSynGlobalTimeDomain, GContainer>(filteredContainers, typeof(CanTSynGlobalTimeDomain), typeof(GContainer)) {
			override protected delegateAdd(org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain canTSynGlobalTimeDomain) {
			...
			override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain canTSynGlobalTimeDomain) {
				canTSynGlobalTimeDomain.target?.gSetDefinition(moduleConfiguration.getContainerDefinition("CanTSynGlobalTimeDomain"))
	...
	static class CanTSynGlobalTimeDomain implements IWrapper<GContainer> {
		...
		def org.artop.ecuc.autosar430.accessors.StbM.StbMSynchronizedTimeBase getCanTSynSynchronizedTimeBaseRef(){
			containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.StbM.StbMSynchronizedTimeBase), "CanTSynSynchronizedTimeBaseRef")
		}
		
		def void setCanTSynSynchronizedTimeBaseRef(org.artop.ecuc.autosar430.accessors.StbM.StbMSynchronizedTimeBase object){
			val containerDef = containerValue.gGetDefinition
			if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CanTSynGlobalTimeFupDataIDList implements IWrapper<GContainer> {
			...
			def List<CanTSynGlobalTimeFupDataIDListElement> getCanTSynGlobalTimeFupDataIDListElements(){
				...
				return new BasicWrappingEList<CanTSynGlobalTimeFupDataIDListElement, GContainer>(filteredContainers, typeof(CanTSynGlobalTimeFupDataIDListElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeFupDataIDList.CanTSynGlobalTimeFupDataIDListElement canTSynGlobalTimeFupDataIDListElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeFupDataIDList.CanTSynGlobalTimeFupDataIDListElement canTSynGlobalTimeFupDataIDListElement) {
						canTSynGlobalTimeFupDataIDListElement.target?.gSetDefinition(containerValue.getContainerDefinition("CanTSynGlobalTimeFupDataIDListElement"))
		...
		static class CanTSynGlobalTimeMaster implements IWrapper<GContainer> {
			...
			static class CanTSynGlobalTimeMasterPdu implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu getCanTSynGlobalTimePduRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu), "CanTSynGlobalTimePduRef")
				}
				
				def void setCanTSynGlobalTimePduRef(org.artop.ecuc.autosar430.accessors.EcuC.EcucConfigSet.EcucPduCollection.Pdu object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
		...
		static class CanTSynGlobalTimeOfnsDataIDList implements IWrapper<GContainer> {
			...
			def List<CanTSynGlobalTimeOfnsDataIDListElement> getCanTSynGlobalTimeOfnsDataIDListElements(){
				...
				return new BasicWrappingEList<CanTSynGlobalTimeOfnsDataIDListElement, GContainer>(filteredContainers, typeof(CanTSynGlobalTimeOfnsDataIDListElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeOfnsDataIDList.CanTSynGlobalTimeOfnsDataIDListElement canTSynGlobalTimeOfnsDataIDListElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeOfnsDataIDList.CanTSynGlobalTimeOfnsDataIDListElement canTSynGlobalTimeOfnsDataIDListElement) {
						canTSynGlobalTimeOfnsDataIDListElement.target?.gSetDefinition(containerValue.getContainerDefinition("CanTSynGlobalTimeOfnsDataIDListElement"))
		...
		static class CanTSynGlobalTimeOfsDataIDList implements IWrapper<GContainer> {
			...
			def List<CanTSynGlobalTimeOfsDataIDListElement> getCanTSynGlobalTimeOfsDataIDListElements(){
				...
				return new BasicWrappingEList<CanTSynGlobalTimeOfsDataIDListElement, GContainer>(filteredContainers, typeof(CanTSynGlobalTimeOfsDataIDListElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeOfsDataIDList.CanTSynGlobalTimeOfsDataIDListElement canTSynGlobalTimeOfsDataIDListElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeOfsDataIDList.CanTSynGlobalTimeOfsDataIDListElement canTSynGlobalTimeOfsDataIDListElement) {
						canTSynGlobalTimeOfsDataIDListElement.target?.gSetDefinition(containerValue.getContainerDefinition("CanTSynGlobalTimeOfsDataIDListElement"))
		...
		static class CanTSynGlobalTimeSyncDataIDList implements IWrapper<GContainer> {
			...
			def List<CanTSynGlobalTimeSyncDataIDListElement> getCanTSynGlobalTimeSyncDataIDListElements(){
				...
				return new BasicWrappingEList<CanTSynGlobalTimeSyncDataIDListElement, GContainer>(filteredContainers, typeof(CanTSynGlobalTimeSyncDataIDListElement), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeSyncDataIDList.CanTSynGlobalTimeSyncDataIDListElement canTSynGlobalTimeSyncDataIDListElement) {
					...
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.CanTSyn.CanTSynGlobalTimeDomain.CanTSynGlobalTimeSyncDataIDList.CanTSynGlobalTimeSyncDataIDListElement canTSynGlobalTimeSyncDataIDListElement) {
						canTSynGlobalTimeSyncDataIDListElement.target?.gSetDefinition(containerValue.getContainerDefinition("CanTSynGlobalTimeSyncDataIDListElement"))
