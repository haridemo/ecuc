	...
	static class LinSMConfigSet implements IWrapper<GContainer> {
		...
		def List<LinSMChannel> getLinSMChannels(){
			...
			return new BasicWrappingEList<LinSMChannel, GContainer>(filteredContainers, typeof(LinSMChannel), typeof(GContainer)) {
				override protected delegateAdd(org.artop.ecuc.autosar430.accessors.LinSM.LinSMConfigSet.LinSMChannel linSMChannel) {
					linSMChannel.target?.gSetDefinition(containerValue.getContainerDefinition("LinSMChannel"))
					super.delegateAdd(linSMChannel)
				}
		
				override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.LinSM.LinSMConfigSet.LinSMChannel linSMChannel) {
					linSMChannel.target?.gSetDefinition(containerValue.getContainerDefinition("LinSMChannel"))
		...
		static class LinSMChannel implements IWrapper<GContainer> {
			...
			def org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel getLinSMComMNetworkHandleRef(){
				containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel), "LinSMComMNetworkHandleRef")
			}
			
			def void setLinSMComMNetworkHandleRef(org.artop.ecuc.autosar430.accessors.ComM.ComMConfigSet.ComMChannel object){
				val containerDef = containerValue.gGetDefinition
				if (containerDef instanceof GParamConfContainerDef) {
			...
			def List<LinSMSchedule> getLinSMSchedules(){
				...
				return new BasicWrappingEList<LinSMSchedule, GContainer>(filteredContainers, typeof(LinSMSchedule), typeof(GContainer)) {
					override protected delegateAdd(org.artop.ecuc.autosar430.accessors.LinSM.LinSMConfigSet.LinSMChannel.LinSMSchedule linSMSchedule) {
						linSMSchedule.target?.gSetDefinition(containerValue.getContainerDefinition("LinSMSchedule"))
						super.delegateAdd(linSMSchedule)
					}
			
					override protected delegateAdd(int index, org.artop.ecuc.autosar430.accessors.LinSM.LinSMConfigSet.LinSMChannel.LinSMSchedule linSMSchedule) {
						linSMSchedule.target?.gSetDefinition(containerValue.getContainerDefinition("LinSMSchedule"))
			...
			static class LinSMSchedule implements IWrapper<GContainer> {
				...
				def org.artop.ecuc.autosar430.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable getLinSMScheduleIndexRef(){
					containerValue.getReference(typeof(org.artop.ecuc.autosar430.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable), "LinSMScheduleIndexRef")
				}
				
				def void setLinSMScheduleIndexRef(org.artop.ecuc.autosar430.accessors.LinIf.LinIfGlobalConfig.LinIfChannel.LinIfScheduleTable object){
					val containerDef = containerValue.gGetDefinition
					if (containerDef instanceof GParamConfContainerDef) {
