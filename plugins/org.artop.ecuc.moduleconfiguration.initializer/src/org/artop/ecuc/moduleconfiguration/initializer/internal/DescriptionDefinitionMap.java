...
public class DescriptionDefinitionMap {
	 ...
	 */
	private static HashMap<String, String> definitionDescriptionMap = new HashMap<String, String>();
	...
	static {
		...
		definitionDescriptionMap.put("DerivedEnumerationParamDef", "EnumerationValue");
		definitionDescriptionMap.put("DerivedBooleanParamDef", "BooleanValue");
		definitionDescriptionMap.put("SymbolicNameReferenceParamDef", "ReferenceValue");
		definitionDescriptionMap.put("ChoiceContainerDef", "Container");
		definitionDescriptionMap.put("ChoiceReferenceParamDef", "ReferenceValue");
		definitionDescriptionMap.put("ConfigReference", "ConfigReferenceValue");
		definitionDescriptionMap.put("ForeignReferenceParamDef", "ReferenceValue");
		definitionDescriptionMap.put("InstanceReferenceParamDef", "InstanceReferenceValue");
		definitionDescriptionMap.put("ReferenceParamDef", "ReferenceValue");
	...
	/**
	 * For getting the description node name for a particular definition node.
	 * 
